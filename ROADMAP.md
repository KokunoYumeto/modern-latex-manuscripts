...
- **Noether:** continue recursive scan audit/backfill from Papers 31-36 onward; expand checked French translation from Paper 04 onward; keep Spanish/Japanese corrections synchronized.
...
- Keep OCR/math-OCR scripts and lessons in the workflow DOI and small GitHub scripts folder.
- Treat OCR and model-generated TeX as witnesses only. Promotion requires source comparison, TeX compilation, and render checks.
- Prefer source-page/book-page manifests, small crop witnesses, and explicit continuation points over giant opaque packages.
- Keep raw/provenance archives on the main raw DOI rather than re-uploading multi-gigabyte provenance to every author record.

## Contribution Priorities

- Report bad or malformed public PDFs with page numbers and screenshots if helpful.
- Submit small TeX corrections as pull requests.
- For large artifact corrections, open an issue and link the external package/Zenodo item.
- Help identify missing scans, better source witnesses, and existing public translations.
