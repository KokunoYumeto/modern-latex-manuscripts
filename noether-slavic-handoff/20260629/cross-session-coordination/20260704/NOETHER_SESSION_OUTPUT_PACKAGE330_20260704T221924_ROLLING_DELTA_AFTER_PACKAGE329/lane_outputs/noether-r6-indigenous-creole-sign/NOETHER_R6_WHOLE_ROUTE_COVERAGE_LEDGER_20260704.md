...
Source-canon overlay: `NOETHER_R6_SOURCE_CANON_STRICT_PROVENANCE_WITNESS_TABLE_20260704.csv` adds 83 strict source-witness rows with URLs, hashes, local paths, license signals, and topic/language/access tags. `NOETHER_R6_NON_SOURCE_GUARDRAIL_ROWS_20260704.csv` separates 10 International Sign comparator policy/question rows that are not source witnesses. `NOETHER_R6_SOURCE_CANON_EXPLICIT_GAP_LEDGER_20260704.csv` adds 72 explicit source/source-archive/GitHub-source-repository gap rows. These overlays do not change any gate count.
