...
|---|---:|---|
| `explicit_blocker_only` | 36 | Target appears only in explicit gap/blocker rows. |
| `retry_capture_plus_explicit_blockers` | 5 | Target has a dated retry-capture addendum, but reviewer/source-owner and reuse gates remain explicit blockers before support movement. |
