...
- Latest package352 adjacent-lane/source-corpus upload-watch validation shape before heartbeat drift recheck: `JSON_OK 22`, `CSV_OK 18`, `CHECKSUM_PAYLOAD_FILES 61`, and zero-gate boundary review unchanged at zero counts after manifest refresh. Heartbeat drift recheck adds one Markdown/JSON/CSV triplet and requires manifest refresh to `JSON_OK 23`, `CSV_OK 19`, and `CHECKSUM_PAYLOAD_FILES 64`.
