...
|---|---|---|
| `AGENTS.md` on branch `codex/noether-pc-20260629` | Read from the safe checkout root on branch `codex/noether-pc-20260629` | Source canon comes before translation. R6 must maintain witness/gap rows, not translation outputs. |
...
Safe checkout observed read-only on branch `codex/noether-pc-20260629` at `45393348e2debe0c2fa347b5e4fa5346f6b12825` (`Add Noether package 352`). `git status --short` showed B3-owned untracked drift at `noether-source-corpus-provenance/20260704/NOETHER_ALL_LOCAL_LATEX_SOURCE_CANON_UPLOAD_20260704T212224Z/`. R6 did not stage, clean, modify, commit, or push it. The parent ledger's Loop Check 79 also records package `352` as the observed pushed package frontier and states that package `353+` drift belongs to B3.
...
| `NOETHER_R6_B3_PACKAGE_BOUNDARY_AUDIT_20260704.csv` | 43 | Per-file package classification for stable non-checksum R6 metadata outputs, excluding audit self-files and checksum manifests. |
...
| B3 package-boundary stable non-checksum files classified | 43 |
