...
| `exact_named_language_source_capture_required` | 28 | Named-language math/STEM source URL, local path, byte count, SHA-256, language/topic tags, and source-owner/reviewer route. |
| `current_gap_retry_required` | 8 | Successful exact source capture or updated failure payload hash, with locator provenance preserved and no R6 source-body package payload. |
