...
| `K-SB-PKG-022` | `SESSION_K_SINGLE_THREAD_GITHUB_GOVERNANCE_RESPONSE_20260705` | md; json; csv | canonical single-thread GitHub governance response sidecar | package as governance response and B3 intake sidecar |
| `K-SB-PKG-023` | `SESSION_K_ACTIVE_ROW_BUCKET_DRAFT_AND_ACQUISITION_20260705` | md; json; csv | active row bucket classification with draft scaffolds and acquisition gaps | package as active-row bucket/draft/acquisition support sidecar |
