...
## Bosnian Modern COBISS Route Recheck

Observation time: 2026-07-05T14:24:30+02:00

Current steering remains source-canon-first. Translation/render/package-output churn remains parked except for source-canon witness usability and package-readiness.

Motivation:

- Bosnian remained an open source blocker and the live URL reachability snapshot still carried a stale `plus-legacy.cobiss.net` timeout.
- The useful source-canon fix was not to promote translation terms, but to replace the stale live bibliographic route with current COBISS Plus routes while keeping the official PMF textbook body/source blocker open.
- The Bosnian row must remain anchored in PMF/COBISS/staff-page controls, with the Scribd mirror/preview retained as candidate-only and not promoted.

Evidence added:

- Current COBISS Plus detail routes for `COBIB 23757574` were cached for NBMO, NUBBIH, and KBZE library contexts.
- Current COBISS Plus author-search and PMFSA subject-search routes were cached as findability corroboration.
- The detail routes returned local phrase hits for `Algebra za kompjuterske nauke`, `Muratović-Ribić`, ISBN `978-9958-592-88-1`, `23757574`, `210 str`, `Prirodno-matematički fakultet`, Bosnian language, printed-book/textbook signals, and COBISS markers.
- A compact phrase-hit bundle was generated as `outputs\source_canon_witness_cache_20260704\bs_cobiss_modern_route_phrase_hits_20260705.csv`.
- The stale live legacy COBISS URL was removed from the main Bosnian row URL list; older legacy cache remains historical local support only when present.

Generated/updated artifacts:

- New `NOETHER_SLAVIC_SOURCE_CANON_BOSNIAN_COBISS_MODERN_ROUTE_RECHECK_20260704.csv/json/md`: CSV SHA256 `1DA1324FD93A8EA277FB1C61355EE55F7C2DC3FE2D1A679141AE2D6E9F40E917`; JSON SHA256 `999E4FB6961366B2F81FC8C4FD42E04703EDD5A4B8165E5F97EDF691D7033BCD`; Markdown SHA256 `397A91CD889D195C32A9866C15AF078646BC51C03890B75DF450BEAEB41378E9`.
- New compact phrase-hit bundle `bs_cobiss_modern_route_phrase_hits_20260705.csv`: SHA256 `827DAA225017F641E087F2709B1F4679ABCEB35A4C7D1F5C0316D2CAF4231A21`.
- New generator `tools/update_source_canon_bosnian_cobiss_modern_route_recheck_20260704.ps1`: SHA256 `D519C0A8980FD317BE664A071DF7BE119490C021BB7CC3C46750C09FA13BE873`.
- Patched Bosnian WP probe generator for modern-COBISS durability: `tools/update_source_canon_bosnian_wp_probe_recheck_20260704.ps1`: SHA256 `97160D8B2A3CF9308012180BEB3117AC26169C452419907965A6639D288BFEB2`.
- Patched blocker matrix generator `tools/update_source_canon_blocker_trigger_matrix_20260704.ps1`: SHA256 `AD82BCDB915AB959D02EEFDEDF58D0B9477973510AB91D3DAD9E3A19FD0769C0`.
- Patched open-blocker queue generator `tools/update_source_canon_open_blocker_queue_20260704.ps1`: SHA256 `508B07511503B1B43400FE91A82454CB497175F1B65EEC6C45E4FCBDFA3D9643`.
- Main witness table refreshed: CSV SHA256 `10EEFB5639AE27774A73A1665F89D43C44173536544DBC34150E719123370335`; JSON SHA256 `590D2B7F7336722B3399A7FC28B69F0A2B08BECC9B0BF9E22AD7E20EE5EC3F73`; Markdown SHA256 `5C252D8641E62E0451B6354D1F5C1ACA41280B5AC8E23EB6E0E67D1337504F94`.
- Cache inventory refreshed: `97` cache files, `92` referenced by main, `97` referenced by any source-canon artifact, `0` unreferenced; CSV SHA256 `C0EDEBCC953274BC7C2CCFC0FE99CCF881ED36874E8308A246A8FD6269230447`.
- Access-boundary audit refreshed: `30` rows, `0` permission claims, `0` review claims, `0` translation triggers; CSV SHA256 `81795349A097A7651B4CC086AA7516E38059F83FBB3FD4C91D8DEF2299FA4E0D`.
- Blocker/trigger matrix refreshed: `14` rows; CSV SHA256 `D0CE2083CBE6A64F55FCDCB135736A3C831F256C539693A73E57F361020E4874`.
- Open-blocker queue refreshed: `14` rows, `4` open blockers, `10` watch-only rows, `0` active rebuild triggers, `0` claims present; CSV SHA256 `76095E3B15BA785E083A44CBF0911F03432EE080303DA979F12EFCF2219A3B95`.
- Non-contamination audit refreshed: `6` checks, `0` non-pass; CSV SHA256 `29092120CEAFF055AA4351971CAE930407B5F834522389012A469C2C07F162E0`.
- URL reachability refreshed after replacing the stale legacy URL: `95` distinct URLs, `95` live reachable, `0` non-reachable or blocked; CSV SHA256 `AACF9EF4916857615DB6D1186946C3B660BB64E37BAFD4522C1303FE5A45E0AB`.
- Handoff manifest was refreshed before this log append: CSV SHA256 `B2A90EAB9730ADFFCF089A4AC00A94B28EE44A22A40841EBAF60A62E6EED8754`. It will be refreshed again after this append so B3 receives the current run-log hash.

Watcher/usability fix:

- Bosnian current state now says `official_control_plus_modern_cobiss_and_third_party_candidate_no_authority_upgrade`.
- The exact blocker now says official PMF/current COBISS Plus/staff-page controls exist, third-party Scribd mirror/preview lead exists, and official fulltext/source or permission-clean copy remains blocked.
- The action route now points to the official PMF Sarajevo textbook/fulltext/source route with current COBISS Plus and PMF controls already cached, and explicitly says to avoid third-party mirror promotion.
...
Bosnian is strengthened from stale legacy COBISS bibliographic findability into current COBISS Plus route evidence with local hashes and zero reachability exceptions. The blocker remains open because no official PMF textbook fulltext/source package, permission-clean copy, qualified native review, canonical approval, accepted correction, license clearance, gate promotion, translation completion, reader rebuild, or Git push is claimed by this lane.

## Interslavic/Panslavic Publication-Route Recheck

Observation time: 2026-07-05T15:14:22+02:00

Current steering remains source-canon-first. Translation/render/package-output churn remains parked except for source-canon witness usability and package-readiness.

Motivation:

- Interslavic/Panslavic remained an open source blocker because the row had useful wiki and dictionary/source-package legibility controls but no publication-level mathematical authority.
- The next useful action was to make the route gap explicit: cache stable dictionary controls, stable wiki revision/API controls, and arXiv route probes, then keep the row blocked for mathematical authority.
- The broad-legibility evidence is useful for cross-Slavic readability, but it must not be treated as canonical terminology approval, source-level mathematical publication, native review, or license clearance.

Evidence added:

- Live Jan van Steenbergen dictionary controls were cached over HTTP after HTTPS refused connections: `ms-en.html`, `ms-pl.html`, and `nms-en.html`.
- The two main Steen dictionary controls contain live term hits for algebra, algoritm, matematika, grupa, koljce, prstenj, polje, matrica, vektor, and modul; the NMS control contains matematika/grupa evidence.
- Stable isv.wikipedia Algebra `oldid=3553` HTML plus MediaWiki API revision metadata for Algebra and Matematika were cached to make the wiki witness reproducible.
- arXiv API route probes were cached for `all:Interslavic`, `all:Interslavic AND all:algebra`, and `all:medzuslovjansky`; each returned `0` total results. These are negative route probes only, not non-Slavic authority evidence.
- The row remains anchored in Wikimedia/Steen/medzuslovjansky/slovnik/arXiv route evidence and not in any claimed publication-level mathematical authority.

Generated/updated artifacts:

- New `NOETHER_SLAVIC_SOURCE_CANON_INTERSLAVIC_PUBLICATION_ROUTE_RECHECK_20260704.csv/json/md`: CSV SHA256 `043E376A5013BB49E364788D7A2BC6E5D3C6F816356AC3AB88AF15F1EA10D0E2`; JSON SHA256 `29C1A5CBA3FD70ECB9DBC1ABD76488B0399445B3F082834EEAE785225265DA42`; Markdown SHA256 `B59A6B4E65E6C0265BEE1603EB52933D32637ED0941425E69DCEF111C81614E3`.
- New generator `tools/update_source_canon_interslavic_publication_route_recheck_20260704.ps1`: SHA256 `38D6241CD2FDF6BC87958B8E3AEC0FF01023B3EA3021CC5DD69F6B7EEE556156`.
- Patched slovnik source-package generator for publication-route durability: `tools/update_source_canon_interslavic_slovnik_package_recheck_20260704.ps1`: SHA256 `FD681CCCC55FE9D86E2EEF48F8CC1441122D04B6F394DE3DD7C30E37141D0093`.
- Patched blocker matrix generator `tools/update_source_canon_blocker_trigger_matrix_20260704.ps1`: SHA256 `B1D6638C6CC1533D8308DF1254F701EDF70AFD703E5F38A36E4DF7C1E80FBF8A`.
- Patched open-blocker queue generator `tools/update_source_canon_open_blocker_queue_20260704.ps1`: SHA256 `73F3D20D28EF3E73143546FC52525ABD17D4D7FCF798D68D4DFBA77735BCDFF8`.
- Main witness table refreshed: CSV SHA256 `9891F8940FCD8C01940EDD295AA5D65833FA02D702019EF9F49ABD2D1499AC4E`; JSON SHA256 `09C8D983158CBBE7FFB1C9685D204BCA9DB7F9A58B38A8F692DDDD859855D2BC`; Markdown SHA256 `F243AAB047496DFE874657D48672B0ABC61902A82415F22DE682144437E3FD50`.
- Cache inventory refreshed: `106` cache files, `101` referenced by main, `106` referenced by any source-canon artifact, `0` unreferenced; CSV SHA256 `73A4AEC2A875578BB8ACADEA88EE26632992030F8BE63274FBDA94FC1223A0B1`.
- Access-boundary audit refreshed: `30` rows, `0` permission claims, `0` review claims, `0` translation triggers; CSV SHA256 `A61A02DB31504FEE826C6582BF468A5CD1DD186C97DC2878386692D7F23CF29C`.
- Blocker/trigger matrix refreshed: `14` rows; CSV SHA256 `FE4B8DC6B0016D6D22D5C8488F99E00893779E01294101765E32A9072092F3EE`.
- Open-blocker queue refreshed: `14` rows, `4` open blockers, `10` watch-only rows, `0` active rebuild triggers, `0` claims present; CSV SHA256 `9FDCF5CB5B8CEE5BFD24B501F44B5B65BF190DF27C1C347B22FAB5CBC6D8D5F7`.
- Non-contamination audit refreshed: `6` checks, `0` non-pass; CSV SHA256 `CDC527A07F4C409F7FF77E46FED9F5E6E675230146A78EC1FD03CEF20971405F`.
- URL reachability refreshed: `104` distinct URLs, `102` live reachable, `2` headers-only exceptions; CSV SHA256 `589FC270F4F96F4840E160AF868245D7EF926810233FD6A8239CF99F88B0878D`.
- Handoff manifest was refreshed before this log append: CSV SHA256 `9318DE143D14074F0130553564ABD29E85E160BF9DEDAB9E5F50339049C38EB1`. It will be refreshed again after this append so B3 receives the current run-log hash.
...
- Interslavic/Panslavic current state now says `source_package_lexicon_plus_publication_route_witness_blocked`.
- The exact blocker now names stable isv.wikipedia/Incubator Algebra raw wikitext, Steen dictionary controls, medzuslovjansky/slovnik dictionary source-package lexicon evidence, wiki revision/API controls, and arXiv route probes as cached evidence.
- The action route now asks for publication-level Interslavic/Panslavic mathematical source, target-language mathematical TeX/e-print source package, or qualified review; current Wikimedia, Steen dictionary, slovnik source-package, and arXiv route evidence remains scouting-only.
...
Interslavic/Panslavic is strengthened from source-package lexicon plus direct wiki evidence into a fuller publication-route witness with live Steen dictionaries, stable wiki revision/API controls, medzuslovjansky/slovnik source-package evidence, and negative arXiv route probes. The blocker remains open because no publication-level mathematical source, target-language TeX/e-print mathematical source package, qualified native review, canonical approval, accepted correction, license clearance, gate promotion, translation completion, reader rebuild, or Git push is claimed by this lane.

## Sorbian Wiki/Body-Route Retry

Observation time: 2026-07-05T15:52:39+02:00

Current steering remains source-canon-first. Translation/render/package-output churn remains parked except for source-canon witness usability and package-readiness.

Motivation:

- Sorbian Lower and Upper remained open source blockers because catalog/source-package routes were strong, but the actual WITAJ/Domowina mathematics terminology booklet/corpus bodies were not locally inspected.
- A web retry did not expose a permission-clean booklet body, but it did surface an official/public Stiftung/zalozba spreadsheet route for the Upper Sorbian mathematics terminology item.
- DSB/HSB Wikipedia mathematics pages are useful target-language broad-legibility controls for mathematics terms, but they are not the missing booklet bodies or qualified review returns.

Evidence added:

- Public Stiftung/zalozba XLSX `2025_kat-3-zakladna_g.xlsx` was cached and parsed. One matching row was extracted: `0/122/08-1A | 1359-0 | Terminologija za matematiku | 4.9000000000000004`.
- Lower Sorbian Wikipedia `Matematika` HTML and raw wikitext were cached. Evidence hits include `matematika`, `algebra`, `analyzis`, `licbowa`, `topologija`, `graśowa`, `aksiom`, and `dopokaz`.
- Upper Sorbian Wikipedia `Matematika` HTML and raw wikitext were cached. Evidence hits include `matematika`, `algebra`, `analyzis`, `ličbowa`, `topologija`, `hrajna`, `aksiom`, and `dopokaz`.
- These routes improve findability and broad Sorbian mathematical legibility only. They do not expose the WITAJ/Domowina terminology booklet bodies, corpus text, TeX/source packages, or permission-clean source copies.

Generated/updated artifacts:

- New `NOETHER_SLAVIC_SOURCE_CANON_SORBIAN_WIKI_BODY_ROUTE_RETRY_20260704.csv/json/md`: CSV SHA256 `3A010C2FEEEB0516685F072FE45B7DFC4AC6BFA56EAC15D922EEB6B4930F6A75`; JSON SHA256 `7148045F34D8471D05014B03A0B4DE74C6D9195216218F3EC108A38C41E41282`; Markdown SHA256 `C876F8131A16555C4F46A74BA30AD163C8A560B9D22D645F2ABD302FD780E20C`.
- New generator `tools/update_source_canon_sorbian_wiki_body_route_retry_20260704.ps1`: SHA256 `4787B5BD9A5181826E72328FB7F35F74AA5934F909B04496A882C0DC53A7A522`.
