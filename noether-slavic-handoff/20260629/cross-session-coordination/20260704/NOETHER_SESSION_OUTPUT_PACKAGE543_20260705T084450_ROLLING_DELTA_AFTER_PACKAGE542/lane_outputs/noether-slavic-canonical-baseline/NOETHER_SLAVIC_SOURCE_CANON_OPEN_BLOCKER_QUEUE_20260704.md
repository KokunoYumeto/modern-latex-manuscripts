...
| P1_open_blocker | Interslavic/Panslavic | Stable isv.wikipedia and Wikimedia/Incubator Algebra raw wikitext are cached; no publication/source-package authority or qualified review exists. | publication-level Interslavic/Panslavic mathematical source, mathematical TeX/e-print source package, or qualified review route; Wikimedia and slovnik source-package lexicon evidence remain scouting-only | Publication-level source, stable source package, or qualified review establishing specific terms. |
