...
| `NOETHER_FA_IR_PRS_AF_CORPUS_TRANSLATION_SLICES_DRAFT_20260704.md` | Corpus translation sidecar for fa_IR and prs_AF, currently slices 001-074 | `86E484EB300C385B0A4B909A295E5EADEE14891B17B3D88DB7FAFE8E94C72D39` |
...
| --- | --- | --- |
| 075 onward | lines 11758 onward | Continue `Idealtheorie in Ringbereichen` at §5, greatest primary components, relatively-prime irreducible ideals, isolated ideals, product decompositions, and module extension. |
...
- Current corpus artifact has slices 001-074.
- Current coverage reaches German baseline line 11757, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, then continue `Idealtheorie in Ringbereichen` at line 11758.
