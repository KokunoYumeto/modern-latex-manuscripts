...
| P1_open_blocker | Interslavic/Panslavic | Stable isv.wikipedia/Incubator Algebra raw wikitext and medzuslovjansky/slovnik dictionary source-package lexicon evidence are cached; no publication-level mathematical authority, TeX/e-print mathematical source, or qualified review exists. | publication-level Interslavic/Panslavic mathematical source, mathematical TeX/e-print source package, or qualified review route; Wikimedia and slovnik source-package lexicon evidence remain scouting-only | Publication-level mathematical source, TeX/e-print/source package for a mathematical text, or qualified review establishing specific terms. |
