...
- Optional Belarusian/Macedonian/Sorbian mathematical-register controls remain an extension gap, not a current package-stability blocker.
...
4. Preserve Slavic canonical output unless a logged rebuild trigger appears.
