...
| `ES-B-002` / `ES-GAP-004` | Spanish | GitHub API `repo.license` null; license endpoint 404; local archive has no LICENSE/COPYING match | Retain explicit repository license gap before reuse beyond provenance. |
