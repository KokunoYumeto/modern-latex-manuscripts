...
| decision | count |
|---|---:|
| `blocked_language_nlp_or_linguistics_record` | 18 |
...
| `defer_requires_source_body_language_domain_review` | 2 |
...
| `language_or_linguistics_record_not_math_corpus` | 2 |
| `language_or_nlp_record_not_math_corpus` | 16 |
| `math_or_math_education_named_in_metadata` | 2 |
...
Two math-education records, for Somali-school and Yoruba/mother-tongue contexts, are retained as possible acquisition leads only. The Tigrinya/Tigrigna TrOCR record is OCR-method context only. All still require exact source body capture, language/domain confirmation, license/access review, and a separate source gate before they can support source canon.
