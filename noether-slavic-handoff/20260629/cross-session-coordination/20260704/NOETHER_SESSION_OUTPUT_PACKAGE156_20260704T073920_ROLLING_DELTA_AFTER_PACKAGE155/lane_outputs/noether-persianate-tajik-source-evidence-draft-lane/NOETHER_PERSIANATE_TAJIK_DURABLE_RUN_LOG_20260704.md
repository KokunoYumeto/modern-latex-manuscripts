...
| `NOETHER_FA_IR_PRS_AF_CORPUS_TRANSLATION_SLICES_DRAFT_20260704.md` | Corpus translation sidecar for fa_IR and prs_AF, currently slices 001-069 | `5510E41A76E48474CABA05271131B8031DF14E7B14E874A493828219F09F4B66` |
...
| --- | --- | --- |
| 070 | lines 11252-11276 | Short 1921 conference contribution on Hentzelt elimination theory and resultant form. |
| 071 onward | lines 11279 onward | `Idealtheorie in Ringbereichen`; major ideal/ring-domain source unit, continue slice-by-slice and compare supplemental repair only if later paper number enters P35/P36/P38/P39/P40 scope. |
...
- Current corpus artifact has slices 001-069.
- Current coverage reaches German baseline line 11249, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, then continue at the next real source unit after line 11249.
