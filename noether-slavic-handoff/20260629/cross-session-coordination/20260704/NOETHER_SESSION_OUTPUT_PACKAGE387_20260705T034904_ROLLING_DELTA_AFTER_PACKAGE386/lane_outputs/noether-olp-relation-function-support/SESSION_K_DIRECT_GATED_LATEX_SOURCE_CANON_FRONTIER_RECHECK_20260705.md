...
- Final observed tracked head for this refresh: `dafe22eef6737a2b3e14dc9ac0b6adb2cc055316` (`Add Noether package 383`).
- Git status at final recheck: untracked package 384 B3-owned package drift after package 383.
...
- Final frontier note: package 381 was later tracked, packages 382 and 383 were pushed, and package 384 was observed as untracked B3-owned drift. Package 382 recorded 4 omitted raw source-body rows rather than copying those raw source bodies into the package.
...
| Package 380 | tracked pushed package observed | 7 copied non-zip files; 0 omitted zips; 0 omitted raw source bodies; copied bytes 145,953; lane R9 7; combined SHA `23CCAF1929A65A9DDBB607AC5B951FBD2E38F1149CC512AE8A129F14ED587C69`. | Record as package-frontier metadata from the package advance sequence. |
| Package 381 | tracked pushed package observed | 1 copied non-zip file; 0 omitted zips; 0 omitted raw source bodies; copied bytes 459,041; lane parent 1; combined SHA `96F2872ADE61EE14B0E417BC0E3D00FE0F6132C19119072163E50647396773FF`. | Record as package-frontier metadata from the package advance sequence. |
| Package 382 | tracked pushed package observed | 10 copied non-zip files; 0 omitted zips; 4 omitted raw source bodies; copied bytes 103,415; lane CJK native/source evidence 10; combined SHA `C627CEF79C222C0F9B8B74379CB2C79EB0F1883E61CF0A390E20CFE2BA550E2F`. | Record package metadata and omitted-raw-source manifest pointer only; Session K does not inspect or copy raw source bodies. |
| Package 383 | final tracked pushed frontier observed | 11 copied non-zip files; 0 omitted zips; 0 omitted raw source bodies; copied bytes 248,694; lanes Session K OLP 5 and Slavic canonical baseline 6; combined SHA `39846B581698EE667678308C27D8AE247A152425F5D4724C4FA994484D1AA626`. | Record as final tracked pushed frontier for this refresh; Session K did not package or push. |
| Package 384 | untracked B3-owned package drift observed | 18 copied non-zip files; 0 omitted zips; 0 omitted raw source bodies; copied bytes 365,961; lanes Session K OLP 3 and Slavic canonical baseline 15; combined SHA `D83268685387FC78B406206D5788B3BBC3D8E609FF734EC522A7E5AC63458F47`. | Record as untracked package drift only; Session K does not stage, clean, commit, or push. |
...
Package 382 includes `NOETHER_SESSION_OUTPUT_PACKAGE382_OMITTED_RAW_SOURCE_BODIES.csv` with 4 omitted raw source-body rows from the Slavic canonical baseline lane, totaling 42,531,744 source bytes. The omission manifest SHA-256 is `DDFA2E58ADE732F2BEB445CACDFB4B9711B77284E3D5F2C4043407BD8B733C05`.

Session K records these omission manifests as source-canon boundary pointers only. It does not copy the omitted raw source bodies, inspect their contents, route Persianate/Tajik, Romance, CJK, or Slavic language content, or assert source permission, license clearance, translation evidence, reviewer return, approval, or canonical status.
