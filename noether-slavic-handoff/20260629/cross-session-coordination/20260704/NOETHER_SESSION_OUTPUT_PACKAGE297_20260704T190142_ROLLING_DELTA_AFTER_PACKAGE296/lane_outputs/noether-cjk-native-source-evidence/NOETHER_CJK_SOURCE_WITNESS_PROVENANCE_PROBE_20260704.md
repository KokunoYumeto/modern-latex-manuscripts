...
Generated UTC: `2026-07-04T16:59:55Z`
...
- GitHub repositories probed: `16`; repositories without API-exposed license endpoint keys: `10`.
...
| `T2sp/rep` | `main` | `none_exposed` | `none_or_error` | `03/06/2025 09:44:52` | Response status code does not indicate success: 404 (Not Found). |
| `naoki-cpp/physics` | `master` | `none_exposed` | `none_or_error` | `07/04/2026 07:10:52` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `A-H4NU/kaist-math-notes` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `Hacker-Code-J/Modern-Mathematics` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `calofmijuck/algebra` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `younghu-kim/rdl-resonant-detection` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `EasonSYC/maths-notes` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `KelvinHoKaHim/undergraduate-mathematics` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `24dakenlo/math_remedial` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |
| `masamichiIto/seminar_materials` | `` | `none_exposed` | `none_or_error` | `` | Response status code does not indicate success: 403 (rate limit exceeded). |

## CTAN Metadata

| Package | Version | License | Topics | URL |
| --- | --- | --- | --- | --- |
| `ctex` | `2.6.1` | `"lppl1.3c"` | `tagged-pdf-incompatible,class,book-pub,chinese` | https://ctan.org/pkg/ctex |
| `xecjk` | `3.10.1` | `"lppl1.3c"` | `chinese,tagged-pdf-unsupported,japanese,korean,xetex` | https://ctan.org/pkg/xecjk |
| `luatexja` | `20260517.0` | `"bsd"` | `japanese,tagged-pdf-partially,class,macro-gen,luatex` | https://ctan.org/pkg/luatexja |
| `kotex-utils` | `2.1.0` | `"lppl1.3c"` | `korean,index` | https://ctan.org/pkg/kotex-utils |
