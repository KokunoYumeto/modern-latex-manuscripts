...
| --- | --- | --- |
| 083 onward | lines 12463 onward | Continue next real source unit, `Ein algebraisches Kriterium für absolute Irreduzibilität`. |
...
- Current coverage reaches German baseline line 12462, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, then continue the next real source unit at line 12463.
