...
Status: `session_b_consumption_sidecar_no_git_push_no_source_text_no_mapping_no_translation_no_approval`
...
Boundary: package consumption metadata only. It is not a branch commit, push, PR update, reviewer return, mapping decision, translation, approval, or readiness claim.
