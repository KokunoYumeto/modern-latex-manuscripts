...
|---|---:|---|
| `explicit_blocker_only` | 25 | Target appears only in explicit gap/blocker rows. |
...
| `route_retry_metadata_blocker` | 8 | Target has dated route-retry metadata, but source-body access is still blocked and no support movement is allowed. |
