...
| `NOETHER_FA_IR_PRS_AF_CORPUS_TRANSLATION_SLICES_DRAFT_20260704.md` | Corpus translation sidecar for fa_IR and prs_AF, currently slices 001-049 | `A4E4DEF93B4486DA9C5848ECE4F45061FD75314CE5B784D97047DACCB32D7C88` |
...
| --- | --- | --- |
| 050 | lines 8469 onward | `Invariante Variationsprobleme`; map before drafting because it introduces variational, conservation-law, and physics-adjacent vocabulary. |
...
- Current corpus artifact has slices 001-049.
- Current coverage reaches German baseline line 8466, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, then map and append slice 050 beginning at German baseline line 8469.
