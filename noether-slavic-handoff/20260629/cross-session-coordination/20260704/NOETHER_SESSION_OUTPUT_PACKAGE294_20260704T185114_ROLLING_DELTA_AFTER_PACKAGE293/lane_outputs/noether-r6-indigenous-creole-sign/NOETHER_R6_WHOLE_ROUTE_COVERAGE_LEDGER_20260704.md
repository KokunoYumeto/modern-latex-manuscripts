...
Source-canon overlay: `NOETHER_R6_SOURCE_CANON_WITNESS_TABLE_20260704.csv` adds 93 source-witness rows with URLs, hashes, local paths, license signals, and topic/language/access tags. `NOETHER_R6_SOURCE_CANON_EXPLICIT_GAP_LEDGER_20260704.csv` adds 69 explicit source/source-archive gap rows. These overlays do not change any gate count.
...
|---|---:|---:|---|
| Indigenous Americas | 4 | 31 | Peru Quechua Central, Quechua Chanka, and Aymara official PDF/text witnesses plus Bolivia Quechua candidate; unresolved official/source-archive rows remain blockers. |
...
| Signed language comparator | 14 | 0 | International Sign comparator/guardrail rows only; no local signed-language source authority. |
...
| Slice 01C Bolivia Quechua candidate | 1 candidate exact curriculum PDF | Candidate exact source pointer exists. | Authority/scope/reuse absent; math-specific route unresolved. |
...
|---|---|---|---|
| Paraguay Guarani | MEC/PRODEPA resolver rows | Slice 02 | Exact source capture plus Guarani/source-owner review route. |
| Bolivia Quechua longitudes | red.minedu resolver row | Slice 02 | Exact PDF capture and local scope classification. |
| Ecuador EIB | official EIB pages and fallback context row | Slice 02 | Exact language/level PDFs and reviewer route. |
| Guatemala Uspanteko | DIGEBI route | Slice 02 | Exact math PDF/download and Uspanteko/source-owner review. |
...
| Bislama | Vanuatu Matematiks/Saens routes | Slice 02 | Exact official PDFs and Bislama reviewer/source-owner return. |
| Papiamento/Papiamentu | Aruba Map/Rampa and policy rows | Slice 02 | Current exact catalog PDFs and orthography/register classification. |
...
## Completion Test For R6 Coverage

The route-coverage objective for local evidence is satisfied when:
...
Current result: satisfied for local artifact coverage as of 2026-07-04. R6 is not translation-complete, authority-complete, reviewer-complete, or pilot-ready. It is covered for responsible corpus-support continuation.
