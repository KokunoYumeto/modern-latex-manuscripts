...
| Run Zenodo/current-reader integration fix pass | Continue after local R6 coverage completion without pretending R6 is a completed reader or translation lane. | `NOETHER_R6_ZENODO_CURRENT_READER_INTEGRATION_FIXPASS_20260704.md` and `NOETHER_R6_ZENODO_CURRENT_READER_INTEGRATION_MANIFEST_20260704.json`. |
...
| Source-canon witness table | `NOETHER_R6_SOURCE_CANON_WITNESS_TABLE_20260704.md` and `NOETHER_R6_SOURCE_CANON_WITNESS_TABLE_20260704.csv` | 93 source witness rows with URLs, hashes, local paths, license signals, and access tags; no source-authority promotion. |
| Explicit source gap ledger | `NOETHER_R6_SOURCE_CANON_EXPLICIT_GAP_LEDGER_20260704.csv` | 69 exact-source/source-archive blocker rows with durable gap IDs and next gates. |
...
## Completed Follow-On Integration Pass

After R6 local coverage completion, this run moved to a Zenodo/current-reader integration/fix pass. `NOETHER_R6_ACCESS_SOURCE_SLICE_QUEUE_20260704.csv` records this as `R6-INTEGRATION-01`. The pass is limited to package/index wording and sidecar metadata:
