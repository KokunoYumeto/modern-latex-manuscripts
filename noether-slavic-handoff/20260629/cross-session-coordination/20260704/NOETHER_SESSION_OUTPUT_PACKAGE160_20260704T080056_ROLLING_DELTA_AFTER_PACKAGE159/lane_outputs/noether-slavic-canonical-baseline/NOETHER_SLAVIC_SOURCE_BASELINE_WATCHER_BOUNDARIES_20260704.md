...
9. Rebuild `EXTERNAL_REVIEW_RETURN_STATUS_20260628.json` if return files are added.
10. If accepted corrections exist, apply only accepted rows, rebuild affected TeX/PDF streams, rerun validators, update manifests, and regenerate package hashes.
