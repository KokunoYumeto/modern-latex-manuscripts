...
Institutional license/access probe addendum:

- `FR-C-007`: follow-up probes of the author home page, ACGA course page, direct PDF, University of Rennes legal page, and University regulation PDF found no permissive course-PDF reuse grant. The University legal page provides intellectual-property/reproduction-reserved context, so the rights/license gap is deepened but not cleared.
- `FR-C-010`: follow-up probes of the author home page, M2 teaching page, direct GIT PDF, and IMJ-PRG legal page found no permissive course-PDF reuse grant. The teaching page includes separate not-to-diffuse reference context and the IMJ-PRG legal page provides conditions/intellectual-property context, so the rights/license gap is deepened but not cleared.
- Supporting artifacts: `NOETHER_ROMANCE_SOURCE_CANON_FRENCH_INSTITUTIONAL_LICENSE_PROBES_20260704.csv`, `NOETHER_ROMANCE_SOURCE_CANON_FRENCH_INSTITUTIONAL_LICENSE_PROBES_CLASSIFIED_20260704.csv`, and `NOETHER_ROMANCE_SOURCE_CANON_FRENCH_INSTITUTIONAL_LICENSE_GAP_ADDENDUM_20260704.md`.
