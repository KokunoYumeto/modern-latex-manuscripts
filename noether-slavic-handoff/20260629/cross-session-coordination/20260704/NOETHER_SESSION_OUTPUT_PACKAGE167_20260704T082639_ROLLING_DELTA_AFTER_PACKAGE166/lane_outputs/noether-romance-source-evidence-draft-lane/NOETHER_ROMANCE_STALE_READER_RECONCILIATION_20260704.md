...
- `NOETHER_ROMANCE_SUPPLEMENTAL_REPAIR_SOURCE_FIDELITY_PASS_20260704.md`
...
The supplemental repair-source fidelity pass confirms the R13 and R14 source anchors against the repair cumulative and does not change consolidated row coverage.
