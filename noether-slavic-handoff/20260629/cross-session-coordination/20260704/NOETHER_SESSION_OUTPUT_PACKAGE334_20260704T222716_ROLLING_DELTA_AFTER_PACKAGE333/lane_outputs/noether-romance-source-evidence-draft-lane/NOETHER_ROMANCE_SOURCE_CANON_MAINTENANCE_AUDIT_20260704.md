...
| license/access signal: recorded | 11 |
| license/access signal: recorded_blank_api_field | 7 |
| license/access signal: weak_or_gap_recorded | 8 |
...
| `FR-C-007` | French | Mourougane PDF URL HTTP 200; license not found | Treat as local provenance/PDF fallback unless license/access status is verified. |
| `FR-C-008`, `FR-C-009` | French | Numdam pages HTTP 200; license/access terms not normalized | Normalize Numdam access/license terms before any redistribution or clearance claim. |
| `FR-C-010` | French | Marche GIT PDF URL HTTP 200; license not found | Treat as local provenance/PDF fallback unless license/access status is verified. |
...
| `ES-C-009` | Spanish | UBA listing/PDF URL HTTP 200; license not found | Treat as local provenance/PDF fallback; semisimple bridge remains review-sensitive. |
| `ES-C-010` | Spanish | Dialnet PDF URL HTTP 200; license not found | Treat as PDF fallback; bibliographic metadata remains thin. |
