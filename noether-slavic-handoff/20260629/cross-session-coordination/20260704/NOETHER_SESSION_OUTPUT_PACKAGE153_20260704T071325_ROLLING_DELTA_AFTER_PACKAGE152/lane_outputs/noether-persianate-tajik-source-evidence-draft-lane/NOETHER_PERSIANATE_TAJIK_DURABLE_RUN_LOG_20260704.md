...
| `NOETHER_FA_IR_PRS_AF_CORPUS_TRANSLATION_SLICES_DRAFT_20260704.md` | Corpus translation sidecar for fa_IR and prs_AF, currently slices 001-048 | `48CD3960FABC8D2F983A73FF915774F248BA414D1AA7E0C2BCB7D9776AAB2FBD` |
...
| --- | --- | --- |
| 049 | lines 8070-8466 | `Invarianten beliebiger Differentialausdrücke`; requires differential-expression vocabulary and invariant-theory flags. |
| 050 | lines 8469 onward | `Invariante Variationsprobleme`; map before drafting because it likely introduces physics/variational vocabulary. |
...
- Current corpus artifact has slices 001-048.
- Current coverage reaches German baseline line 8066, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, then append slice 049 beginning at German baseline line 8070.
