...
|---|---:|---|
| `exact_official_source_capture_required` | 20 | Official-source exact URL, local path, byte count, SHA-256, language/level/topic tags, and source-owner/reviewer route. |
...
| `current_gap_retry_required` | 3 | Successful exact source capture or updated failure payload hash, with locator provenance preserved and no R6 source-body package payload. |
