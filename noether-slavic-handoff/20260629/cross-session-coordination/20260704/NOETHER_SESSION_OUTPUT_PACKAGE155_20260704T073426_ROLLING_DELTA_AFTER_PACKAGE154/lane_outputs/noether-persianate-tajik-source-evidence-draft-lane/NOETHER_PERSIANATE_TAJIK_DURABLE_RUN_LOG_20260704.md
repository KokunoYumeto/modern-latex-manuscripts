...
| `NOETHER_FA_IR_PRS_AF_CORPUS_TRANSLATION_SLICES_DRAFT_20260704.md` | Corpus translation sidecar for fa_IR and prs_AF, currently slices 001-052 | `04E0BDB2CCBC7D6F2F1885E0C1B2A23D8C6926783BBE80A65125114DEBA7D54E` |
...
| --- | --- | --- |
| 053 | lines 9081-9304 | Inspect apparent post-`Invariante Variationsprobleme` gap before next visible article; do not assume blank/appendix. |
| 054 | lines 9307 onward | `Die Endlichkeit des Systems der ganzzahligen Invarianten binärer Formen`; binary-form invariant vocabulary likely high-risk. |
...
- Current corpus artifact has slices 001-052.
- Current coverage reaches German baseline line 9078, with a backfilled earlier gap at lines 845-880.
- Tajik Cyrillic remains source-discovery only with zero promoted term rows.
- Next action: refresh manifest/checksum after this log patch, inspect lines 9081-9304, then continue at the next real source unit.
