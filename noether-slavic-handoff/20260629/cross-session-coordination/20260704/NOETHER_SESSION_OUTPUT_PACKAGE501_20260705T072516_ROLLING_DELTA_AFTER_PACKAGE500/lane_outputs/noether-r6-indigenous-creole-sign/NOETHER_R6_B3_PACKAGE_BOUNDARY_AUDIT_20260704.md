...
| Artifact | Rows | Use |
|---|---:|---|
| `NOETHER_R6_B3_PACKAGE_BOUNDARY_AUDIT_20260704.csv` | 59 | Per-file package boundary classification for stable non-checksum R6 metadata outputs, including file hash, size, artifact class, B3 raw-source-pattern flags, package action, and non-claim boundary. |

## Results

| Check | Count |
|---|---:|
| Audited stable non-checksum R6 output files | 59 |
| Include as support metadata if B3 selects the lane delta | 59 |
...
| `source_canon_provenance_metadata_table` | 35 |
