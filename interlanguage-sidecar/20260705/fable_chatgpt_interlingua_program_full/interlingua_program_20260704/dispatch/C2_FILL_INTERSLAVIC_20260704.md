# C2 Fill Ledger — Interslavic lane (Slavic)

2026-07-04. 40 core-spine rows missing in this lane. For each: provide a WITNESSED form (source-pinned, native evidence per SOURCE_USE_POLICY category 2), or mark GAP (searched, absent), or NOT_APPLICABLE (with reason). Never invent forms. Return this file filled; it feeds UNION_TERM_SPINE_v3 and the lane's own spine.

_Rows arrive via the interlingual concept ledger (de->concept). Statuses stay honest: linked_to_concept vs witnessed_for_branch (E/W/S separately; W/S from the 20-source shelf) vs reviewed_for_bridge_use. Draft translations are NOT witnesses (SOURCE_USE_POLICY)._

## algebra  (curriculum_algebra)
- concept_id: `C2-algebra` · present in: arabic_farsi_persianate, controlled_arabic, malay_indonesian, pan_romance
...
## finite  (curriculum_algebra)
- concept_id: `C2-finite` · present in: arabic_farsi_persianate, malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## matrix  (curriculum_algebra)
- concept_id: `C2-matrix` · present in: arabic_farsi_persianate, controlled_arabic, malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## subgroup  (curriculum_algebra)
- concept_id: `C2-subgroup` · present in: arabic_farsi_persianate, controlled_arabic, malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## conversely  (proof_grammar)
- concept_id: `C2-conversely` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## exists  (proof_grammar)
- concept_id: `C2-exists` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 

## for all  (proof_grammar)
- concept_id: `C2-for_all` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## identity  (proof_grammar)
- concept_id: `C2-identity` · present in: malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 

## if and only if  (proof_grammar)
- concept_id: `C2-if_and_only_if` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## proof  (proof_grammar)
- concept_id: `C2-proof` · present in: arabic_farsi_persianate, controlled_arabic, malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## respectively  (proof_grammar)
- concept_id: `C2-respectively` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## therefore  (proof_grammar)
- concept_id: `C2-therefore` · present in: pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
