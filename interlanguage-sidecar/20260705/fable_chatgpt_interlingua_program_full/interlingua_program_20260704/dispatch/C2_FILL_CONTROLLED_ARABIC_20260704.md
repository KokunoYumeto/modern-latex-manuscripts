# C2 Fill Ledger — Controlled Arabic lane (R3)

2026-07-04. 30 core-spine rows missing in this lane. For each: provide a WITNESSED form (source-pinned, native evidence per SOURCE_USE_POLICY category 2), or mark GAP (searched, absent), or NOT_APPLICABLE (with reason). Never invent forms. Return this file filled; it feeds UNION_TERM_SPINE_v3 and the lane's own spine.

_Witness sources: native math register shelf (+ targeted fallback PDFs, marked). Status vocabulary as in the 60-term spine (source_backed_promotable_seed / attested_needs_review / fallback_attested_needs_review / open_*)._
...
## decomposition  (curriculum_algebra)
- concept_id: `C2-decomposition` · present in: arabic_farsi_persianate, interslavic, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## prime ideal  (curriculum_algebra)
- concept_id: `C2-prime_ideal` · present in: interslavic, malay_indonesian, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
...
## elementary divisor  (noether_corpus)
- concept_id: `C2-elementary_divisor` · present in: interslavic, pan_romance
- fill_status: [ ] witnessed / [ ] gap / [ ] not_applicable
- form(s): 
- witness_source (file/URL + locator): 
- status_note: 
