# W/S Slavic witness Backfill v1 — search the LOCAL 20-source triangulation shelf
...
out = {
    "artifact": "ws_witness_backfill_v1",
...
(OUT / "ws_witness_backfill_v1_20260704.json").write_text(
    json.dumps(out, ensure_ascii=False, indent=1), encoding="utf-8")

md = ["# W/S Witness Backfill v1 — local shelf search", "",
...
(OUT / "ws_witness_backfill_v1_20260704.md").write_text("\n".join(md), encoding="utf-8")
