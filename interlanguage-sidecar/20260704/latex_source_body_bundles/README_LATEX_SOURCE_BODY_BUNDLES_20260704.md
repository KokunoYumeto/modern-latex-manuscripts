# Interlanguage LaTeX Source-Body Bundles, 2026-07-04

These four ZIP files are the GitHub-visible source-body bundles for Web/Pro/Codex interlanguage work.

They contain actual LaTeX-like file bodies, not only URLs, ledgers, or checksums:

- `Interlanguage_LaTeX_SourceBodies_Romance_ES_FR_20260704.zip`: Spanish/French/Romance source-body feed, 1,526 entries, 1,503 source-like entries.
- `Interlanguage_LaTeX_SourceBodies_Persian_RTL_Arabic_20260704.zip`: Persian/RTL/Arabic-script source-body feed, 1,253 entries, 1,240 source-like entries.
