...
expected_slice = "2F90BDA5829FDABF1D40797C2C529DB1AA95A9207F3A2040DB9F3612F526B171"
...
start, end = 21209, 21254
source_dir = TRANCHE / "source"
source_dir.mkdir(parents=True, exist_ok=True)
exact_path = source_dir / "R823_HG_T006_de_exact.tex"
exact_path.write_bytes(("\n".join(lines[start - 1 : end]) + "\n").encode("utf-8"))
(source_dir / "R823_HG_T006_de_numbered.txt").write_text(
...
seed = TRANCHE / "semantic" / "R823_HG_T006_clause_map_seed.csv"
rows = []
with seed.open(encoding="utf-8-sig", newline="") as handle:
    for row in csv.DictReader(handle):
        ...
        rows.append(row)
clause_map = TRANCHE / "semantic" / "R823_HG_T006_clause_map.csv"
fields = list(rows[0])
...
manifest = {
    "artifact": "R823_HG_T006_SOURCE_MANIFEST",
    ...
    "next_heading": "Kapitel II. Galoissche Theorie kommutativer Koerper",
}
(source_dir / "R823_HG_T006_SOURCE_MANIFEST.json").write_text(
