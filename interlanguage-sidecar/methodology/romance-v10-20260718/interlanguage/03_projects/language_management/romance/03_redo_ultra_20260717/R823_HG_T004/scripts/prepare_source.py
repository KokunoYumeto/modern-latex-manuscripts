...
expected_slice = "2D757BFD661CE638D41F593DF6636A939AA0042477B6169A38217CAD23FB71BF"
...
start, end = 21117, 21146
source_dir = TRANCHE / "source"
source_dir.mkdir(parents=True, exist_ok=True)
exact_path = source_dir / "R823_HG_T004_de_exact.tex"
exact_path.write_bytes(("\n".join(lines[start - 1:end]) + "\n").encode("utf-8"))
(source_dir / "R823_HG_T004_de_numbered.txt").write_text(
...
seed = TRANCHE / "semantic" / "R823_HG_T004_clause_map_seed.csv"
rows = []
with seed.open(encoding="utf-8-sig", newline="") as handle:
    for row in csv.DictReader(handle):
        ...
        rows.append(row)
clause_map = TRANCHE / "semantic" / "R823_HG_T004_clause_map.csv"
fields = list(rows[0])
...
manifest = {
    "artifact": "R823_HG_T004_SOURCE_MANIFEST",
    ...
    "next_line": 21148,
    "next_heading": "§ 4 continued: formulas exhibiting the isomorphism and change of basis",
}
(source_dir / "R823_HG_T004_SOURCE_MANIFEST.json").write_text(
