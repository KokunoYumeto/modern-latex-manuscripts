...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # A target-only line number or a vague R823 chapter citation must not
        # count as source provenance. Exact authority lines, native-source
        # pages, and independent hash-pinned native TeX lines must count.
        require(
            has_strong_source_locator("R823 cum_de.tex lines 14536--14540"),
        ...
        require(
            ...
            "native French PDF page locator was rejected",
        )
        require(
            has_strong_source_locator(
            ...
            "independent hash-pinned native TeX line locator was rejected",
        )
        require(
        ...
        require(
            not has_strong_source_locator("N43_rebuild_fr.tex:487"),
        ...
        require(
            not has_strong_source_locator("R823 chapters on ideal theory"),
