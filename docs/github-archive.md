...
The work-level adoption source commit's bounded link audit is recorded as
`manifests/github-custody/20260809_links_r15.json`. It covers 36 committed
...
contributor/issue entry points. It resolves 1,140 local links to 781 unique
