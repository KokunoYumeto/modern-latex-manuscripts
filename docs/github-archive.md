...
| Audit the GitHub maintenance chain | This page | Current map-manifest and public-front [closure](../manifests/published-github/map-front-r1-close.json) and [source receipt](../manifests/published-github/map-front-r1.json); predecessor hardened Stacks candidate-intake [closure](../manifests/published-github/stacks-entry-r1-close.json) |
