...
This page is the GitHub-only audit trail for the repository-maintained catalogs. It
...
readback, and where to start browsing.
...
| Find an author, work, or corpus | [Coverage-map index](github-maps.md) | [`maps-r8.json`](../manifests/github-custody/maps-r8.json) |
...
| Audit the GitHub maintenance chain | This page | Current public-interface [closure](../manifests/published-github/ui-clean-r3-close.json), [source receipt](../manifests/published-github/ui-clean-r3.json), and [hardened current state](../manifests/github-custody/state.json) |
...
|---|---|---|---|
| Public GitHub interface r3 | Removes workstation, task, session, and operator prose from active public surfaces; labels preserved directives and catalogs as dated history; corrects supplied EGA, Noether, SGA, and FAC discovery heads; binds `maps-r8` with 19/19 member replay; producer, reader, and external-record mutations zero | [`d1e5b671`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/d1e5b6713211f692c099c573bfc5d0e40ca75a3d), [`3f7d38ae`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/3f7d38aebb46f8b8a8202bb1fbeaa18967e8b06a) | [Actions run `31553470219`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31553470219), [38-path source receipt](../manifests/published-github/ui-clean-r3.json) |
...
| Steinitz 1906 frontier reconciliation | Requires binding and bibliographically comparing the dedicated-record German/English 1906 packet with the mapped Euler-polyhedron note before transcription; if identical, ingest/review the existing generation and do not retranscribe; create a new generation only if proved distinct. Source bytes replayed 14/14; the first sparse run's stale R5-map failure remains adverse history, and the four-path correction is current and green. No producer or corpus byte changed. | [`5fb9d4a`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/5fb9d4a08956103d0cd294f7ed4337f813e9f22b), [`cd03e36`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/cd03e36de247ab7066d821a8b9dd55834b252861), [`2b1abc8`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/2b1abc8cfa5b0f5ba54f556cd1be446fab589249) | [Failed source run `31331145637`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31331145637), [successful correction run `31331582898`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31331582898), [successful receipt run `31332131815`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31332131815), [18-path receipt](../manifests/published-github/stein-r1.json), [33-cycle closure](../manifests/published-github/stein-r1-close.json) |
| Commons-governed Stacks reference architecture | Adds one architecture-only board row and a five-layer machine contract: exact read-only upstream pin, namespaced Commons overlay, deterministic composition, optional distinctly titled GFDL-compliant modified edition, and periodic sync. The upstream repository, pin, overlay, and build remain explicitly unbound; PR evidence is limited to the supplied closed-unmerged/no-comment/no-review facts with no motive inference. | [`b94ccf40`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/b94ccf40cecda93ffb94fdc5b6575e65a2c30d2f), [`2a3aa2a4`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/2a3aa2a48acf7cae45afa959be79cdbff82c85f6) | [Source run `31476821791`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31476821791), [receipt run `31477302142`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31477302142), [13-path source receipt](../manifests/published-github/stacks-r1.json), [36-cycle closure](../manifests/published-github/stacks-r1-close.json) |
...
| Hardened Stacks candidate intake | Publishes an exact, offline, fail-closed contract for manifest-complete, provenance-referenced unregistered Commons overlay candidates; binds member and receipt subjects, rejects path and namespace aliases, and preserves intent-specific issue routes. The accepted cross-platform correction makes the case-collision fixture identical on Windows and Linux. Registry entries, accepted candidates, mathematical entries, composition runs, generated members, and builds remain zero. | [`7887ff58`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/7887ff58743043f83b911990e19730490207805b), [`ef5db089`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/ef5db0893c506354466b58851d7817ca336e3485), [`53971c4c`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/53971c4c7306df0776f6ac3575f590ef44da3962) | [Failed predecessor run `31547301588`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31547301588), [accepted run `31548040621`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31548040621), [receipt run `31548510448`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31548510448), [21-path source receipt](../manifests/published-github/stacks-entry-r1.json), [56-cycle closure](../manifests/published-github/stacks-entry-r1-close.json) |
| Map manifest and public-front correction | Preserves `maps-r6` and binds all 19 current map members in `maps-r7`; makes exact map member/tree replay mandatory; removes a false Steinitz work-queue attribution; corrects stale SGA7 II and historical-current wording; removes internal execution jargon without changing producer or reader bytes. | [`288a5cb9`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/288a5cb9702739f67e8aeb00e53700c6b5bbd629), [`414a4fdb`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/414a4fdb78502a8e147a5abebd840e13a45be858), [`7705ffb7`](https://github.com/KokunoYumeto/modern-latex-manuscripts/commit/7705ffb7ce71dc6de2f86093a84e0a3e6915f67f) | [Source run `31550778146`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31550778146), [receipt run `31551145744`](https://github.com/KokunoYumeto/modern-latex-manuscripts/actions/runs/31551145744), [17-path source receipt](../manifests/published-github/map-front-r1.json), [58-cycle closure](../manifests/published-github/map-front-r1-close.json) |

The current hardened Stacks candidate-intake
[closure](../manifests/published-github/stacks-entry-r1-close.json) binds source
commit `ef5db089` and receipt commit `53971c4c`: source readback matched 21/21
paths / 851,916 bytes, receipt readback matched 6/6 paths / 678,779 bytes, and
both accepted Actions runs passed. Its
...
The additive evidence aggregate is 56 cycles, 3,318 observations, and
1,229,665,126 bytes with zero mismatches. The predecessor reader-first interface
...
and both Actions runs passed. The landing and active queue now lead with public
readers, sources, coverage, adoption, and evidence while the 78-row machine
board remains exact. The additive evidence aggregate is 54 cycles, 3,291
observations, and 1,228,134,431 bytes with zero mismatches. The predecessor public-interface
[closure](../manifests/published-github/ui-clean-r1-close.json), the
executable Stacks-preflight
...
log, and navigation paths. Across the twenty-eight predecessor cycles through
the public queue-and-scope receipt commit, those receipts preserve 3,041 additive
raw-readback observations / 1,208,486,039 bytes with zero mismatches.

The archived 151-commit predecessor inventory forms one direct-parent,
...
commit `5f66d4d1` remains immutable predecessor evidence: 41 documents, 1,306
local links, 824 unique targets, and zero missing or prohibited targets. The
adoption v3 receipt audit for
...
The index names only the exact GitHub-maintenance cycles linked above. It does
not enumerate unrelated receipt directories or
