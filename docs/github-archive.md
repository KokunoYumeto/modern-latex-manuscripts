...
| Audit the GitHub maintenance chain | This page | Current [Steinitz frontier source-and-correction receipt](../manifests/published-github/stein-r1.json); [thirty-cycle frontier predecessor](../manifests/published-github/frontier-r1-close.json) |
