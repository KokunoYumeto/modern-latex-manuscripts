...
| Audit the GitHub maintenance chain | This page | Current [Commons Stacks architecture receipt](../manifests/published-github/stacks-r1.json); [Steinitz frontier predecessor closure](../manifests/published-github/stein-r1-close.json) |
