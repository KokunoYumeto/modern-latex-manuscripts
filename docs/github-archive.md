...
| Audit the GitHub maintenance chain | This page | Current adoption v2 [closure](../manifests/published-github/adopt-v2-close.json) and [source receipt](../manifests/published-github/adopt-v2.json); predecessor [Commons Stacks intake closure](../manifests/published-github/stacks-intake-close.json) |
...
The current adoption v2 [closure](../manifests/published-github/adopt-v2-close.json)
extends the additive evidence aggregate through receipt commit `7d56af9d` to
40 commit-pinned readback cycles, 3,156 observations, and 1,217,243,661 bytes
with zero mismatches. Its [source receipt](../manifests/published-github/adopt-v2.json)
binds the 18-path operational update; the [Commons Stacks intake
closure](../manifests/published-github/stacks-intake-close.json) remains the
