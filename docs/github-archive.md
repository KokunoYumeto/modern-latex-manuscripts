...
| Audit the GitHub maintenance chain | This page | Current [Commons Stacks intake source receipt](../manifests/published-github/stacks-intake.json), predecessor [architecture closure](../manifests/published-github/stacks-r1-close.json) and [source receipt](../manifests/published-github/stacks-r1.json); [Steinitz frontier predecessor closure](../manifests/published-github/stein-r1-close.json) |
