...
| Audit the GitHub maintenance chain | This page | Current empty Stacks-overlay infrastructure [source receipt](../manifests/published-github/stacks-infra-r1.json); predecessor Stacks-pin and Commons-handback [closure](../manifests/published-github/stacks-pin-r1-close.json) |
...
The current empty Stacks-overlay infrastructure source receipt records the
