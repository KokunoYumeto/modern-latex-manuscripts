...
| Audit the GitHub maintenance chain | This page | Current hardened Stacks candidate-intake [closure](../manifests/published-github/stacks-entry-r1-close.json) and [source receipt](../manifests/published-github/stacks-entry-r1.json); predecessor reader-first [closure](../manifests/published-github/ui-clean-r2-close.json) |
