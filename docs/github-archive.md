...
| Audit the GitHub maintenance chain | This page | Current [Steinitz frontier closure](../manifests/published-github/stein-r1-close.json) and [source-and-correction receipt](../manifests/published-github/stein-r1.json); [thirty-cycle frontier predecessor](../manifests/published-github/frontier-r1-close.json) |
...
The current [Steinitz frontier closure](../manifests/published-github/stein-r1-close.json)
extends the additive evidence aggregate through the source, correction, and
receipt to 33 commit-pinned readback cycles, 3,081 observations, and
1,211,745,005 bytes with zero mismatches. The thirty-cycle
[frontier closure](../manifests/published-github/frontier-r1-close.json) remains
