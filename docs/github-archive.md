...
| Audit the GitHub maintenance chain | This page | Delivered adoption v3 [source receipt](../manifests/published-github/adopt-v3.json); current clean adoption v2 [closure](../manifests/published-github/adopt-v2-close.json); predecessor [Commons Stacks intake closure](../manifests/published-github/stacks-intake-close.json) |
