...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 66 | 8 | 50 | 398.07 MB | Version [10.5281/zenodo.21694014](https://doi.org/10.5281/zenodo.21694014) directly exposes six neutral-named English readers in SGA1-6 order, primary editable TeX, and two French readers. The preferred 1,474-page SGA3 R23 cumulative covers the Introduction, Exposés I-XXVI, Tome-I subject index, Tome-III guide, and terminal index. Fifty ZIPs / 4,253 non-directory members group source, QA, predecessor, and visual-provenance evidence. All 66 outer files passed anonymous exact readback. Direct readers contain no project/model/workflow/source-status commentary; genuine source-era editorial apparatus remains. SGA1 is the default preview and is not exhaustively convention-v2 certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held. |
