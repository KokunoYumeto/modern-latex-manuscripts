...
| [Workflow / replication packet](https://zenodo.org/records/20650700) | 11 | 3 | 7 | 0.3 MB | Latest workflow refresh adds the SGA/Noether/Weber aid-packet lessons: OCR as locator rather than authority, OCR-vs-TeX gap scanning, page-map drift, high-DPI witness packages, source-window sampling for prose compression, Noether original-printing reconstruction, and public release hygiene. Earlier workflow files still document SGA/Deligne/Gordan witness packets and Lean/Lake as selective formal-checking companions rather than bulk scan-transcription verifiers. |
...
| [Weber](https://zenodo.org/records/20650823) | 36 | 8 | 25 | 810 MB | `Lehrbuch der Algebra` Volume I complete; current Volume II readers through §176; Volume III current repaired cumulative. Batch104-Batch120 expose supporting provenance, repairs, and source checks; Batch120 repairs Volume II §§106 and 114 and reports 93 open gap-audit rows. |
...
| [Luigi Bianchi](https://zenodo.org/records/20650630) | 11 | 5 | 5 | 739 MB | `Lezioni di geometria differenziale` Vol. I complete through source pdfpages 001-543; A2 preferred continuation now runs through p0066 with §§10-12 complete and §13 deliberately deferred. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20650618) | 25 | 0 | 24 | 1.32 GB | Dedicated package set now adds Abel16, extending Abelsche Functionen through source p227 / printed p205; Abel13-15 remain the preceding p182-p217 tranches. AllPrior AuditFix01 remains the consolidated prior checkpoint. |
...
| [Additional author cluster](https://zenodo.org/records/20650905) | 90 | 10 | 80 | 4.55 GB | Selected drafts and update packets for authors not yet split into full author records; newest surface adds `Kneser_LVR_hqfig_p0158_0177_DE_EN_20260611.zip`, a high-quality figure and scan-witness repair for Kneser p0158-p0177 / §§37-39. It does not extend the text/math scope beyond p0177. The same record retains the selected Frobenius cumulative integration, Poincare v1_19 through Chapter XI, and earlier routed Frobenius/Kneser/Poincare support packets. |
