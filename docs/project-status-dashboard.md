...
Latest Noether public hygiene: current version [10.5281/zenodo.21426158](https://doi.org/10.5281/zenodo.21426158) has 37 files: 16 reader PDFs, 15 coherent ZIPs, and 6 manifest/status files, totaling 1692.24 MB. It fronts a 466-page R823 German reader with a bounded direct-source audit of Paper 30 source pages 37--61 and retains the 473-page Spanish, 494-page French, and 529/552-page Interslavic readers, Indonesian Paper 36, and eight direct CJK PDFs for complete Papers 26/36 in Simplified Chinese, generic Traditional Chinese, Japanese, and Korean. File `15` carries the corrected Paper 30 TeX, exact diff, source slice, enlarged witnesses, build evidence, hashes, and audit status. Existing translations are not represented as synchronized to that German patch. Arabic and Persian Paper 06 remain partial. Spanish, French, Interslavic, and the bounded CJK short works passed their declared technical gates but lack native/community certification. The record does not claim complete Paper 30 or whole-corpus certification, universal mathematical source certification, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 37 | 16 | 15 | 1692.24 MB | Current version [10.5281/zenodo.21426158](https://doi.org/10.5281/zenodo.21426158) fronts the German R823 Paper 30 source-control reader and retains the Spanish, French, and complete current Interslavic reader surfaces; Indonesian Paper 36; and eight direct CJK PDFs for complete Papers 26/36. File `15` preserves the exact Paper 30 patch and evidence. Partial Arabic/Persian Paper 06 remains grouped, and translations are not silently represented as synchronized to the German patch. Working corpus/source-control/translation lane only, not complete Paper 30 or whole-corpus certification, universal synchronization, native/community certification, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 17 | 6 | 6 | 1016.31 MB | Version [10.5281/zenodo.21428977](https://doi.org/10.5281/zenodo.21428977) fronts the 309-page SGA5 English working translation, adds the 304-page Spanish SGA5 checkpoint with 356 editable units through Exposé XV §3 no.2, the rationality theorem, and Lemmas 1-3, directly exposes the corrected 381-page SGA6 full-range layered English reader, and retains the 374-page French SGA6 source-rescribe checkpoint at idx684. The Spanish package contains frozen authority/evidence, build records, hashes, and targeted visual QA. SGA6 English authority remains non-uniform by design. The Spanish SGA5 checkpoint is intentionally incomplete; none is a critical edition and SGA7-I remains partial. |
...
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 38 | 2 | 15 | 4603.73 MB | Current version [10.5281/zenodo.21423647](https://doi.org/10.5281/zenodo.21423647) fronts the v0.12 six-page language-manager fleet map; retains Romance v10, Interslavic v0.6, prior source-body/automata material, and the Noether R823 completion gate; and adds stable controls for eight language-management lanes plus a compact bounded-output snapshot. Moving SGA workpasses are excluded. Included translations and review drafts retain explicit source-reconciliation and native-review caveats. Methodology/reproducibility infrastructure only; not native-language certification, mathematical proof checking, peer review, or a critical edition. |
