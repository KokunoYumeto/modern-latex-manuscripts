...
| Total public file surface | 40.50 GB |
...
Latest Noether public hygiene: current version [10.5281/zenodo.21312393](https://doi.org/10.5281/zenodo.21312393) has 15 files: 2 reader PDFs, 8 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page integrated-v26 German source-control reader, keeps the older English reader and multilingual checkpoints available, preserves R787-R804 evidence as grouped rollups, and groups the source-heavy v26 chain behind the reader. Earlier current heads remain in immutable versions rather than competing on the latest surface. It does not claim Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 15 | 2 | 8 | 1796.6 MB | Current version [10.5281/zenodo.21312393](https://doi.org/10.5281/zenodo.21312393) fronts the 466-page integrated-v26 German reader and groups the source-heavy v26 source-control chain. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
