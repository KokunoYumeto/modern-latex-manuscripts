...
Latest Noether public hygiene: current Zenodo version [10.5281/zenodo.21434690](https://doi.org/10.5281/zenodo.21434690) has 100 files and fronts the inherited English cumulative reader. GitHub custody now also holds bounded English Paper 4 Sections 8 and 9, Chinese Paper 27 in PRC-oriented Hans and controlled generic Hant, complete bounded German Paper 8 pp.93-102 evidence, and a preferred 466-page German cumulative closing collected pp.711-777, Paper 2 pp.28-34, and Paper 4 pp.118-143. The author matrix reports 730/753 body-and-tail keys closed (96.95%); Paper 2 pp.35-57 is the sole open German body band. The new head has 17 open target-output visuals; 193 source-derived images and four source PDFs are metadata-only because rights are unresolved. Paper 27 adds two open Chinese target renders and one metadata-only German control render. The bounded English Paper 4 sequence continues at the Paper 5 wrapper / R823 line 4501, and Korean Paper 29 continues at line 53. These surfaces do not claim a complete-author release, whole-corpus certification, native or regional language certification, universal mathematical source certification, rights clearance, or critical-edition status.

GitHub custody update 2026-07-19: SGA1 opening through Proposition I.9.1 r2, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. The SGA1 I.8 r4 package remains immutable predecessor history; the new exact cursor is excluded French line 1704, beginning the corollary after Proposition I.9.1. Expose VIII has twenty-two separate unit states through the independently sealed fourth proof-step base case `(iv) => (ii)`, `n = 0` / French line 2826, continuing substantively at line 2828 after excluded blank line 2827, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 42 | 43 | 2362.92 MB | Current Zenodo version [10.5281/zenodo.21434690](https://doi.org/10.5281/zenodo.21434690) fronts the inherited English cumulative reader. GitHub adds bounded English Paper 4 Sections 8-9, Chinese Paper 27 Hans/Hant target pairs, German Paper 8 pp.93-102, and the preferred German cumulative closing collected pp.711-777, Paper 2 pp.28-34, and Paper 4 pp.118-143. The privacy-clean page-QC index has 758 keys; the author matrix reports 730/753 body-and-tail keys closed. The 51 P10/P14/P15 rows are historical audit imports, not fresh inspections. Paper 2 pp.35-57 is the sole open German body band; the bounded English Paper 4 sequence continues at the Paper 5 wrapper / R823 line 4501; Korean Paper 29 continues at line 53. Seventeen new target visuals are open, while 193 source images and four source PDFs are metadata-only. Working corpus only, not a complete-author release, whole-corpus certification, native/regional validation, universal synchronization, rights clearance, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves SGA1 through Proposition I.9.1 r2, audited SGA2 Expose VII, and twenty-two bounded Expose VIII states through the fourth proof-step base case `(iv) => (ii)`, `n = 0` / line 2826, continuing substantively at line 2828. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
