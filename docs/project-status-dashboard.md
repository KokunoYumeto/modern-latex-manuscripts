...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21697218 fronts complete source-aligned EGA II through authority EOF, source-aligned EGA IV Sections 1-10, and assigned partial EGA 0/III Sections 8-13 and EGA III Sections 1-7 readers, with direct masters and grouped recursive source. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 28 | 13 | 8 | 479.54 MB | Version [10.5281/zenodo.21697218](https://doi.org/10.5281/zenodo.21697218) preserves the French originals and fronts the complete 165-page source-aligned EGA II working reader plus the 268-page source-aligned EGA IV Sections 1-10 working reader, direct master TeX files, and exact source ZIPs. Partial 120-page EGA 0/III Sections 8-13 and 150-page EGA III Sections 1-7 readers remain direct. All 28 outer files and all eight ZIPs / 281 members passed anonymous exact readback. EGA IV has 1,041 non-clickable printed locators and continues at Section 11; the wider EGA corpus remains partial and non-uniform. |
