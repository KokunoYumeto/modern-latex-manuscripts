...
Latest Noether local queue hygiene: R574/R573/R572/R571/R570/R569 current Noether source-control split, 2026-07-02: R574 is the latest packaged local TeX-changing German source-control head. It applies exactly one source-backed Paper 30 printed p32 prose repair, changing non-source `auch` to source `stets` after checking printed/source pp26-32 against best-local Math. Ann. 96 IA raw-JP2 witnesses (~400ppi). R573 remains the predecessor Paper 40 pp514-529 source-style merge; R572 remains the no-patch tail-closure packet classifying collected pp779-782 as non-Noether publisher advertisements/blanks; R571/R570/R569 are older support layers. Because the Noether record is at the 100-file ceiling, R569-R574 are queued for curated rollup rather than loose upload. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, 650+ source certification, multilingual synchronization, or critical-edition material. Paper 30 pp33-61 remain the next open audit span.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. R574 is the latest packaged local TeX-changing German source-control head: one source-backed Paper 30 printed p32 `auch` -> `stets` repair after pp26-32 were checked against best-local ~400ppi IA raw-JP2 witnesses. R573 remains the predecessor P40 pp514-529 merge; R572/R571/R570/R569 are older tail/support layers. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, 650+ certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p428 in `CERT_LOG.md` / `AGENT_SCORECARD.md`. Exposé VIII is closed at p371; Exposé X is locally recorded through references at p406; Exposé XII reaches p428, with p427-p428 clean/no-TeX-fix ledger entries and p428 opening §6 / §6.1. Treat p266-p428 as live workpass/provenance metadata only unless later compactly packaged, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. Agent/diagram-aid ledgers are finders rather than certification. SGA6 is substantial but not complete; SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
