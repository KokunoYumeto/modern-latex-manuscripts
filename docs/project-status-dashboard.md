...
GitHub custody update 2026-07-19: SGA1 opening through I.8 r4, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. The SGA1 I.7 package remains immutable predecessor history; I.8 continues at French line 1654 / section I.9. Expose VIII has twenty-one separate unit states through the independently sealed third proof step `(iii) => (iv)` / French line 2819, continuing at line 2820 without a blank separator, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
