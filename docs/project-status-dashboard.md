...
Latest Noether local queue hygiene: R546 is the current coherent packaged local TeX-changing German source-control candidate. It is a one-locus Kapferer/Noether tail repair on top of R545: Math. Ann. 97 printed p.562, formula (3), first two right-hand-side entries restored from `x\cdot K_2` / `x\cdot K_3` to source `x\cdot K_1` / `x\cdot K_2`; the related p567 congruence repair was already present in R545. R545 and earlier R530-R544/R286/R528-R529 layers remain historical source-control, no-patch support, or provenance. The second-web intake now fronts `40_R546_WEBB_R534_KAPFERER_P562_FORMULA3_SOURCEFIX.zip` with 40 top-level files / 35 ZIP payloads / 4,281,724,544 ZIP bytes. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R546, carrying R530/R531, R532/R533, R534-R545 source-control/provenance and adding the Kapferer/Noether p562 formula (3) RHS repair. R528/R529 remain support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
