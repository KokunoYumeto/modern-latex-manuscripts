...
Latest Noether local queue hygiene: R551 is the current local TeX-changing German source-control head. It is a focused Paper 40 printed p530 source-style repair on top of R550, restoring the Galois/Hilfssatz/theorem-heading layout around the noncommutative Galois-theory Hauptsatz and simple-system Galois-theory material. R550 remains the newest zipped package with a full summary and integrates nine source-backed WebB R546 fixes across P24 p245, P40 pp515-524, and Kapferer pp559-566/p564. R549/R548/R547/R546 are historical source-control steps beneath this chain. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
