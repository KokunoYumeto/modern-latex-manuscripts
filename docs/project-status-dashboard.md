...
Latest Noether public hygiene: current version [10.5281/zenodo.21421049](https://doi.org/10.5281/zenodo.21421049) has 22 files: 5 reader PDFs, 12 coherent ZIPs, and 5 manifest/status files. It retains the 466-page v26/R823 German source-control reader, directly exposes the 473-page Spanish R823 working translation, and adds 529-page Latin-script and 552-page Cyrillic-script Interslavic readers plus a complete 442-body TeX/PDF/evidence ZIP. Spanish passed its declared 81-unit gate. Interslavic passed the current complete-corpus build and exact 002A/002B normalization gates, but lacks native/community certification. English and CJK remain only partly synchronized. The record does not claim universal mathematical source certification or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 22 | 5 | 12 | 1600.25 MB | Current version [10.5281/zenodo.21421049](https://doi.org/10.5281/zenodo.21421049) retains the 466-page v26/R823 German reader, adds the 473-page Spanish reader, and exposes complete current Interslavic body surfaces as 529-page Latin and 552-page Cyrillic readers with 221 canonical TeX units per script. Working corpus/source-control/translation lane only, not universal synchronization, native/community certification, mathematical source certification, or a critical edition. |
