...
Latest Noether local queue hygiene: R559 is the current coherent zipped local TeX-changing German source-control head. It is a focused Paper 40 printed pp.540-541 simple-systems/components tail source-math/source-style repair on top of R558/R557/R556/R555/R553/R552/R551/R550, restoring source component notation, component proof relations, the italic simple-system theorem, `A_r`, quaternion-example brackets, the inseparable-centre clause, uppercase `\mathfrak C`, `Zusammenfassung:` styling, the source degree sentence, and final Schur punctuation. R559/R558/R557/R556 are coherent packages with ZIP/hash, ledgers, and two-pass builds; R559 compiles to a 468-page cumulative German PDF. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R559, carrying R530/R531, R532/R533, R534-R545 source-control/provenance, the R546 Kapferer/Noether p562 formula (3) RHS repair, the R547-R549 Paper 40 p526-p529 source-style repairs, the R550 WebB R546 missing-source fixes, the R551-R553 source-control chain, the coherent R555/R556/R557/R558 predecessors, and the R559 Paper 40 pp.540-541 simple-systems/components tail repair. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
