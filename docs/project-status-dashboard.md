...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 68 | 8 | 49 | 409.30 MB | Version [10.5281/zenodo.21677179](https://doi.org/10.5281/zenodo.21677179) directly exposes six clean English readers in SGA1-6 order, primary editable TeX where available, and two French workpasses. The preferred 1,460-page SGA3 cumulative covers the Editorial Notice, Introduction, Exposés I-XXVI, Tome-I index, Tome-III guide, and terminal index. Forty-nine ZIPs / 4,235 members group source, diagram, QA, predecessor, and SGA6 visual-provenance evidence. All 68 outer files passed anonymous exact readback. SGA1 is the default preview and is not exhaustively convention-v2 certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held. |
