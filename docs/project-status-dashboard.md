...
| Top-level PDFs | 435 |
| Artifact/source ZIPs | 409 |
| Manifest/status files | 85 |
| Editable TeX files | 8 |
| Total public file surface | 40.21 GB |
...
Latest Noether public hygiene: current version [10.5281/zenodo.21300773](https://doi.org/10.5281/zenodo.21300773) has 15 files: 2 reader PDFs, 8 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page R813/integrated-v12 German source-control reader, keeps the English reader and multilingual checkpoints available, preserves R787-R804 evidence as grouped rollups, and groups the checked R805-R813 chain behind the reader. Superseded R796/R804/R805 current-head files remain in earlier immutable versions rather than competing on the latest surface. It does not claim Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 15 | 2 | 8 | 1499.3 MB | Current version [10.5281/zenodo.21300773](https://doi.org/10.5281/zenodo.21300773) fronts the 466-page R813/integrated-v12 German reader and groups R805-R813 source-control evidence. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 719.1 MB | Latest compact version [10.5281/zenodo.21302915](https://doi.org/10.5281/zenodo.21302915) fronts three reader/checking PDFs and two grouped TeX/audit/source-support ZIPs. SGA5 remains incomplete and unsynchronized. The frozen SGA6 source-rescribe reaches #376 / idx379 / volume p366 / Exposé VI p2 after traversing Exposé V pp47-68, restoring two whole omitted pages, and repairing relations, notation, diagrams, and unsupported tags; it remains a workpass rather than certification. Content after idx379 remains inherited scaffold until directly checked. SGA7-I remains partial. |
