...
GitHub custody update 2026-07-19: SGA1 opening through Corollary I.9.3 and its complete proof r1, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Earlier SGA1 checkpoints remain immutable predecessor history; revoked I.9.2 r1 and rejected I.9.3 staging attempt1 were not copied. The new exact SGA1 cursor is excluded French line 1761, beginning Corollary I.9.4. Expose VIII has twenty-seven separate unit states through the independently sealed Proposition 3.2 proof opening and condition (c) / French line 2907, continuing at implication `(a) => (b)`, line 2909, after excluded blank line 2908, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
