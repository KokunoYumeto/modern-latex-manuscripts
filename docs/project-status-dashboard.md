...
Latest Noether public hygiene: current version [10.5281/zenodo.21418246](https://doi.org/10.5281/zenodo.21418246) has 16 files: 2 reader PDFs, 9 coherent ZIPs, and 5 manifest/status files. It keeps the 466-page v26/R822 German source-control reader as the explicit default preview and adds a Paper 06 Slavic working tranche with 16 units each in Interslavic Latin/Cyrillic, Russian, and Ukrainian. All 64 standalone TeX files compile; 17 reviewed orthographic changes affect the two Interslavic branches only. A fresh line-by-line Paper 06 source reconciliation and linguistic review remain open. It does not claim Noether closure, language certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 16 | 2 | 9 | 1378.58 MB | Current version [10.5281/zenodo.21418246](https://doi.org/10.5281/zenodo.21418246) retains the 466-page v26/R822 German reader as default preview and adds the Paper 06 Slavic working tranche. Working corpus/source-control/translation lane only, not whole-corpus closure, source synchronization, linguistic certification, or a critical edition. |
