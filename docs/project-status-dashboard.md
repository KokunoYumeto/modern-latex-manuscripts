...
Latest Noether local queue hygiene: R523 is the current clean packaged local TeX-changing source-control candidate, after two Paper 24 printed p233 congruence-to-zero repairs on top of R522. R522 remains the previous Paper 24 pp239-240 source-repair checkpoint. The second-web intake fronts R523 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R523: R496 supplies the post-P43 tail/Schur fixes, R504 Paper 14 source-backed fixes, R507 a tail display-punctuation fix, R516 a Paper 24 p232 order fix, R518 a Paper 24 p241 `von der Dimension` repair, R519 three Paper 24 p246 bare-product display repairs, R520 two Paper 24 p250 substitution-chain repairs, R521 one Paper 24 p257 `\mathcal R'` repair plus pp251-261 visual audit support, R522 five Paper 24 pp239-240 source repairs, and R523 two Paper 24 p233 congruence repairs. R508-R515 and R517 are support/no-patch/source-quality/visual-audit packets, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
