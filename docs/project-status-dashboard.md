...
Latest Noether local queue hygiene: R544 is the current coherent packaged local TeX-changing German source-control candidate. R530/R531 remain source-control steps beneath it; R532/R533 are no-patch support/provenance; R534-R537 repair Paper 40 pp.515-517; R538 restores p518 operator-domain/Doppelmodul source layout; R539 restores p519 Folgerungen/Satz source wording; R540 restores p520 Linearformenmodul layout plus the order-sensitive automorphism calculation; R542 restores Paper 40 p522 transition/corollary/matrix-commutant heading layout; R543 restores Paper 40 p523 section-3/Normalbasis proof material; and R544 restores Paper 40 p524 Erweiterungsmodul/invariant-module material. The second-web intake now fronts R544 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R544, carrying the R530/R531 repair chain, R532/R533 support, R534-R537 Paper 40 pp.515-517 repairs, R538-R540 Paper 40 pp.518-520 repairs, R542 p522 repair, R543 p523 repair, and the packaged p524 Erweiterungsmodul/invariant-module repair. R528/R529 remain support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
