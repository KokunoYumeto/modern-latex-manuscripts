...
Latest Noether local queue hygiene: R527 is the current clean packaged local TeX-changing German source-control candidate after the R523-R527 Paper 24 repair chain. R528 is now registered as no-patch visual/source-audit support for Paper 24 printed pp.250-261 on top of R527; it promotes no TeX change and does not replace R527 as the head. WebB R497 is separately registered as a TeX-changing tail/Kapferer source-control provenance artifact, distinct from the local R497 no-patch Paper 22 survival guardrail; R285 is registered as P08/P10/P13/P15/P19 source-merge provenance and workflow evidence, not as a base replacement. The second-web intake fronts R527 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R527: the active chain includes R496 post-P43 tail/Schur fixes, WebB R497 tail/Kapferer hard-source provenance, R504 Paper 14 source-backed fixes, R507 a tail display-punctuation fix, R516/R518/R519/R520/R521/R522/R523/R524/R525/R526/R527 Paper 24 source-control repairs, and R285 P08/P10/P13/P15/P19 provenance/workflow evidence. R528 adds no-patch visual/source-audit support for Paper 24 printed pp.250-261 on top of R527. R508-R515, R517, and R528 are support/no-patch/source-quality/visual-audit packets, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
