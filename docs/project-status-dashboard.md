...
GitHub custody update 2026-07-19: SGA1 opening through Proposition I.9.1 r2, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. The SGA1 I.8 r4 package remains immutable predecessor history; the new exact cursor is excluded French line 1704, beginning the corollary after Proposition I.9.1. Expose VIII has twenty-one separate unit states through the independently sealed third proof step `(iii) => (iv)` / French line 2819, continuing at line 2820 without a blank separator, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
