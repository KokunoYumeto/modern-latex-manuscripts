...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21712610 fronts reference-v2 working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, and the complete published EGA III text through 7.9.14, plus source-aligned EGA IV Sections 1-10. Direct masters and grouped recursive source remain available, and four archives preserve 471 actual high-detail EGA IV source-image witnesses through printed page 118. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 34 | 14 | 12 | 1700.4 MB | Version [10.5281/zenodo.21712610](https://doi.org/10.5281/zenodo.21712610) preserves the French originals and fronts five current English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the complete published EGA III text through 7.9.14, and source-aligned EGA IV Sections 1-10. The leading 125-member bundle, five direct masters, and grouped source/QA files keep the reader shelf compact. Four additional ZIPs contain 471 actual high-detail EGA IV source-image witnesses from printed pages 5-118. All 34 outer files and all 56 members of the newest archive passed anonymous exact readback; all 33 predecessor files remained byte-identical. EGA IV continues at Section 11; the wider EGA corpus remains partial and non-uniform. |
