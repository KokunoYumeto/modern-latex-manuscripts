...
| [Weber](https://zenodo.org/records/20644466) | 29 | 8 | 18 | 582 MB | `Lehrbuch der Algebra` Volume I complete; current Volume II readers through §176; Volume III current repaired cumulative. Batch104-Batch113 expose supporting provenance, repairs, and source checks; Batch113 reports 104 open gap-audit rows. |
...
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20644458) | 22 | 0 | 21 | 1.17 GB | Dedicated package set now adds Abel11-Abel13, extending Abelsche Functionen through source p189 / printed p167; Abel13 stops where equation (4) continues onto p190. AllPrior AuditFix01 remains the consolidated prior checkpoint. |
...
| [Additional author cluster](https://zenodo.org/records/20642082) | 97 | 10 | 85 | 4.26 GB | Selected drafts and update packets for authors not yet split into full author records; Bianchi, Gordan, and Steinitz now have preferred standalone records, while this mixed shelf keeps backstop/provenance copies plus Poincare v1_14, Frobenius, Kneser, Mikami, Kronecker/Kron, Picard, and related tranches with explicit caveats. |
