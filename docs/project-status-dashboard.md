...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 721.7 MB | Latest compact Zenodo version [10.5281/zenodo.21416482](https://doi.org/10.5281/zenodo.21416482) freezes the French SGA6 source-rescribe at #663/idx646 / volume p633 / Exposé XIII p18, with idx647 next. A separate English Exposé X restart covers idx532-537 only. SGA5 remains incomplete, error-bearing, and unsynchronized; SGA6 remains a workpass rather than certification, and content after idx646 remains inherited scaffold until directly checked. SGA7-I remains partial. |
