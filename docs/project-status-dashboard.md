...
| 2. Serious source-aware work, caveat-heavy | Bianchi, Gordan, Steinitz, Gibbs, Maxwell, SGA, EGA, Deligne, Ukrainian applied mathematics, non-European/Chinese/Indian/Islamic records | Real reader, translation, data/table, or source-audit surfaces exist. | Range quality varies; diagrams, tables, page-local source closure, and language synchronization must be checked. EGA now has a complete source-aligned EGA II working reader and an EGA IV Sections 1-10 source-aligned reader beside partial EGA 0/III and EGA III lanes. |
...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21715531 fronts reference-v2 working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, and the complete published EGA III text through 7.9.14, plus cumulative source-aligned EGA IV Sections 1-10. Archive 02e preserves bounded Sections 16-18; direct reader 00f and archive 02f preserve bounded Sections 19-21 plus Part 4 backmatter. Direct masters and grouped recursive source remain available, and eleven archives preserve 989 actual high-detail EGA IV source-image witnesses continuously across printed pages 5-336. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [Weber](https://doi.org/10.5281/zenodo.20412153) | 56 | 6 | 41 | 1762.68 MB | Latest version [10.5281/zenodo.21513712](https://doi.org/10.5281/zenodo.21513712) retains the Volume I p88 German reader as preview and adds two deterministic current-audit image archives: 248 page-mapped tight crops and 846 recovered formula/glyph/detail images with unresolved page locators. Exact manifests bind hashes, dimensions, parent scan, locator status, and QA disposition. The readers remain modernized/summarized rather than source-critical; all three volumes remain incomplete, and the images are provenance evidence rather than certification. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 73 | 9 | 55 | 463.1 MB | Version [10.5281/zenodo.21711433](https://doi.org/10.5281/zenodo.21711433) starts with one 1,394-member ZIP containing all six cumulative English readers and their complete buildable TeX closures. The same readers and masters remain direct in SGA1-6 order; SGA1 is the default preview. The clean 1,470-page SGA3 R29 reader covers Introduction, Exposés I-XXVI, Tome-I subject index, Tome-III mathematical guide, and terminal index. Direct SGA7 files now provide the complete working source transcription of all six written exposés I, II, VI, VII, VIII, and IX in a 267-page reader with 162 native diagrams and no raster diagram inputs. Two compact SGA7 audit archives preserve 12 actually opened high-detail crops and rights-blocked provenance metadata without changing a reader. Direct readers omit project-production and workflow notes; genuine source-era editorial apparatus remains. SGA7 I is not a complete English translation; SGA3 is not final whole-reader diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered. |
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 44 | 14 | 22 | 3571.6 MB | Version [10.5281/zenodo.21715531](https://doi.org/10.5281/zenodo.21715531) preserves the French originals and fronts five current cumulative English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the complete published EGA III text through 7.9.14, and source-aligned EGA IV Sections 1-10. Archive 02e preserves bounded Sections 16-18; direct reader 00f and archive 02f preserve the 134-page bounded Sections 19-21 plus Part 4 backmatter reader. The leading 125-member bundle, direct masters, and grouped source/QA files keep the reader shelf compact. Eleven additional ZIPs contain 989 actual high-detail EGA IV source-image witnesses continuously across printed pages 5-336. All 44 outer files / 3,745,045,609 bytes and all 27 members of the two new ZIPs passed anonymous exact readback; all 41 predecessor files remained byte-identical. Sections 11-15 remain the cumulative integration gap; the wider EGA corpus remains partial and non-uniform. |
...
| [Workflow / replication packet](https://doi.org/10.5281/zenodo.20461174) | 11 | 1 | 2 | 1.0 MB | Current version [10.5281/zenodo.21707334](https://doi.org/10.5281/zenodo.21707334) fronts the corrected seven-page A4 workflow reader and retains the exact Markdown, source method, resource-efficiency note, native-TeX SGA3 diagram-fidelity correction, grouped source packet, and controls. It adds one exact July 11-27 ChatGPT research-briefing export, labeled generated and unverified. Existing 600/1200-dpi evidence remains valid; only 300-only approvals and independently found defects are reopened. New final successors use native TeX and 300/5000/9000-dpi review. These are methodology, accountability, and research-note materials, not edition or translation certification. |
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 51 | 2 | 19 | 4745.56 MB | Current version [10.5281/zenodo.21485338](https://doi.org/10.5281/zenodo.21485338) retains the complete v0.13 numbered archive and adds the bounded CJK visual-evidence package: 290 open project-generated/recovered images, six public-safe controls, and metadata-only representation of 14 rights-blocked images. The index keeps 49 provenance-incomplete records and one inherited undecodable PNG visible. Methodology, normalization, corpus, bounded working-translation, provenance, and visual-QA evidence only; not native-language validation, translation/source-fidelity certification, rights clearance, mathematical proof checking, peer review, or a critical edition. |
