...
The SGA/EGA distinction still matters. SGA has current English reader surfaces through SGA7 I with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21740145 fronts standalone working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, the published EGA III text through 7.9.14, and complete reference-v2 EGA IV through Sections 1-21 and EOF. Direct masters and grouped buildable source remain available after the reader shelf. The single cross-volume EGA 0-IV PDF is still in production. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 40 | 13 | 20 | 3578.8 MB | Version [10.5281/zenodo.21740145](https://doi.org/10.5281/zenodo.21740145) preserves the French originals and fronts five standalone English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the published EGA III text through 7.9.14, and complete reference-v2 EGA IV through Sections 1-21 and EOF. The leading 135-member bundle, direct masters, and grouped source/QA files keep the reader shelf compact. All 40 outer files / 3,752,670,964 bytes, all 36 retained predecessor files, all 135 leading-bundle members, and all 84 EGA IV package members passed anonymous exact readback. A single cross-volume EGA 0-IV PDF remains in production; the wider EGA corpus remains a working, non-uniform scholarly surface rather than a critical edition. |
...
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 65 | 2 | 21 | 4745.61 MB | Current version [10.5281/zenodo.21743417](https://doi.org/10.5281/zenodo.21743417) retains the complete numbered archive, Fable controls, and exact G15 gate-map source anchor, then adds one compact commit-pinned Persian Noether-topic XeLaTeX source ZIP. It closes that narrow editable-source row only; Persian invariant theory, Arabic invariant theory, Dari editable mathematics, Tajik native TeX, semantic reconciliation, linguistic review, and global-ledger completeness remain open. Methodology, normalization, corpus, source-custody, bounded working-translation, provenance, and QA evidence only; not native-language validation, translation/source-fidelity certification, rights clearance, proof checking, peer review, or a critical edition. |
