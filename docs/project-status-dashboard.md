...
| Public files indexed | 973 |
| Top-level PDFs | 587 |
| Artifact/source ZIPs | 342 |
| Manifest/status files | 41 |
| Total public file surface | 30.11 GB |
...
| [Additional author cluster](https://zenodo.org/records/20650780) | 89 | 10 | 79 | 4.47 GB | Selected drafts and update packets for authors not yet split into full author records; newest surface adds the selected Frobenius cumulative integration for items 053, 054, 056-061, 070, and 071, with German/English cumulative readers, TeX archives, and source scans. It also retains Kneser p0158-p0177 / §§37-39 complete, Poincare v1_19 through Chapter XI, and prior routed Frobenius/Kneser/Poincare support packets. |
