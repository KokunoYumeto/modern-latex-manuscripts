...
Latest Noether public hygiene: current version [10.5281/zenodo.21433750](https://doi.org/10.5281/zenodo.21433750) has 89 files: 39 reader PDFs, 35 coherent ZIPs, 3 direct editable TeX files, and 12 manifest/status files. It fronts the English cumulative reader and retains the German R823, Spanish, French, Interslavic, and earlier bounded multilingual surfaces. It adds Chinese Paper 37 in PRC-oriented Simplified Chinese and controlled generic Traditional Chinese plus Korean Paper 29 U03 after U01-U02, with exact editable/evidence packages. Six visual archives preserve twenty-two open project-generated renders; rights-blocked or control-only pixels are represented by metadata, hashes, and coordinates only. Paper 4 continues at Section 7 / R823 line 4112, Korean Paper 29 continues at line 47, and the 353 `važi*|važe*` probes remain an external-authority blocker. These surfaces passed their declared technical gates but lack native/community certification. The record does not claim complete Paper 4 or Paper 29, whole-corpus certification, universal mathematical source certification, rights clearance, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 89 | 39 | 35 | 2205.94 MB | Current version [10.5281/zenodo.21433750](https://doi.org/10.5281/zenodo.21433750) fronts the English cumulative reader, retains the German R823/Spanish/French/Interslavic surfaces, extends bounded Paper 4 English through Section 6, and adds Japanese Paper 23, Korean Paper 29 U01-U03, and Chinese Paper 37 in two controlled targets with rights-aware visual evidence. Paper 4 continues at Section 7 / R823 line 4112; Korean Paper 29 continues at line 47. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not complete Paper 4 or Paper 29, whole-corpus certification, universal synchronization, native/community certification, rights clearance, or a critical edition. |
