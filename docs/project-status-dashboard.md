...
Latest Noether local queue hygiene: Noether R572 is the current packaged local no-patch tail-closure packet above R571. It classifies collected pp779-782 as publisher advertisements/blanks, not missing Noether content, and leaves the cumulative TeX byte-identical to R571. R571 remains the current packaged local TeX-changing German source-control head, with R570 as the latest packaged no-patch content checkpoint and R569 as the prior substantive p761/p764 repair head. R569 repairs collected p761 `a^S=a` to `a^{S^r}=a` and p764 subtitle text; R570 checks pp767-772 with no promoted TeX patch. R569/R570/R571/R572 are queued for curated rollup under the Noether file ceiling, not loose upload or certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. R572 is the latest packaged no-patch tail-closure packet above R571 and records pp779-782 as ads/blanks rather than missing Noether content. R571 remains the latest packaged local TeX-changing German source-control head, applying the p776 `Bd. III.2` -> `Bd.III.2` Kronecker-review source repair. R569 remains the prior p761/p764 repair head, and R570 remains the no-patch checkpoint over pp767-772. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
