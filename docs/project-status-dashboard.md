...
| [Frobenius](https://doi.org/10.5281/zenodo.20673444) | 2 | 0 | 1 | 166.16 MB | Dedicated selected group-character German/English working package with QA03 status: 10/10 selected items, 221/221 tracked source-intake pages, and 241 merged source-scan pages. |
