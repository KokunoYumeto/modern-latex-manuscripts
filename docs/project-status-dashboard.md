...
Latest Noether local queue hygiene: R560 is the current coherent local TeX-changing German source-control head. It is a focused Paper 31 printed pp.89/98 component-identity and determinant-matrix source-math repair on top of R559. R560 compiles to a 468-page cumulative German PDF with two XeLaTeX passes and includes README, R560 ledgers, exact diff, source witnesses, render checks, and SHA256 manifest evidence. R559/R558/R557/R556 are coherent predecessors; this is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
