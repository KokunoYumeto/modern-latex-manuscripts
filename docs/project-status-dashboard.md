...
Latest Noether local queue hygiene: R525 is the current clean packaged local TeX-changing source-control candidate, after one Paper 24 printed p236 formula (5) Nullstellen-family `r` index repair plus a p235 no-patch check on top of R524. R524 remains the previous Paper 24 p234 formula (4) equality-repair checkpoint. The second-web intake fronts R525 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R525: R496 supplies the post-P43 tail/Schur fixes, R504 Paper 14 source-backed fixes, R507 a tail display-punctuation fix, R516 a Paper 24 p232 order fix, R518 a Paper 24 p241 `von der Dimension` repair, R519 three Paper 24 p246 bare-product display repairs, R520 two Paper 24 p250 substitution-chain repairs, R521 one Paper 24 p257 `\mathcal R'` repair plus pp251-261 visual audit support, R522 five Paper 24 pp239-240 source repairs, R523 two Paper 24 p233 congruence repairs, R524 one Paper 24 p234 formula (4) source-style equality repair, and R525 one Paper 24 p236 formula (5) Nullstellen-family `r` index repair plus p235 no-patch support. R508-R515 and R517 are support/no-patch/source-quality/visual-audit packets, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p343 with p344 as next cursor. p340-p343 cover Expose VII section 9 around Lemma 9.4, Theorem 9.2/Mumford self-intersection, Proposition 9.6, and D161 edge-by-edge diagram checking. Treat p266-p343 as live workpass/provenance metadata only, not a compact promoted public delta, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 is substantial but not complete: a June 11 audit found 127/524 sampled source prose windows, about 24%, missing from current TeX in late regions. SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
