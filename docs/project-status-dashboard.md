...
Latest Noether local queue hygiene: R558 is the current coherent zipped local TeX-changing German source-control head. It is a focused Paper 40 printed p539 §9 definitions / reduction-to-simple-systems source-math/source-style repair on top of R557/R556/R555/R553/R552/R551/R550, restoring the barred basis-change line, §9 title and section headings, `(kommutativer)` for `\Lambda`, source § references, the italic `Tatsachen:` block, simple-systems dash structure, and emphasis on `separablem`. R557/R556 are coherent predecessors with ZIP/hash, ledgers, and two-pass 469-page builds; R559 is observed only as an unfinished local work folder. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R558, carrying R530/R531, R532/R533, R534-R545 source-control/provenance, the R546 Kapferer/Noether p562 formula (3) RHS repair, the R547-R549 Paper 40 p526-p529 source-style repairs, the R550 WebB R546 missing-source fixes, the R551-R553 source-control chain, the coherent R555/R556/R557 predecessors, and the R558 Paper 40 p539 §9 definitions/reduction repair. R559 is observed only as an unfinished local work folder. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p397 in `CERT_LOG.md`. Exposé VIII is closed at p371; Exposé X is checked through the Euler-Poincaré formula (7.2) and proof steps a/b. The p392-p397 refresh verifies triangle diagram D179, completes the proof of Proposition 5.1 / the Weil formula, opens and completes the local-term definition layer in §6, fixes the systematic `A` vs `\Lambda` transcription error in the `Hom`/`Sw` terms on p394-p395, and fixes a dropped prime `C` to `C'` on p397. Fixes #35-#44 and diagrams through D179 are recorded. Treat p266-p397 as live workpass/provenance metadata only unless later compactly packaged, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 is substantial but not complete; SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
