...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 85 | 12 | 62 | 652.5 MB | Version [10.5281/zenodo.21747165](https://doi.org/10.5281/zenodo.21747165) retains the complete SGA1-7 I bundle and adds a direct 194-page SGA7 II English current-progress reader through complete Exposé XVIII with a 137-member source ZIP. SGA1 remains the default preview. All 85 files, 82 retained identities, and 137 replacement-package members passed anonymous exact readback. SGA7 II remains incomplete and is not exhaustive-reference certified. |
