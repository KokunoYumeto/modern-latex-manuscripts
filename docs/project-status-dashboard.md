...
Latest Noether public hygiene: current version [10.5281/zenodo.21434076](https://doi.org/10.5281/zenodo.21434076) has 98 files: 41 reader PDFs, 39 coherent ZIPs, 5 direct editable TeX files, and 13 manifest/status files. It fronts the English cumulative reader and retains the German R823, Spanish, French, Interslavic, and earlier bounded multilingual surfaces. It adds Chinese Paper 37 in PRC-oriented Simplified Chinese and controlled generic Traditional Chinese plus Korean Paper 29 U03 after U01-U02, with exact editable/evidence packages. Six visual archives preserve twenty-eight open project-generated renders; rights-blocked or control-only pixels are represented by metadata, hashes, and coordinates only. Paper 4 continues at Section 7 / R823 line 4112, Korean Paper 29 continues at line 53, and the 353 `važi*|važe*` probes remain an external-authority blocker. These surfaces passed their declared technical gates but lack native/community certification. The record does not claim complete Paper 4 or Paper 29, whole-corpus certification, universal mathematical source certification, rights clearance, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 98 | 41 | 39 | 2317.90 MB | Current version [10.5281/zenodo.21434076](https://doi.org/10.5281/zenodo.21434076) fronts the English cumulative reader, retains the German R823/Spanish/French/Interslavic surfaces, extends bounded Paper 4 English through Section 6, and adds Japanese Papers 21 and 23, Korean Paper 29 U01-U04, and Chinese Paper 37 in two controlled targets with rights-aware visual evidence. Paper 4 continues at Section 7 / R823 line 4112; Korean Paper 29 continues at line 53. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not complete Paper 4 or Paper 29, whole-corpus certification, universal synchronization, native/community certification, rights clearance, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 18 | 6 | 5 | 47.14 MB | Version [10.5281/zenodo.21432714](https://doi.org/10.5281/zenodo.21432714) retains the exact current SGA1 I.3, SGA5 replacement, and SGA6 idx684 objects, while removing one obsolete path-bearing SGA5 archive and two stale controls from the latest surface. The 309-page SGA5 reader remains the default preview. Historical versions remain immutable. None is a complete volume or critical edition. |
