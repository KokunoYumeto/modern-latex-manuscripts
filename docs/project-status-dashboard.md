...
Latest Noether public hygiene: current version [10.5281/zenodo.21431982](https://doi.org/10.5281/zenodo.21431982) has 53 files: 27 reader PDFs, 18 coherent ZIPs, and 8 manifest/status files. It fronts the English cumulative reader and retains the German R823, Spanish, French, Interslavic, and earlier bounded multilingual surfaces. It adds bounded source-audited English Paper 4 Introduction/Postscript and Sections 1-2 with exact evidence in file `19`, while retaining Paper 3 and CJK Papers 27-29. File `17` preserves 3,024 unique render/review images not already present by exact hash in prior evidence packages. File `11` retains all 442 current Interslavic TeX/PDF units and the final audit; file `15` retains Paper 30 evidence. Paper 4 continues at Section 3 / R823 line 3730, and the 353 `važi*|važe*` probes remain an external-authority blocker. These surfaces passed their declared technical gates but lack native/community certification. The record does not claim complete Paper 4, whole-corpus certification, universal mathematical source certification, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 53 | 27 | 18 | 2163.91 MB | Current version [10.5281/zenodo.21431982](https://doi.org/10.5281/zenodo.21431982) fronts the English cumulative reader, retains the German R823/Spanish/French/Interslavic surfaces, and adds bounded Paper 4 Introduction/Postscript and Sections 1-2 readers with exact evidence in file `19`; Paper 3/27-29 remain available. File `17` preserves 3,024 unique render/review images; file `11` retains all 442 current Interslavic units and the final audit; file `15` retains Paper 30 evidence. Paper 4 continues at Section 3 / R823 line 3730. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not complete Paper 4, whole-corpus certification, universal synchronization, native/community certification, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 20 | 6 | 6 | 752.04 MB | Version [10.5281/zenodo.21432199](https://doi.org/10.5281/zenodo.21432199) retains the 309-page SGA5 English source-synchronized reader as default preview, extends the bounded six-page SGA1 English checkpoint through Expose I section I.3, and retains a 377-page layered SGA6 reader reconciled through idx684 with a compact privacy-clean support package. French/Spanish SGA6 checkpoints remain available. None is a complete volume or critical edition. |
