...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA working translation/source snapshots. Latest public update 2026-06-24 (`10.5281/zenodo.20822648`) adds `SGA5_repair032_audit_support_20260624.zip`, a bundled SGA5 repair/audit support artifact. It is not completion or certification: a newer manual certification log treats agents/workflows as finders, not certifiers, and a queued p154 status package now records pp.1-154 as page-locally certified. Pages 1-72 close Expose I; pp.73-137 close Expose III; pp.138-154 cover Expose III B through Lemma 3.5 / diagram D074, with section 3 nearly complete. The current ledger reports a 307-page workpass compile and 154 pages certified; p155 is next. p146, p148, p150, and p151 identify/fix intermittent dropped referenced diagram/equation label and notation-deviation classes, so a global referenced-label/notation audit is required before stronger claims. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current pp.1-154 certification is opening-range evidence, not global SGA5 certification. SGA6/SGA7 compression/source-check caveats remain explicit. |
