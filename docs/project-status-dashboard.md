...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 14 | 5 | 4 | 877.64 MB | Current version [10.5281/zenodo.21421508](https://doi.org/10.5281/zenodo.21421508) fronts the 309-page SGA5 English source-checked working translation and adds a four-page SGA6 Spanish Exposé X idx532-537 working tranche with editable TeX, direct source witnesses, ledgers, hashes, build evidence, and render checks. SGA5 English is substantial but not a critical edition or global independent certification. The French SGA6 checkpoint reaches #679/idx662; the full-range layered English reader remains in review; SGA7-I remains partial. |
