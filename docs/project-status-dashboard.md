...
Latest Noether local queue hygiene: R555 is the current coherent zipped local TeX-changing German source-control head. It is a focused Paper 40 printed pp.534-535 Rangrelationen / Section 8 source-math/source-style repair on top of R554/R553/R552/R551/R550, restoring source emphasis, multiplication dots, footnote 18 at `n=m\cdot r`, barred `\bar\Omega`, source-style §4/§8 headings, `m=s\cdot p^f`, `(Z:Z_0)=p^f`, `(reduzierter)` Spur, `(Darstellungstheorie §21)`, and the separable first-kind theorem statement. R553/R552 are coherent predecessors; R554 is folded into R555 rather than separately fronted. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
