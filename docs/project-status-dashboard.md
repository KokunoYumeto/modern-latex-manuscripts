...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 719.2 MB | Latest compact version [10.5281/zenodo.21306092](https://doi.org/10.5281/zenodo.21306092) fronts three reader/checking PDFs and two grouped TeX/audit/source-support ZIPs. SGA5 remains incomplete and unsynchronized. The frozen SGA6 source-rescribe reaches #410 / idx413 / volume p400 / Exposé VI p36 after checking 34 further source pages and repairing relations, notation, display structure, diagrams, and unsupported tags; it remains a workpass rather than certification. Content after idx413 remains inherited scaffold until directly checked. SGA7-I remains partial. |
