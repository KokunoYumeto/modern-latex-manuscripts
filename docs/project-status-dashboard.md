...
Latest Noether public hygiene: current version [10.5281/zenodo.21434690](https://doi.org/10.5281/zenodo.21434690) has 100 files: 42 reader PDFs, 43 coherent ZIPs, 7 direct editable TeX files, and 8 manifest/status files. It fronts the inherited English cumulative reader and retains the German, Spanish, French, Interslavic, and earlier bounded multilingual surfaces. The current update adds the Paper 2 pp.58-92 closure, Paper 4 German Sections 6-7 repairs, bounded English Section 7, and a 53-render indexed visual package; 79 source-derived rasters are represented by metadata, hashes, and geometry only. Paper 2 pp.23-57 remain open. Paper 4 continues at Section 8 / R823 line 4270, Korean Paper 29 continues at line 53, and the 353 `važi*|važe*` probes remain an external-authority blocker. These surfaces passed their declared technical gates but lack native/community certification. The record does not claim complete Paper 2, Paper 4, or Paper 29, whole-corpus certification, universal mathematical source certification, rights clearance, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 42 | 43 | 2362.92 MB | Current version [10.5281/zenodo.21434690](https://doi.org/10.5281/zenodo.21434690) fronts the inherited English cumulative reader, retains the German/Spanish/French/Interslavic surfaces, closes bounded Paper 2 pp.58-92, and extends bounded Paper 4 English through Section 7. Paper 2 pp.23-57 remain open; Paper 4 continues at Section 8 / R823 line 4270; Korean Paper 29 continues at line 53. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not complete Paper 2, Paper 4, or Paper 29, whole-corpus certification, universal synchronization, native/community certification, rights clearance, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes bounded SGA1 through Exposé I §I.6 and complete bounded SGA2 Exposés V-VI, retains the exact current SGA5 replacement and SGA6 idx684 objects, and pairs all eight reader PDFs with direct TeX downloads. The 309-page SGA5 reader remains the default preview; privacy-clean support and 37 project renders remain grouped. Rights are `License Not Specified`; historical versions remain immutable. SGA1 and SGA2 are active but incomplete, SGA5 is selected rather than complete, SGA6 has mixed authority layers, and none is a critical edition. |
