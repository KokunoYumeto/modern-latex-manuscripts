...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 730.2 MB | Latest compact Zenodo version [10.5281/zenodo.21419947](https://doi.org/10.5281/zenodo.21419947) freezes the French SGA6 source-rescribe at #679/idx662 / volume p649 / Exposé XIII p34, with idx663 next. A separate English Exposé X restart covers idx532-537 only. SGA5 remains incomplete, error-bearing, and unsynchronized; SGA6 remains a workpass rather than certification, and content after idx662 remains inherited scaffold until directly checked. SGA7-I remains partial. |
