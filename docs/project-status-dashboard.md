...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21713359 fronts reference-v2 working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, and the complete published EGA III text through 7.9.14, plus source-aligned EGA IV Sections 1-10. Direct masters and grouped recursive source remain available, and eight archives preserve 818 actual high-detail EGA IV source-image witnesses from printed pages 5-155 and 185-281. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 38 | 13 | 17 | 2809.7 MB | Version [10.5281/zenodo.21713359](https://doi.org/10.5281/zenodo.21713359) preserves the French originals and fronts five current English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the complete published EGA III text through 7.9.14, and source-aligned EGA IV Sections 1-10. The leading 125-member bundle, five direct masters, and grouped source/QA files keep the reader shelf compact. Eight additional ZIPs contain 818 actual high-detail EGA IV source-image witnesses from printed pages 5-155 and 185-281. All 38 outer files and all 177 members of the two newest archives passed anonymous exact readback; all 36 predecessor files remained byte-identical. The image gap on pages 156-184 is explicit. EGA IV continues at Section 11; the wider EGA corpus remains partial and non-uniform. |
