...
Latest Noether public hygiene: current version [10.5281/zenodo.21406056](https://doi.org/10.5281/zenodo.21406056) has 15 files: 2 reader PDFs, 8 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page v26/R822 German source-control reader, keeps the older English reader and multilingual checkpoints available, preserves R787-R804 evidence as grouped rollups, and groups the size-controlled current German package behind the reader. R822 adds four bounded direct-source Paper 20 refinements beyond R821 with no OCR promoted; all non-Paper-20 bytes are preserved exactly and render changes are confined to output pp218-220. Earlier current heads remain in immutable versions rather than competing on the latest surface. It does not claim Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 15 | 2 | 8 | 1363.77 MB | Current version [10.5281/zenodo.21406056](https://doi.org/10.5281/zenodo.21406056) fronts the 466-page v26/R822 German reader and groups the size-controlled current German source-control package. R822 adds four direct-source Paper 20 refinements beyond R821 with no OCR promoted. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 722.4 MB | Latest compact Zenodo version [10.5281/zenodo.21402087](https://doi.org/10.5281/zenodo.21402087) freezes the French SGA6 source-rescribe at #662/idx645 / volume p632 / Exposé XIII p17, with idx646 next. A separate English Exposé X restart covers idx532-537 only. SGA5 remains incomplete, error-bearing, and unsynchronized; SGA6 remains a workpass rather than certification, and content after idx645 remains inherited scaffold until directly checked. SGA7-I remains partial. |
...
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 21 | 1 | 10 | 4430.4 MB | Current version [10.5281/zenodo.21300808](https://doi.org/10.5281/zenodo.21300808) fronts the July 10 methodology PDF, preserves grouped source-body/provenance payloads, and adds the v0.4 Claude/Fable executable-methodology workspace. Methodology and corpus infrastructure only; not native approval, accepted terminology, language completion, or translation certification. |
