...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves SGA1 through Corollary I.9.3 and its complete proof r1, audited SGA2 Expose VII, and the exact Expose VIII cumulative R5 package through line 2928 with 30 source-bearing bodies / 32 bounded states. The R5 package has one editable TeX source, an eight-page reader, and complete project-generated reader/workbook QA; no French authority file or source-page pixel is bundled. GitHub also carries eight rights-curated Expose X package surfaces for French lines 3414-3456, 3522-3530, 3532-3540, 3542, 3544-3553, 3555-3566, 3568-3571, and 3573-3574. The latter seven packages form a source-bearing sequence through line 3574, separated only by excluded authority blank lines. Theorem 3.10 / lines 3576-3586, the closing comment / line 3588, the Expose XI opening / lines 3590-3596, Expose XI Section 1 / lines 3598-3606, the line-3607 Picard-cohomology transition, and Proposition XI.1.1 / lines 3609-3616 have independent PASS handoffs but remain metadata-only because their release authorization is false; every target and pixel is held. Proposition XI.1.1 applies the manager-closed `Pic(Y_n)` to `Pic(X_n)` policy, but no proposition target is publicly released. Lines 3457-3521 remain unclaimed. A July 22 read-only SGA6 watch found no material successor: idx684 remains the admitted authority and idx685 the English cursor. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, no continuous Expose IX-X release is claimed, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
