...
Latest Noether public hygiene: current version [10.5281/zenodo.21422620](https://doi.org/10.5281/zenodo.21422620) has 33 files: 14 reader PDFs, 13 coherent ZIPs, and 6 manifest/status files. It retains the 466-page v26/R823 German source-control reader, directly exposes the 473-page Spanish and 529/552-page Interslavic readers, fronts Indonesian Paper 36, and adds eight direct CJK PDFs for complete Papers 26/36 in Simplified Chinese, generic Traditional Chinese, Japanese, and Korean. Arabic and Persian Paper 06 remain partial. Spanish, Interslavic, and the bounded CJK short works passed their declared technical gates but lack native/community certification. Broader English and CJK readers remain only partly synchronized. The record does not claim universal mathematical source certification or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 33 | 14 | 13 | 1600.95 MB | Current version [10.5281/zenodo.21422620](https://doi.org/10.5281/zenodo.21422620) retains the German, Spanish, and complete current Interslavic reader surfaces; fronts Indonesian Paper 36; and adds eight direct CJK PDFs for complete Papers 26/36. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not universal synchronization, native/community certification, mathematical source certification, or a critical edition. |
