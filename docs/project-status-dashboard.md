...
Latest Noether source-support hygiene: status ledger v12 plus the Paper 16 IA JP2/GDZ400 source-upgrade package, Paper 17 GDZ600 full-raw-page package, and Paper 19 GDZ400 max-source/dense-tail-crop package are registered as source support for future checking. They add corrected source routes, exact article/source routes, raw page images, max-probe/source-quality ledgers, and labelled witness crops, but apply no TeX patch and do not certify those papers; they belong in a compact Noether rollup/rebalance, not above reader-facing PDFs.
