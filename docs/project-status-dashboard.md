...
Latest Noether public hygiene: current version [10.5281/zenodo.21421559](https://doi.org/10.5281/zenodo.21421559) has 24 files: 6 reader PDFs, 13 coherent ZIPs, and 5 manifest/status files. It retains the 466-page v26/R823 German source-control reader, directly exposes the 473-page Spanish and 529/552-page Interslavic readers, and adds a fronted complete-work Indonesian Paper 36 working translation plus grouped Arabic/Persian/Indonesian components. Arabic and Persian Paper 06 remain partial. Spanish and Interslavic passed their declared technical gates but lack native/community certification. English and CJK remain only partly synchronized. The record does not claim universal mathematical source certification or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 24 | 6 | 13 | 1600.52 MB | Current version [10.5281/zenodo.21421559](https://doi.org/10.5281/zenodo.21421559) retains the German, Spanish, and complete current Interslavic reader surfaces, and adds a fronted Indonesian Paper 36 working translation plus grouped partial Arabic/Persian Paper 06 components. Working corpus/source-control/translation lane only, not universal synchronization, native/community certification, mathematical source certification, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 15 | 5 | 5 | 996.30 MB | Current version [10.5281/zenodo.21421931](https://doi.org/10.5281/zenodo.21421931) fronts the 309-page SGA5 English working translation and directly exposes a 381-page SGA6 full-range layered English reader, while retaining the French workpasses and bounded four-page Spanish SGA6 Exposé X idx532-537 tranche. The SGA6 English package contains editable TeX, authority/formula/terminology/page ledgers, build evidence, all-page QA, contact sheets, prefix-repair evidence, hashes, and validation. Its authority is non-uniform by design: inherited/partially synchronized prefix, French-synchronized idx532-662, then scan-checked draft tail. None is a critical edition or uniform source certification; SGA7-I remains partial. |
