...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p355 in `AGENT_SCORECARD.md`. p355 is in Exposé VIII, records fix #34 in the `K(F)` formula, and tracks diagrams through D171; the local workpass compile log reports 307 pages. Treat p266-p355 as live workpass/provenance metadata only, not a compact promoted public delta, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 is substantial but not complete: a June 11 audit found 127/524 sampled source prose windows, about 24%, missing from current TeX in late regions. SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
