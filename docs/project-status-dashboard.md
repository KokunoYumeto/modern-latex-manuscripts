...
Latest Noether local queue hygiene: R534 is the current clean packaged local TeX-changing German source-control candidate. R530/R531 remain source-control steps beneath it; R532/R533 are no-patch support/provenance; R534 adds one source-backed Paper 40 p515 comma repair. The second-web intake now fronts R534 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R534, carrying the R530/R531 repair chain plus one Paper 40 p515 comma source fix. R532/R533 and R528/R529 are support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
