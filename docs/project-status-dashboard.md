...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves audited Expose VII and sixteen bounded Expose VIII states through the Lemma 2.4 reductions and statement / line 2721. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
