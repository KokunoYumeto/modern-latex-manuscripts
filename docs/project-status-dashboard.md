...
Latest Noether local queue hygiene: R563 is the current local TeX-changing German source-control head. It is a one-locus tail printed pp.725-730 source-style repair over R562, changing `\emph{Beweis.} 1.` to source-visible `\emph{Beweis} 1.` on collected p730 / cumulative output p433. R563 compiles to a 468-page cumulative German PDF with two XeLaTeX passes and includes README_R563, audit/provenance/source-witness/render evidence, and a local ZIP queued for the next curated rollup. R562 remains the richer ledged predecessor: a focused Paper 40 printed pp.530-535 source-check pass on top of R561, integrating selected WebB R556 candidate fixes only after local comparison with GDZ source witnesses. R561/R560/R559/R558/R557/R556 are coherent predecessors; this is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. A newer local R564 folder is held/rejected because its dense-tail x-to-\chi substitutions conflict with the collected p731 source witness; R563 remains current. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current local TeX-changing source-control head is R563, a one-locus tail pp.725-730 source-style repair over R562. R562 remains the richer ledged Paper 40 pp.530-535 source-check predecessor, carrying the R550-R562 source-control chain and coherent R561/R560/R559/R558/R557/R556 predecessors. R564 is held/rejected for an x-to-\chi source mismatch on collected p731, so R563 remains current. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
| [Weber](https://doi.org/10.5281/zenodo.20412153) | 54 | 8 | 38 | 1486.86 MB | `Lehrbuch der Algebra` Volume I represented as repaired but still under source-audit correction; Volume II readers through §176 plus recursive repair packets; Volume III current repaired cumulative. Latest public version <https://doi.org/10.5281/zenodo.20837104> adds Batch137, Batch138, and B139. Local post-public Phase 2 workpass now records coherent German re-transcriptions or verified faithful checks for §§141, 148, 149, 151, 153-156, 158, 162, 163, 165, and §§167-183, with §§171-172 re-verified as genuine map-phase transcriptions; the current German workpass compiles to 410 pages. The earlier §§148-156, §§167-170, and §§173-183 held blocks are closed locally; remaining held ranges include §69, §138 numbering/layout, p466, and §184 onward. This is not English synchronized, not whole-Volume-I certification, and not a certified critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p421 in `CERT_LOG.md` / `AGENT_SCORECARD.md`. Exposé VIII is closed at p371; Exposé X is locally recorded through its references at p406, including diagrams D178-D184, the Euler-Poincaré formula, local terms, and A/Λ transcription fixes; later Exposé XII live-ledger evidence now reaches p421, with the p421 source Arabic "1)" versus TeX Roman "I)" label deviation deferred to p422. Treat p266-p421 as live workpass/provenance metadata only unless later compactly packaged, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 is substantial but not complete; SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
