...
Latest Noether public hygiene: the current Noether version is the 2026-07-07 R805 source-control update, [10.5281/zenodo.21247333](https://doi.org/10.5281/zenodo.21247333). It has 18 files: 2 reader PDFs, 10 coherent ZIPs, 6 manifest/status files, fronts `00_Noether_German_Cumulative_Working_SourceControl_R805_20260707.pdf`, preserves R787-R804 evidence grouped as 06a/06b/06c/06d, keeps the R804 v11 source-control package as file 07, and adds the R805 Paper 19 p57 E-family correction packet as file 08. It does not claim reader release, Noether closure, whole-corpus certification, 650+ source certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 18 | 2 | 10 | 2.07 GB | Reader-facing first: latest version [10.5281/zenodo.21247333](https://doi.org/10.5281/zenodo.21247333) fronts the R805 German/source-control PDF, keeps standalone English papers grouped, preserves R787-R804 source-repair/audit rollups, retains `07_Noether_Current_SourceControl_Integrated_v11_R800_R804_20260707.zip`, and adds the R805 Paper 19 p57 E-family correction packet as file 08. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, 650+ page/source certification, multilingual synchronization, or a critical edition. |
