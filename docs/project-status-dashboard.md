...
GitHub custody update 2026-07-22: SGA1 opening through Corollary I.9.3 and its complete proof r1, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Expose VIII has twenty-seven separately classified states through French line 2907 and is not presented as a cumulative release. GitHub also preserves non-continuous rights-curated Expose X checkpoints for Proposition 2.3 through editor note 3 / French lines 3414-3456, the standalone Remark 3.7 / Corollary 3.8 units at lines 3532-3540, the transition sentence at line 3542, and the Lemma 3.9 statement at lines 3544-3553. Source-page rasters are metadata-only because redistribution rights remain unresolved; the candidate Lemma 3.6 proof at lines 3522-3530 is fail-closed. This does not claim continuous Expose IX-X coverage.
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves SGA1 through Corollary I.9.3 and its complete proof r1, audited SGA2 Expose VII, twenty-seven bounded Expose VIII states through line 2907, and non-continuous rights-curated Expose X checkpoints for French lines 3414-3456, 3532-3540, 3542, and 3544-3553. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, no continuous Expose IX-X release is claimed, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
