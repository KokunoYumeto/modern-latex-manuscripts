...
GitHub custody update 2026-07-19: SGA1 opening through the duplicate-numbered Corollary and Proposition I.9.2 statements r2, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Earlier SGA1 checkpoints remain immutable predecessor history; revoked I.9.2 r1 was not copied. The new exact SGA1 cursor is excluded French line 1722, beginning the proof of the second visible I.9.2 statement. Expose VIII has twenty-four separate unit states through the independently sealed fourth proof-step case `(iv) => (ii)`, `n > 1` / French line 2872, continuing at Section 3, line 2874, after excluded blank line 2873, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves SGA1 through the duplicate-numbered Corollary and Proposition I.9.2 statements r2, audited SGA2 Expose VII, and twenty-four bounded Expose VIII states through the fourth proof-step case `(iv) => (ii)`, `n > 1` / line 2872, continuing at Section 3, line 2874. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
