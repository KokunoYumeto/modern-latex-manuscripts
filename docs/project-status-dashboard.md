...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest local SGA5 control package is `SGA5_FullAudit_Workpass_Salvage_v2_20260626.zip`, which preserves the fresh French workpass, repair032 baseline, fresh diff, CERT_LOG, AGENT_SCORECARD, and reconciliation notes. CERT_LOG/AGENT_SCORECARD are the controlling status files: completed rows reach p194, p195 is next, and about 223 pages still need reconciliation/certification. This is opening-range workpass evidence for a curated SGA5 expose selection, not complete SGA5, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. |
