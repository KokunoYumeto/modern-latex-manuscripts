...
Latest Noether local queue hygiene: R520 is the current clean packaged local TeX-changing source-control candidate, after two Paper 24 printed p250 substitution-chain repairs on top of R519. The second-web intake fronts R520 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R520: R496 supplies the post-P43 tail/Schur fixes, R504 Paper 14 source-backed fixes, R507 a tail display-punctuation fix, R516 a Paper 24 p232 order fix, R518 a Paper 24 p241 `von der Dimension` repair, R519 three Paper 24 p246 bare-product display repairs, and R520 two Paper 24 p250 substitution-chain repairs. R508-R515 and R517 are support/no-patch/source-quality/visual-audit packets, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
