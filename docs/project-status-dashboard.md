...
GitHub custody update 2026-07-19: independently audited Noether Paper 4 Section 8 and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Expose VIII has fifteen separate unit states through the independently sealed Corollary 2.3 proof/open-cover comparison / French line 2713, with explicit self-gated, sealed, superseded, quarantined, and rights-blocked distinctions. They are not presented as a cumulative Expose VIII release.
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 33 | 8 | 9 | 70.05 MB | Version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547) publishes SGA1 through I.6 and bounded SGA2 Exposes V-VI with eight direct PDF/TeX pairs. GitHub additionally preserves audited Expose VII and fifteen bounded Expose VIII states through the Corollary 2.3 proof/open-cover comparison / line 2713. Rights are `License Not Specified`; SGA1 and SGA2 remain active but incomplete, SGA5 is selected, SGA6 has mixed authority, and none is a critical edition. |
