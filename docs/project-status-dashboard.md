...
Latest Noether public hygiene: current version [10.5281/zenodo.21394234](https://doi.org/10.5281/zenodo.21394234) has 15 files: 2 reader PDFs, 8 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page v26/R821 German source-control reader, keeps the older English reader and multilingual checkpoints available, preserves R787-R804 evidence as grouped rollups, and groups the size-controlled current German package behind the reader. R820/R821 add 12 direct-source Paper 20 emphasis and typography refinements beyond R819 with no OCR promoted; all non-Paper-20 text is preserved exactly. Earlier current heads remain in immutable versions rather than competing on the latest surface. It does not claim Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 15 | 2 | 8 | 1393.0 MB | Current version [10.5281/zenodo.21394234](https://doi.org/10.5281/zenodo.21394234) fronts the 466-page v26/R821 German reader and groups the size-controlled current German source-control package. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
