...
Latest Noether local queue hygiene: R527 is the current clean packaged local TeX-changing German source-control candidate after the R523-R527 Paper 24 repair chain. R528 is registered as no-patch visual/source-audit support for Paper 24 printed pp.250-261 on top of R527, and R529 is registered as no-patch current-base survival support for Papers 25-30 on top of R528/R527. Neither R528 nor R529 replaces R527 as the TeX-changing head. WebB R497 is separately registered as a TeX-changing tail/Kapferer source-control provenance artifact, distinct from the local R497 no-patch Paper 22 survival guardrail; R285 is registered as P08/P10/P13/P15/P19 source-merge provenance and workflow evidence, not as a base replacement. The second-web intake now fronts R529 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
