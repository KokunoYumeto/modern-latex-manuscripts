...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA working translation/source snapshots. Latest public update 2026-06-24 adds `SGA5_repair032_audit_support_20260624.zip`. It is not completion or certification: a newer manual certification log treats agents/workflows as finders, not certifiers, and a queued p188 status package records pp.1-188 in the page-local ledger. Pages 1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked complete in the ledger; Expose III B Part II §5 is locally closed through p182; §6 has started with pp.183-188 checked locally; D001-D101 are covered. This is opening-range evidence for a curated TeX selection, not global SGA5 certification. SGA6/SGA7 compression/source-check caveats remain explicit. |
