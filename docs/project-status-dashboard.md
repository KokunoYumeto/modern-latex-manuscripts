...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 15 | 5 | 5 | 1011.20 MB | Version [10.5281/zenodo.21424602](https://doi.org/10.5281/zenodo.21424602) fronts the 309-page SGA5 English working translation, directly exposes the corrected 381-page SGA6 full-range layered English reader, and adds the 374-page French SGA6 source-rescribe checkpoint through idx684 / volume p671 / Exposé XIV p5. The French package contains editable release/upstream TeX, the pagewise ledger, errata, idx663-684 source witnesses, render QA, build evidence, and hashes. The bounded four-page Spanish SGA6 Exposé X idx532-537 tranche remains public. English authority remains non-uniform by design: inherited/partially synchronized prefix, French-synchronized idx532-662, then scan-checked draft tail. The French cursor is not whole-volume certification; none is a critical edition and SGA7-I remains partial. |
