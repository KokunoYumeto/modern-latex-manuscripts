...
Latest Noether local queue hygiene: R547 is the current coherent packaged local TeX-changing German source-control candidate. It is a focused Paper 40 printed p526 source-style repair on top of R546, restoring the source run-in Darstellungsklassen/Rangrelation theorem layout and formula (1) as a left-labelled display. R546 remains historical Kapferer/Noether p562 formula (3) support; R545 and earlier R530-R544/R286/R528-R529 layers remain historical source-control, no-patch support, or provenance. The second-web intake now fronts `40_R547_P40P526_DARSTELLUNGSKLASSEN_RANGRELATION_SOURCEFIX.zip` with 40 top-level files / 35 ZIP payloads / 4,289,631,087 ZIP bytes. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R547, carrying R530/R531, R532/R533, R534-R545 source-control/provenance, the R546 Kapferer/Noether p562 formula (3) RHS repair, and the R547 Paper 40 p526 Darstellungsklassen/Rangrelation source-style repair. R528/R529 remain support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
