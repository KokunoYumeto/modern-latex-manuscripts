...
Latest Noether public hygiene: current version [10.5281/zenodo.21419257](https://doi.org/10.5281/zenodo.21419257) has 17 files: 2 reader PDFs, 10 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page v26/R823 German source-control reader, retains the Paper 06 Slavic working tranche, and adds bounded R823-synchronized English, CJK/Korean, and Slavic lecture-book components. R823 makes six direct-source Paper 20 repairs without promoting OCR. The full language readers remain unsynchronized, Korean coverage is bounded, and the Slavic book-front is 1 of 32 core units. It does not claim Noether closure, language certification, complete multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 17 | 2 | 10 | 1375.82 MB | Current version [10.5281/zenodo.21419257](https://doi.org/10.5281/zenodo.21419257) fronts the 466-page v26/R823 German reader and adds bounded source-synchronized English, CJK/Korean, and Slavic components. Working corpus/source-control/translation lane only, not whole-corpus closure, complete synchronization, linguistic certification, or a critical edition. |
