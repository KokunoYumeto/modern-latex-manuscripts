...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21708950 fronts reference-v2 working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, and the complete published EGA III text through 7.9.14, plus source-aligned EGA IV Sections 1-10. Direct masters and grouped recursive source remain available. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 30 | 13 | 9 | 483.36 MB | Version [10.5281/zenodo.21708950](https://doi.org/10.5281/zenodo.21708950) preserves the French originals and fronts five current English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the complete published EGA III text through 7.9.14, and source-aligned EGA IV Sections 1-10. The leading 125-member bundle, five direct masters, and four current source/QA ZIPs make the reader shelf compact. All 30 outer files and every member of all nine ZIPs passed anonymous exact readback. EGA IV continues at Section 11; the wider EGA corpus remains partial and non-uniform. |
