...
Latest Noether local queue hygiene: R549 is the current coherent packaged local TeX-changing German source-control candidate. It is a focused Paper 40 printed pp.528-529 source-style repair on top of R548, restoring source-style run-in/italic treatment for the inner-automorphism, elementwise-commuting subring, and matrix-ring sharpening theorems, centered §6/Galois-theory heading material, and the §6 item-1 opening with source-inline `\Gcal` / `A^*/P^*` and `\mathfrak H\sim H^*/P^*` relations. R548 remains historical p527 Rangrelation/§5 support; R547 remains historical p526 support; R546 remains Kapferer/Noether p562 formula (3) support. The second-web intake now fronts `41_R549_P40P528_529_AUTOMORPHISM_VERTAUSCHUNG_GALOIS_SOURCEFIX.zip` with 43 top-level files / 36 readable ZIP payloads / 4,393,008,962 ZIP bytes. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent packaged local TeX-changing source-control candidate is R549, carrying R530/R531, R532/R533, R534-R545 source-control/provenance, the R546 Kapferer/Noether p562 formula (3) RHS repair, the R547 Paper 40 p526 Darstellungsklassen/Rangrelation source-style repair, the R548 Paper 40 p527 Rangrelation/§5 source-style repair, and the R549 Paper 40 pp.528-529 Automorphismen/Vertauschung/Galois source-style repair. R528/R529 remain support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
| [Weber](https://doi.org/10.5281/zenodo.20412153) | 54 | 8 | 38 | 1486.86 MB | `Lehrbuch der Algebra` Volume I represented as repaired but still under source-audit correction; Volume II readers through §176 plus recursive repair packets; Volume III current repaired cumulative. Latest public version <https://doi.org/10.5281/zenodo.20837104> adds Batch137, Batch138, and B139. New local pending Weber material includes B140-B145, the p648 content-map closure status package, and a Phase 2 local workpass now accepting coherent German re-transcriptions for §§141, 156, 158, 162, 163, 165, §§167-170, and §§173-179; §§171-172 are re-verified as genuine map-phase transcriptions; the current German workpass compiles to 403 pages. The earlier §§148-156, §§167-170, and §§173-179 held blocks are closed locally; remaining held ranges include §69, §138 numbering/layout, p466, and §180 onward. This is not English synchronized, not whole-Volume-I certification, and not a certified critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 100 | 74 | 25 | 3.23 GB | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact promoted SGA5 delta remains p260-p265, but later live ledger/provenance now records the local SGA5 workpass through p391 in `CERT_LOG.md`. Exposé VIII is closed at p371; Exposé X is checked through the proof continuation of Proposition 5.1, with p389 opening §5 `La formule de Weil`, p390 verifying Proposition 5.1/the Weil formula (5.2), and p391 checking the reduction-of-traces/Künneth continuation. Fixes #35-#37, diagrams through D178, the §4 Swan/Artin formulas, and the §5 Weil-formula proof opening are recorded. Treat p266-p391 as live workpass/provenance metadata only unless later compactly packaged, not SGA5 completion, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 is substantial but not complete; SGA7-I is still partial starter work. Corrections are welcome via GitHub issues or pull requests. |
