...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 66 | 8 | 50 | 398.00 MB | Version [10.5281/zenodo.21695622](https://doi.org/10.5281/zenodo.21695622) directly exposes six neutral-named English readers in SGA1-6 order, primary editable TeX, and two French readers. The preferred 1,471-page SGA3 R25 cumulative and 864-page SGA4 R8 successor are reader-clean. Fifty ZIPs / 4,259 file members plus six directory entries group source, QA, predecessor, and visual-provenance evidence. All 66 outer files passed anonymous exact readback. Direct readers contain no AI/project/model/workflow/source-status commentary; genuine source-era editorial apparatus remains. SGA1 is the default preview and is not exhaustively convention-v2 certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held. |
