...
Latest Noether local queue hygiene: R562 is the current coherent local TeX-changing German source-control head. It is a focused Paper 40 printed pp.530-535 source-check pass on top of R561, integrating selected WebB R556 candidate fixes only after local comparison with GDZ source witnesses. R562 compiles to a 468-page cumulative German PDF with two XeLaTeX passes and includes README_R562, ledgers, exact diff, GDZ source witnesses/crops, render checks, a matching ZIP, and SHA256 manifest evidence. R561/R560/R559/R558/R557/R556 are coherent predecessors; this is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
