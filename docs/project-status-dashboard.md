...
Latest Noether local queue hygiene: R537 is the current clean packaged local TeX-changing German source-control candidate. R530/R531 remain source-control steps beneath it; R532/R533 are no-patch support/provenance; R534/R535 add Paper 40 p515 punctuation repairs, R536 repairs p516 footnote-anchor punctuation, and R537 rebuilds the p517 theta/operator block. The second-web intake now fronts R537 as a source/state handoff, not as a reader release. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current clean packaged local TeX-changing source-control candidate is R537, carrying the R530/R531 repair chain, R532/R533 support, R534/R535 Paper 40 p515 punctuation repairs, R536 p516 footnote-anchor repairs, and the R537 p517 theta/operator source rebuild. R528/R529 remain support/no-patch/provenance layers, not new TeX heads. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
