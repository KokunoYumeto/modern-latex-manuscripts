...
Latest Noether local queue hygiene: R565 is the current local TeX-changing German source-control head. It applies a p742 bare-tau superscript repair on top of R564, changing `\alpha_{\nu\mu}^{(\tau)}` to `\alpha_{\nu\mu}^{\tau}` after source inspection. R564 is validated as a source-matching p730-p731 chi-to-x/dense-formula repair; the earlier R564 hold/rejection note was a false public-status conclusion and is superseded. R563/R562/R561/R560/R559/R558/R557/R556 remain coherent predecessors. R565 compiles to a 468-page cumulative German PDF and includes README/audit/provenance/source-witness/render evidence plus ZIP SHA256 `BD0642DB3368080A56251524B840BD14C32B4F718FB5407F751FA172A783A04D`. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current local TeX-changing source-control head is R565, a p742 bare-tau superscript repair over validated R564. R564 is now source-confirmed for p730-p731 chi-to-x/dense-formula repair, not held/rejected. R563/R562 remain coherent predecessors. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
