...
The SGA/EGA distinction still matters. SGA has six current English reader surfaces with deep source/reference/diagram work. EGA is non-uniform but no longer merely a support lane: current record 21712882 fronts reference-v2 working readers for EGA 0 through Section 13, complete EGA I, complete EGA II, and the complete published EGA III text through 7.9.14, plus source-aligned EGA IV Sections 1-10. Direct masters and grouped recursive source remain available, and six archives preserve 649 actual high-detail EGA IV source-image witnesses from printed pages 5-127 and 185-225. Neither corpus is a critical edition or blanket whole-series source certification.
...
| [EGA](https://doi.org/10.5281/zenodo.20414353) | 36 | 16 | 12 | 2034.4 MB | Version [10.5281/zenodo.21712882](https://doi.org/10.5281/zenodo.21712882) preserves the French originals and fronts five current English readers: EGA 0 through Section 13, complete EGA I, complete EGA II, the complete published EGA III text through 7.9.14, and source-aligned EGA IV Sections 1-10. The leading 125-member bundle, five direct masters, and grouped source/QA files keep the reader shelf compact. Six additional ZIPs contain 649 actual high-detail EGA IV source-image witnesses from printed pages 5-127 and 185-225. All 36 outer files and all 186 members of the two newest archives passed anonymous exact readback; all 34 predecessor files remained byte-identical. The image gap on pages 128-184 is explicit. EGA IV continues at Section 11; the wider EGA corpus remains partial and non-uniform. |
