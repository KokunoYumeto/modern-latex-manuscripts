...
Latest Noether public hygiene: current version [10.5281/zenodo.21429723](https://doi.org/10.5281/zenodo.21429723) has 37 files: 16 reader PDFs, 15 coherent ZIPs, and 6 manifest/status files. It fronts the English cumulative working reader and retains the German R823 source-control readers, 473-page Spanish, 494-page French, 527-page Latin Interslavic, 551-page Cyrillic Interslavic, Indonesian Paper 36, and eight direct CJK PDFs for complete Papers 26/36. File `11` carries all 442 current Interslavic TeX/PDF units, Tranches 002A-007, and the final 221-unit audit; file `15` retains the bounded Paper 30 source-control evidence. The internally resolvable Interslavic queue is closed, with 353 `važi*|važe*` probes in 101 files explicitly blocked on external linguistic/community authority. Spanish, French, Interslavic, and the bounded CJK short works passed their declared technical gates but lack native/community certification. The record does not claim whole-corpus certification, universal mathematical source certification, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 37 | 16 | 15 | generated from live catalog | Current version [10.5281/zenodo.21429723](https://doi.org/10.5281/zenodo.21429723) fronts the English cumulative reader and retains the German R823, Spanish, French, and complete current Interslavic reader surfaces; Indonesian Paper 36; and eight direct CJK PDFs for complete Papers 26/36. File `11` preserves all 442 current Interslavic TeX/PDF units, Tranches 002A-007, and the final audit; file `15` preserves the bounded Paper 30 patch and evidence. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not whole-corpus certification, universal synchronization, native/community certification, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 14 | 5 | 5 | 1011.20 MB | Version [10.5281/zenodo.21429328](https://doi.org/10.5281/zenodo.21429328) fronts the 309-page SGA5 English working translation, directly exposes the corrected 381-page SGA6 full-range layered English reader, and retains the 374-page French SGA6 source-rescribe checkpoint at idx684 plus the bounded Spanish SGA6 tranche. The two historical Spanish SGA5 checkpoints are withdrawn after a terminology-ledger regression; no current Spanish SGA5 body is included pending a canonical rebuild. SGA6 English authority remains non-uniform by design; none is a critical edition and SGA7-I remains partial. |
