...
Latest Noether local queue hygiene: R561 is the current coherent local TeX-changing German source-control head. It is a focused Paper 32 printed p226 source-symbol repair on top of R560, correcting Brauer/Noether footnote and prose parameter drift from `\ell` to source-visible `\varrho` in `b^2p^2\varrho^2`, `bp\varrho`, and the `a,b,p,\varrho` parameter lists. R561 compiles to a 468-page cumulative German PDF with two XeLaTeX passes and includes README_R561, ledgers, exact diff, raw IA JP2-derived source witnesses, render checks, a matching ZIP, and SHA256 manifest evidence. R560/R559/R558/R557/R556 are coherent predecessors; this is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 100 | 50 | 37 | 2.06 GB | Reader-facing first: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active German/source-audit control layers. Current coherent local TeX-changing source-control candidate is R560, carrying R530/R531, R532/R533, R534-R545 source-control/provenance, the R546 Kapferer/Noether p562 formula (3) RHS repair, the R547-R549 Paper 40 p526-p529 source-style repairs, the R550 WebB R546 missing-source fixes, the R551-R553 source-control chain, the coherent R555/R556/R557/R558 predecessors, the R559 Paper 40 pp.540-541 simple-systems/components tail repair, and the R560 Paper 31 p89/p98 component-identity/determinant-matrix repairs. This remains a working corpus/source-control lane, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
