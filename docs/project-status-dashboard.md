...
Latest Noether local queue hygiene: R557 is the current coherent zipped local TeX-changing German source-control head. It is a focused Paper 40 printed p538 idempotents / complementary-bases source-math/source-style repair on top of R556/R555/R553/R552/R551/R550, restoring the source-style idempotent theorem/proof block, the distinction between idempotents of `Z_\Omega` and extension systems `Z_{Z^{(i)}}` / `Z_Z`, complementary-bases theorem formulas and matrix wording, `Vertauschung der Matrizen`, and footnotes 21 and 22. R556 is now a coherent predecessor with its own ZIP/hash, ledgers, and two-pass 469-page build; R555/R553/R552 are coherent earlier predecessors, and R554 is folded into the later chain. This is source-control/support material only, not a reader release, Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition material. Older R/RA/source-support packets remain anti-regression and source-evidence layers and should be folded into compact rollups rather than treated as standalone paper certification.
