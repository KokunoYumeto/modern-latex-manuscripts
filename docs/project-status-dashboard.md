...
has 42 files and seventeen grouped archives. It retains all 36 predecessor
files byte-identically and adds three SGA6 crop/provenance archives. Anonymous
readback matched all 42 files and all 1,944 new archive members. The public
pixels are 460 explicit targeted zoom/recheck crops and 1,470 recovered named
high-detail crops; 1,698 routine page derivatives remain metadata-only. SGA1
is the authoritative default preview. The snapshot is temporal through the
cutoff after `idx314`, not continuous audit certification, scan republication,
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 42 | 10 | 17 | 271.73 MB | Version [10.5281/zenodo.21515326](https://doi.org/10.5281/zenodo.21515326) directly exposes eight sequential English readers: complete-volume working SGA1, complete SGA2 R8, sealed cumulative SGA3 I-IV, standalone native-diagram V, bounded Loop-1 VI-A, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Two French workpasses and ten primary TeX files remain direct; seventeen ZIPs group source, diagram, QA, predecessor, and high-detail crop evidence. All 42 files and 1,944 newly added archive members passed anonymous exact readback; 36 predecessor files remain byte-identical. SGA1 is the authoritative default preview. SGA1 is not exhaustively convention-v2 certified; SGA3 remains incomplete because VI-B and VII-XXVI are absent; SGA4half is rights-held. The SGA6 crop snapshot is visual/provenance evidence, not continuous certification or scan republication. |
