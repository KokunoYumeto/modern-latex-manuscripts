...
| Total public file surface | 40.56 GB |
...
Latest Noether public hygiene: current version [10.5281/zenodo.21320035](https://doi.org/10.5281/zenodo.21320035) has 15 files: 2 reader PDFs, 8 coherent ZIPs, and 5 manifest/status files. It fronts the 466-page v26/R819 German source-control reader, keeps the older English reader and multilingual checkpoints available, preserves R787-R804 evidence as grouped rollups, and groups the full current German package behind the reader. R818/R819 add 25 direct-source Paper 20 corrections with no OCR promoted; all non-Paper-20 text is preserved exactly. Earlier current heads remain in immutable versions rather than competing on the latest surface. It does not claim Noether closure, whole-corpus certification, multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 15 | 2 | 8 | 1846.8 MB | Current version [10.5281/zenodo.21320035](https://doi.org/10.5281/zenodo.21320035) fronts the 466-page v26/R819 German reader and groups the full current German source-control package. Working corpus/source-control lane only, not whole-corpus closure, page-by-page certification, multilingual synchronization, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 8 | 3 | 2 | 719.2 MB | Latest compact Zenodo version [10.5281/zenodo.21312517](https://doi.org/10.5281/zenodo.21312517) freezes SGA6 at #435/idx438 / Exposé VII p10, with idx439 next. SGA5 remains incomplete and unsynchronized; SGA6 remains a workpass rather than certification, and content after idx438 remains inherited scaffold until directly checked. SGA7-I remains partial. |
