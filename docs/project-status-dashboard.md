...
GitHub custody update 2026-07-22: SGA1 opening through Corollary I.9.3 and its complete proof r1, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Expose VIII has twenty-seven separately classified states through French line 2907 and is not presented as a cumulative release. GitHub also preserves readback-verified, non-continuous rights-curated Expose X checkpoints for Proposition 2.3 through editor note 3 / French lines 3414-3456, the standalone Remark 3.7 / Corollary 3.8 units at lines 3532-3540, and the additive transition sentence at line 3542. Source-page rasters are metadata-only because redistribution rights remain unresolved; the candidate Lemma 3.6 proof at lines 3522-3530 is fail-closed. This does not claim continuous Expose IX-X coverage.
