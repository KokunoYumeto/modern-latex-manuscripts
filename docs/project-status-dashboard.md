...
Latest Noether public hygiene: current version [10.5281/zenodo.21431458](https://doi.org/10.5281/zenodo.21431458) has 48 files: 24 reader PDFs, 17 coherent ZIPs, and 7 manifest/status files. It fronts the English cumulative reader and retains the German R823, Spanish, French, Interslavic, and earlier bounded multilingual surfaces. It adds bounded English Paper 3 and CJK Papers 27-29 with editable evidence; file `17` preserves 3,024 unique render/review images not already present by exact hash in prior evidence packages. File `11` retains all 442 current Interslavic TeX/PDF units and the final audit; file `15` retains Paper 30 evidence. The 353 `važi*|važe*` probes remain an external-authority blocker. These surfaces passed their declared technical gates but lack native/community certification. The record does not claim whole-corpus certification, universal mathematical source certification, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 48 | 24 | 17 | generated from live catalog | Current version [10.5281/zenodo.21431458](https://doi.org/10.5281/zenodo.21431458) fronts the English cumulative reader, retains the German R823/Spanish/French/Interslavic surfaces, and adds bounded Paper 3/27-29 readers plus editable evidence. File `17` preserves 3,024 unique render/review images; file `11` retains all 442 current Interslavic units and the final audit; file `15` retains Paper 30 evidence. Partial Arabic/Persian Paper 06 remains grouped. Working corpus/source-control/translation lane only, not whole-corpus certification, universal synchronization, native/community certification, or a critical edition. |
