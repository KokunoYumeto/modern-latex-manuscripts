...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 76 | 51 | 17 | 237.58 MB | Curated reader-facing working surface with cumulative readers, 43 standalone English paper PDFs, compact language/source packages, RA23 display-layout corrections, and RA25-RA34 Paper 02 source-critical symbol/body/table audit packages. RA29 closes the Paper 02 body through printed pp.84-90 at the current page-level standard; RA30 adds the final-summary/table-plate audit package; RA31 source-checks Tabelle I on printed/source p.91; RA33/RA34 source-checks Tabelle II on printed/source p.92, rows 0-23 at plate-row level. Local staging now has RA37/RA40/RA41, RA42 Paper 05 source-audit web drop, targeted Paper 06 and Paper 07 source-audit web drops, Paper 19 tail source-audit fixes, a Paper 20 Lean/source-audit formula-fix web drop, plus a German source-audit support set queued; RA41 reports Paper 04 pp.118-154 closed at the current German source-symbol standard, RA42 flags one Paper 05 cumulative title-footnote integration defect, Papers 06-07 flag source-style symbolic footnotes versus numeric TeX footnotes, Paper 19 corrects tail element-divisor exponent indices/source order, and Paper 20 corrects formula (13) factor-sum indices to `\kappa,\lambda`. The whole corpus remains 3/43 German source-symbol closed papers. Final Paper 02 tag/layout inventory and multilingual propagation remain open. |
