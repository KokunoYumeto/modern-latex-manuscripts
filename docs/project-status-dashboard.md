...
GitHub custody update 2026-07-22: SGA1 opening through Corollary I.9.3 and its complete proof r1, independently audited Noether Paper 4 Section 8, and SGA2 Expose VII are mirrored with exact producer evidence and project-render visual indexes while their same-concept Zenodo updates remain pending. Expose VIII has twenty-seven separately classified states through French line 2907 and is not presented as a cumulative release. GitHub now also preserves one standalone rights-curated Expose X checkpoint for Proposition 2.3 through editor note 3 / French lines 3414-3456, with raw cursor 3457 and substantive cursor 3458. Its three source-page rasters are metadata-only because redistribution rights remain unresolved. This does not claim continuous Expose IX-X coverage.
