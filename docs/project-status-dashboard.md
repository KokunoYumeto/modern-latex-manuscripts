...
Latest Noether public hygiene: current version [10.5281/zenodo.21420665](https://doi.org/10.5281/zenodo.21420665) has 19 files: 3 reader PDFs, 11 coherent ZIPs, and 5 manifest/status files. It retains the 466-page v26/R823 German source-control reader, directly exposes a 473-page Spanish R823 working translation, retains the Paper 06 Slavic tranche, and expands the bounded English R823 component set to twelve papers while preserving CJK/Korean and Slavic lecture-book components. Spanish passed its declared 81-unit gate; the other full language readers remain unsynchronized, Korean coverage is bounded, and the Slavic book-front is 1 of 32 core units. It does not claim Noether closure, native-language certification, complete multilingual synchronization, or critical-edition status.
...
| [Noether](https://doi.org/10.5281/zenodo.20412587) | 19 | 3 | 11 | 1403.1 MB | Current version [10.5281/zenodo.21420665](https://doi.org/10.5281/zenodo.21420665) retains the 466-page v26/R823 German reader, adds a 473-page Spanish R823 working translation, and carries twelve bounded English R823 components plus CJK/Korean and Slavic units. Working corpus/source-control/translation lane only, not whole-corpus closure, universal synchronization, native-language certification, or a critical edition. |
...
| [SGA](https://doi.org/10.5281/zenodo.20410947) | 12 | 4 | 3 | 874.9 MB | Current version [10.5281/zenodo.21420146](https://doi.org/10.5281/zenodo.21420146) fronts the 309-page SGA5 English source-checked working translation and groups its editable TeX, full source scan, French/inherited-English controls, ledgers, build logs, and render QA. The English pass closes 432 scan-derived candidate loci but is not a critical edition or global independent certification. The retained French SGA6 checkpoint reaches #679/idx662 / volume p649 / Exposé XIII p34; later text remains inherited scaffold and the live English lane is not yet coherently frozen. SGA7-I remains partial. |
...
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 24 | 1 | 11 | 4431.4 MB | Current version [10.5281/zenodo.21418942](https://doi.org/10.5281/zenodo.21418942) fronts the 19-page v0.5 research-method report, preserves grouped source-body/provenance payloads, and adds the exact State C/W0 and unified-v6.2 data plus executable audit as file `12`. Methodology, reproducibility, and corpus infrastructure only; not native approval, accepted terminology, language completion, or translation certification. |
