...
| [Interlanguage methodology](https://doi.org/10.5281/zenodo.21124403) | 56 | 2 | 20 | 4745.57 MB | Current version [10.5281/zenodo.21730669](https://doi.org/10.5281/zenodo.21730669) retains the complete numbered archive and adds a commit-pinned Interslavic dictionary anchor for 353 held mathematical uses of `važiti` across 101 files. The checked row says “weigh, balance,” not abstract “hold/be valid”; no mass rewrite was made. Methodology, normalization, corpus, bounded working-translation, provenance, and QA evidence only; not native-language validation, translation/source-fidelity certification, rights clearance, proof checking, peer review, or a critical edition. |
