...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs in one ZIP, compact German/source and multilingual packages, plus active source-audit/support packets. Latest public version [10.5281/zenodo.21247333](https://doi.org/10.5281/zenodo.21247333) fronts the R805 German/source-control PDF, keeps the R787-R804 source-repair/audit rollups, retains the R804 integrated v11 German/source-control package, and adds the R805 Paper 19 p57 E-family correction packet. Evidence is grouped as Paper 30, Paper 24, Paper 34, Paper 40, Paper 14, and Paper 19 support, OCR-locator support, manifests/checksums, and targeted source-repair packets. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
