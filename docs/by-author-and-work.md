...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R553 is the current coherent zipped local source-control head: R552 repairs Paper 40 p531 `Voraussetzungen`/Hilfssatz material, R553 repairs Paper 40 p532 Definition/Hauptsatz/`Zerfallungskorper`/section-7 source math, and R554 is visible locally but not promoted because its wrapper/audit metadata are stale. R551/R550/R549/R548/R547/R546 are historical source-control steps beneath this chain. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
