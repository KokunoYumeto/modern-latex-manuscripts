...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21703611](https://doi.org/10.5281/zenodo.21703611) starts with one clean bundle containing all six cumulative English readers and their buildable TeX closures. The same six readers and master TeX files remain direct in SGA1-6 order; the complete 262-page SGA1 reference-v2 R2 reader is the default preview. Sixty-five unrelated predecessor files are retained byte-identically, while source, QA, predecessor, and visual-provenance material remains separately grouped. SGA3 is not final diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
