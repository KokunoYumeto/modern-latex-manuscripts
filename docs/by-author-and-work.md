...
| James Clerk Maxwell | `A Treatise on Electricity and Magnetism`, Volume I source-witnessed working tranches: IA 1873 first-edition pp.001-059, with published math/token registers through pp.001-058 and local pending staging closing p.059 register/index refresh plus pp.060-079 continuation, extending local cumulative staging to pp.001-079. A separate pending source/provenance supplement set adds IA 500ppi/raw JP2 leaves and metadata/PDF/OCR witnesses not already in the pp.001-059 handoff. Earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267 are also included. The record includes an IA master-image source-index helper; broader batch TeX/PDF substrate is status-mixed, and ledgers/source witness images govern promoted range claims. | [Maxwell](https://doi.org/10.5281/zenodo.20653107) |
