...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus active source-audit/support packets. Current local pending authority is R127_REBUILT for the German/source-audit branch, with P09-P12 best-available no-new-patch guardrails and P19/P20 survival evidence below strict 650+ full-page certification. Not a certified critical edition; synchronization and source-check corrections remain active. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
