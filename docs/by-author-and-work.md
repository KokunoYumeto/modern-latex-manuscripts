...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local candidate is R483: a focused Papers 10, 13, 14, and 15 German source-regression repair checkpoint on the R482/R481 lineage. R479-R482, R456/R457, and the earlier 86-artifact R372-R455 wave remain provenance/current-control support. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
