...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21707869](https://doi.org/10.5281/zenodo.21707869) starts with one clean bundle containing all six cumulative English readers and their buildable TeX closures. The same six readers and master TeX files remain direct in SGA1-6 order; the complete 262-page SGA1 reference-v2 R2 reader is the default preview. The clean 1,470-page SGA3 R29 cumulative and its 918-member buildable-source package replace the scattered SGA3 front. A direct partial SGA7 source-transcription reader covers complete Exposes I, II, VI, VII, and VIII. Sixty-seven predecessor files are retained byte-identically, while QA, predecessor, and visual-provenance material remains separately grouped. SGA3 is not final diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered; SGA7 is partial and is not an English translation. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
