...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R560 is the current coherent local source-control head: it repairs Paper 31 pp.89/98 source math on top of R559/R558/R557/R556/R555/R553/R552/R551/R550. R560 corrects the component identity to source-visible `\gamma_i=\gamma_i\varepsilon_i` and the determinant-square matrix bottom row to `a_1^{(n)} ... a_n^{(n)}`. R559/R558/R557/R556 are coherent predecessors, not unpromoted attempts; R555/R553/R552 remain coherent earlier predecessors, and R554 is folded into the later chain rather than separately fronted. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
