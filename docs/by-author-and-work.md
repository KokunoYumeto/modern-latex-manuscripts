...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p276. p276 checks the core proof of Expose VI Proposition 2.2.4 on the Leray spectral sequence; p275 records the source-fidelity Leray notation fix at line 8861. Treat p270-p276 as live provenance/workpass metadata only, not a promoted compact delta, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local TeX-changing candidate is R483: a focused Papers 10, 13, 14, and 15 German source-regression repair checkpoint on the R482/R481 lineage. R484 is no-patch Paper 29/Paper 30 survival/source-quality support only and keeps R483's cumulative hashes. R479-R482, R456/R457, and the earlier 86-artifact R372-R455 wave remain provenance/current-control support. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
