...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest local SGA5 live workpass status records pp.1-188 as page-local hand-certification evidence only: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (sections 1-4, pp.140-161) is marked complete in that ledger; Expose III B Part II section 5 is locally closed through p182; section 6 has started and pp.183-188 check the non-commutative six-functor/Kunneth/duality/local-trace/pairing setup; p187 fixes an operator/shriek garble, p188 checks the bridge identity `(6.6.4)`, and D001-D101 are covered. SGA5 is not complete, globally certified, English-synchronized, or a critical edition; compile-clean diagrams/formulas/notation still require source checks. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
