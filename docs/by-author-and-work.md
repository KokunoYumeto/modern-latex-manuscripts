...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local French SGA5 workpass through p480 and locally claim body-text completion for the selected 10-exposé branch. The ledger reports 52 TeX fixes, about 160 source-documented items, and D001-D193 diagram tracking. Treat p266-p480 as live provenance/workpass metadata only unless later compactly packaged and independently checked, not SGA5 completion, not English synchronization, not global source-faithfulness, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
