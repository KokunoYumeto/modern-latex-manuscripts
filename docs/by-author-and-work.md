...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p323. p321-p323 cover Lemme 7.2.1, Proposition 7.3, Corollaire 7.4, and Corollaire 7.5 on complete intersections; p324 is the next cursor. Treat p266-p323 as live provenance/workpass metadata only, not a promoted compact delta, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive repairs now public through Batch137/B138/B139; Volume III remains the earlier repaired cumulative. Latest public version is <https://doi.org/10.5281/zenodo.20837104>. Batch137 reports the active 112-row ledger at 112/112 closed; Batch138 fixes the Volume II Â§6 control-footnote corruption; B139 fixes the Volume II English Â§49 merged display-tag issue. | [Weber](https://doi.org/10.5281/zenodo.20412153) |
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local build-complete German handoff parent is R485: a one-macro build-completeness wrapper on the R483 source-regression line, compiling the R483 German cumulative content to 471 pages after R483's broken/truncated 305-page probe. R483 remains the focused Papers 10, 13, 14, and 15 German source-regression content checkpoint; R484/R486-R495/R497-R506 are no-patch survival/source-quality/confusion-point/current-survival closure support only. R496 is the earlier five-fix post-P43 tail/Schur candidate, R504 promotes two source-backed Paper 14 p183/p193 fixes, and R507 is now the current local source-control candidate after one source-confirmed tail display-punctuation fix. The second-web intake is a 40-file / 35-ZIP source/state handoff folder, not a reader release. R491/R492 confirm current Paper 17/18 survival; R493/R494 confirm full Paper 19/20 survival; R495/R497/R498 confirm Papers 21/22/23 survival; R499/R500/R501 extend no-patch survival through Papers 24-39, with Paper 30 carrying only prior R479/WebR283 source-backed citation-spacing repairs; R502/R503 close Papers 40-43 and the post-P43 tail for current-survival purposes, while R505/R506 close Papers 01-20 on the R504 base. R479-R482, R456/R457, and the earlier 86-artifact R372-R455 wave remain provenance/current-control support. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
