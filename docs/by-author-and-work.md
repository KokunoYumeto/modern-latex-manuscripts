...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21637870](https://doi.org/10.5281/zenodo.21637870) has 67 files and directly exposes six English readers in SGA1-6 order plus primary TeX where available: complete-volume working SGA1, complete SGA2 R8, the 1,182-page SGA3 current-progress cumulative with complete working bodies I-XVIII and XX plus partial XXI and XXII, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete reference-linked SGA6. Two French workpasses remain direct and forty-eight ZIPs group source, diagrams, QA, predecessor evidence, and SGA6 high-detail audit crops/provenance metadata. SGA1 is the default preview and remains non-exhaustively certified. SGA3 remains incomplete because XIX and XXIII-XXVI are gaps and two included exposés are partial; Exposé XVII still awaits its whole-exposé high-zoom diagram pass and Exposé V figures 007-011 retain disclosed label-placement defects, so final diagram fidelity remains open. SGA4half is rights-held. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
