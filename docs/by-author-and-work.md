...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p275. p275 checks Expose VI section 2.2 through Definition 2.2.3 and the opening of Proposition 2.2.4, and records a source-fidelity Leray spectral-sequence notation fix at line 8861; the workpass PDF rebuild is 307 pages. Treat p270-p275 as live provenance/workpass metadata only, not a promoted compact delta, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local bridge is R456, adopting Web R281 as the shared German continuation base after Web R281 integrated the R448-R455 chain: P14 printed pp.192-201, P15 printed p.140, and the P39 pp.189-194 no-patch guard. The earlier 86-artifact R372-R455 wave remains provenance/current-control support. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
