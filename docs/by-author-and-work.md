...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact German/source and multilingual packages, and active source-audit support. Latest version [10.5281/zenodo.21406056](https://doi.org/10.5281/zenodo.21406056) fronts the 466-page v26/R822 German source-control reader and groups the current source package. R822 makes four bounded direct-source Paper 20 refinements beyond R821. The English and multilingual readers are useful but not synchronized to every German repair. Not corpus closure, paper-by-paper certification, or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
