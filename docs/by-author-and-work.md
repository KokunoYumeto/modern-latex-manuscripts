...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p363 in `AGENT_SCORECARD.md`. Exposé VIII has started; p352 records fix #33, p355 records fix #34 in the `K(F)` formula, and diagrams are tracked through D176. Treat p266-p363 as live provenance/workpass metadata only, and p364 as scratch/patch-candidate material only, not a promoted compact delta, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R531 is the current clean packaged local TeX-changing German source-control candidate: R530 promotes source-backed Paper 24 Hilfssatz V p245-p246 repairs on top of R529, and R531 restores the source-backed R497 post-P43 Deuring tail/Kapferer repairs on top of R530. R528/R529 remain no-patch support/audit/survival layers rather than TeX heads, and older R523-R527/R530 packets are superseded source-control checkpoints. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting `39_R531_TAIL_KAPFERER_SURVIVALFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
