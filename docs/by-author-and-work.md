...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p391 in `CERT_LOG.md`. Exposé VIII is closed at p371; Exposé X is checked through the proof continuation of Proposition 5.1, with p389 opening §5 `La formule de Weil`, p390 verifying Proposition 5.1/the Weil formula (5.2), and p391 checking the reduction-of-traces/Künneth continuation. Treat p266-p391 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R549 is the current coherent packaged local TeX-changing German source-control candidate: it carries the R530/R531 repairs, R532/R533 support, R534-R545 source-control history, R546 Kapferer/Noether Math. Ann. 97 p562 formula (3) RHS repair, R547 Paper 40 p526 source-style repair, R548 Paper 40 p527 Rangrelation/§5 source-style repair, and adds the focused Paper 40 pp.528-529 Automorphismen/Vertauschung/Galois source-style repair. The second-web intake is a 43-file / 36-ZIP source/state handoff folder fronting `41_R549_P40P528_529_AUTOMORPHISM_VERTAUSCHUNG_GALOIS_SOURCEFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
