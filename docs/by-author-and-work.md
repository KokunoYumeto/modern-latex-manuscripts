...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest public update 2026-06-24 adds `SGA5_repair032_audit_support_20260624.zip` as repair/audit evidence only. SGA5 is not complete or certified: the later live workpass reports 411 verified corrections and a compiling 307-page French workpass, with p375-p484 carefully audited and the front-grind cursor at printed p100; p1-p74, p100-p374, heavy-QA/front-middle pages, uncertain/type-B items, and English synchronization remain open. Diagrams/formulas/notation should be checked against source scans. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive gap repairs public through Batch132. Local pending Batch137 reports the active 112-row ledger at 112/112 closed after Volume I bulk scan-reviewed no-change closures; Batch138 adds a focused post-closure Volume II section 6 control-character footnote fix; B139 adds a focused Volume II English section 49 merged-tag repair; Volume III remains the earlier repaired cumulative. | [Weber](https://doi.org/10.5281/zenodo.20412153) |
