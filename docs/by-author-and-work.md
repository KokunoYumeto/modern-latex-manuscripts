...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21647537](https://doi.org/10.5281/zenodo.21647537) has 92 files and directly exposes six English readers in SGA1-6 order, primary TeX where available, two French workpasses, and eight bounded native-diagram SGA3 readers. The preferred public SGA3 cumulative is 1,434 pages and integrates the Editorial Notice, Introduction, Exposés I-XXIII and XXV-XXVI, terminal bibliography, and Tome III index; the Tome III guide and Exposé XXIV are explicit gaps. Exposé XIII is separately direct with native diagrams and reference-v2 evidence. Fifty-seven ZIPs / 5,563 members group sources, diagrams, QA, predecessor evidence, and SGA6 high-detail audit crops/provenance metadata. A 1,492-page Loop-1 integration remains held rather than published. SGA1 is the default preview and remains non-exhaustively certified; SGA4half is rights-held. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
