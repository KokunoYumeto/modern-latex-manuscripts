...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R534 is the current clean packaged local TeX-changing German source-control candidate: it carries R530/R531 repairs and adds a Paper 40 p515 comma source fix. R532/R533 and R528/R529 remain no-patch support/audit/survival layers rather than TeX heads. The second-web intake is a 41-file / 36-ZIP source/state handoff folder fronting `40_R534_P40P515_COMMA_SOURCEFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
