...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p428 in `CERT_LOG.md` / `AGENT_SCORECARD.md`. Exposé VIII is closed at p371; Exposé X is locally recorded through references at p406; Exposé XII live-ledger evidence reaches p428; p427-p428 are clean/no-TeX-fix ledger entries and p428 opens §6 / §6.1. Treat p266-p428 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R574 is the current packaged local TeX-changing source-control head: it applies one source-backed Paper 30 printed p32 prose repair, changing `auch` to source `stets` after checking pp26-32 against best-local ~400ppi IA raw-JP2 witnesses. R573 remains the predecessor P40 pp514-529 source-style merge; R572 remains the no-patch tail-closure packet classifying pp779-782 as publisher ads/blanks; R571/R570/R569 are older support layers. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
