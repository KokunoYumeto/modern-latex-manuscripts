...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact source/audit packages, and multilingual branches. Latest version [10.5281/zenodo.21420665](https://doi.org/10.5281/zenodo.21420665) retains the 466-page v26/R823 German source-control reader and adds a 473-page Spanish R823 working translation, twelve bounded synchronized English components, and bounded CJK/Korean and Slavic units. The Spanish branch passed its declared 81-unit source-reconciliation gate; full English/Chinese/Japanese synchronization remains open, and Korean/Slavic coverage is bounded. Not corpus closure, native-language certification, paper-by-paper certification, or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
