...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact source/audit packages, and multilingual branches. Latest version [10.5281/zenodo.21431458](https://doi.org/10.5281/zenodo.21431458) fronts the English cumulative reader and directly exposes 473-page Spanish, 494-page French, and 527/551-page Interslavic readers. It adds bounded English Paper 3, Korean Paper 27, four CJK Paper 28 readers, and two Chinese Paper 29 readers with editable evidence. File `17` preserves 3,024 unique render/review images; file `11` retains all 442 current Interslavic units and the final audit. The bounded translated surfaces passed declared technical gates but lack native/community certification. Not whole-corpus certification, universal mathematical source certification, or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
