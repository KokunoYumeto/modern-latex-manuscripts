...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21499857](https://doi.org/10.5281/zenodo.21499857) has 21 files and directly exposes English SGA1, SGA2, SGA5, and SGA6 readers and editable TeX, followed by French SGA5/6 pairs; checkpoints and evidence are grouped into ZIPs. SGA2 is a complete 184-page source-aligned working reader and is the default preview. SGA1 is a credited convenience reader without the exhaustive reference retrofit. GitHub now carries final exhaustive-reference SGA5 R9 and reference-linked SGA6 readers, but those exact replacements still await the staged same-concept Zenodo successor. SGA3 is incomplete custody, SGA4 proper is fail-closed, and SGA4.5 is rights-held custody only. These are working editions, not critical editions, uniform source certification, peer review, or blanket rights determinations. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
