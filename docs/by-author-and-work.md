...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact source/audit packages, and multilingual branches. Latest version [10.5281/zenodo.21419257](https://doi.org/10.5281/zenodo.21419257) fronts the 466-page v26/R823 German source-control reader and adds bounded R823-synchronized English, CJK/Korean, and Slavic components. Full English/Chinese/Japanese synchronization remains open; Korean and the Slavic lecture-book branch are bounded. Not corpus closure, language certification, paper-by-paper certification, or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
