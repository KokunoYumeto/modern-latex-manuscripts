...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R551 is the current local TeX-changing German source-control head: a focused Paper 40 p530 Galois/Hilfssatz source-style repair on top of R550. R550 remains the newest zipped package with complete summary metadata and nine source-backed WebB R546 fixes; R549/R548/R547/R546 are historical source-control steps beneath this chain. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
