...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21704696](https://doi.org/10.5281/zenodo.21704696) starts with one clean bundle containing all six cumulative English readers and their buildable TeX closures. The same six readers and master TeX files remain direct in SGA1-6 order; the complete 262-page SGA1 reference-v2 R2 reader is the default preview. The clean 1,470-page SGA3 R29 cumulative and its 918-member buildable-source package replace the scattered SGA3 front. Sixty-two predecessor files are retained byte-identically, while QA, predecessor, and visual-provenance material remains separately grouped. SGA3 is not final diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
| Grothendieck and Dieudonne, EGA | Current version [10.5281/zenodo.21706639](https://doi.org/10.5281/zenodo.21706639) starts with one clean bundle containing one cumulative English reader and buildable TeX closure for every current scope: EGA0, complete reference-v2 EGA II, EGA III Sections 1-7, and EGA IV Sections 1-10. The same readers and masters remain direct beside the French originals. EGA II is complete for its stated working scope; the wider EGA corpus remains partial and non-uniform. | [EGA](https://doi.org/10.5281/zenodo.20414353) |
