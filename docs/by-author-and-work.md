...
| Serious source-aware work, but caveat-heavy | Bianchi, Gordan, Steinitz, Gibbs, Maxwell, SGA, EGA, Deligne, Ukrainian applied mathematics, non-European/Chinese/Indian/Islamic records | Real reader or translation work exists, but source closure, continuity, diagram/table fidelity, or work-level completion varies. SGA7 I has complete working French and English readers; SGA7 II has a partial English reader through complete Exposé XVIII and a further-reaching French working transcription. EGA has complete working reader surfaces for EGA 0-IV. |
...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21747165](https://doi.org/10.5281/zenodo.21747165) starts with one clean bundle containing the current complete SGA1-7 I English readers and buildable TeX closures. The same readers remain direct and SGA1 is the default preview. A separate 194-page SGA7 II English current-progress reader covers complete Exposés X-XVIII through Corollary 6.7 and the bibliography, with a 137-member source ZIP; Exposé XIX and later English scope are absent. French working transcriptions remain separate. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
