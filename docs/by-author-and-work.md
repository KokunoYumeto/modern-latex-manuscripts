...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R547 is the current coherent packaged local TeX-changing German source-control candidate: it carries the R530/R531 repairs, R532/R533 support, R534-R545 source-control history, R546 Kapferer/Noether Math. Ann. 97 p562 formula (3) RHS repair, and adds the focused Paper 40 p526 Darstellungsklassen/Rangrelation source-style repair. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting `40_R547_P40P526_DARSTELLUNGSKLASSEN_RANGRELATION_SOURCEFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
