...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21698501](https://doi.org/10.5281/zenodo.21698501) has 66 files and directly exposes six neutral-named English readers in SGA1-6 order, primary TeX, and two French readers. SGA1, SGA2, and SGA3 use the clean R2, R10, and R27 reading surfaces; SGA4 proper is the 864-page R8 reader-clean successor; SGA6 is the 376-page R10 reader-pure successor. Bounded reader history no longer appears loose; 50 exact ZIPs preserve source, QA, predecessor, and visual-provenance material. Direct PDFs exclude project-production/workflow/status and project-written source-reading commentary while retaining source-era editorial apparatus. SGA1 is the default preview and remains non-exhaustively certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
