...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R537 is the current clean packaged local TeX-changing German source-control candidate: it carries R530/R531 repairs, R532/R533 support, R534/R535 Paper 40 p515 punctuation repairs, R536 p516 footnote-anchor repairs, and the R537 p517 theta/operator source rebuild. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting `40_R537_P40P517_THETAOPERATOR_SOURCEFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
