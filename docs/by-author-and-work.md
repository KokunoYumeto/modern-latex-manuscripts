...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local French SGA5 workpass through p480 and locally claim body-text completion for the selected 10-exposé branch. The current ledger reports about 60 numbered TeX-fix events (TALLY 59 / max fix #60), ERRATA 115, D001-D193 diagram tracking, and a 306pp/0err compile gate. Recert spot-checks still found real defects, including p455 interpolation/removal and p274-p275 notation fixes. Treat p266-p480 as live provenance/workpass metadata only unless later compactly packaged and independently checked, not SGA5 completion, not English synchronization, not global source-faithfulness, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs in one ZIP, compact German/source and multilingual packages, plus active source-audit/support packets. Latest public version [10.5281/zenodo.21246784](https://doi.org/10.5281/zenodo.21246784) keeps the R787-R804 source-repair/audit rollups and adds the R804 integrated v11 German/source-control head. Evidence is grouped as Paper 30, Paper 24, Paper 34, Paper 40, Paper 14, and Paper 19 support, OCR-locator support, and CSV manifests/checksums. R790 and R799 standalone ZIPs were absent locally despite checksum sidecars; later cumulative material carries the R799 p684 correction into v11. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive repairs now public through Batch137/B138/B139; Volume III remains the earlier repaired cumulative. Latest public version is <https://doi.org/10.5281/zenodo.20837104>. The completed 2026-07-02 20-page Volume I sample-cert audit failed as certification: §26/p90 and §164/p544 require full re-transcription, p400 and p580 content drops were fixed locally, 12 sample pages were clean, and §141-188 should be reverified page-by-page. Volume I is not whole-volume certified. | [Weber](https://doi.org/10.5281/zenodo.20412153) |
