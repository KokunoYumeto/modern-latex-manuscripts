...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R561 is the current coherent local source-control head: it repairs Paper 32 p226 source-symbol drift on top of R560/R559/R558/R557/R556/R555/R553/R552/R551/R550, changing Brauer/Noether footnote/prose parameter loci from `\ell` to source-visible `\varrho` in `b^2p^2\varrho^2`, `bp\varrho`, and the `a,b,p,\varrho` parameter lists. R560 remains the coherent Paper 31 pp.89/98 predecessor with the `\gamma_i=\gamma_i\varepsilon_i` and determinant-row repairs. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
