...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p397 in `CERT_LOG.md`. Exposé VIII is closed at p371; Exposé X is checked through the Euler-Poincaré formula (7.2) and proof steps a/b. The p392-p397 refresh verifies triangle diagram D179, completes the proof of Proposition 5.1 / the Weil formula, opens and completes the local-term definition layer in §6, fixes the systematic `A` vs `\Lambda` transcription error in the `Hom`/`Sw` terms on p394-p395, and fixes a dropped prime `C` to `C'` on p397. Treat p266-p397 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R558 is the current coherent zipped local source-control head: it repairs Paper 40 p539 §9 definitions/reduction-to-simple-systems source math on top of R557/R556/R555/R553/R552/R551/R550. R557/R556 are coherent predecessors, not unpromoted attempts; R555/R553/R552 remain coherent earlier predecessors, and R554 is folded into the later chain rather than separately fronted. R559 is not promoted without ZIP/hash/ledgers/logbook closure. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
