...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest public update 2026-06-24 adds `SGA5_repair032_audit_support_20260624.zip` as repair/audit evidence only. SGA5 is not complete or certified: the later live workpass reports 411 verified corrections and a 307-page PDF with no fatal/LaTeX-error diagnostics in the latest observed log scan, but the newer manual certification log treats agents/workflows as finders and records pp.1-16 as certified so far (pp.1-12 and pp.14-16 clean; p13 fixed with two source-fidelity corrections; p15 has a documented Type-B source typo handled in TeX; p16 records the diagram-index page-drift risk). Final diff/FINDINGS refresh, compact packaging, continued page-by-page hand certification or independent validation, optional low-value prose-fidelity review where desired, and English synchronization remain open. Diagrams/formulas/notation should be checked against source scans. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
