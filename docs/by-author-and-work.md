...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest local SGA5 control package is `SGA5_FullAudit_WebDrop_p001_p254_certified_staged_p255_p484_20260626.zip`, which preserves the active French workpass PDF/TeX/log plus CERT_LOG, AGENT_SCORECARD, method/status notes, source-witness crops/images, inventory, and checksums. The package wrapper is the public boundary: p254 is the current promoted cursor, p255 is next, and substantial source reconciliation remains. Recent rows p250-p254 close Expose V and open Expose VI: p250 finishes Theorem A.3/QED and Expose V, p251 opens Expose VI, p252 records the V-to-VI bridge plus Props. 1.1.2/1.1.3 opening, p253 closes Prop. 1.1.3 proof and opens section 1.1.4, and p254 closes section 1.1.4 / opens section 1.2 with Definition 1.2.1 and Z_l(1); diagrams remain tallied D001-D142; p253-p254 have no diagram; D140 keeps the earlier recorded layout simplification. p255-p484 source crops/images are included as continuation witnesses only and are not promoted as certified pages. Embedded p255 log text is not promoted until a later wrapper or deliberate review resolves that boundary. Local ledger terms such as certified/complete are interpreted as page-local workpass status only. This is opening-range workpass evidence for a curated SGA5 expose selection, not complete SGA5, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, Simplified Chinese, and Slavic work-so-far packages, plus active source-audit/support packets. Current local pending authority is R127_REBUILT plus R128 convergence/routing for the German/source-audit branch, with targeted P01 repair, P02-P20 survival/no-new-patch guardrails, P09-P20 queue/status index plus R128 P09-P13 no-patch survival control, P21/P23 survival bridge with P22 source-restoration context, P22/P30/P37/P42 repair candidates including the later R128 P37 regression fix on the R128/P42 active base, P24-P34 queue/survival reconciliation, Tail/Kapferer no-new-patch reconciliation, P35/P36/P38/P41/P43 stale-patch guardrails, R128's 16 queue records plus 28,020 source-inventory rows, and R128 Local Codex anti-regression/source-router packages for P42, P19/P20, and P14-P18 below strict full-page certification unless explicitly stated otherwise. Not a certified critical edition; synchronization and source-check corrections remain active. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
