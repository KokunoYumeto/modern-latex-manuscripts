...
| Serious source-aware work, but caveat-heavy | Bianchi, Gordan, Steinitz, Gibbs, Maxwell, SGA, EGA, Deligne, Ukrainian applied mathematics, non-European/Chinese/Indian/Islamic records | Real reader or translation work exists, but source closure, continuity, diagram/table fidelity, or work-level completion varies. SGA7 I has complete working French and English readers; SGA7 II has a partial English reader through Exposé XX §4.3 and a further-reaching French working transcription. EGA has complete working reader surfaces for EGA 0-IV. |
...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21750586](https://doi.org/10.5281/zenodo.21750586) starts with one clean bundle containing the current complete SGA1-7 I English readers and buildable TeX closures. The same readers remain direct and SGA1 is the default preview pending an exact global SGA reader. A separate 212-page SGA7 II English current-progress reader covers complete Exposés X-XIX and Exposé XX through §4.3, with a 148-member source ZIP and two compact high-resolution source-image ZIPs; §4.4 is next and Exposés XXI-XXII are absent. French working transcriptions remain separate. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
