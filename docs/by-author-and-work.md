...
|---|---|---|
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive gap repairs public through Batch132. Local pending Batch137 reports the active 112-row ledger at 112/112 closed after Volume I bulk scan-reviewed no-change closures; Batch138 adds a focused post-closure Volume II section 6 control-character footnote fix; Volume III remains the earlier repaired cumulative. | [Weber](https://doi.org/10.5281/zenodo.20412153) |
