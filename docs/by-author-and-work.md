...
| James Clerk Maxwell | `A Treatise on Electricity and Magnetism`, Volume I source-checked working tranches: IA 1873 first-edition pp.001-040, plus earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267. Broader batch TeX/PDF substrate is status-mixed; ledgers and source witness images govern source-checked claims. | [Maxwell](https://zenodo.org/records/20658800) |
