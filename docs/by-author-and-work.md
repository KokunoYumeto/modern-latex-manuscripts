...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p364 in `AGENT_SCORECARD.md`. Expose VIII has started; p352 records fix #33, p355 records fix #34, p364 records fix #35, and diagrams are tracked through D176. Treat p266-p364 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
