...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p426 in `CERT_LOG.md` / `AGENT_SCORECARD.md`. Exposé VIII is closed at p371; Exposé X is locally recorded through its references at p406, including diagrams D178-D184, the Euler-Poincaré formula, local terms, and A/Λ transcription fixes. Later Exposé XII live-ledger evidence now reaches p426; the p421/p422 label issue is resolved as a source typo/no TeX fix, and fix #50 removes a non-source `c.q.f.d.` marker at p422. Treat p266-p426 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. The next local task is continuing from p427. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R573 is the current packaged local TeX-changing source-control head: it promotes WebB R559 source-backed Paper 40 pp.514-529 style/footnote/reference fixes onto R572. R572 remains the no-patch tail-closure packet classifying pp779-782 as publisher ads/blanks, not missing Noether content. R571/R570/R569 are predecessor support layers. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive repairs now public through Batch137/B138/B139; Volume III remains the earlier repaired cumulative. Latest public version is <https://doi.org/10.5281/zenodo.20837104>. Batch137 reports the active 112-row ledger at 112/112 closed; Batch138 fixes the Volume II §6 control-footnote corruption; B139 fixes the Volume II English §49 merged display-tag issue. A 2026-07-02 Volume I sample-cert audit is 12/20 pages complete and found one major p90/§26 reformulation plus two minor punctuation deviations, so Volume I is not whole-volume certified. | [Weber](https://doi.org/10.5281/zenodo.20412153) |
