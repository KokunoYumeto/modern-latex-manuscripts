...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R572 is the current packaged no-patch tail-closure packet above R571: it classifies collected pp779-782 as publisher ads/blanks, not missing Noether content. R571 remains the current packaged local TeX-changing source-control head, applying the p776 `Bd. III.2` -> `Bd.III.2` Kronecker-review source repair. R569 remains the prior p761/p764 repair head, and R570 remains the no-patch checkpoint over pp767-772. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
