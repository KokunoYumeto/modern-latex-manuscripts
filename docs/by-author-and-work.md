...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest local SGA5 control package is `SGA5_FullAudit_WebDrop_p001_p253_certified_staged_p254_p484_20260626.zip`, which preserves the active French workpass PDF/TeX/log plus CERT_LOG, AGENT_SCORECARD, method/status notes, source-witness crops/images, inventory, and checksums. CERT_LOG/AGENT_SCORECARD are the controlling status files: completed rows reach p253, p254 is next, and substantial source reconciliation remains. Recent rows p250-p253 close Expose V and open Expose VI: p250 finishes Theorem A.3/QED and Expose V, p251 opens Expose VI, p252 records the V-to-VI bridge plus Props. 1.1.2/1.1.3 opening, and p253 closes Prop. 1.1.3 proof and opens section 1.1.4; diagrams remain tallied D001-D142; p253 has no diagram; D140 keeps the earlier recorded layout simplification. p254-p484 source crops/images are included as continuation witnesses only and are not promoted as certified pages. Local ledger terms such as certified/complete are interpreted as page-local workpass status only. This is opening-range workpass evidence for a curated SGA5 expose selection, not complete SGA5, not synchronized English, not a critical edition, and not global source-faithfulness. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
