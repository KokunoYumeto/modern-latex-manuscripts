...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R522 is the current clean packaged local TeX-changing source-control candidate after five Paper 24 printed pp239-240 source repairs on top of R521; R521 remains the previous p257 `\mathcal R'` repair and pp251-261 visual-audit checkpoint. R508-R515 and R517 are support/no-patch/source-quality/visual-audit packets, not new TeX heads. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting R522, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
