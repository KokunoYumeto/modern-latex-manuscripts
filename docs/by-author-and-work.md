...
| Grothendieck and Dieudonne, EGA | Current version [10.5281/zenodo.21702700](https://doi.org/10.5281/zenodo.21702700) starts with one clean bundle containing one cumulative English reader and buildable TeX closure for every current scope: EGA0, complete EGA II, EGA III Sections 1-7, and EGA IV Sections 1-10. The same readers and masters remain direct beside the French originals. EGA II is complete for its stated working scope; the wider EGA corpus remains partial and non-uniform. | [EGA](https://doi.org/10.5281/zenodo.20414353) |
