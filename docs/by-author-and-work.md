...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R544 is the current coherent packaged local TeX-changing German source-control candidate: it carries R530/R531 repairs, R532/R533 support, R534-R537 Paper 40 pp.515-517 repairs, R538-R540 Paper 40 pp.518-520 source repairs, R542 p522 repairs, R543 p523 repairs, and the packaged p524 Erweiterungsmodul/invariant-module repair. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting `40_R544_P40P524_ERWEITERUNGSMODUL_SOURCEFIX.zip`, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
