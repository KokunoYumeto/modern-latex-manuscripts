...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local queue is post-WebR273/R273-plus-LocalCodex current-control material; latest local chain reaches R306, with R306 adding a Paper 15 p148 source exponent repair on top of R305, R305 adding a Paper 15-only source-style `\varrho` repair on top of R304, R304 adding Paper 15 p142 source punctuation/footnote-marker repairs on top of R303, R303 adding a Paper 15 p140 inline-congruence/source-footnote repair on top of R302, R302 adding two Paper 24 p233 source-style `=0(...)` repairs on top of R301, R291 as the preferred Paper 24 span-restore rollup, R293 correcting the R292 line, R294-R301 source-regression fixes for P15/P14/P10/P08/P21/P27/P31, and R301 no-patch/survival packets for P14/P16-P20/P10-P11/P08/P22/P42, alongside earlier P06 p195, P15 p140/p142/p148/varrho, P24 p233 formula (2), P24 p233 equals-zero, and p234 formula (4) source-style patches from best-available native400/GDZ400-derived evidence, P43 p21, P11 pp.223-224, P05/P07/P08/P12/P13/P20 guards, the Paper 22 GDZVol88 source-witness plus pp.53-79 source-note/formula patch, a Paper 21 p.71 varrho source-symbol patch with invalid-witness warning, the Paper 32 Brauer no-patch closure, post-P43 tail p735 `Wisssch.` source-typo no-patch closure, p754 matrix-ring `\mathfrak Z` source patch, p755-p758 source-audit no-patch closure, p759 unbarred-`u_S`/extra-display source patch, p760-p762 source audit with p762 quotient-`\mathscr H` source patch, p763-p766 Kapferer-transition source audit with p763 `\simeq` and p764 subtitle patches, p770-p774 source audit with a p772 `y^{(K)}` exponent patch, and p775-p778 final-bibliography source audit with p777 `Ore`/`Braunschweig` patches. A later R307 loose folder exists locally but is not promoted until build/package/logbook closure. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization and source-check corrections remain active. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
