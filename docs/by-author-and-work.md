...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest public update 2026-06-24 adds `SGA5_repair032_audit_support_20260624.zip` as repair/audit evidence only. SGA5 is not complete or certified: the later live workpass reports 411 verified corrections and a 307-page PDF with no fatal/LaTeX-error diagnostics in the latest observed log scan, but the newer manual certification log treats agents/workflows as finders and records pp.1-90 as page-locally certified; pp.1-72 close Expose I (Verdier main text §§1-5, Bibliographie, and Illusie Appendix §§1-7; logged fixes include source-fidelity, twist-sign, underline, source-typo, shriek-functor, xref, and notation repairs; D001-D013 are hand-verified perfect; Type-B/source-or-editorial conventions, diagram-index page drift, and the open cross-document R^!f / R f^! notation-normalization item remain documented risks). Pages 73-90 cover Expose III through the end of section 2 and into section 3.2 (Corollary 2.6.1, the type-(3,4) case, Lemme 2.6.3, Proposition 2.5, the fundamental correspondence isomorphism, support correspondences, and the first trace example), with D014-D027 hand-verified perfect through the Expose III section 3.1 projection diagram; p91 is next. Final diff/FINDINGS refresh, compact packaging, continued page-by-page hand certification or independent validation, optional low-value prose-fidelity review where desired, and English synchronization remain open. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current pp.1-90 certification is opening-range evidence, not global SGA5 certification. Diagrams/formulas/notation should be checked against source scans. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus active Paper 02 RA25-RA34, Paper 04 RA37/RA40, RA69-RA75 source-apparatus/source-text correction packets, and Paper 33 IA source-witness provenance support. Not a certified critical edition; synchronization and source-check corrections remain active. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
...
| Henri Poincare | `Oeuvres`, Tome I French/English working packages through public `poincare_v1_26.zip`; explicitly non-continuous. Local Edge sweep recovered not-yet-public v1_03, v1_04, v1_05, and v1_07 packages; v1_06 and v1_22-v1_23 remain absent by this sweep. | [Poincare](https://doi.org/10.5281/zenodo.20673461) |
| Ernst Steinitz | Package-audited German/English working packets: 1910 fields sections 1-24, 1913 Bedingt I complete, strict 1894/1897/1906 early works, 1914 Bedingt II complete, and 1916 Bedingt III started through pp.1-13. | [Steinitz](https://doi.org/10.5281/zenodo.20616988) |
