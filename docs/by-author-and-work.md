...
| Grothendieck and Dieudonne, EGA | Current version [10.5281/zenodo.21712025](https://doi.org/10.5281/zenodo.21712025) retains the 125-member bundle containing all five current cumulative English readers and their buildable TeX closures. The same readers and masters remain direct beside the retained French originals. EGA 0 through Section 13, EGA I through authority EOF, EGA II through authority EOF, and the complete published EGA III text through 7.9.14 are reference-v2 working readers; EGA IV remains partial through Sections 1-10. Two source-witness ZIPs contain 343 actual high-detail EGA IV images from printed pages 5-86. | [EGA](https://doi.org/10.5281/zenodo.20414353) |
