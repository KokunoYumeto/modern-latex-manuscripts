...
| James Clerk Maxwell | `A Treatise on Electricity and Magnetism`, Volume I source-checked working tranches: book pages 95-101, 103, 105, 109, and continuous pp.111-267. The batch TeX/PDF substrate is status-mixed; the ledger and delta packets govern source-checked claims. | [Maxwell](https://zenodo.org/records/20653108) |
