...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact source/audit packages, and multilingual branches. Latest version [10.5281/zenodo.21418246](https://doi.org/10.5281/zenodo.21418246) retains the 466-page v26/R822 German source-control reader as default preview and adds a 64-unit Paper 06 Slavic working tranche across Interslavic Latin/Cyrillic, Russian, and Ukrainian. The translation tranche still needs source-delta reconciliation and linguistic review. Not corpus closure, language certification, paper-by-paper certification, or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
