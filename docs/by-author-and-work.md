...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5 and SGA 6 modern LaTeX working editions, French source/workpass readers, English working translations, source scans, repair ledgers, and audit packages. Current version 10.5281/zenodo.21420146 fronts the 309-page SGA5 English source-checked working translation through the printed-p484 index; the grouped package carries editable TeX, the full scan, controls, ledgers, and render QA. It closes 432 scan-derived candidate loci but is not a critical edition or global independent certification. The retained French SGA6 workpass reaches idx662 / volume p649 / Exposé XIII p34, while its live English branch is still being synchronized; SGA7-I remains partial and caveat-heavy. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus with cumulative German/English readers, 43 standalone English papers in one ZIP, compact source/audit packages, and multilingual branches. Latest version [10.5281/zenodo.21421049](https://doi.org/10.5281/zenodo.21421049) retains the 466-page v26/R823 German source-control reader; adds the 473-page Spanish R823 reader; and publishes complete current Interslavic bodies as 529-page Latin and 552-page Cyrillic readers with 221 canonical TeX units per script. The Spanish branch passed its declared 81-unit source-reconciliation gate. Interslavic passed the current complete-corpus build and bounded normalization gates, but lacks native/community certification. Full English/Chinese/Japanese synchronization remains open. Not universal mathematical source certification or a critical edition. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
