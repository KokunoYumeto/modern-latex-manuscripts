...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21511144](https://doi.org/10.5281/zenodo.21511144) has 39 files and directly exposes eight English readers in SGA order plus primary TeX: complete-volume working SGA1, complete SGA2 R8, bounded SGA3 through III plus standalone IV and native-diagram V, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Two French workpasses remain direct and fourteen ZIPs group source, diagrams, QA, and predecessor evidence. Expose V has 66 native diagram sources; 66 source-PDF witness crops are withheld with public provenance metadata. SGA2 is the default preview. SGA1 remains non-exhaustively certified; SGA3 remains incomplete after V; SGA4half is rights-held. These are working editions, not critical editions, uniform source certification, peer review, or blanket rights determinations. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
