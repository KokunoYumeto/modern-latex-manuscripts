...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest public update 2026-06-24 adds `SGA5_repair032_audit_support_20260624.zip` as repair/audit evidence only. SGA5 is not complete or certified: the later live workpass reports 411 verified corrections and a 307-page PDF with no fatal/LaTeX-error diagnostics in the latest observed log scan, but the newer manual certification log treats agents/workflows as finders and records pp.1-83 as page-locally certified; pp.1-72 close Expose I (Verdier main text §§1-5, Bibliographie, and Illusie Appendix §§1-7; logged fixes include source-fidelity, twist-sign, underline, source-typo, shriek-functor, xref, and notation repairs; D001-D013 are hand-verified perfect; Type-B/source-or-editorial conventions, diagram-index page drift, and the open cross-document R^!f / R f^! notation-normalization item remain documented risks). Pages 73-83 open Expose III through section 2.2 and the start of Proposition 2.3, with D014-D016 hand-verified perfect; p84 is next. Final diff/FINDINGS refresh, compact packaging, continued page-by-page hand certification or independent validation, optional low-value prose-fidelity review where desired, and English synchronization remain open. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current pp.1-83 certification is opening-range evidence, not global SGA5 certification. Diagrams/formulas/notation should be checked against source scans. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
