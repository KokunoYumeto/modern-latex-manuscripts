...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5 and SGA 6 modern LaTeX working editions, French source/workpass readers, English and Spanish working translations, source scans, repair ledgers, and audit packages. Corrective version 10.5281/zenodo.21422245 fronts the 309-page SGA5 English working translation and directly exposes the corrected 381-page SGA6 full-range layered English reader; it restores Lemma 5.8.2 footnote 14 omitted from historical version 21421931. The reader covers the full extant scan but declares three authority layers: inherited/partially synchronized prefix, French-synchronized idx532-662, and scan-checked draft tail. Its TeX, ledgers, all-page QA, prefix-repair and correction evidence, and validation are grouped in file `06`. The bounded Spanish Exposé X idx532-537 tranche remains public; SGA7-I remains partial and caveat-heavy. None is a critical edition or uniform source certification. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
