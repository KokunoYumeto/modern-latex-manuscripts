...
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source and multilingual work-so-far packages, plus active source-audit/support packets. Current local build-complete German handoff is R485: a one-macro build-completeness wrapper on the R483 source-regression line, compiling the R483 German cumulative content to 471 pages after R483's broken/truncated 305-page probe. R483 remains the focused Papers 10, 13, 14, and 15 German source-regression content checkpoint; R484/R486-R494 are no-patch survival/source-quality/confusion-point/current-survival closure support only. The second-web intake is a 29-ZIP source/state handoff folder, not a reader release. R491/R492 confirm current Paper 17/18 survival; R493/R494 confirm full Paper 19/20 survival against the latest repaired/audited spans. R479-R482, R456/R457, and the earlier 86-artifact R372-R455 wave remain provenance/current-control support. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
