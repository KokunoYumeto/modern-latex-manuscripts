...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21694014](https://doi.org/10.5281/zenodo.21694014) has 66 files and directly exposes six neutral-named English readers in SGA1-6 order, primary TeX, and two French readers. The preferred public SGA3 cumulative is the 1,474-page R23 reader covering the Introduction, Exposés I-XXVI, Tome-I subject index, Tome-III mathematical guide, and terminal index. Bounded reader history no longer appears loose; 50 exact ZIPs preserve source, QA, predecessor, and visual-provenance material. Direct PDFs exclude project/model/workflow/status commentary while retaining source-era editorial apparatus. SGA1 is the default preview and remains non-exhaustively certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
