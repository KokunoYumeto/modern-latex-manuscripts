...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p360 in `AGENT_SCORECARD.md`. Exposé VIII has started; p352 records fix #33, p355 records fix #34 in the `K(F)` formula, and diagrams are tracked through D174. Treat p266-p360 as live provenance/workpass metadata only, not a promoted compact delta, not SGA5 completion, not English synchronization, and not a critical edition. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R527 is the current clean packaged local TeX-changing German source-control candidate after the R523-R527 Paper 24 repair chain; R526/R525/R524/R523 are superseded source-control checkpoints. R528 is no-patch visual/source-audit support for Paper 24 printed pp.250-261 on top of R527, and R529 is no-patch current-base survival support for Papers 25-30 on top of R528/R527; neither is a new TeX head. WebB R497 is now separately registered as a TeX-changing tail/Kapferer provenance artifact, distinct from the local R497 no-patch P22 guardrail, and R285 is recorded as P08/P10/P13/P15/P19 provenance/workflow evidence rather than a base replacement. R508-R515, R517, R528, and R529 are support/no-patch/source-quality/visual-audit/survival packets, not new TeX heads. The second-web intake is a 40-file / 35-ZIP source/state handoff folder fronting R529, not a reader release. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
