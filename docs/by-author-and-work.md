...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. Latest inspected local additions are R685/R686/R687/R688: R685/R686 are no-patch source-support layers for P40/P41/P42/P30, R687 promotes one P40 printed p537 source fix (`Z` to `Z_\Omega`), and R688 promotes one P24 printed p234 norm-separator fix (`\mid` to comma in the module-norm display only). The R688 German cumulative compiles to 466 pages. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
