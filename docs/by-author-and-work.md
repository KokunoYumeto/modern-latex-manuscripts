...
|---|---|---|
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest compact SGA5 delta still promotes only p260-p265 as page-local French workpass/source-audit evidence, but later live ledger/provenance checkpoints now record the local SGA5 workpass through p421 in `CERT_LOG.md` / `AGENT_SCORECARD.md`. Exposé VIII is closed at p371; Exposé X is locally recorded through its references at p406, including diagrams D178-D184, the Euler-Poincaré formula, local terms, and A/Λ transcription fixes. Later Exposé XII live-ledger evidence now reaches p421, with a p421 source Arabic "1)" versus TeX Roman "I)" label deviation deferred to p422. Treat p266-p421 as live provenance/workpass metadata only unless later compactly packaged, not SGA5 completion, not English synchronization, and not a critical edition. The next local task is continuing from p422 and resolving the deferred label issue before promotion. SGA6 and SGA7-I remain substantial working drafts with source-compression/detail caveats. Corrections are welcome via GitHub issues or pull requests. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
...
|---|---|---|
| Emmy Noether | Curated numbered-paper working corpus: cumulative German/English readers, 43 standalone English paper PDFs, compact German/source and multilingual packages, plus active source-audit/support packets. R563 is the current local TeX-changing source-control head: a one-locus tail pp.725-730 source-style repair over R562. R562 remains the richer ledged predecessor for Paper 40 pp.530-535 repairs on top of R561/R560/R559/R558/R557/R556/R555/R553/R552/R551/R550, integrating only selected WebB R556 candidates after local source comparison. R561 remains the coherent Paper 32 p226 `\varrho` predecessor, and R560 remains the coherent Paper 31 pp.89/98 predecessor. R564 is newer on disk but held/rejected for an x-to-`\chi` source mismatch on collected p731, so it is not a promoted successor. Slavic and interlanguage staging remains mathematics plus linguistics apparatus, not just PDFs. Not a certified critical edition; source witness quality is mixed, and language synchronization, source-check corrections, compact Zenodo rebalancing, and page-level certification remain active/open. | [Noether](https://doi.org/10.5281/zenodo.20412587) |
