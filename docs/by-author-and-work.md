...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21519758](https://doi.org/10.5281/zenodo.21519758) has 48 files and directly exposes eight sequential English readers plus primary TeX: complete-volume working SGA1, complete SGA2 R8, sealed cumulative SGA3 I-IV, standalone native-diagram V, bounded Loop-1 VI-A, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Two French workpasses remain direct and twenty-three ZIPs group source, diagrams, QA, predecessor evidence, and 1,936 targeted or named high-detail SGA6 audit crops. The 1,778 routine page derivatives remain metadata-only. SGA1 is the authoritative preview and remains non-exhaustively certified. SGA3 remains incomplete because VI-B and VII-XXVI are absent; SGA4half is rights-held. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
