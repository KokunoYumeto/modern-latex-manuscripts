...
|---|---|---|
| Grothendieck and collaborators, SGA | Compact current version [10.5281/zenodo.21672742](https://doi.org/10.5281/zenodo.21672742) has 68 files and directly exposes six clean English readers in SGA1-6 order, primary TeX where available, and two French workpasses. The preferred public SGA3 cumulative is the 1,472-page R17 reader covering the Editorial Notice, Introduction, Exposés I-XXVI, Tome-I index, Tome-III mathematical guide, and terminal index. Bounded SGA3 reader history no longer appears loose; two exact ZIPs preserve it behind the cumulative reader. Forty-nine ZIPs / 4,235 file members group sources, diagrams, QA, predecessor evidence, and SGA6 high-detail audit crops/provenance metadata. SGA1 is the default preview and remains non-exhaustively certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
