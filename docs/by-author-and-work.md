...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Latest public update 2026-06-24 adds a bundled SGA5 repair032 audit-support artifact; this is not a completed or certified SGA5 edition. Use it as repair evidence only; current local full-audit coverage is pp.1-60 of 484 plus p103, and diagrams/formulas/notation should be checked against source scans. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
