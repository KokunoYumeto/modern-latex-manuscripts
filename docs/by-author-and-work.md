...
| Grothendieck and collaborators, SGA | SGA 5/6 and further SGA working translation material, plus source/reference and audit packets. Current drafts are structurally useful but not proofread final editions; latest repair026 is a compact cumulative SGA5/SGA6 French-output refresh, while the repair025 targeted SGA5 source-page audit remains preserved in the previous Zenodo version. | [SGA](https://zenodo.org/records/20673346) |
...
|---|---|---|
| Heinrich Weber | `Lehrbuch der Algebra`: Volume I German/English represented as a repaired working branch; Volume II current readers through section 176 with recursive gap repairs through Batch132. Latest Batch132 repairs Vol. II §§120 and 128 and reports the active 112-row ledger at 73 closed / 39 open; Volume III remains the earlier repaired cumulative. | [Weber](https://zenodo.org/records/20673435) |
| Emmy Noether | Curated numbered-paper working corpus: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus active Paper 02 RA25-RA33 source-audit correction packets. Not a certified critical edition; synchronization and source-check corrections remain active. | [Noether](https://zenodo.org/records/20673149) |
| Luigi Bianchi | `Lezioni di geometria differenziale` Vol. I Italian source transcription and English translation working draft represented through source pdfpages 001-543, with source witness and TeX/auditfix ZIP; A2 now has compact/core coverage through source p0120 via `Bianchi_A2_core_p0001_0120_IT_EN_20260612.zip`. | [Bianchi](https://zenodo.org/records/20673425) |
| Paul Gordan / Clebsch-Gordan | `Gordan_Abel26_p332_342_DE_EN_20260612.zip` extends `Theorie der Abelschen Functionen` through source pp.332-342 / printed pp.310-320 and cumulative German/English TeX/PDF through source p342. It completes §87 and §§88-90 and repairs a prior cumulative-inclusion bug. Earlier Abel tranches and AllPrior AuditFix01 remain correction/provenance layers. | [Gordan](https://zenodo.org/records/20673409) |
| Ferdinand Georg Frobenius | Selected group-character papers in German/English; QA03 cumulative package reports 10/10 selected items and 221/221 tracked source-intake pages. | [Frobenius](https://zenodo.org/records/20673445) |
| Henri Poincare | `Oeuvres`, Tome I French/English working packages through `poincare_v1_26.zip`; explicitly non-continuous local stream with missing v1_03-v1_07 and v1_22-v1_23 artifacts. | [Poincare](https://zenodo.org/records/20673462) |
...
| Bianchi | Backstop/routed copies for the now-dedicated Bianchi record; prefer the standalone [Bianchi record](https://zenodo.org/records/20673425) for current readers and the latest A2 p0120 compact/core package. |
| Poincare | Prefer the standalone [Poincare record](https://zenodo.org/records/20673462). Mixed-shelf Poincare copies remain provenance/backstop where present. |
...
| Gordan / Clebsch-Gordan | Backstop/routed copies for the now-dedicated Gordan record; prefer the standalone [Gordan record](https://zenodo.org/records/20673409) for Abel11-Abel26, AllPrior AuditFix01, and branch-specific auditfix packets. |
| Frobenius | Prefer the standalone [Frobenius record](https://zenodo.org/records/20673445). Mixed-shelf Frobenius copies remain provenance/backstop where present. |
