...
|---|---|---|
| Grothendieck and collaborators, SGA | Current version [10.5281/zenodo.21702669](https://doi.org/10.5281/zenodo.21702669) starts with one clean bundle containing all six cumulative English readers and their buildable TeX closures. The same six readers and master TeX files remain direct in SGA1-6 order; SGA1 is the default preview. The prior 66-file surface is retained byte-identically, while source, QA, predecessor, and visual-provenance material remains separately grouped. SGA1 remains non-exhaustively certified; SGA3 is not final diagram-fidelity closure; SGA4half is rights-held; SGA6 remains layered. | [SGA](https://doi.org/10.5281/zenodo.20410947) |
