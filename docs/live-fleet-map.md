...
| Research / formalization sidecars | The separate split-zero geometry research lane fronts a concise 12-page common-deformation-register note, retains the broader 91-page draft and Version 10 history, and groups editable sources plus scoped Lean/Python checks. The classical Lean lane preserves buildable mathlib-style candidate modules and their build/provenance material. | **Public.** Split-zero version `10.5281/zenodo.21316072` under concept DOI `10.5281/zenodo.20822444`; Lean/formalization record `10.5281/zenodo.21129946`. These are exploratory research and library-candidate artifacts, not peer review, historical-source certification, or proof that every broader claim is correct. | Publish only coherent new sidecar artifacts with readable front matter, editable source, build/check evidence, and an honest scope statement; do not create unrelated DOIs without an explicit request. |
