...
Current caveat from the 2026-06-24 SGA audit-support updates, with 2026-06-25 hand-certification reconciliation: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not certified complete. A newer manual certification log demotes agent/workflow passes to finder status rather than certification status: pp.1-70 certified so far (p1-p70 page-locally certified: Expose I main text §§1-5, Bibliographie, and Illusie Appendix §§1-7 through Theoreme 7.5 demonstration start; p13/p19/p26/p37/p40/p41/p44/p45/p51-p53/p55-p56/p61-p64/p66 include logged source-fidelity, twist-sign, underline, source-typo, or notation fixes; p33 twist and p37 L-i_? agent fixes verified/applied; p38-p40 and p45 SGA-to-SGAA/j^! checks verified; p41 (4.5.3)'' xbar placement, p42 local-cohomology/R_!f notation, p43 closure-node, and D001-D012 diagram checks verified; Type-B/source-or-editorial conventions and diagram-index page drift remain documented risks), with p71 next. The broader local full-audit workpass remains repair evidence and reports 411 verified corrections, a p1-p484 page-by-page French source audit in the live status note, and a 307-page PDF with no fatal/LaTeX-error diagnostics in the latest observed log scan. Remaining publication/audit work includes final diff/FINDINGS refresh, compact packaging, independent validation, optional low-value prose-fidelity review where desired, and English synchronization. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current pp.1-70 certification is Expose I evidence, not global SGA5 certification. This is preservation/support evidence for ongoing repair, not a certified edition, not an independently packaged or promoted edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.
