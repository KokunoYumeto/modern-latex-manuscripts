...
2026-07-01 superseded local audit follow-up: `manifests/source-intake/20260701_sga5_full_audit_p333_certlog_update.md/json` records the earlier SGA5 workpass checkpoint with 333 completed page rows. p329-p333 cover Expose VII section 8.4 Lemme 8.4.1 through section 8.6 Proposition 8.6.3; p330 and p333 record edge-by-edge checks of D156 and D157; p331 records three local loci / two source-typo corrections in Proposition 8.5. This remains provenance for the p333 checkpoint, now superseded as current cursor by the p364 checkpoint below; do not promote it as a compact delta, SGA5 completion, English synchronization, or critical-edition material.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p360_local_workpass_refresh.md/json` records the earlier p360 local SGA5 workpass refresh. It remains provenance for Exposé VIII p351-p360, including fix #33, fix #34, diagrams D165-D174, and the start of section 5 on pseudo-coherent complexes. It is now superseded as the current cursor by the p364 manifest below.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p363_local_workpass_refresh.md/json` records the earlier p363 local SGA5 workpass folder refresh. It remains provenance for p360-p363: D174-D176, section 5 pseudo-coherent complexes, sections 6 and 7 on perfect complexes and the ring case, and the K-group identities. It is now superseded as the current live-ledger cursor by the p364 manifest below.

2026-07-02 latest local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p364_local_workpass_refresh.md/json` records the current local SGA5 workpass folder refresh. The newest inspectable scorecard evidence reaches p364: p360 opens section 5 on pseudo-coherent complexes with D174 verified; p361 verifies diagrams D175-D176 and notes one editor label-addition on D176; p362 closes section 5 and opens sections 6 and 7 on perfect complexes and the ring case; p363 records the K-group identities; and p364 records fix #35 for a module-side/type issue in the `X^\bullet` / `\Phi` passage, with no diagram. The compact promoted SGA5 delta still stops at p260-p265. Treat p266-p364 as live ledger/provenance only unless later compactly packaged: not a compact delta, not SGA5 completion, not English synchronization, not global source-faithfulness certification, and not critical-edition material.
...
The current local SGA5 status reflected by this record has two layers. The latest compact promoted delta is still `SGA5_FullAudit_WebDrop_p260_p265_workpass_delta_20260626`, which promotes only p260-p265 as page-local French workpass/source-audit evidence. Later live ledger/provenance checkpoints now record the local SGA5 workpass through p364 in `AGENT_SCORECARD.md`, with Exposé VIII started, fixes #33/#34/#35 recorded, and diagrams tracked through D176; the local workpass PDF is 307 pages. The broader folder `SGA continuation 2/_claude_aid/sga5_full_audit_20260623` contains live workpass TeX/PDF, `CERT_LOG.md`, `AGENT_SCORECARD.md`, method notes, and many source crops, but those folder-level materials are evidence/provenance, not a global quality certificate. Later crops or cursor text beyond p364 remain active scratch unless explicitly packaged in a later compact delta.
