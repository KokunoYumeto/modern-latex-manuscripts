...
Current caveat from the 2026-06-24 SGA audit-support updates, with 2026-06-26 hand-certification reconciliation: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not certified complete. A newer manual certification log demotes agent/workflow passes to finder status rather than certification status. The current compact local status package records p172 in the page-local certification ledger: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked certified complete; Expose III B Part II §5 is underway through p172. The p172 ledger reports 13 TeX fixes plus one cosmetic p172 cleanup, 27 source typos or source oddities found, and D001-D086 covered in the running diagram ledger; D082/D084/D085/D086 are perfect and D083 was corrected at p171. The p171 page remains important because three math-bearing TeX content errors in diagram 5.9.1 compiled cleanly and were found only by source/type checking; p172 then confirmed adjacent diagrams 5.9.2-5.9.4 as perfect. The broader local full-audit workpass remains repair evidence and reports a 307-page PDF with no fatal/LaTeX-error diagnostics in the latest observed log scan. Remaining publication/audit work includes continued page-by-page hand certification from p173 onward, global referenced-label/notation audit, independent validation, optional low-value prose-fidelity review where desired, and English synchronization. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current p1-p172 certification is opening-range evidence, not global SGA5 certification. This is preservation/support evidence for ongoing repair, not a certified edition, not an independently packaged or promoted edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.
