...
Current caveat from the 2026-06-24 SGA audit-support updates, with 2026-06-26 hand-certification reconciliation: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not certified complete. A newer manual certification log demotes agent/workflow passes to finder status rather than certification status. The current compact local status package records p188 in the page-local certification ledger: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked complete in the ledger; Expose III B Part II §5 is locally closed through p182; and §6 has started with pp.183-188 checked locally. The p188 ledger reports 16 TeX fixes plus one cosmetic p172 cleanup, 31 source typos or source oddities found, D001-D101 covered in the running diagram ledger, and a 307-page PDF with no fatal/LaTeX-error diagnostics. Page p186 defines the non-commutative local trace `(6.5.3)`, p187 fixes the first section-6 operator/shriek garble, and p188 checks the pairing/cup-product bridge identity `(6.6.4)`. The p171 and p175 pages remain important because math-bearing TeX content errors in diagrams/displays compiled cleanly and were found only by source/type checking. Remaining publication/audit work includes continued page-by-page hand certification from p189 onward, global referenced-label/notation audit, independent validation, optional low-value prose-fidelity review where desired, and English synchronization. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current p1-p188 certification is opening-range evidence, not global SGA5 certification. This is preservation/support evidence for ongoing repair, not a certified edition, not an independently packaged or promoted edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.
