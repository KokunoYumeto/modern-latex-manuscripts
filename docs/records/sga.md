...
2026-07-03 local workpass/recert refresh: the SGA5 local French workpass ledger under `SGA continuation 2/_claude_aid/sga5_full_audit_20260623` now reaches p480 and locally claims body-text completion for the selected 10-expose branch (I, III, IIIB, V, VI, VII, VIII, X, XII, XV). The current local ledger has advanced beyond the older p480 summary: it reports about 60 numbered TeX-fix events (TALLY 59 fixes / max fix #60), ERRATA 115, D001-D193 diagrams verified/tracked, and a compile gate reported as 306pp/0err. Later recert spot-checks #77-#82 found and fixed real edition defects, including an interpolation/removal issue around p455 and an `R^i_! f` notation-consistency cluster around p274-p275, so the public interpretation stays conservative. The GitHub mirror now includes the actual Claude ledger packet at `sources/sga/sga5-claude-ledgers-p480-20260703/`, including `ERRATA_LNM589.md`, `CERT_LOG.md`, `AGENT_SCORECARD.md`, quality/method/status notes, findings logs, index artifacts, and the current `sga5_fr_workpass` TeX/PDF/log. Current local hashes are `CERT_LOG.md` SHA256 `08C23B206BA6B4D6F4E5163A1D1AAD91A605203D192DC9B958861B176A21E7EB`, `ERRATA_LNM589.md` SHA256 `03B09AFDC7A8E4888ADFE4AF95E93DD6C875CF5D82B0FD44B1A2A58633AAA6B6`, `sga5_fr_workpass.tex` SHA256 `791F4EFFC5E02832D5D77ED03518C8156D6F07E4C8238B03545DB93D883FBB28`, and `sga5_fr_workpass.pdf` SHA256 `977E3180CF5404DC7F0057C87551E41A7C0B87AE89BAFA5D8D40425DCD08B68A`. This is a local workpass/ledger claim only. It is not yet a compact promoted Zenodo delta, not an English synchronization, not an index audit, not independent certification, not global SGA5 source-faithfulness, and not a critical edition.

2026-07-05 local SGA6 source-rescribe evidence refresh: the GitHub mirror includes a compact copy of the July SGA6 Claude/Codex workpass packet at `sources/sga/sga6-claude-workpass-source-rescribe-20260704/`, with `CERT_LOG.md`, `ERRATA_SGA6.md`, the current `sga6_fr_workpass` TeX/PDF/log, scratch/source-proof logs, and checksums. The local audit found that the earlier SGA6 `repair033` French TeX is a readable scaffold with paraphrased/condensed regions, not a globally faithful transcription. The task therefore pivoted to source-rescribing against the better 360dpi Internet Archive scan item `theoriedesinters0225bert`. The copied ledger now reaches entry #194, idx197 / volume p184 / Expose II p25; Expose I is complete through its bibliography page and the source-rescribe is proceeding through Expose II, with the next cursor at idx198 / volume p185 / Expose II p26. The mirrored workpass compiles with 0 LaTeX errors to a 390-page PDF. This is SGA6 source-repair provenance and continuation evidence only: not a completed SGA6 reader release, not English synchronization, not whole-SGA6 source-faithfulness certification, not an index audit, and not a critical edition.
...
2026-07-01 superseded local audit follow-up: `manifests/source-intake/20260701_sga5_full_audit_p333_certlog_update.md/json` records the earlier SGA5 workpass checkpoint with 333 completed page rows. p329-p333 cover Expose VII section 8.4 Lemme 8.4.1 through section 8.6 Proposition 8.6.3; p330 and p333 record edge-by-edge checks of D156 and D157; p331 records three local loci / two source-typo corrections in Proposition 8.5. This remains provenance for the p333 checkpoint, now superseded as current cursor by the p480 receipt above; do not promote it as a compact delta, SGA5 completion, English synchronization, or critical-edition material.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p360_local_workpass_refresh.md/json` records the earlier p360 local SGA5 workpass refresh. It remains provenance for Exposé VIII p351-p360, including fix #33, fix #34, diagrams D165-D174, and the start of section 5 on pseudo-coherent complexes. It is now superseded as the current cursor by the p480 receipt above.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p363_local_workpass_refresh.md/json` records the earlier p363 local SGA5 workpass folder refresh. It remains provenance for p360-p363: D174-D176, section 5 pseudo-coherent complexes, sections 6 and 7 on perfect complexes and the ring case, and the K-group identities. It is now superseded as the current live-ledger cursor by the p480 receipt above.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p364_local_workpass_refresh.md/json` records the p364 local SGA5 workpass folder refresh. The newest inspectable scorecard evidence at that checkpoint reached p364: p360 opened section 5 on pseudo-coherent complexes with D174 verified; p361 verified diagrams D175-D176 and noted one editor label-addition on D176; p362 closed section 5 and opened sections 6 and 7 on perfect complexes and the ring case; p363 recorded the K-group identities; and p364 recorded fix #35 for a module-side/type issue in the `X^\bullet` / `\Phi` passage, with no diagram. It is now superseded as the current live-ledger cursor by the p480 receipt above.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p380_local_workpass_refresh.md/json` records the earlier p380 SGA5 workpass folder refresh. It remains provenance for Exposé X §3.7 and the `K^\bullet(\Lambda[G])` involution checkpoint, but is now superseded as the current live-ledger cursor by the p480 receipt above.

2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p384_local_workpass_refresh.md/json` records the p384 SGA5 workpass refresh. It remains provenance for Proposition 3.8, Corollary 3.9, the beginning of §4 `La représentation de Swan`, Lemma 4.1, and §4.2 formulas (4.2.1)-(4.2.3), but is now superseded as the current live-ledger cursor by the p480 receipt above.


2026-07-02 superseded local audit follow-up: `manifests/source-intake/20260702_sga5_full_audit_p388_local_workpass_refresh.md/json` records the p388 local SGA5 workpass folder refresh. It remains provenance for Exposé X §4 through §4.6 and the local/tame ramification remark, but is now superseded as the current live-ledger cursor by the p480 receipt above.

SGA5 local workpass refresh through p428 2026-07-02: `manifests/source-intake/20260702_sga5_full_audit_p428_local_workpass_refresh.md/json` records the earlier p428 cursor. It remains provenance for the Exposé VIII/X/XII local ledger advance, but is now superseded as the current local cursor by the p480 receipt. Agent/diagram-aid ledgers are finders, not certification. Not a reader release, not SGA5 completion, not English synchronization, not global source-faithfulness certification, and not critical-edition material.

2026-07-01 superseded local audit follow-up: `manifests/source-intake/20260701_sga5_full_audit_p323_certlog_update.md/json` records the earlier SGA5 workpass checkpoint with 323 completed page rows. p321 checks Lemme 7.2.1 equivalent conditions and proof, including TeX fix #30 for the D153 array implications; p322 closes Lemme 7.2.1 and checks Proposition 7.3 with the `EP(Y)` formula in Chern classes; p323 checks Corollaire 7.4 and Corollaire 7.5 on complete intersections, including `EP(X)-EP(Y)` and Betti-number formulae. This remains provenance for the p323 checkpoint, now superseded as current cursor by later checkpoints; do not promote it as a compact delta, SGA5 completion, English synchronization, or critical-edition material.
...
The current local SGA5 status reflected by this record has two layers. The latest compact promoted delta is still `SGA5_FullAudit_WebDrop_p260_p265_workpass_delta_20260626`, which promotes only p260-p265 as page-local French workpass/source-audit evidence. Later live ledger/provenance checkpoints now record the local SGA5 workpass through p480 in `CERT_LOG.md`; the local ledger claims body-text completion for the selected 10-exposé branch, with index audit, global packaging, label/QED audit, English synchronization, and independent certification still open. The broader folder `SGA continuation 2/_claude_aid/sga5_full_audit_20260623` contains live workpass TeX/PDF, `ERRATA_LNM589.md`, `CERT_LOG.md`, `AGENT_SCORECARD.md`, method/status notes, and source-audit findings. The GitHub mirror preserves a compact copy of those ledgers at `sources/sga/sga5-claude-ledgers-p480-20260703/`, but those folder-level materials are evidence/provenance, not a global quality certificate. Later crops or cursor text beyond p480 remain active scratch unless explicitly packaged in a later compact delta.
