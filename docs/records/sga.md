...
Current caveat from the 2026-06-24 SGA audit-support updates, with 2026-06-26 hand-audit reconciliation: the latest published record is DOI 10.5281/zenodo.20822648. SGA5 is explicitly not certified complete. The current compact local status package is `SGA5_FullAudit_Workpass_Status_p001_p249_20260626.zip`: it preserves the current French workpass PDF/TeX/log plus CERT_LOG, AGENT_SCORECARD, FINDINGS, method/status notes, swarm status, manifest, and checksums. CERT_LOG/AGENT_SCORECARD are the freshest controlling status files; STATUS.md is only an archive-side summary. Parsed completed rows reach p249, while p250 is only the next cursor and is not promoted as complete. The included workpass compiles to a 307-page PDF. The p190, p194, p197, p199, p205, p208, p213, p220, p225, p226, p228, p230, p232, p234, p236, p237, p240, p242, and p245 packages remain provenance only and are superseded as the current cursor. Substantial source reconciliation remains, English remains unsynchronized, and risk lanes remain functor order, underlines/object operators, O versus underlined O, Hom variants, D^-, c\ell/cl, guillemets, diagram index drift, and per-expose notation shifts. Expose III B is locally hand-audited through its bibliography in this workpass; Expose V opens at p204; p209-p249 cover Proposition 2.2.2 through the Shih appendix Theorem A.3 proof boundary, including copied-source repairs at p209/p214, diagram checks D113-D142, section 2 closure at p219, section 3 closure at p224, section 4 closure at p232, p237 E_C abelian/exact-embedding argument, p238 Proposition 5.2.2, p239 Theorem 5.2.3/Proposition 5.2.4/Lemme 5.2.4.1 opening, p240 diagrams D138/D139 plus lemma/proposition closure, p241 Corollaire 5.2.5 and section 5.3 opening, p242 Proposition 5.3.1 proof plus Corollaire 5.3.2, p243 Shih appendix opening and spectral-filter terminology, p244 functoriality and systems-projectifs opening, p245 Section A.2 continuation including bidegree TikZ figure D140, p246 A.2 part c) closing material, p247 A.2 close/A.3 Shih opening and D141, p248 Theorem A.3 statement/proof opening, and p249 Theorem A.3 proof continuation with D142. D140 has source-verified mathematical labels and bidegree content, but the TeX drawing simplifies the source layout by collapsing distinct `O` and `alpha` verticals; this is a recorded layout-fidelity caveat, not a fully mirrored source diagram. D141 and D142 are recorded as checked in the included ledgers, but remain page-local workpass evidence. p250-p252 source chunks may exist locally but are not promoted in this package because the included CERT_LOG has no completed entries for them. The p69 scope note clarifies that the source scan is the full 484-page LNM 589, but the local TeX is a curated 10-expose selection (I, III, IIIB, V, VI, VII, VIII, X, XII, XV); current p1-p249 evidence is opening-range workpass evidence, not global SGA5 certification. This is preservation/support evidence for ongoing repair, not a certified edition, not an independently packaged or promoted edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as Complete, Source-Checked, Strict, or High-Fidelity are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.
