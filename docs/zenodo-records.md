...
| <https://zenodo.org/records/20588791> | Arthur Cayley author record: draft/provenance readers and salvage packages. Current Cayley PDFs/TeX are retained, but they are not accuracy-certified and need page-by-page source audit before scholarly use. |
...
| <https://zenodo.org/records/20613262> | Additional author cluster: Minkowski, Hecke, Landau, Steinitz, Hensel, Oka, Hausdorff, Grassmann, Killing, and routed Bianchi/Poincare/Frobenius/Gordan/Kneser/Mikami/Kronecker/etc. material; latest routed sweep adds Frobenius 060, Gordan Abel04, and Kneser p0122-p0138 as package-audited tranches with explicit package-level caveats. |
