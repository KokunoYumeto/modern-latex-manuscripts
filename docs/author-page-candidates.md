...
| James Clerk Maxwell | `A Treatise on Electricity and Magnetism`, Volume I now has a dedicated source-witnessed working-tranche record for IA 1873 first-edition pp.001-059, with p.059 awaiting the next math/token register refresh, plus earlier ledger-backed pp.95-101, 103, 105, 109, and continuous pp.111-267. |
