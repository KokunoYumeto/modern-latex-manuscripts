...
A June 25 Weber adaptation shows how that method changes when the starting TeX is not a faithful transcription. The corrected priority is German transcription first: audit for omitted lines, compressed prose, missing formulae, wrong symbols, and occasional over-added editorial completions before treating English translation as a production axis. The local source measurement helper found no native Weber scan at or above the 650dpi trust line; the best on-disk sources are about 500-560dpi, so hard formula checks need tight crops and explicit uncertainty flags. The Weber packet is mirrored in `workflow/AI_Run_Workflow_Weber_FindVerifyFix_Audit_Method_20260625.zip` and queued for the workflow DOI. The refreshed GitHub packet now carries the certification/method logs through Band I p311, including p144-p167 small omissions, the p154 sign repair, p160-p161 prose fixes, rejected false/source-typo reversions at p147/p155/p158/p162, p168-p173 dropped-equation restoration/rejects, p174-p179 ratio/section-divider/index-order repairs, p180-p185 clean/cosmetic/revert-reject evidence, p186-p209 invariant-theory/covariant repairs, p210-p221 dense Hermite/Tschirnhausen repairs plus a structural-hold warning, p222-p257 Cardano/Bezoutiante/Sturm repairs, p258-p287 quadratic-form/Hermite/discriminant determinant repairs, and p288-p299 characteristic-theory/fundamental-theorem repairs, p300-p305 Budan-Fourier/Newton repairs including two restored sign tables, and p306-p311 Newton/Descartes/Jacobi criteria repairs including a restored double-row table and dropped formula material. It also adds method lessons on whole-section holds, over-expansion detection, line-wrap macro corruption, phantom no-scan hallucinations, and page-count compile gates as evidence of content restoration or swallowing. It deliberately excludes bulky source chunks; those should be generated on demand from the page manifest.
