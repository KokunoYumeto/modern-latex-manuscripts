...
- Related local folder: `Noether_R124plus_P13_p251_254_CommonsDjVu_Audit_WebDrop_20260625`, 18 files / 18,395,103 bytes, key TeX SHA256 `2BC6355047AC0136B40204A13AA903F14BCC7C249BF22498E4C1A2FB42D920D0`.
- Folder status: fresh p251-p254 source-witness/crop staging folder only. It has Commons DjVu page witnesses, split crops, a copied/current candidate TeX, and a logbook snapshot, but no README, confirmed-fixes ledger, source-quality ledger, visual/no-fix ledger, compiled output PDF, checksum manifest, or explicit statement that TeX changes were actually applied. Do not upload or front it until it is packaged, ledgered, compiled, and reviewed.
