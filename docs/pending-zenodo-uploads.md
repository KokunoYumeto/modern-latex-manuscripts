...
- `Noether_R124plus_P26_P28_P27_qpGlyphFix_WebDrop_20260625.zip`, 12,424,452 bytes, SHA256 `A865BE3F6DFBB3177EE39128983463335E161D3D181DE201AF840F91AB9428D2`.
- `Noether_R124plus_P25_p119_GaloisFieldOverbarFix_WebDrop_20260625.zip`, 5,990,085 bytes, SHA256 `93EFFFFAB9EE7E681AB56F0485685D2D3C2B26CBEBB7ECC3352032F30C12F8A9`.
...
Status: pending consolidation only. Do not upload these one by one. The substantive new patches are the narrow P11 p221 front-matter comma/source-line correction, the P25 p119 Galois-field overbar correction candidate, and the later P27 q/p glyph-style correction candidate. The other files are salvage, apparatus-audit, post-P11 no-new-patch survival evidence, boundary/regression proof, or live source-audit logbook/provenance material. The P25 and P27 packages use selected 600 ppi GDZ/JDMV witnesses, still below the strict 650+ local source floor, so they should remain reversible candidates until consolidated. Noether is already at Zenodo's 100-file ceiling, so the next public Noether refresh needs pruning/replacement or one compact rollup. These are working source-audit artifacts, not reader-facing completion, whole-corpus certification, or critical-edition material.
