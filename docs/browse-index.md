...
| Work on Noether only | [Emmy Noether record](https://zenodo.org/records/20672553) |
...
| Corpus | What Is There Now | Best First File |
|---|---|---|
| [Emmy Noether](https://zenodo.org/records/20672553) | Curated numbered-paper corpus with cumulative readers, 43 standalone English paper PDFs, and multilingual working branches. | Open the cumulative reader PDFs first; use compact language/source ZIPs for TeX/source checking. RA23 display-layout corrections plus RA25-RA31 Paper 02 source-critical symbol/body audit packages are included; RA29 closes the Paper 02 body through printed pp.84-90; RA30 adds the final-summary/table-plate audit package; RA31 source-checks Tabelle I on printed/source p.91, while Tabelle II p.92 and cross-language propagation remain open. |
