...
| [James Clerk Maxwell](https://zenodo.org/records/20653382) | `A Treatise on Electricity and Magnetism`, Volume I source-checked working tranches. Current public coverage is IA 1873 first-edition pp.001-024 plus earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267; not a complete Treatise edition. | Start with the status files, then the ZIPs for TeX/PDF, source witnesses, ledgers, render checks, and IA/OCR witness material. |
