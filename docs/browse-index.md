...
| Work on Weber only | [Heinrich Weber record](https://zenodo.org/records/20644466) |
...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20645719) |
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20645705) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20645706) |
...
| [Heinrich Weber](https://zenodo.org/records/20644466) | Modern LaTeX drafts and English translation drafts for `Lehrbuch der Algebra`. | Open Volume I first; Volume II readers run through §176, with recursive repair packets through Batch113. |
...
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20645705) | Dedicated package set with Abel11-Abel13 for the current Abelsche continuation through source p193 / printed p171, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel13 p182-p193 includes the p190 continuation of equation (4). Reader PDFs, TeX, source witnesses, and audits are inside the packages. |
...
| [Additional author cluster](https://zenodo.org/records/20645706) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Poincare v1_14 is the current routed Poincare tranche; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
