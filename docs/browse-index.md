...
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20660721) |
...
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20660721) | Dedicated package set with Abel17 now extending the Abelsche continuation through source p243 / printed p221, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel13 p182-p193 includes the p190 continuation of equation (4), Abel14/15 continue p194-p217, Abel16 continues p218-p227, and Abel17 continues p228-p243. Reader PDFs, TeX, source witnesses, and audits are inside the packages. |
