...
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20651148) |
...
| [Additional author cluster](https://zenodo.org/records/20651148) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_20 through Chapters XII-XIII, the Frobenius selected-sequence QA03 cumulative package, and the Kneser p0158-p0177 high-quality figure/source-witness repair; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
