...
| Work on Noether only | [Emmy Noether record](https://zenodo.org/records/20670504) |
...
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20670492) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20669391) |
...
| [Additional author cluster](https://zenodo.org/records/20669391) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_21 through Chapter XIV, the Frobenius selected-sequence QA03 cumulative package, and the Kneser p0206-p0219 source-witness continuation with Fig. 24 as a source-derived crop; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
