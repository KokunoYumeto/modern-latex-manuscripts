...
| [Luigi Bianchi](https://zenodo.org/records/20651036) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543. A2 now has a preferred p0001-p0066 re-audit correction package: §§10-12 remain complete, with §13 deliberately deferred at the p0066/p0067 handoff. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
