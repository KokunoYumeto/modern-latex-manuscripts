...
| Read or continue SGA translation work | [SGA working English translation](https://zenodo.org/records/20667338) |
...
| Work on Noether only | [Emmy Noether record](https://zenodo.org/records/20667332) |
| Work on Weber only | [Heinrich Weber record](https://zenodo.org/records/20667337) |
...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20664430) |
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20667319) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20664437) |
...
| [SGA](https://zenodo.org/records/20667338) | SGA 5/6 and further SGA working translation material, plus source/reference packets. Current drafts are structurally useful but not proofread final editions; latest SGA repair020 repairs concrete SGA5 French diagrams on source pp.083-086 and p102. SGA6 French is unchanged from the carried-forward cumulative, English remains unsynchronized, and SGA6/SGA7 compression/source-check caveats remain explicit. | Open the reader PDFs first, then source ZIPs and audit packets. |
...
| Corpus | What Is There Now | Best First File |
|---|---|---|
| [Emmy Noether](https://zenodo.org/records/20667332) | Curated numbered-paper corpus with cumulative readers, 43 standalone English paper PDFs, and multilingual working branches. | Open the cumulative reader PDFs first; use compact language/source ZIPs for TeX/source checking. RA23 display-layout corrections and the RA26 Paper 02 source-critical symbol audit package are included, but source corrections still need cross-language propagation. |
| [Heinrich Weber](https://zenodo.org/records/20667337) | Modern LaTeX drafts and English translation drafts for `Lehrbuch der Algebra`. | Open Volume I first; Volume II readers run through §176, with recursive repair packets through Batch126. Batch126 closes Vol. II §6 and §§14/16/17 symbol/footnote patches; 84 priority repair rows remain open. |
...
| [James Clerk Maxwell](https://zenodo.org/records/20667750) | `A Treatise on Electricity and Magnetism`, Volume I source-witnessed working tranches. Current public coverage is IA 1873 first-edition pp.001-055 plus earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267; not a complete Treatise edition. | Start with the status files, then the ZIPs for TeX/PDF, source witnesses, ledgers, render checks, and IA/OCR witness material. |
| [Luigi Bianchi](https://zenodo.org/records/20664430) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543. A2 now has a p0001-p0077 continuation package: §13 is restored from lower source p0066, §§13-16 are represented through p0077, and the next continuation is p0078 inside §17. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20667319) | Dedicated package set with Abel21 now extending the Abelsche continuation through source pp.279-291 / printed pp.257-269, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel21 completes the continuation of §74, all §75, and all §76. Next continuation is source p292 / printed p270, Elfter Abschnitt / §77. |
...
| [Additional author cluster](https://zenodo.org/records/20664437) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_21 through Chapter XIV, the Frobenius selected-sequence QA03 cumulative package, and the Kneser p0177-p0192 source-witness continuation with Figures 19-20 as source-derived crops; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
