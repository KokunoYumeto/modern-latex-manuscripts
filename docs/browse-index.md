...
| Reproduce the workflow | [Workflow / replication packet](https://zenodo.org/records/20650989) |
...
| Work on Weber only | [Heinrich Weber record](https://zenodo.org/records/20650823) |
...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20650630) |
...
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20650905) |
...
| [Heinrich Weber](https://zenodo.org/records/20650823) | Modern LaTeX drafts and English translation drafts for `Lehrbuch der Algebra`. | Open Volume I first; Volume II readers run through §176, with recursive repair packets through Batch119. |
...
| [Luigi Bianchi](https://zenodo.org/records/20650630) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543. A2 now has a preferred p0001-p0066 continuation package: §§10-12 complete, with §13 deliberately deferred at the p0066/p0067 handoff. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20650618) | Dedicated package set with Abel16 now extending the Abelsche continuation through source p227 / printed p205, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel13 p182-p193 includes the p190 continuation of equation (4), Abel14/15 continue p194-p217, and Abel16 continues p218-p227. Reader PDFs, TeX, source witnesses, and audits are inside the packages. |
...
| [Additional author cluster](https://zenodo.org/records/20650905) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include the Kneser p0158-p0177 high-quality figure/source-witness repair, Poincare v1_19 through Chapter XI, the selected Frobenius cumulative integration, the prior Kneser p0139-p0158 tranche, Frobenius 070 p016-p034, and Frobenius 071; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
