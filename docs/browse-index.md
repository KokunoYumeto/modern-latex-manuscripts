...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20668784) |
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20668971) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20668791) |
...
| [Luigi Bianchi](https://zenodo.org/records/20668784) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543. A2 now has a p0001-p0090 continuation package: the earlier §13 restoration is retained, the current slice continues p0078-p0090 through §§17-22, and the next continuation is p0091. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20668971) | Dedicated package set with Abel22 now extending the Abelsche continuation through source pp.292-299 / printed pp.270-277 and cumulative German/English TeX/PDF through source p299, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel22 covers the beginning of Elfter Abschnitt, all §77, all §78, and the opening of §79 through the displayed w_i transformation. Next continuation is source p300 / printed p278. |
...
| [Additional author cluster](https://zenodo.org/records/20668791) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_21 through Chapter XIV, the Frobenius selected-sequence QA03 cumulative package, and the Kneser p0193-p0206 source-witness continuation with Figures 21-23 as source-derived crops; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
