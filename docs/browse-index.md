...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20618045) |
...
| [Luigi Bianchi](https://zenodo.org/records/20618045) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543, with reader PDFs, source witness, TeX, ledgers, and auditfix package. A2 now has a high-quality Italian/English working start through source p0001-p0028 / autograph pp.1-9; the full A2 work remains incomplete. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
