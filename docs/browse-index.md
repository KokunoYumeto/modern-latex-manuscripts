...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20649956) |
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20649946) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20650460) |
...
| [Luigi Bianchi](https://zenodo.org/records/20649956) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543, with reader PDFs, source witness, TeX, ledgers, and auditfix package. A2 now has a high-quality Italian/English working start through source p0001-p0066 plus preferred audit-continuation through p0001-p0057; the full A2 work remains incomplete. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20649946) | Dedicated package set with Abel11-Abel15 for the current Abelsche continuation through source p217, plus AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel13 p182-p193 includes the p190 continuation of equation (4), and Abel14/15 continue p194-p217. Reader PDFs, TeX, source witnesses, and audits are inside the packages. |
...
| [Additional author cluster](https://zenodo.org/records/20650460) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_19 through Chapter XI, Kneser p0139-p0158, Frobenius 070 p016-p034, and Frobenius 071; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
