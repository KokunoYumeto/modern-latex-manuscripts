...
| Work on Noether only | [Emmy Noether record](https://zenodo.org/records/20672174) |
| Work on Weber only | [Heinrich Weber record](https://zenodo.org/records/20672175) |
...
| Corpus | What Is There Now | Best First File |
|---|---|---|
| [Emmy Noether](https://zenodo.org/records/20672174) | Curated numbered-paper corpus with cumulative readers, 43 standalone English paper PDFs, and multilingual working branches. | Open the cumulative reader PDFs first; use compact language/source ZIPs for TeX/source checking. RA23 display-layout corrections plus RA25-RA29 Paper 02 source-critical symbol/body audit packages are included; RA29 closes the Paper 02 body through printed pp.84-90, while table plates and cross-language propagation remain open. |
| [Heinrich Weber](https://zenodo.org/records/20672175) | Modern LaTeX drafts and English translation drafts for `Lehrbuch der Algebra`. | Open Volume I first; Volume II readers run through §176, with recursive repair packets through Batch128. Batch128 repairs Volume II §§29-30 from source scans pp.121-127, with p.128 as the §31 handoff boundary, replacing a previously compressed Sylow-theorem region; larger compression clusters remain explicitly open. |
