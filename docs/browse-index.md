...
| Reproduce the workflow | [Workflow / replication packet](https://zenodo.org/records/20670272) |
...
| Read or continue SGA translation work | [SGA working English translation](https://zenodo.org/records/20670531) |
...
| Work on Noether only | [Emmy Noether record](https://zenodo.org/records/20672323) |
| Work on Weber only | [Heinrich Weber record](https://zenodo.org/records/20672355) |
...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20669390) |
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20671984) |
| Work on Steinitz only | [Ernst Steinitz record](https://zenodo.org/records/20617915) |
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20672178) |
...
| [SGA](https://zenodo.org/records/20670531) | SGA 5/6 and further SGA working translation material, plus source/reference packets. Current drafts are structurally useful but not proofread final editions; latest SGA repair019/repair020 packets repair concrete SGA5 French diagram clusters on source pp.030-048 and pp.083-086 plus p102. SGA6 French is unchanged from the carried-forward cumulative, English remains unsynchronized, and SGA6/SGA7 compression/source-check caveats remain explicit. | Open the reader PDFs first, then source ZIPs and audit packets. |
...
| [Historical reference witnesses](https://zenodo.org/records/20415777) | Secondary witnesses and historical reference material useful for checking translations and source lineage. | Open the reader PDFs first; use the artifact ZIP for provenance. |

## Algebra, Arithmetic, and Analysis

| Corpus | What Is There Now | Best First File |
|---|---|---|
| [Emmy Noether](https://zenodo.org/records/20672323) | Curated numbered-paper corpus with cumulative readers, 43 standalone English paper PDFs, and multilingual working branches. | Open the cumulative reader PDFs first; use compact language/source ZIPs for TeX/source checking. RA23 display-layout corrections plus RA25-RA30 Paper 02 source-critical symbol/body audit packages are included; RA29 closes the Paper 02 body through printed pp.84-90; RA30 adds the final-summary/table-plate audit package, while full Table II lower-row audit and cross-language propagation remain open. |
| [Heinrich Weber](https://zenodo.org/records/20672355) | Modern LaTeX drafts and English translation drafts for `Lehrbuch der Algebra`. | Open Volume I first; Volume II readers run through §176, with recursive repair packets through Batch129. Batch129 repairs Volume II §§33-34 from source scans pp.134-140, with p.141 / §35 as the handoff boundary, replacing compressed/simple-group material and adding Frobenius proof material, footnotes, and explicit permutation arrays; larger compression clusters remain explicitly open. |
...
| [James Clerk Maxwell](https://zenodo.org/records/20670590) | `A Treatise on Electricity and Magnetism`, Volume I source-witnessed working tranches. Current public coverage is IA 1873 first-edition pp.001-055 plus earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267; not a complete Treatise edition. | Start with the status files, then the ZIPs for TeX/PDF, source witnesses, ledgers, render checks, and IA/OCR witness material. |
| [Luigi Bianchi](https://zenodo.org/records/20669390) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543. A2 now has a p0001-p0090 summation-limit repair package; it retains coverage through §§17-22, adds no new pages, and leaves p0091 as the next continuation. | Open the Vol. I or A2 reader PDFs first; use the ZIPs for source witnesses, TeX, auditfix details, and ledgers. |
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20671984) | Dedicated package set with the revised Abel23 now extending the Abelsche continuation through source pp.300-308 / printed pp.278-286 and cumulative German/English TeX/PDF through source p308, plus pp.306-307 formula crops and AllPrior AuditFix01 for De linea, theta, Formensystem, and earlier Abelsche support branches. | Open the relevant ZIP; Abel23 continues and closes §79 and covers visible §80 through the final formula for the integral sums v_h. Next continuation is after source p308 / printed p286. |
...
| [Additional author cluster](https://zenodo.org/records/20672178) | Selected drafts and update packets for Minkowski, Hecke, Landau, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. work. Current routed additions include Poincare v1_24 for Tome I source witnesses v1_0329-v1_0345 / Chapters XVII-XVIII, the Frobenius selected-sequence QA03 cumulative package, and the Kneser p0206-p0219 source-witness continuation with Fig. 24 as a source-derived crop; Bianchi, Gordan, and Steinitz remain there as backstop/provenance copies but now have preferred standalone records. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
