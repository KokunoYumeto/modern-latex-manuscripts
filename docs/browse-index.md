...
| Read or continue SGA translation work | [SGA working English translation](https://zenodo.org/records/20616461) |
...
| Work on Gordan/Clebsch-Gordan only | [Paul Gordan and Clebsch-Gordan record](https://zenodo.org/records/20617198) |
...
| [SGA](https://zenodo.org/records/20616461) | SGA 5/6 and further SGA working translation material, plus source/reference packets. SGA5 and SGA6 are structurally covered in current drafts, but audits found localized compression/omission gaps; the latest SGA5 repair008 package is a targeted French diagram/formula source-witness repair, and witness-aid/candidate output is not promoted without independent source checks. | Open the reader PDFs first, then source ZIPs and audit packets. |
...
| [Paul Gordan and Clebsch-Gordan](https://zenodo.org/records/20617198) | Dedicated package set for Abelsche Functionen through source pp.001-121 / printed pp.001-099 with the p089-121 auditfix as current correction layer, plus latest complete De linea geodetica and staged Formensystem working packets. | Open the relevant ZIP; reader PDFs, TeX, source witnesses, and audits are inside the packages. |
