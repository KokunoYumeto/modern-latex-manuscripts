...
| [James Clerk Maxwell](https://zenodo.org/records/20653108) | `A Treatise on Electricity and Magnetism`, Volume I source-checked working tranches. Ledger-backed coverage is book pages 95-101, 103, 105, 109, and continuous pp.111-267; not a complete Treatise edition. | Start with the status file, then the ZIP for TeX/PDF substrate, source-check deltas, ledger, and IA source indexes. |
