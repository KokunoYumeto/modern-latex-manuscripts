...
| Read or continue SGA translation work | [SGA working English translation](https://zenodo.org/records/20614598) |
...
| Work on Bianchi only | [Luigi Bianchi record](https://zenodo.org/records/20615815) |
...
| [SGA](https://zenodo.org/records/20614598) | SGA 5/6 and further SGA working translation material, plus source/reference packets. SGA5 and SGA6 are structurally covered in current drafts, but audits found localized compression/omission gaps; the latest SGA5 repair007 package is a targeted French source-witness repair, and witness-aid/candidate output is not promoted without independent source checks. | Open the reader PDFs first, then source ZIPs and audit packets. |
| [Deligne](https://zenodo.org/records/20615537) | Separate working access record for Deligne papers, letters, draft TeX, and translation material; latest refresh updates the 2026-06-09 v2 repair/math-audit slot with D001-D017 witness material, D001-D017 equation-dense audit material, and D074-D090 descending triage. | Top-level paper/letter PDFs, then the source/provenance and repair/audit ZIPs. |
...
| [Luigi Bianchi](https://zenodo.org/records/20615815) | `Lezioni di geometria differenziale` Vol. I Italian/English working edition through source pdfpages 001-543, with reader PDFs, source witness, TeX, ledgers, and audit package. | Open the English or Italian reader PDF first; use the ZIP for source witnesses, TeX, and audit ledgers. |
| [Additional author cluster](https://zenodo.org/records/20615611) | Selected drafts and update packets for Minkowski, Hecke, Landau, Steinitz, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Bianchi/Poincare/Frobenius/Gordan/Kneser/Mikami/Kronecker/etc. work, now including Steinitz Bedingt II through p024, a Bianchi backstop copy through p0543, and Gordan Abel06 through p106. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
