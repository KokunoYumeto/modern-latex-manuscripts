...
| Browse additional selected author drafts | [Additional author cluster](https://zenodo.org/records/20612367) |
...
| [Additional author cluster](https://zenodo.org/records/20612367) | Selected drafts and update packets for Minkowski, Hecke, Landau, Steinitz, Hensel, Oka, Hausdorff, Grassmann, Killing, plus routed Bianchi/Poincare/Frobenius/Gordan/Kneser/Mikami/Kronecker/etc. work. | Open the named reader PDFs first; use the routed ZIPs for current working editions, source checks, and package-level audit details. |
