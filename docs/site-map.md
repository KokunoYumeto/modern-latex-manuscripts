...
| [Adoption board schema](../manifests/adopt.schema.json) and [validation](../manifests/adopt.check.json) | Formal item/mirror contract and bounded replay of IDs, states, enums, and tracked archive paths. |
