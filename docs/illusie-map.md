# Luc Illusie Coverage

## Check Before Duplicating

This repository already preserves separate French and English working editions
of *Complexe cotangent et déformations I–II*. Continue the existing masters;
do not restart the translated scope or replace it with a bilingual reader.
