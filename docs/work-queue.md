...
| Bianchi | Verify Vol. I formulas, references, terminology, and index entries against the source witness. For A2, locate a complete alternate witness before canonical body transcription; current A2 intake shows missing manuscript pages and duplicate source pages. | [Bianchi record](https://zenodo.org/records/20617674) |
| Gordan / Clebsch-Gordan | Continue Abelsche Functionen from source p.122 / printed p.100 at the section 28 table; use the p089-121 auditfix as the current correction layer for the previous Abel range, and use the theta/Formensystem auditfix plus De linea geodetica packet as current source-witnessed branches. | [Gordan record](https://zenodo.org/records/20617548) |
