...
| Gordan / Clebsch-Gordan | Continue `Theorie der Abelschen Functionen` after source p299 / printed p277. Use Abel22 and `Gordan_AllPrior_AuditFix01_20260610.zip` as the current correction/provenance layers; next handoff is source p300 / printed p278, continuation of §79. | [Gordan record](https://zenodo.org/records/20670492) |
