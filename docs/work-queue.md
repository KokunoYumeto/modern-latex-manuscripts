...
| SGA | Continue SGA and keep reader/source/audit packets synchronized with the current caveats. | [SGA record](https://zenodo.org/records/20617332) |
| SGA | Continue SGA5 repair after repair009: synchronize English to the latest French repairs, then attack the open diagram microgeometry, exact-symbol inventory, and underlined-operator typography lanes outside the patched Expose III/III B scope. | [SGA record](https://zenodo.org/records/20617332) |
| SGA | Repair the SGA6 nuclear-audit gaps, starting with p014, then clusters 423-454, 619-653, and 670-692. Continue SGA 7-I and SGA 7-II from the French reference PDFs only with explicit source-check caveats. | [SGA record](https://zenodo.org/records/20617332) |
...
| Bianchi | Verify Vol. I formulas, references, terminology, and index entries against the source witness. For A2, continue the high-quality branch from source p0029 / autograph p.10 / section 3; keep the older p0001-p0060 witness as intake/provenance, not authority. | [Bianchi record](https://zenodo.org/records/20618045) |
| Gordan / Clebsch-Gordan | Continue Abelsche Functionen from source p.122 / printed p.100 at the section 28 table; use the p089-121 auditfix as the current correction layer for the previous Abel range, and use theta auditfix04 plus the De linea geodetica packet as current source-witnessed branches. | [Gordan record](https://zenodo.org/records/20617906) |
...
| Additional authors | Check the selected drafts for wrapper removal, title accuracy, and source alignment before splitting into more complete author records. Bianchi, Gordan, and Steinitz now have standalone records; the mixed shelf still needs Poincare, Frobenius, Kneser, Mikami, Kronecker/Kron, Picard, Klein-Fricke, Maxwell/old-physics, and related tranches triaged by package-level caveats. Poincare v1_07 is the current routed tranche, through the first thesis first part. | [Additional author cluster](https://zenodo.org/records/20617597) |
