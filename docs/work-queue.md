...
| Maxwell / old physics | Continue `A Treatise on Electricity and Magnetism`, Volume I after the current public source-checked tranches: IA 1873 first-edition pp.001-044 plus earlier book pages 95-101, 103, 105, 109, and continuous pp.111-267. The next local continuation is printed p.045; keep future public updates compact and ledger-governed, and do not merge broad OCR-derived Maxwell material into source-checked claims. | [Maxwell record](https://zenodo.org/records/20659236) |
