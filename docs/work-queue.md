...
| Noether | Continue source checking and multilingual translation branches from the curated numbered-paper corpus; carry RA23 display-layout fixes and RA25/RA26 Paper 02 source-critical corrections forward, finish Paper 02 from §25 at p83 bottom/p84, then p84-p90/table plates, propagate RA12-RA27 symbol corrections across EN/ES/JA/FR/ZH, and run a full symbol audit beyond Paper 01. | [Noether record](https://zenodo.org/records/20668796) |
...
| Bianchi | Verify Vol. I formulas, references, terminology, and index entries against the source witness. For A2, use `Bianchi_A2_cont_p0001_0090_IT_EN_20260612.zip` as the latest continuation layer through p0090, then continue from p0091 after section 22; keep older witness/intake layers as provenance, not authority. | [Bianchi record](https://zenodo.org/records/20668784) |
| Gordan / Clebsch-Gordan | Continue `Theorie der Abelschen Functionen` after source p.291 / printed p.269. Use Abel21 and `Gordan_AllPrior_AuditFix01_20260610.zip` as the current correction/provenance layers; next handoff is source p292 / printed p270, Elfter Abschnitt / §77. | [Gordan record](https://zenodo.org/records/20667319) |
