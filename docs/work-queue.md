...
| Maxwell / old physics | Convert the Maxwell `Treatise on Electricity and Magnetism` work into a compact reader tranche only after separating source-checked pages from the broad OCR-derived draft. Current local staging has a first-edition restart through early Vol. I pages and selected later Vol. I repairs, but the broad Vol. I/II draft still has LaTeX errors, figure/table gaps, and OCR-derived regions. | [Additional author cluster](https://zenodo.org/records/20651148) |
