...
| Gordan / Clebsch-Gordan | Continue Abelsche Functionen from source p.122 / printed p.100 at the section 28 table; use the p089-121 auditfix as the current correction layer for the previous Abel range, and verify the complete/latest De linea geodetica and Formensystem packets against bundled source witnesses. | [Gordan record](https://zenodo.org/records/20617198) |
