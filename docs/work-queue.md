...
| Weber | Continue the English translation of Lehrbuch der Algebra beyond the current Volume II draft surface. | [Weber record](https://zenodo.org/records/20650823) |
...
| Bianchi | Verify Vol. I formulas, references, terminology, and index entries against the source witness. For A2, use `Bianchi_A2_cont_p0001_0066_IT_EN_20260611.zip` as the preferred current layer, then continue from the section 13 handoff at p0066/p0067; keep older witness/intake layers as provenance, not authority. | [Bianchi record](https://zenodo.org/records/20650630) |
...
| Additional authors | Check the selected drafts for wrapper removal, title accuracy, and source alignment before splitting into more complete author records. Bianchi, Gordan, Steinitz, Sylvester, and Gibbs now have standalone records; the mixed shelf still needs Poincare, Frobenius, Kneser, Mikami, Kronecker/Kron, Picard, Klein-Fricke, Maxwell, and related tranches triaged by package-level caveats. Current routed tranches include `Kneser_LVR_hqfig_p0158_0177_DE_EN_20260611.zip` as the preferred figure/source-witness repair for Kneser p0158-p0177 / §§37-39, `Frobenius_all_GE_EN_cum_scans_20260611.zip` for the selected Frobenius sequence, Poincare v1_19, and prior Frobenius/Kneser/Poincare support packets. | [Additional author cluster](https://zenodo.org/records/20650905) |
