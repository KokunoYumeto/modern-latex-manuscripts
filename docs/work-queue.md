...
| Gordan / Clebsch-Gordan | `Theorie der Abelschen Functionen` is carried through the authorial ending in the published `Gordan_Abel27_p343_355_DE_EN_20260612.zip`; source pp.356-362 are blank/end/cover scan witnesses. Local staging now also has `Gordan_Abelsche_FinalAuditFix02_DE_EN_20260613.zip`, reporting a final recursive Abelsche audit/fix and the §91 `w_k^{(h)}` correction, plus `Gordan_de_linea_p025_047_final_LA_EN_scans_20260613.zip`, reporting Latin/English working coverage for `De linea geodetica` through p001-p047; upload and catalog regeneration remain pending. Next work is upload, catalog refresh, reader-facing extraction, or further non-Abelsche Gordan branches. | [Gordan record](https://doi.org/10.5281/zenodo.20616260) |
