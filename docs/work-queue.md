...
| Additional authors | Check the selected drafts for wrapper removal, title accuracy, and source alignment before splitting into more complete author records. Bianchi, Gordan, Steinitz, Sylvester, and Gibbs now have standalone records; the mixed shelf still needs Poincare, Frobenius, Kneser, Mikami, Kronecker/Kron, Picard, Klein-Fricke, Maxwell, and related tranches triaged by package-level caveats. Poincare v1_18, Kneser p0139-p0158, Frobenius 070 p016-p034, and Frobenius 071 are the current routed tranches. | [Additional author cluster](https://zenodo.org/records/20650182) |
