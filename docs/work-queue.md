...
| Maxwell / old physics | Continue `A Treatise on Electricity and Magnetism`, Volume I after the current ledger-backed source-checked working tranches: book pages 95-101, 103, 105, 109, and continuous pp.111-267. Keep future public updates compact and ledger-governed; do not merge broad OCR-derived Maxwell material into source-checked claims. | [Maxwell record](https://zenodo.org/records/20653108) |
