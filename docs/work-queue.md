...
| Noether | Continue source checking and multilingual translation branches from the curated numbered-paper corpus; carry RA23 display-layout fixes and RA25-RA42/P06/P07 source-critical corrections forward, run final Paper 02 tag/layout inventory, propagate source corrections across EN/ES/JA/FR/ZH where applicable, and run a full symbol audit beyond Paper 01. RA37 is locally staged for Paper 04 pp.122-127 and reports restoration of an omitted determinant-product display in formula (8); RA40 is locally staged for Paper 04 pp.140-145 and reports Paper 04 printed pp.118-145 checked, 28/38 source pages closed, and six source-symbol/display corrections; RA41 closes Paper 04 pp.118-154 at the current German source-symbol standard; RA42 supplies Paper 05 source/witness material and flags one RA41 cumulative title-footnote integration defect; targeted Paper 06 and Paper 07 audits flag source-style symbolic footnotes versus numeric TeX footnotes. These are queued for Zenodo upload and are not yet in the public file catalog. | [Noether record](https://doi.org/10.5281/zenodo.20412587) |
