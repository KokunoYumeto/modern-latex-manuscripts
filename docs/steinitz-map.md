...
The controls still name two author-corpus gaps: the 1906 Euler-polyhedron note
and the 1908 *Beiträge zur Analysis Situs*. No 1913, 1914, or 1916 work is in
this bounded GitHub selection, regardless of descriptions maintained on other
...
6. Add the missing 1906 and 1908 works as distinct bounded generations; do not infer later Steinitz works are already in GitHub.
