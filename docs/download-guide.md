...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21420665](https://doi.org/10.5281/zenodo.21420665). Open the German R823 source-control PDF for source state, or the directly exposed 473-page Spanish PDF for the Spanish reader. File `10` contains Spanish TeX, exact authority, parity/build/hash/QA evidence; file `09` groups twelve bounded R823 English components plus CJK/Korean and Slavic units; file `08` retains the Paper 06 Slavic tranche. Treat compilation and audit packets as evidence, not universal synchronization, native-language certification, paper-by-paper certification, or critical-edition status. |
