...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21431982](https://doi.org/10.5281/zenodo.21431982). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German R823/Paper 30 source-control readers; or the direct bounded Paper 3/4/26-29/36 readers. Paper 4 files `01b`-`01d` cover only the Introduction/Postscript and Sections 1-2; Section 3 / R823 line 3730 is next. File `19` carries their exact editable evidence; file `16` carries Paper 3/27-29 evidence; file `17` carries the complete 3,024-image visual-evidence body; file `11` carries all 442 current Interslavic units and the final audit; files `14` and `15` carry French and Paper 30 evidence. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, or critical-edition status. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21431745](https://doi.org/10.5281/zenodo.21431745). Open the 309-page SGA5 English source-synchronized default reader, then its compact support ZIP, the four-page SGA1 checkpoint through Expose I section I.2, and the 377-page layered SGA6 reader reconciled through idx684. A compact privacy-clean SGA6 support ZIP is now present. French idx684 and bounded Spanish SGA6 checkpoints remain available. |
