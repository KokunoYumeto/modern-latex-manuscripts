...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21707869](https://doi.org/10.5281/zenodo.21707869). Download the leading `00_Current_SGA1-6_English_Readers_and_Buildable_TeX_20260730.zip` once for all six cumulative reader PDFs and their complete TeX closures, or open direct PDFs `00a` through `00f`. The complete 262-page SGA1 reference-v2 R2 reader remains the default preview. The clean 1,470-page SGA3 R29 reader is direct and also packaged with its complete buildable TeX closure in a 918-member ZIP. A separate 163-page SGA7 source-transcription checkpoint covers complete Exposes I, II, VI, VII, and VIII. Anonymous readback passed all 71 outer files, all 1,394 leading-bundle members, all 918 SGA3 source-package members, all 10 SGA7 source-package members, and all 12 current release-control members; 67 predecessor files remain byte-identical. SGA3 is not final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered; SGA7 is partial and is not an English translation. |
