...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21419257](https://doi.org/10.5281/zenodo.21419257). Open the 466-page v26/R823 German source-control PDF first. File `09` groups bounded R823-synchronized English, CJK/Korean, and Slavic components; file `08` retains the Paper 06 Slavic working tranche. Treat compilation and audit packets as evidence, not complete synchronization, language certification, paper-by-paper certification, or critical-edition status. |
