...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21432199](https://doi.org/10.5281/zenodo.21432199). Open the 309-page SGA5 English source-synchronized default reader, then its compact support ZIP, the six-page SGA1 checkpoint through Expose I section I.3, and the 377-page layered SGA6 reader reconciled through idx684. A compact privacy-clean SGA6 support ZIP is present. French idx684 and bounded Spanish SGA6 checkpoints remain available. |
