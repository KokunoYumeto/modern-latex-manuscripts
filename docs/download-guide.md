...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21516193](https://doi.org/10.5281/zenodo.21516193). Open the direct English readers in sequence: complete-volume working SGA1 (authoritative preview), complete SGA2 R8, sealed cumulative SGA3 I-IV, standalone native-diagram V, bounded Loop-1 VI-A, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Primary TeX remains direct; twenty-one ZIPs group source, diagrams, QA, bounded checkpoints, predecessor evidence, and seven SGA6 crop/provenance sets. All 46 files and all 11 newly added archive members passed exact readback. The crop archives preserve 1,935 targeted or named high-detail checking images; 1,758 routine page derivatives remain metadata-only. The latest increment covers indices 322-326. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains incomplete because VI-B and VII-XXVI are absent; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
