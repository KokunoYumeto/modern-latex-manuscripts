...
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), cumulative reader PDFs and standalone English paper PDFs first; ZIPs contain TeX/source packages and active Paper 02/Paper 04 source-audit correction packets. Locally staged German source-audit support ZIPs plus Paper 05, Paper 06, Paper 07, Paper 08, Paper 16, Paper 18, Paper 19, Paper 20, and RA43 Paper 06 web drops add RA/source ledgers, high-DPI witnesses, OCR/Markdown locator material, Paper 08/Paper 16/Paper 18/Paper 19/Paper 20 math/source corrections, and Paper 06-08 source-style footnote-marker issues, but are not public Zenodo files until the next upload succeeds. |
