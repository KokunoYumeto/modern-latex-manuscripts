...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), latest version [10.5281/zenodo.21421508](https://doi.org/10.5281/zenodo.21421508). Open the 309-page SGA5 English working translation first. The four-page SGA6 Spanish Exposé X idx532-537 PDF is separately readable; file `05` contains its TeX, direct source witnesses, ledgers, hashes, build evidence, and render checks. Use the retained SGA5 grouped ZIP for editable TeX, full scan, controls, and QA; use the retained SGA6 files for the French idx662 workpass and older English draft. Serious working editions, not critical editions or whole-volume certification. |
