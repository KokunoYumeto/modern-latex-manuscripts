...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21246462](https://doi.org/10.5281/zenodo.21246462). Open cumulative reader PDFs and standalone English paper ZIP first. Use compact language/source ZIPs and the 06a/06b/06c/06d R787-R804 rollups for TeX, German/source-audit control material, OCR-locator support, and multilingual branches. Treat RA/R/source-audit packets as repair evidence and queue-control, not as separate paper certification. |
