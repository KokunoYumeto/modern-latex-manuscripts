...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21434690](https://doi.org/10.5281/zenodo.21434690). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German source-control readers; or the direct bounded paper readers. Files `01b`-`01i` cover Paper 4 Introduction/Postscript through Section 7; Section 8 / R823 line 4270 is next. The version also exposes Japanese Papers 21 and 23, Korean Paper 29 U01-U04, and Chinese Paper 37 in PRC-oriented Simplified Chinese and controlled generic Traditional Chinese. Files `47`, `48`, and `51` carry the newest source/evidence packages; file `49` carries 53 open project renders and metadata-only records for 79 rights-blocked source-derived rasters. File `17` retains the earlier 3,024-image body. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, rights clearance, or critical-edition status. |
| Weber | [Weber record](https://doi.org/10.5281/zenodo.20412153), latest public version [10.5281/zenodo.21402223](https://doi.org/10.5281/zenodo.21402223). Open the current German Volume I p88 workpass first as readable modernized/summarized working material; its grouped ZIP carries TeX, ledgers, exact diff, source pages/crops, and render checks. The English Volume I PDF predates the latest German repairs. Volume II reaches §176; Volume III is an incomplete repaired cumulative, not a finished v3. All three volumes are incomplete, and none is source-critical; SGA's bounded source-audit work is substantially closer to source. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21435547](https://doi.org/10.5281/zenodo.21435547). Open the 309-page SGA5 English source-synchronized default reader, then the ten-page SGA1 checkpoint through Exposé I §I.6, the separate complete bounded SGA2 Exposé V and VI readers, and the 377-page layered SGA6 reader reconciled through idx684. All eight reader PDFs have matching direct TeX downloads: SGA1 English; SGA2 Exposés V and VI English; SGA5 French and English; and SGA6 French, English, and the bounded Spanish Exposé X tranche. Privacy-clean ledgers and 37 project renders remain grouped. SGA1 continues at French line 1217 / §I.7; SGA2 continues at line 2274 / Exposé VII. Record rights are `License Not Specified`; none is a complete volume or critical edition. |
