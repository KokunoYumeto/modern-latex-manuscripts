...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21647537](https://doi.org/10.5281/zenodo.21647537). Open the six direct English readers in sequence: complete-volume working SGA1 (default preview), complete SGA2 R8, the 1,434-page SGA3 current-progress cumulative, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete reference-linked SGA6. Eight bounded native-diagram SGA3 readers, now including Exposé XIII, and their primary TeX are also direct. Fifty-seven ZIPs group source, diagrams, QA, bounded checkpoints, predecessor evidence, and SGA6 visual-provenance sets. All 92 files and all 5,563 ZIP file members passed exact anonymous readback. The public SGA3 cumulative integrates the Editorial Notice, Introduction, Exposés I-XXIII and XXV-XXVI, terminal bibliography, and Tome III index, with explicit Tome III guide and Exposé XXIV gaps. A separate 1,492-page Loop-1 integration remains held. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
