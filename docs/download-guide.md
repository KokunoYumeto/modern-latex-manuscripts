...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21514656](https://doi.org/10.5281/zenodo.21514656). Open the direct English readers in sequence: complete-volume working SGA1 (authoritative preview), complete SGA2 R8, sealed cumulative SGA3 I-IV, standalone native-diagram V, bounded Loop-1 VI-A, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Primary TeX remains direct; fourteen ZIPs group source, diagrams, QA, bounded checkpoints, and predecessor evidence. All 39 files and the new VI-A archive's 60 members passed exact readback. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains incomplete because VI-B and VII-XXVI are absent; VI-A native diagrams and exhaustive reference certification remain open; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition or blanket rights determination. |
