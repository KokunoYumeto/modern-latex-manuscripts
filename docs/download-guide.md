...
| EGA working and support lanes | [EGA current version](https://doi.org/10.5281/zenodo.21715531) retains the 125-member clean ZIP containing all five current cumulative English reader PDFs and their complete buildable TeX closures. EGA0 remains the record preview. EGA 0 through Section 13, EGA I through authority EOF, EGA II through authority EOF, and the complete published EGA III text through 7.9.14 are reference-v2 working readers; the direct cumulative EGA IV reader remains partial through Sections 1-10. Archive 02e adds bounded Sections 16-18; direct PDF 00f and archive 02f add bounded Sections 19-21 plus Part 4 backmatter. Eleven later-numbered ZIPs contain 989 actual high-detail EGA IV source-image witnesses continuously across printed pages 5-336. |
