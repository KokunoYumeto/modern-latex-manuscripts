...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21753102](https://doi.org/10.5281/zenodo.21753102). Download the leading `00_Current_SGA1-7_English_Readers_and_Buildable_TeX_20260801.zip` once for the current complete SGA1-7 I English readers and buildable TeX, or open the direct PDFs. The direct SGA7 II English reader has 226 pages through Exposé XXI §4 and its bibliography and a 160-member reader/TeX ZIP; two optional source-image ZIPs preserve high-resolution translated-scope witnesses. It is incomplete; the Exposé XXI §5 appendix and later English scope remain. SGA1 stays the preview until an exact internally linked global SGA reader is delivered and replayed. |
...
| EGA working readers | [EGA current version](https://doi.org/10.5281/zenodo.21744406) fronts the continuous 1,356-page linked EGA 0-IV reader. Open it for the full sequence, open one of the five direct standalone readers, or download the leading 265-member ZIP for all six PDFs and complete buildable TeX. Supporting source and QA archives remain in the full file list rather than the reader guide. |
