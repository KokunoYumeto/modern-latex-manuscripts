...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21246784](https://doi.org/10.5281/zenodo.21246784). Open cumulative reader PDFs and standalone English paper ZIP first. Use compact language/source ZIPs, the 06a/06b/06c/06d R787-R804 rollups, and file 07 for the R804 integrated v11 German/source-control head, TeX, audit control material, OCR-locator support, and multilingual branches. Treat RA/R/source-audit packets as repair evidence and queue-control, not as separate paper certification. |
