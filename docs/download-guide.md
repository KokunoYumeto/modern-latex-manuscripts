...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21418246](https://doi.org/10.5281/zenodo.21418246). Open the 466-page v26/R822 German source-control PDF first. File `08` is the Paper 06 Slavic working tranche; use its TeX, source slices, ledgers, and checksums for continuation. Treat compilation and audit packets as evidence, not language certification, paper-by-paper certification, or critical-edition status. |
