...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21750586](https://doi.org/10.5281/zenodo.21750586). Download the leading `00_Current_SGA1-7_English_Readers_and_Buildable_TeX_20260801.zip` once for the current complete SGA1-7 I English readers and buildable TeX, or open the direct PDFs. The direct SGA7 II English reader has 212 pages through Exposé XX §4.3 and a 148-member reader/TeX ZIP; two optional source-image ZIPs preserve the high-resolution translated and preparatory witnesses. It is incomplete; §4.4 and later English scope remain. SGA1 stays the preview until an exact internally linked global SGA reader is delivered and replayed. |
