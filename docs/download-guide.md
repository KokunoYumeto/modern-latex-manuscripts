...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21247333](https://doi.org/10.5281/zenodo.21247333). Open the R805 German/source-control PDF, cumulative reader PDFs, and standalone English paper ZIP first. Use compact language/source ZIPs, the 06a/06b/06c/06d R787-R804 rollups, file 07 for the preserved R804 integrated v11 source-control package, and file 08 for the R805 Paper 19 p57 E-family correction packet. Treat RA/R/source-audit packets as repair evidence and queue-control, not as separate paper certification. |
| Weber | [Weber record](https://doi.org/10.5281/zenodo.20412153), Volume I first; Volume II readers through §176 plus recursive repair packets through public Batch137/B138/B139. Latest public version <https://doi.org/10.5281/zenodo.20837104> reports the active 112-row ledger at 112/112 closed via Batch137, then adds focused Batch138 and B139 post-closure/off-ledger repairs. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), the current reader PDFs first, then the audit/source ZIPs. This is serious active repair material, especially for SGA5, but not complete or globally source-faithful. |
