...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21433750](https://doi.org/10.5281/zenodo.21433750). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German R823/Paper 30 source-control readers; or the direct bounded paper readers. Files `01b`-`01h` cover Paper 4 Introduction/Postscript through Section 6; Section 7 / R823 line 4112 is next. The version also exposes Japanese Paper 23, Korean Paper 29 U01-U03, and Chinese Paper 37 in PRC-oriented Simplified Chinese and controlled generic Traditional Chinese. Files `26`-`29`, `34`, and `36` carry exact editable/evidence packages; files `30`-`32`, `35`, `37`, and `40` carry twenty-two open project-generated renders while rights-blocked or control-only pixels remain metadata-only. File `17` retains the 3,024-image body. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, rights clearance, or critical-edition status. |
