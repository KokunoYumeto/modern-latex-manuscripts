...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21694014](https://doi.org/10.5281/zenodo.21694014). Open the six neutral-named direct English readers in sequence: `00a` SGA1 (default preview), `00b` SGA2 R9, `00c` the 1,474-page SGA3 R23 cumulative, then `00d` SGA4, `00e` SGA5, and `00f` SGA6. Historical readers, source, QA, and predecessor objects are grouped behind ZIPs instead of appearing on the direct shelf. All 66 files and all 4,253 non-directory ZIP members passed exact anonymous readback. All eight direct PDFs omit project production, model, workflow, source-status, correction-history, and comparison-lineage commentary while retaining genuine source-era editorial apparatus. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains a heterogeneous working integration rather than final diagram-fidelity closure; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
