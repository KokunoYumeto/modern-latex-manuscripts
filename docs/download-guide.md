...
| Serre FAC and GAGA | [Serre record](https://doi.org/10.5281/zenodo.21720996), current version [10.5281/zenodo.21720997](https://doi.org/10.5281/zenodo.21720997). Open the default 54-page FAC French working reader first; its master/body TeX are direct. The FAC ZIP contains the complete delivered source/evidence closure plus four actual source-scan crops used during checking. FAC covers 70/82 printed pages and names all twelve gaps. The separate GAGA ZIP contains the complete first-pass TeX source for printed pp.1-42; no GAGA PDF is fronted because the existing build visibly typesets page-join sentinels. |
