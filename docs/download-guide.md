...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21512567](https://doi.org/10.5281/zenodo.21512567). Open the direct English readers in sequence: complete-volume working SGA1 (initial preview), complete SGA2 R8 (second), sealed cumulative SGA3 I-IV plus standalone native-diagram V, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Primary TeX remains direct; thirteen ZIPs group source, diagrams, QA, bounded checkpoints, and predecessor evidence. The I-IV archive has 199 exact members and introduces no new source-pixel class. Expose V remains byte-identical and rights-curated. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains incomplete after V; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition or blanket rights determination. |
