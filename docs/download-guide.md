...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21703611](https://doi.org/10.5281/zenodo.21703611). Download the leading `00_Current_SGA1-6_English_Readers_and_Buildable_TeX_20260730.zip` once for all six cumulative reader PDFs and their complete TeX closures, or open direct PDFs `00a` through `00f`. The complete 262-page SGA1 reference-v2 R2 reader remains the default preview. The 1,394-member bundle, privacy-clean 180-member SGA1 source ZIP, seven release controls, all 67 outer files, and all 65 retained predecessor files passed anonymous readback. SGA3 remains a heterogeneous working integration rather than final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered. |
