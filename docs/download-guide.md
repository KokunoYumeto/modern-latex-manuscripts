...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21636270](https://doi.org/10.5281/zenodo.21636270). Open the six direct English readers in sequence: complete-volume working SGA1 (default preview), complete SGA2 R8, the 1,100-page SGA3 current-progress cumulative with complete working bodies I-XVI and XVIII plus partial XVII, XX, and XXII, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete reference-linked SGA6. Primary TeX remains direct; forty-eight ZIPs group source, diagrams, QA, bounded checkpoints, predecessor evidence, and SGA6 visual-provenance sets. All 67 files and all 4,319 ZIP file members passed exact anonymous readback. SGA3 is explicitly incomplete: XIX, XXI, and XXIII-XXVI are gaps, while XVII, XX, and XXII end at visible partial boundaries; translated scopes retain their stated diagram/reference caveats. The newest SGA6 increment preserves 68 high-detail crops actually opened during idx653-665 audit and records 13 unread alternatives plus 65 routine bands as rights-blocked metadata; prior tranches remain exact. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
