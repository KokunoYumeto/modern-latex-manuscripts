...
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), cumulative reader PDFs and standalone English paper PDFs first; ZIPs contain TeX/source packages and active Paper 02/Paper 04 source-audit correction packets. Locally staged German source-audit support ZIPs plus Paper 05, Paper 06, Paper 07, Paper 19, and Paper 20 web drops add RA/source ledgers, high-DPI witnesses, OCR/Markdown locator material, one Paper 05 cumulative-integration fix request, Paper 06-07 source-style footnote-marker issues, Paper 19 tail element-divisor/source-order corrections, and one Paper 20 formula (13) factor-sum index correction, but are not public Zenodo files until the next upload succeeds. |
