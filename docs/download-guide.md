...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21394234](https://doi.org/10.5281/zenodo.21394234). Open the 466-page v26/R821 German source-control PDF first, then the retained English/multilingual working readers. Use the grouped TeX/source/audit packages for checking. Treat R/RA/source-audit packets as repair evidence, not paper-by-paper certification or critical-edition status. |
