...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), current compact version [10.5281/zenodo.21699405](https://doi.org/10.5281/zenodo.21699405). Open the default 459-page full cumulative English working reader or its directly exposed master TeX first. German, Spanish, French, and paired Interslavic readers also remain direct downloads. Nine coherent ZIPs group bounded CJK and other-language work, current source-control material, repair evidence, visual evidence, and predecessor maps. The latest successor retained 19 files byte-identically and replaced source-audit archive 61 with a 132-member repair-survivor package; all 20 outer files and all 132 replacement members passed anonymous readback. Treat the corpus and evidence as working translation/source-control material, not universal synchronization, native/community certification, whole-corpus source certification, accessibility certification, rights clearance, or a critical edition. |
| Noether/CJK visual evidence | [Dedicated dataset](https://doi.org/10.5281/zenodo.21499950), current record [10.5281/zenodo.21499951](https://doi.org/10.5281/zenodo.21499951). Download the single image ZIP for 290 public-safe visual-evidence and render-QA images; read `README_DATASET.md`, `VALIDATION.json`, and `DATASET_MANIFEST.csv` first. Fourteen rights-blocked images are metadata-only, 1,716 non-project dependency images are excluded, and one inherited malformed contact-sheet PNG is retained as explicit adverse evidence. This supplements the Noether and methodology records; it is not a reader, translation, source-fidelity or mathematical certification, native-language review, or blanket rights determination. |
| Weber | [Weber record](https://doi.org/10.5281/zenodo.20412153), latest public version [10.5281/zenodo.21728241](https://doi.org/10.5281/zenodo.21728241). Open the default 420-page German Volume I working reader first; its editable TeX is direct and one compact ZIP carries the reader/source/QA closure. Volume I covers the body through Section 188 and the printed errata. Its stricter cold page-by-page pass reaches printed p124 with p125 next, so this is a complete working reader rather than a full symbol-by-symbol recertification. The older English Volume I PDF is unsynchronized; Volume II reaches Section 176; Volume III remains an incomplete repaired cumulative. These are useful working reconstructions, not source-critical or critical editions. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21782424](https://doi.org/10.5281/zenodo.21782424). Download the leading 152-member R3 reader/source ZIP once, or open the 4,179-page cumulative English reader selected as the default preview. Nine direct standalone readers, nine masters, nine source ZIPs, current logbooks, graph ledgers, and exact controls follow. The reader PDFs contain mathematics and source-era apparatus rather than workflow/status prose. |
...
| EGA working readers | [EGA current version](https://doi.org/10.5281/zenodo.21780931) fronts the continuous 1,356-page linked EGA 0-IV reader. Open it for the full sequence, open one of the five direct standalone readers, or download the leading 265-member ZIP for all six PDFs and complete buildable TeX. The later file slots add exact EGA I diplomatic-French/paired-English source custody through printed p.127, its pre-Stacks scaffold, logbooks, decision/error ledgers, validator, and provenance package. |
| Serre FAC source custody | [Mixed Serre custody record](https://doi.org/10.5281/zenodo.21720996), version [10.5281/zenodo.21721854](https://doi.org/10.5281/zenodo.21721854), preserves the 63-page FAC French working transcription, editable TeX, its 27-member source/evidence ZIP, and the earlier GAGA first-pass source closure. Use this for preservation history rather than as the current GAGA reader. |
| FAC quality evidence | [Surviving unified FAC concept](https://doi.org/10.5281/zenodo.21720996), version [10.5281/zenodo.21781714](https://doi.org/10.5281/zenodo.21781714). Start with `00_FAC_Blind_Comparison_Readable_Report.pdf`, then the 78-page complete reader, frozen 74-page blind reader, 79 unit reviews, 138 findings, logbooks, reversals, and complete source/evidence ZIP. Nos.1-79 predate discovery of Achinger-Krupa; nos.80-81 do not belong to the blind claim. The redundant concept 21779392 is tombstoned. |
| Serre GAGA | [Dedicated pure-GAGA concept](https://doi.org/10.5281/zenodo.21781322), version [10.5281/zenodo.21781323](https://doi.org/10.5281/zenodo.21781323). The complete privacy-clean package ZIP is first and the clean 26-page linked English reader is the default preview. Direct English TeX, diplomatic and corrected French TeX, logbooks, decision/correction/reversal ledgers, reference graph, validators, and reproduction tools follow. All 62 files and all 62 ZIP members passed anonymous readback. |
