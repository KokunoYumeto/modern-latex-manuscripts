...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21434076](https://doi.org/10.5281/zenodo.21434076). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German R823/Paper 30 source-control readers; or the direct bounded paper readers. Files `01b`-`01h` cover Paper 4 Introduction/Postscript through Section 6; Section 7 / R823 line 4112 is next. The version also exposes Japanese Papers 21 and 23, Korean Paper 29 U01-U04, and Chinese Paper 37 in PRC-oriented Simplified Chinese and controlled generic Traditional Chinese. Files `26`-`29`, `34`, and `36` carry exact editable/evidence packages; files `30`-`32`, `35`, `37`, `40`, `43`, and `45` carry twenty-eight open project-generated renders while rights-blocked or control-only pixels remain metadata-only. File `17` retains the 3,024-image body. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, rights clearance, or critical-edition status. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21432714](https://doi.org/10.5281/zenodo.21432714). Open the 309-page SGA5 English source-synchronized default reader, then its compact support ZIP, the six-page SGA1 checkpoint through Expose I section I.3, and the 377-page layered SGA6 reader reconciled through idx684. Privacy-clean SGA6 support is present; the obsolete path-bearing SGA5 archive is absent from this latest surface. French idx684 and bounded Spanish SGA6 checkpoints remain available. |
