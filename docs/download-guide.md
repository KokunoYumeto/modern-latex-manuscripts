...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21637870](https://doi.org/10.5281/zenodo.21637870). Open the six direct English readers in sequence: complete-volume working SGA1 (default preview), complete SGA2 R8, the 1,182-page SGA3 current-progress cumulative with complete working bodies I-XVIII and XX plus partial XXI and XXII, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete reference-linked SGA6. Primary TeX remains direct; forty-eight ZIPs group source, diagrams, QA, bounded checkpoints, predecessor evidence, and SGA6 visual-provenance sets. All 67 files and all 4,399 ZIP file members passed exact anonymous readback. SGA3 is explicitly incomplete: XIX and XXIII-XXVI are gaps, while XXI and XXII end at visible partial boundaries. Exposé XVII is textually complete but its high-zoom diagram pass remains open. Exposé V figures 007-011 have known bottom arrow-label placement defects, with mathematical content intact; final diagram-fidelity closure remains open. SGA6 visual-provenance tranches remain exact. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
