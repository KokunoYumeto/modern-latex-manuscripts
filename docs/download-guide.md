...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21677179](https://doi.org/10.5281/zenodo.21677179). Open the six clean direct English readers in sequence: complete-volume working SGA1 (default preview), complete SGA2 R8, the 1,460-page SGA3 R18 cumulative, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete reference-linked SGA6. The SGA3 cumulative covers the Editorial Notice, Introduction, Exposés I-XXVI, Tome-I index, Tome-III mathematical guide, and terminal index. Historical bounded SGA3 readers and predecessor objects are grouped behind ZIPs instead of appearing on the direct reader shelf. Forty-nine ZIPs group source, diagrams, QA, bounded checkpoints, predecessor evidence, and SGA6 visual-provenance sets. All 68 files and all 4,235 ZIP file members passed exact anonymous readback. The direct SGA1, SGA2, SGA3, and SGA5 readers omit 351 reader-facing production, source-status, translator-process, and model-facing apparatus items while retaining edition-authored notes. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains a heterogeneous working integration rather than final diagram-fidelity closure; SGA4half remains rights-held. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
