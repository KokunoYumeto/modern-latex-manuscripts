...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), cumulative reader PDFs and standalone English paper PDFs first. Use compact language/source ZIPs for TeX, German/source-audit control material, and multilingual branches. Treat the many RA/R/source-audit packages as repair evidence and queue-control, not as separate paper certification. |
