...
| EGA working and support lanes | [EGA current version](https://doi.org/10.5281/zenodo.21713359) retains the 125-member clean ZIP containing all five current cumulative English reader PDFs and their complete buildable TeX closures. EGA0 remains the record preview. EGA 0 through Section 13, EGA I through authority EOF, EGA II through authority EOF, and the complete published EGA III text through 7.9.14 are reference-v2 working readers; EGA IV remains partial through Sections 1-10. Eight later-numbered ZIPs contain 818 actual high-detail EGA IV source-image witnesses from printed pages 5-155 and 185-281; pages 156-184 are not represented. |
