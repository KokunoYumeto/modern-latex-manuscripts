...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21704696](https://doi.org/10.5281/zenodo.21704696). Download the leading `00_Current_SGA1-6_English_Readers_and_Buildable_TeX_20260730.zip` once for all six cumulative reader PDFs and their complete TeX closures, or open direct PDFs `00a` through `00f`. The complete 262-page SGA1 reference-v2 R2 reader remains the default preview. The clean 1,470-page SGA3 R29 reader is direct and also packaged with its complete buildable TeX closure in a 918-member ZIP. Anonymous readback passed all 68 outer files, all 1,394 bundle members, all 918 SGA3 source-package members, all 32 SGA3 QA members, and all nine release controls; 62 predecessor files remain byte-identical. SGA3 is not final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered. |
...
| EGA working and support lanes | [EGA current version](https://doi.org/10.5281/zenodo.21706639) begins with one 99-member clean ZIP containing one cumulative reader PDF and complete TeX closure for every current EGA scope. EGA0 remains the record preview; EGA II is complete through authority EOF and reference-v2 closed, while EGA0, EGA III, EGA IV, and the wider corpus remain partial or non-uniform. |
