...
| Weber | [Weber record](https://zenodo.org/records/20650399), Volume I first; later volumes are in progress |
| Noether | [Noether record](https://zenodo.org/records/20643913), cumulative German/English and multilingual reader PDFs first |
| Bianchi | [Bianchi record](https://zenodo.org/records/20650630), English or Italian Vol. I reader first; for A2 use `Bianchi_A2_cont_p0001_0066_IT_EN_20260611.zip` as the preferred continuation through p0066, with older HQ/audit ZIPs retained as provenance/support layers. |
