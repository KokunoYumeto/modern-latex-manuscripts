...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21431041](https://doi.org/10.5281/zenodo.21431041). Open the replacement 309-page SGA5 English source-synchronized reader, then its compact TeX/ledger/render-QA ZIP, the four-page SGA1 checkpoint, and the corrected 381-page layered SGA6 reader. The former SGA6 support ZIP is absent because a wrap-aware audit found reconstructable local paths; the reader itself is unchanged and a privacy-clean replacement is pending. French idx684 and bounded Spanish SGA6 checkpoints remain available. |
