...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21747165](https://doi.org/10.5281/zenodo.21747165). Download the leading `00_Current_SGA1-7_English_Readers_and_Buildable_TeX_20260801.zip` once for the current complete SGA1-7 I English readers and buildable TeX, or open the direct PDFs. The direct SGA7 II English reader has 194 pages through complete Exposé XVIII and a 137-member reader/TeX ZIP. It is incomplete; Exposé XIX and later English scope are absent. SGA1 remains the default preview. |
