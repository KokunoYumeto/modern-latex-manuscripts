...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21429723](https://doi.org/10.5281/zenodo.21429723). Open the default English cumulative working reader; the 473-page Spanish or 494-page French PDFs for those language branches; the 527/551-page PDFs for Interslavic; the German R823/Paper 30 source-control readers; the one-page Indonesian Paper 36 PDF; or the eight direct CJK PDFs for complete Papers 26/36. File `11` carries all 442 current Interslavic TeX/PDF units, Tranches 002A-007, and the final audit; file `15` carries the Paper 30 source-control evidence; file `14` carries the exact French TeX/evidence closure. Treat compilation and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, or critical-edition status. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21429328](https://doi.org/10.5281/zenodo.21429328). Open the 309-page SGA5 English working translation, then the corrected 381-page SGA6 full-range layered English reader. File `06` carries the SGA6 English editable TeX, authority/formula/terminology/page ledgers, build evidence, all-page renders, contact sheets, prefix-repair and correction evidence, hashes, and validation. The 374-page French SGA6 idx684 checkpoint and four-page Spanish SGA6 Exposé X idx532-537 tranche remain available. No current Spanish SGA5 body is included; the two historical July 18 checkpoints are withdrawn pending a canonical rebuild. These are serious working translations and source-repair checkpoints, not critical editions, uniform whole-volume source certification, native-language certification, or whole-SGA completion. |
