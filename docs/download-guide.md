...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21421049](https://doi.org/10.5281/zenodo.21421049). Open the German R823 source-control PDF for source state; the 473-page Spanish PDF for Spanish; or the 529-page Latin-script and 552-page Cyrillic-script PDFs for Interslavic. File `11` contains all 442 current Interslavic TeX bodies and individual PDFs plus normalization/build/render/source evidence; file `10` contains Spanish TeX/evidence; file `09` groups twelve bounded R823 English components plus CJK/Korean/Slavic components. Treat compilation and audit packets as evidence, not universal synchronization, native/community certification, paper-by-paper mathematical certification, or critical-edition status. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), latest version [10.5281/zenodo.21420146](https://doi.org/10.5281/zenodo.21420146). Open the 309-page SGA5 English working translation first. Use its grouped ZIP for editable TeX, the full scan, French/inherited-English controls, ledgers, manifests, build logs, and render QA; use the retained SGA6 files for the French idx662 workpass and older English draft. Serious source-aware working editions, not critical editions or whole-volume certification. |
