...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21430393](https://doi.org/10.5281/zenodo.21430393). Open the 309-page SGA5 English working translation, then the four-page SGA1 Exposé I opening/§I.1 checkpoint and the corrected 381-page SGA6 full-range layered English reader. File `07` carries the SGA1 editable TeX and evidence. The former SGA6 file `06` is absent from the current surface because a wrap-aware audit found reconstructable local paths; the reader PDF itself is unchanged and a privacy-clean support replacement is pending. The French SGA6 idx684 and bounded Spanish SGA6 checkpoints remain available. |
