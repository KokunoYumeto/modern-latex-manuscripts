...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21421559](https://doi.org/10.5281/zenodo.21421559). Open the German R823 source-control PDF for source state; the 473-page Spanish PDF for Spanish; the 529/552-page PDFs for Interslavic; or the fronted one-page Indonesian Paper 36 PDF. File `12` groups Arabic and Iranian Persian Paper 06 opening units plus Indonesian Paper 36 with editable TeX and evidence. Arabic/Persian Paper 06 remain partial. Files `09`-`11` retain the synchronized components, Spanish source/evidence, and complete current Interslavic bodies. Treat compilation and audit packets as evidence, not universal synchronization, native/community certification, paper-by-paper mathematical certification, or critical-edition status. |
...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), corrective version [10.5281/zenodo.21422245](https://doi.org/10.5281/zenodo.21422245). Open the 309-page SGA5 English working translation first, then the corrected 381-page SGA6 full-range layered English reader. This version restores Lemma 5.8.2 footnote 14 omitted from historical version 21421931. File `06` contains the SGA6 editable TeX, authority/formula/terminology/page ledgers, build evidence, all-page renders, contact sheets, prefix-repair and correction evidence, hashes, and validation. The four-page Spanish SGA6 Exposé X idx532-537 PDF remains separately readable with its compact evidence ZIP. Serious working editions, not critical editions, uniform whole-volume source certification, or whole-SGA completion. |
