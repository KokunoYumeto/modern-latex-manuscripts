...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21778810](https://doi.org/10.5281/zenodo.21778810). Download the leading 126-member presentation-clean ZIP once, or open the 4,177-page cumulative English reader selected as the default preview. Nine direct standalone readers, nine masters, nine source ZIPs, and exact controls follow. The reader PDFs contain mathematics and source-era apparatus rather than workflow/status prose. |
...
| FAC quality evidence | [Dedicated FAC concept](https://doi.org/10.5281/zenodo.21779392), version [10.5281/zenodo.21779393](https://doi.org/10.5281/zenodo.21779393). Start with `00_READ_ME_FIRST.md`, then the frozen 74-page blind reader, 78-page complete reader, 79 unit reviews, 138 findings, logbooks, reversals, and source package. Nos.1-79 predate discovery of Achinger-Krupa; nos.80-81 do not belong to the blind claim. |
