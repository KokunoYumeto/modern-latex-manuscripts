...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21696318](https://doi.org/10.5281/zenodo.21696318). Open the six neutral-named direct English readers in sequence: `00a` SGA1 (default preview), `00b` SGA2 R9, `00c` the 1,470-page SGA3 R26 reader-pure cumulative, `00d` the 864-page SGA4 R8 reader-clean successor, `00e` SGA5, and `00f` the 376-page SGA6 R10 reader-pure successor. Historical readers, source, QA, and predecessor objects are grouped behind ZIPs instead of appearing on the direct shelf. All 66 files and all 4,245 ZIP file members passed exact anonymous readback. All eight direct PDFs omit AI, project, workflow, source-status, correction-history, comparison-lineage, and project-written source-reading commentary while retaining genuine source-era editorial apparatus. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains a heterogeneous working integration rather than final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
