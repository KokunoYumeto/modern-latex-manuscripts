...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21422620](https://doi.org/10.5281/zenodo.21422620). Open the German R823 source-control PDF for source state; the 473-page Spanish PDF for Spanish; the 529/552-page PDFs for Interslavic; the one-page Indonesian Paper 36 PDF; or the eight direct CJK PDFs for complete Papers 26/36 in Simplified Chinese, generic Traditional Chinese, Japanese, and Korean. File `09` carries exact CJK TeX/audit evidence; file `12` groups Arabic and Iranian Persian Paper 06 openings plus Indonesian Paper 36. Arabic/Persian Paper 06 remain partial. Treat compilation and audit packets as evidence, not universal synchronization, native/community certification, paper-by-paper mathematical certification, or critical-edition status. |
