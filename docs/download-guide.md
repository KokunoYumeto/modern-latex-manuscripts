...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21432525](https://doi.org/10.5281/zenodo.21432525). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German R823/Paper 30 source-control readers; or the direct bounded paper readers. Files `01b`-`01e` cover Paper 4 Introduction/Postscript through Section 3; Section 4 / R823 line 3839 is next. Files `03q`/`03r` are Chinese Paper 25. Files `21`/`22` carry exact Section 3 and Paper 25 evidence; files `23`/`24` carry Korean Paper 27 and Japanese Paper 24 visual evidence; file `17` retains the 3,024-image body. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, or critical-edition status. |
