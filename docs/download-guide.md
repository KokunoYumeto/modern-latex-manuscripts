...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21511144](https://doi.org/10.5281/zenodo.21511144). Open the direct English readers in sequence: complete-volume working SGA1, complete SGA2 R8 (the default preview), SGA3 through III plus standalone IV and native-diagram V, certified reference-v2 SGA4 proper r7, SGA5 R9, and complete terminal SGA6. Primary TeX remains direct; fourteen ZIPs group source, diagrams, QA, bounded checkpoints, and predecessor evidence. Expose V has 66 native diagram TeX sources and zero PDF image XObjects; 66 source-PDF witness crops are withheld with exact public metadata. SGA1 is substantially linked but not exhaustively convention-v2 certified. SGA3 remains incomplete after V. SGA4 proper r7 covers Exposes I-XIX including V bis and excludes rights-held SGA4half. Record rights are `License Not Specified`; none is a critical edition or blanket rights determination. |
