...
| Interest | Start With |
|---|---|
| Noether | [Noether record](https://doi.org/10.5281/zenodo.20412587), latest public version [10.5281/zenodo.21431458](https://doi.org/10.5281/zenodo.21431458). Open the default English cumulative reader; the Spanish, French, or Interslavic cumulative PDFs; the German R823/Paper 30 source-control readers; or the direct bounded Paper 3/26-29/36 readers. File `16` carries editable Paper 3/27-29 evidence; file `17` carries the complete 3,024-image visual-evidence body; file `11` carries all 442 current Interslavic units and the final audit; files `14` and `15` carry French and Paper 30 evidence. Treat compilation, render, and audit packets as evidence, not universal synchronization, native/community certification, whole-corpus certification, paper-by-paper mathematical certification, or critical-edition status. |
