...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21711433](https://doi.org/10.5281/zenodo.21711433). Download the leading `00_Current_SGA1-6_English_Readers_and_Buildable_TeX_20260730.zip` once for all six cumulative reader PDFs and their complete TeX closures, or open direct PDFs `00a` through `00f`. The complete 262-page SGA1 reference-v2 R2 reader remains the default preview. The clean 1,470-page SGA3 R29 reader is direct and also packaged with its complete buildable TeX closure in a 918-member ZIP. Direct SGA7 files provide the complete working source transcription of all six written SGA7 I exposés in a 267-page reader, editable master, and 12-member reader/source ZIP. Two compact archives contain 12 actually opened high-detail SGA7 source crops and provenance-only metadata for the larger rights-blocked image surface. Anonymous readback passed all 73 outer files, all 12 members of the source ZIP, and all 17 current release-control members; 69 unrelated predecessor files remain byte-identical. SGA3 is not final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered; SGA7 I is not a complete English translation. |
