...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21745704](https://doi.org/10.5281/zenodo.21745704). Download the leading `00_Current_SGA1-7_English_Readers_and_Buildable_TeX_20260801.zip` once for the current complete SGA1-7 I English readers and buildable TeX, or open the direct PDFs. The new direct SGA7 II English reader has 186 pages through Exposé XVIII Corollary 5.8.7 and a 130-member reader/TeX ZIP. It is incomplete; later English scope is absent. SGA1 remains the default preview. |
