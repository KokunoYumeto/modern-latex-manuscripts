...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21720340](https://doi.org/10.5281/zenodo.21720340). Download the leading `00_Current_SGA1-6_English_Readers_and_Buildable_TeX_20260730.zip` once for all six cumulative reader PDFs and their complete TeX closures, or open direct PDFs `00a` through `00f`. The complete 262-page SGA1 reference-v2 R2 reader remains the default preview. The clean 1,470-page SGA3 R29 reader is direct and also packaged with its complete buildable TeX closure in a 918-member ZIP. Direct SGA7 files provide the complete working source transcription of all six written SGA7 I exposés and the bounded 130-page SGA7 II X-XVII working French reader. Grouped archives preserve actual high-detail and recovered-page source pixels, 29 lead-opened SGA7 I/II crops, 260 post-cutoff SGA7 I crops, and the exact SGA7 II Exposé-XVIII boundary crop. SGA3 is not final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered; SGA7 I is not a complete English translation and SGA7 II Exposé XVIII remains incomplete. |
