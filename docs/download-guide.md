...
| SGA | [SGA record](https://doi.org/10.5281/zenodo.20410947), current version [10.5281/zenodo.21700836](https://doi.org/10.5281/zenodo.21700836). Open the six neutral-named direct English readers in sequence: `00a` SGA1 R2 (default preview), `00b` SGA2 R10, `00c` the 1,470-page SGA3 R28 cumulative, `00d` the 864-page SGA4 R8 reader-clean successor, `00e` SGA5, and `00f` the 376-page SGA6 R10 reader-pure successor. SGA3 R28 has 13,132 named destinations, 12,344 valid internal GoTo actions, and exact replay for 3,744/3,744 mapped stable targets. Historical readers, source, QA, and predecessor objects are grouped behind ZIPs instead of appearing on the direct shelf. All 66 files and all 4,250 ZIP file members passed exact anonymous readback. SGA1 is substantially linked but not exhaustively convention-v2 certified; SGA3 remains a heterogeneous working integration rather than final diagram-fidelity closure; SGA4half remains rights-held; SGA6 remains layered. Record rights are `License Not Specified`; none is a critical edition, scan republication, or blanket rights determination. |
