...
- Weber currently has Volume I complete and current public Volume II German/English cumulative readers through §176. Older §143 reader PDFs remain as historical artifacts in the same record; use files prefixed `CURRENT` for the latest Volume II surface. Batch104-Batch132 cover Volume II §§169-176 plus recursive repairs, with Batch132 repairing Volume II §§120 and 128 and reporting the public active 112-row ledger at 73 closed / 39 open. Local pending Batch137 reports the active 112-row ledger at 112/112 closed after Volume I bulk scan-reviewed no-change closures; local pending Batch138 adds a focused Volume II section 6 control-character footnote fix. Off-ledger audit, dense formula sections, section-boundary displays, glyph substitutions, omitted footnotes, and patch-integration candidates remain open. The next linear continuation point follows Volume II §176 at source p643 while recursive/off-ledger audit continues.
