...
Current record: <https://zenodo.org/records/20667338> (concept DOI: <https://doi.org/10.5281/zenodo.20410947>)
...
- SGA5 is now represented by a substantial cumulative French/English working surface, but it is not a scribe-grade or critical edition. The latest promoted repair package is `sga5_sga6_repair020_20260612.zip`: SGA5 French closes concrete source-level diagram defects on source pp.083-086 and p102, including diagrams (2.4.0), (2.4.1), (2.5.1), and the cube repair (4.4.0). SGA6 French is unchanged from the current carried-forward cumulative branch. English remains an unsynchronized carry-forward, not a synchronized branch. Remaining risk is global rather than solved: SGA6 still has substantial compression flags and open v3 worklist rows, and SGA5/SGA6 still need full diagram/exact-symbol inventory, underlined-operator typography outside patched lanes, diagram microgeometry checking, and English synchronization. Subtle errors such as missing or reversed diagram arrows remain plausible outside patched lanes. The SGA witness-aid ZIPs are witness/anchor aids, not promoted replacement text.
...
Weber: <https://zenodo.org/records/20667337>

Noether: <https://zenodo.org/records/20667332>

- Weber currently has Volume I complete and current public Volume II German/English cumulative readers through §176. Older §143 reader PDFs remain as historical artifacts in the same record; use files prefixed `CURRENT` for the latest Volume II surface. Batch104-Batch126 cover Volume II §§169-176 plus recursive repairs including Vol. I §§124, 151, 157, 166, 171, 183 and Vol. II §§6, 14, 16, 17, 20, 21, 52, 57, 58, 60, 61, 71, 77, 81, 99, 101, 106, 114, 118, 126. Batch126 closes the Vol. II §6 footnote patch and Vol. II §§14/16/17 kappa/varkappa symbol patches; V2 §71 p277 is preserved as witness only after adjudication. The active repair ledger reports 28/112 priority rows closed and 84 open, with Tier-3 11/11 closed. The next continuation point follows Volume II §176 at source p643 while the recursive repair lane remains active.
...
Current dedicated record: <https://zenodo.org/records/20667319>

- The dedicated Gordan/Clebsch-Gordan record is now the preferred surface for this lane. The current top continuation package is `Gordan_Abel21_p279_291_DE_EN_20260612.zip`, extending `Theorie der Abelschen Functionen` through source pp.279-291 / printed pp.257-269 and completing the continuation of §74, all §75, and all §76. The next continuation point is source p292 / printed p270, Elfter Abschnitt / §77. Earlier Abel13-Abel20 tranches remain support/provenance layers. `Gordan_AllPrior_AuditFix01_20260610.zip` remains the consolidated checkpoint for De linea, theta, Formensystem, and Abelsche through p121, including the theta FIX05 correction for the `c^8=1` display and wide-display reflow.
