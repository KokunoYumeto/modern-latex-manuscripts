...
- Noether additional 2026-06-14 staging note: RA73 adds a targeted Paper 31 source-author-line/footnote-counter repair, the Paper 32 IA source-witness packet adds compact source/provenance support for printed pp.221-228, and RA74 adds a targeted Paper 32 source-author-block/page-break repair that restores the Brauer/Noether author block and starts Paper 32 on a new rendered page. These are queued working candidates/provenance aids only: not full Paper 31/32 certifications, not critical-edition claims, and not propagated to non-German branches.
