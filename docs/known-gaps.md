...
Current record: <https://zenodo.org/records/20665102> (concept DOI: <https://doi.org/10.5281/zenodo.20410947>)
...
- SGA5 is now represented by a substantial cumulative French/English working surface, but it is not a scribe-grade or critical edition. The latest promoted repair package is `sga5_sga6_repair018_20260612.zip`: SGA5 French closes concrete source-level diagram defects on source pp.030, 031, and 084 using the 179-row diagram micropass aid. SGA6 French is carried forward from the earlier Expose VI repair lane, which restored source pp.391-397 in French from source scans, replacing compressed/non-source material around the projective-bundle K' section. English remains an unsynchronized carry-forward, not a synchronized branch. Remaining risk is global rather than solved: SGA6 still has substantial compression flags and open v3 worklist rows, and SGA5/SGA6 still need full diagram/exact-symbol inventory, underlined-operator typography outside patched lanes, diagram microgeometry checking, and English synchronization. Subtle errors such as missing or reversed diagram arrows remain plausible outside patched lanes. The SGA witness-aid ZIPs are witness/anchor aids, not promoted replacement text.
...
Weber: <https://zenodo.org/records/20665199>

Noether: <https://zenodo.org/records/20665205>

- Weber currently has Volume I complete and current public Volume II German/English cumulative readers through §176. Older §143 reader PDFs remain as historical artifacts in the same record; use files prefixed `CURRENT` for the latest Volume II surface. Batch104-Batch125 cover Volume II §§169-176 plus recursive repairs including Vol. I §§124, 151, 157, 166, 171, 183 and Vol. II §§20, 21, 52, 57, 58, 60, 61, 71, 77, 81, 99, 101, 106, 114, 118, 126. Batch123 closes Vol. II §71, Batch124 closes Vol. I §§166 and 171, and Batch125 closes Vol. I §157 with a rho-notation correction. The active repair ledger reports 24/112 priority rows closed and 88 open. The next continuation point follows Volume II §176 at source p643 while the recursive repair lane remains active.
...
- Noether now has a curated public surface: cumulative reader PDFs, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus the RA23 compact correction package. RA23 fixes a source-critical display-layout/vertical-rule correction class across DE/EN/ES/JA/FR. Chinese was scanned for the same issue and no promoted candidate was found. Open items remain: Paper 02 symbol pass from p.66/p.67 onward, RA12-RA22 symbol-correction propagation across language branches, and a full symbol audit beyond Paper 01.
...
Current dedicated record: <https://zenodo.org/records/20664430>
...
- The 2026-06-12 public surface now includes `Bianchi_A2_cont_p0001_0077_IT_EN_20260612.zip` as the latest A2 continuation layer through p0001-p0077. It restores lower p0066 section-13 material, continues through section 16, and starts Chapter II / section 17. Earlier p0001-p0066 audit/HQ packages remain provenance/support layers.
...
- A2, `Lezioni sulla teoria dei gruppi continui finiti di trasformazioni`, now has an Italian/English working start through source p0001-p0077, about 10 percent of the 731-page source. It covers sections 1-16 and starts Chapter II / section 17; p0078 is the next handoff. A2 is not complete.

## Gordan / Clebsch-Gordan

Current dedicated record: <https://zenodo.org/records/20664425>

- The dedicated Gordan/Clebsch-Gordan record is now the preferred surface for this lane. The current top continuation package is `Gordan_Abel19_p252_270_DE_EN_20260612.zip`, extending Abelsche Functionen through source p270 / printed p248. Abel13 p182-p193 includes the p190 continuation of equation (4), while Abel14, Abel15, and Abel16 continue p194-p227, Abel17 covers p228-p243, and Abel18 covers p244-p251. `Gordan_AllPrior_AuditFix01_20260610.zip` remains the consolidated checkpoint for De linea, theta, Formensystem, and Abelsche through p121, including the theta FIX05 correction for the `c^8=1` display and wide-display reflow.
...
Current record: <https://zenodo.org/records/20664437>
...
- The 2026-06-11 routed sweep consolidation now includes `Frobenius_all_GE_EN_cum_scans_QA03_20260611.zip`, a selected Frobenius sequence cumulative/QA package, and `Kneser_LVR_p0177_0192_DE_EN_20260612.zip`, a Kneser LVR continuation for source p0177-p0192 / sections 40-42 with source-derived crops for Figures 19 and 20. The earlier p0158-p0177 package remains the previous tranche. Older Zenodo versions retain superseded provenance. Prefer the dedicated Bianchi, Gordan, and Steinitz records for their current public surfaces.
