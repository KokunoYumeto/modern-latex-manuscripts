...
- Noether currently has the numbered German/English corpus and active Spanish/Japanese/French/Simplified-Chinese branches. The public Noether record is refreshed through `N_FRZH_Paper17_combined_20260609.zip`, which combines the original P17a package with the original French and zh-Hans Paper 17 §§5-7 continuation package to stay within the Zenodo 100-file limit. Paper 17 §8 is the next FR/ZH continuation point. These FR/ZH files remain checkpoint streams, not complete corpora.
...
Current dedicated record: <https://zenodo.org/records/20615815>

- Bianchi Vol. I is now split into its own reader-facing record, with Italian source transcription, English translation working edition, source scan witness, and TeX/audit ZIP through source pdfpages 001-543.
