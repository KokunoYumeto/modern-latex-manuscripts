...
\bigskip
\noindent This file is a working translation artifact only. It translates the cleaned source text opening material and the start of \S 1; it does not yet claim chapter-complete coverage.

\clearpage

\section*{Translator's note}
This is a working English translation prepared from the cleaned typeset Weber source currently in hand. It covers the group-theory sections §§2--6 of the extracted Weber volume. Mathematical notation has been normalized lightly, but the structure and claims of the source have been preserved.
...
\section*{Translator's note}
This working English translation is prepared from the cleaned typeset Weber source currently in hand. It continues the group-theory opening of the second volume and covers \S\S 7--8 together with the short connecting appendix paragraph. Mathematical notation has been normalized only lightly.
...
\section*{Translator's note}
This working English translation continues the opening Abelian-group chapter of the cleaned Weber source currently in hand. It covers the main part of \S 11 on group characters and the beginning of \S 12 on divisors of an Abelian group and reciprocal groups. I have normalized punctuation and a few notational conventions, but the order of argument is Weber's.
...
\section*{Translator's note}
This working translation continues the Weber line from the start of linear substitutions. Batch 07 translated the definition of linear substitutions, their composition law, and inverse substitutions. The present batch continues with transformed and transposed substitutions, then translates the next two sections on fractional linear substitutions in one variable and permutation groups as linear substitution groups. I have preserved Weber's order of exposition and formulas while lightly regularizing punctuation and notation.
...
\section*{Translator's note}
This batch continues Weber's invariant-theoretic bridge between linear groups and equation theory.  The term ``form problem'' translates \emph{Formenproblem}.
...
\section*{Translator's note}
This batch continues Weber's linear-group chapter and begins the next section on fractional linear substitutions.  The available cleaned source skips from \S 49 to \S 51; this batch translates all sections present in that interval.
