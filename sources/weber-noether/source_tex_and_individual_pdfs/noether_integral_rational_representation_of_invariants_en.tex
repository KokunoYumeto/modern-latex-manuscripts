...
\usepackage{hyperref}
\title{Emmy Noether\\Working English Translation Batch 03\\On Integral Rational Representation of Invariants}
\author{}
\date{}
\begin{document}
\maketitle
...
This working translation is based on the cleaned Noether source currently available in the session. It begins the 1916 paper \emph{Über ganze rationale Darstellung der Invarianten eines Systems von beliebig vielen Grundformen}. I have translated the introductory discussion and the first section, where Noether proves Hilbert's conjectural description of the simultaneous invariants by reducing to the case of \(n\) linearly independent basic forms and their polar derivatives.
