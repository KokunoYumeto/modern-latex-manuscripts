...
\usepackage{hyperref}
\title{Emmy Noether\\Working English Translation Batch 02\\The Finiteness Theorem for the Invariants of Finite Groups}
\author{}
\date{}
\begin{document}
\maketitle
...
This working English translation is prepared from the cleaned typeset Noether source currently in hand. It covers Noether's paper \emph{Der Endlichkeitssatz der Invarianten endlicher Gruppen} (Math.\ Ann.\ 77 (1916), pp.~89--92), as identified in the collected-papers table. Notation has been normalized lightly, but the mathematical content and order of the argument have been preserved.
