...
\begin{tikzpicture}[scale=1.05,line cap=round,line join=round]
  ...
  \draw (0,-2.55) -- (0,1.75);
  \node[rotate=90,anchor=south] at (-0.36,0.55) {Pinch-point};
  \node[rotate=90,anchor=south] at (-0.36,-1.05) {Nodal line};

  \draw[thick] (P) -- (3.85,0.18);
  \node at (1.2,0.27) {axis};

  \draw (0,-2.35) -- (2.25,1.05);
  \node[rotate=58] at (1.05,-1.0) {Ray};
  \draw (0,-2.35) -- (0.88,-0.45);
  \node[rotate=68] at (0.45,-0.78) {Pinch-plane};

  \draw (P) .. controls (0.95,1.05) and (2.15,1.23) .. (3.4,0.25);
  \draw (P) .. controls (0.75,0.82) and (1.85,0.92) .. (2.72,0.55);
  \draw (0,0.08) .. controls (1.1,0.02) and (2.55,0.04) .. (3.25,0.22);

  \foreach \pt in {(0,0.55),(0.72,0.84),(1.08,0.96),(1.50,1.03),(2.18,0.93),
                  (0.70,0.52),(1.05,0.56),(1.55,0.50),(2.05,0.56)} {
    \fill \pt circle (1.6pt);
  }
  \fill (2.0,0.58) circle (1.6pt);
\end{tikzpicture}
\end{center}
