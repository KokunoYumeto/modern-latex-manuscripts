...
\begin{tikzpicture}[scale=0.95,line cap=round,line join=round]
  ...
  \coordinate (b) at (3.0,2.35);
  \coordinate (a) at (0,2.35);
  \coordinate (h) at (0.72,0.72);
  \coordinate (g) at (2.28,0.72);
  \coordinate (f) at (2.28,1.62);
  \coordinate (e) at (0.72,1.62);
  ...
  \node[above] at (1.50,2.38) {$K$};
  \node[right] at (3.07,1.17) {$K$};
  \node[below] at (1.50,-0.05) {$K$};
  \node[left] at (-0.08,1.17) {$K$};
  \node at (1.50,1.96) {$L$};
  \node at (1.50,0.33) {$N$};
  \node at (0.37,1.17) {$P$};
  \node at (2.63,1.17) {$M$};
