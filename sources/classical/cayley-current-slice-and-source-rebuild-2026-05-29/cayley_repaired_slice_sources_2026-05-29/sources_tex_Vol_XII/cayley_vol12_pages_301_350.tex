...
\draw (1.45,0) node[below] {$A$};
\draw (-3.05,0) node[below] {$B$};
\draw[->] (1.45,0) arc[start angle=0,end angle=118,radius=1.95];
\draw (-2.2,1.73) node[left] {$B$};
\draw (0.72,1.66) node[right] {$C$};
\draw (0,0) -- (0,1.62);
\draw (0,1.62) -- ++(-0.08,0.25);
\draw (0.06,1.62) -- ++(0.08,0.25);
\draw (-2.55,0.10) -- ++(-0.32,0.08);
\draw (-2.55,-0.02) -- ++(-0.32,0.00);
\draw (-2.55,-0.14) -- ++(-0.32,-0.08);
\end{tikzpicture}
\qquad
\begin{tikzpicture}[scale=0.78,line cap=round,line join=round]
\node at (0,3.0) {Fig.~2.};
\draw (-2.1,0) -- (2.1,0);
\draw (-1.55,0) arc[start angle=180,end angle=0,radius=1.55];
\draw (0,0) -- (0,1.55);
\fill (-1.55,0) circle (1.2pt) node[below left] {$B'$};
\fill (0,0) circle (1.2pt) node[below] {$O'$};
\fill (1.55,0) circle (1.2pt) node[below right] {$A'$};
\fill (0,1.55) circle (1.2pt) node[above] {$C'$};
\end{tikzpicture}
\end{figure}
...
\node at (0,3.35) {Fig.~3.};
\draw[->] (-4.6,0) -- (4.75,0) node[right] {$x$};
\draw[->] (0,-2.55) -- (0,2.88) node[above right] {$y$};
\draw (-3.05,0) circle (1.8);
\draw (1.65,0) circle (1.8);
\draw (-0.15,0) .. controls (-0.20,0.78) and (0.10,1.25) .. (0.62,1.52)
                 .. controls (1.12,1.76) and (1.55,1.45) .. (1.40,0.90)
                 .. controls (1.25,0.35) and (0.65,0.16) .. (0.16,0.06);
\draw (-0.15,0) .. controls (-0.20,-0.78) and (0.10,-1.25) .. (0.62,-1.52)
                 .. controls (1.12,-1.76) and (1.55,-1.45) .. (1.40,-0.90)
                 .. controls (1.25,-0.35) and (0.65,-0.16) .. (0.16,-0.06);
\draw (0.05,0) ellipse (0.72 and 0.42);
\draw (0.92,0) ellipse (0.84 and 0.52);
\fill (-4.85,0) circle (1.2pt) node[below] {$A'$};
\fill (-0.15,0) circle (1.2pt) node[below left] {$O$};
\fill (0.02,0) circle (1.2pt) node[below right] {$B'$};
\fill (1.45,0) circle (1.2pt) node[below] {$F$};
\fill (1.84,0) circle (1.2pt) node[below] {$B$};
\fill (3.45,0) circle (1.2pt) node[below right] {$A$};
\fill (0.75,1.52) circle (1.2pt) node[above] {$P$};
\fill (1.34,0.55) circle (1.2pt) node[right] {$Q$};
\fill (1.34,-0.55) circle (1.2pt) node[right] {$Q'$};
\fill (0.62,-1.52) circle (1.2pt) node[below] {$P'$};
\end{tikzpicture}
\end{figure}
...
\node at (0,3.15) {Fig.~4.};
\draw (-3.15,0) -- (3.55,0);
\draw (0.55,0) circle (1.55);
\draw (-0.98,0) .. controls (-0.35,1.18) and (0.78,1.28) .. (1.42,0.48)
              .. controls (1.88,-0.12) and (1.42,-0.86) .. (0.62,-0.92)
              .. controls (-0.18,-0.96) and (-0.82,-0.54) .. (-0.98,0);
\draw (-0.25,-1.70) .. controls (0.35,-0.72) and (0.30,0.82) .. (0.20,1.78);
\draw[dashed] (-1.98,1.75) .. controls (-1.18,1.18) and (-1.02,0.45) .. (-0.98,0);
\draw[dashed] (-1.98,-1.70) .. controls (-1.18,-1.10) and (-1.02,-0.42) .. (-0.98,0);
\draw[dashed] (-0.25,1.98) .. controls (0.18,1.52) and (0.28,1.08) .. (0.20,0.72);
\draw[dashed] (-0.25,-1.98) .. controls (0.18,-1.52) and (0.28,-1.08) .. (0.20,-0.72);
\fill (-0.98,0) circle (1.2pt) node[left] {$B'$};
\fill (0.80,0) circle (1.2pt) node[above right] {$O'$};
\fill (2.10,0) circle (1.2pt) node[right] {$A'$};
\end{tikzpicture}
\end{figure}
