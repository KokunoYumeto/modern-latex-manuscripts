...
\textit{[Figure: incident ray from $Q$ on the axis of $x$ refracted at the axis of $y$; angles of incidence and refraction at $A$.]}
...
\textit{[Figure: circle centred at $O$ with radius $OA$ along the $x$-axis; incident ray $G_{0}G_{1}$, intermediate points of incidence $G_{1}$, $G_{2}$, $\ldots$, and the final point $G$ from which the last reflected ray $GG'$ emerges.]}
...
\textit{[Figure: circle with centre $C$; radiant point $B$ inside; incident ray $RBP$ meeting the circle at $P$ and reflected as $PS$; fixed radius $CA$.]}
