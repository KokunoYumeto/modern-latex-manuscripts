...
\textit{[Table: development of $(\alpha - \beta)^8 \{\alpha\beta - b(\alpha + \beta) + c\}$. The four rows of binomial expansions corresponding to the factors $(\alpha - \beta)^8$, $\alpha\beta$, $-b(\alpha + \beta)$ and $+c$ are written out across ten columns of $\alpha^i\beta^{10-i}$ powers, with the row of coefficients $1, -8, +28, -56, +70, -56, +28, -8, +1$ for $(\alpha - \beta)^8$ and the corresponding shifted/scaled rows for the other three factors. Below the rule, the per-monomial sums are tabulated in twelve rows labelled $bj$, $ci$, $dh$, $eg$, $f^2$, $b^4h$, $bcg$, $bdf$, $b^2cf$, $c^2g$, $cdf$, $ce^2$ with column-wise contributions and the final divisor-column $\div -14$ giving the final integer coefficients of the sharp seminvariant $ci \infty ce^2$. A trailing tally $\pm 23$ summarises the result.]}
...
\textit{[Table: large four-column reduction table giving for each weight $w = 2, 3, \ldots, 12$ the sharp seminvariants with their initial and final terms and the corresponding reduction expressions in capital-letter seminvariants $C, D, E, E_2, F, F_2, G, G_2, G_3, G_4, H, H_2, \ldots$; the precise numerical coefficients and product expressions are exhibited line-by-line in the printed scan and are too dense to faithfully transcribe in linear form here. The columns are headed by the weight $w$, and within each column the entries are arranged as: seminvariant in the form ``(final-term) $\infty$ (initial-term)'', followed by its reduction (where present) as a polynomial in $C, D, E, \ldots$. Entries without a reduction are perpetuants. Headings for the four blocks are $w = 2, 3, 4, 5, 6, 7, 8, 9, 10$ in the left two columns and $w = 11, 12$ in the right two columns. Representative entries: $w=2$: $c \infty -b^2$, $C$; $w=3$: $d \infty 2b^3$, $D$; $w=4$: $e \infty 3c^2$, $E$, with $E_2 = C^2$; $c^2 \infty b^4$, $F$; $w=5$: $f \infty -bc^2$, $F$, $F_2 = CD$; $w=6$: $g \infty -10d^2$, $G$; $G_2 = CE - G_2$; $G_3$, $G_4 = C^3$; etc. Where no reduction is given, the form is irreducible, i.e.\ it is a perpetuant.]}
...
\textit{[Table: large four-column listing of sharp seminvariants for the weights $w = 13, 14, 15, 16$, organized in four parallel columns each headed by the weight and by the capital-letter symbol assigned to that weight ($N, O, P, Q$ respectively). For each weight the entries are pairs (final-term, initial-term) printed line-by-line, with running numerical labels $1, 2, 3, \ldots$ down the right-hand side of each column. The entries cover all sharp seminvariants of the given weight. For $w=13$: $n \infty bdf^2$, $N$, with subsequent entries including $dk \infty bcf^2$, $fi \infty bce^3$, $ej \infty bd^2e^2$, \ldots, terminating with $c^5d \infty b^{15}$. For $w=14$: $o \infty h^2$, $O$, with subsequent entries including $cm \infty cg^2$, $ek \infty ef^2$, $dl \infty b^2g^2$, $fj \infty bdf^2$, \ldots, terminating with $c^7 \infty b^{14}$. For $w=15$: $p \infty bg^2$, $P$, with subsequent entries including $2cm \infty bg^2$, $bo \infty bfg^2$, $edl \infty bcg^2$, $fk \infty bef^2$, $cn \infty bce^3$, $ej \infty bd^2g$, $gk \infty c^2f^2$, $f^2i \infty c^2d^3$, \ldots, terminating with $c^7d \infty b^{15}$. For $w=16$: $q \infty c^4$, $Q$, with subsequent entries including $eo \infty cf^2$, $cm \infty bdg^2$, $fl \infty bcg^2$, $cek \infty bcfg^2$, $dn \infty b^2h^2$, $i^2 \infty d^2f^2$, $ch^2 \infty bc^2g^2$, $cg^2 \infty bd^5$, $efh \infty b^2ce^3$, \ldots, terminating with $c^8 \infty b^{16}$. Within each column the running tally on the right-hand side increases as the list descends. The precise pair-by-pair transcription is rendered ambiguous by the density and partial-illegibility of the scan.]}
...
\textit{[Table: ten-column numerical worksheet exhibiting the operation $Z$ on the seminvariant $j \infty bc^2$. The rows are labelled by the monomials in the result ($k$, $bj$, $ci$, $dh$, $eg$, $f^2$, $b^4h$, $bch$, $bdg$, $bef$, $b^2cg$, $cdf$, $c^2g$, $b^3df$, $ce^2$); the columns are headed $1, 2, \ldots, 10$ corresponding to the ten terms $9b\partial_a, 8c\partial_b, \ldots$ of $Z$, with two further columns at the right marked with a dagger $\dagger$ and an asterism $*$ holding the additional term $+ 32(ci \infty ce^2)$ added to fix the initial coefficient and the final tabulated result for $dh \infty b^2e^2$ respectively. Column totals are noted at the bottom; the column $\div -18$ records the divisor applied to obtain the final tabulated form.]}
