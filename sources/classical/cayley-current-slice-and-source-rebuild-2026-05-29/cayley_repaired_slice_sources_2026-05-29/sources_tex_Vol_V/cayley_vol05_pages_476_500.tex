...
\textit{[Figure: composite plot of the secondary caustic curves for the various values of $m$ enumerated above; the figure (PDF p.\ 489) shows the half of the curve delineated above, with axes, the reflecting circle $x^{2} + y^{2} = 1$, the line $x = m$, and the loop, cusps, nodes and acnode marked.]}
