...
\begin{tikzpicture}[scale=0.72, line cap=round, line join=round]
  \coordinate (O) at (-2.4,-1.75);
  \draw[->] (O) -- (2.55,-1.75) node[right] {$\alpha$};
  \draw[->] (O) -- (-3.35,-2.65) node[below left] {$\beta$};
  \draw[->] (O) -- (-2.4,1.15) node[above] {$\gamma$};

  \coordinate (P) at (-0.75,0.05);
  \coordinate (F) at (0.85,0.05);
  \coordinate (T) at (1.35,0.85);
  \coordinate (B) at (-0.25,0.85);
  \coordinate (D) at (-1.20,-1.10);
  \coordinate (R) at (0.40,-1.10);
  \coordinate (One) at (0.90,-0.30);
  \coordinate (S) at (-0.70,-0.30);
  \draw (P)--(F)--(R)--(D)--cycle;
  \draw (B)--(T)--(One)--(S)--cycle;
  \draw (P)--(B) (F)--(T) (R)--(One) (D)--(S);
  \draw[densely dashed] (B)--(D) (S)--(R);
  \node[left] at (P) {$P$};
  \node[right] at (T) {$Q$};
  \node[below] at (R) {$R$};
  \node[left] at (S) {$S$};
  \node[right] at (One) {$1$};
  \node[below left] at (D) {$2$};
  \node[above] at (B) {$3$};
  \node[right] at (F) {$4$};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.72, line cap=round, line join=round]
  \coordinate (A) at (-1.65,1.15);
  \coordinate (B) at (1.65,1.15);
  \coordinate (C) at (1.45,-1.30);
  \coordinate (D) at (-1.80,-1.28);
  \coordinate (O) at (0,0);
  \draw (A)--(B)--(C)--(D)--cycle;
  \draw (O) circle (1.35);
  \draw (A)--(C) (B)--(D);
  \draw (-2.15,0)--(2.15,0);
  \draw (0,-1.72)--(0,1.72);
  \draw (-2.05,0)--(0,1.72)--(2.05,0)--(0,-1.72)--cycle;
  \fill (O) circle (1.2pt);
  ...
  \node[above left] at (-0.62,0.57) {$M$};
  \node[above right] at (0.72,0.58) {$N$};
  \node[below right] at (0.78,-0.70) {$P$};
  \node[below left] at (-0.96,-0.72) {$Q$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.72, line cap=round, line join=round]
  ...
  \coordinate (c) at (-1.15,-1.10);
  \coordinate (e) at (1.15,-1.10);
  \coordinate (B) at (-0.56,0.18);
  \coordinate (F) at (0.56,0.18);
  \coordinate (D) at (0,-1.10);
  \draw (a)--(c)--(e)--cycle;
  \fill (a) circle (1.1pt) (c) circle (1.1pt) (e) circle (1.1pt);
  \fill (B) circle (1.1pt) (F) circle (1.1pt) (D) circle (1.1pt);
  \node[above] at (a) {$a$};
...
\begin{tikzpicture}[scale=0.78, line cap=round, line join=round]
  \coordinate (a) at (0,1.10);
  \coordinate (c) at (-2.15,-1.03);
  \coordinate (e) at (2.15,-1.03);
  \coordinate (D) at (0,-1.03);
  \coordinate (B) at (-0.55,0.48);
  \coordinate (F) at (0.55,0.48);
  \draw
    (-2.15,-1.03)
      .. controls (-2.65,-0.32) and (-2.42,0.72) .. (-1.58,1.05)
      .. controls (-0.92,1.30) and (-0.30,0.96) .. (0,0.76)
      .. controls (0.30,0.96) and (0.92,1.30) .. (1.58,1.05)
      .. controls (2.42,0.72) and (2.65,-0.32) .. (2.15,-1.03)
      .. controls (1.20,-1.30) and (0.46,-1.24) .. (0,-1.03)
      .. controls (-0.46,-1.24) and (-1.20,-1.30) .. (-2.15,-1.03);
  \draw (0,0.98)
      .. controls (-0.86,0.62) and (-0.62,-0.56) .. (0,-1.03)
      .. controls (0.62,-0.56) and (0.86,0.62) .. (0,0.98);
  \draw (a)--(c)--(e)--cycle;
  \fill (a) circle (1.1pt) (c) circle (1.1pt) (e) circle (1.1pt);
  \fill (B) circle (1.1pt) (F) circle (1.1pt) (D) circle (1.1pt);
  \node[above] at (a) {$a$};
