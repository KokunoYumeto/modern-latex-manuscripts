...
\begin{center}
\textit{[Figure: $O$, $P$, $r$, $Q$, $K$, $k$, $L$, $M$ as described in the text; figure omitted in this reset.]}
\end{center}
...
\begin{center}
\textit{[Figure: the points $S$, $S'$, $S''$, $O$, $O'$, $P$, $P'$, $N$, $N'$, $M$, $M'$ as described; figure omitted in this reset.]}
\end{center}
