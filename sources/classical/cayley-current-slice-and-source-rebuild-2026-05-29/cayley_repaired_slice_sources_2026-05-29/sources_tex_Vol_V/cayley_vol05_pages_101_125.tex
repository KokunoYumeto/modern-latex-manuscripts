...
\begin{center}
\par\noindent\fbox{\parbox{0.9\textwidth}{\footnotesize [Figure — see scan: $O$, $P$, $r$, $Q$, $K$, $k$, $L$, $M$ as described in the text; figure omitted in this reset.]}}\par
\end{center}
...
\begin{center}
\par\noindent\fbox{\parbox{0.9\textwidth}{\footnotesize [Figure — see scan: the points $S$, $S'$, $S''$, $O$, $O'$, $P$, $P'$, $N$, $N'$, $M$, $M'$ as described; figure omitted in this reset.]}}\par
\end{center}
...
\noindent\footnotesize The following pages reproduce the corresponding range of the Internet Archive scan for visual reference of figures, tables, and any text that may have been compressed in the typeset reconstruction. Source: \texttt{collectedmathema05cayluoft.pdf}, pages 101--125.
\normalsize
\includepdf[pages=101-125,scale=0.92,pagecommand={\thispagestyle{empty}}]{local workspace path
