...
\begin{center}
\textit{[Figure: a small spherical-triangle diagram with vertex angle $\theta$ and side $\sigma$; the departure-point is shown along the orbit line, with $\sigma$ as the arc from node to departure-point.]}
\end{center}
