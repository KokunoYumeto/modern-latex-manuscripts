...
\begin{align*}
x_1 : y_1 : 1 &= (a_1,b_1,c_1\,\mid\alpha',\beta',\gamma')
: -(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma') : (f_1,g_1,h_1\,\mid\alpha',\beta',\gamma'), \\
x_2 : y_2 : 1 &= (a_2,b_2,c_2\,\mid\alpha'',\beta'',\gamma'')
: -(a_2,b_2,c_2\,\mid\alpha'',\beta'',\gamma'') : (f_2,g_2,h_2\,\mid\alpha'',\beta'',\gamma''), \\
x_3 : y_3 : 1 &= (a_3,b_3,c_3\,\mid\alpha''',\beta''',\gamma''')
: -(a_3,b_3,c_3\,\mid\alpha''',\beta''',\gamma''') : (f_3,g_3,h_3\,\mid\alpha''',\beta''',\gamma'''),
\end{align*}
...
we have
\[
r_1 = \frac{(f_1,g_1,h_1\,\mid\alpha',\beta',\gamma'')}{(f_1,g_1,h_1\,\mid\alpha',\beta',\gamma')},
\]
if
\[
u = \sqrt{[(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma')]^2 + [(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma'')]^2}.\]

\newpage
\noindent
the sign being taken in such manner that $r_1$ shall be positive; viz.~the sign must be the
same as that of $(f_1,g_1,h_1\,\mid\alpha'',\beta'',\gamma'')$. And we have the like formul\ae\ for $r_2$, and $r_3$.
...
\begin{multline*}
\{x'(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma') + y'(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma')\}
[-r_1(f_1,g_1,h_1\,\mid\alpha'',\beta'',\gamma'') + r_2(f_2,g_2,h_2\,\mid\alpha'',\beta'',\gamma'')] + \\
\{x'(a_2,b_2,c_2\,\mid\alpha'',\beta'',\gamma'') + y'(a_2,b_2,c_2\,\mid\alpha'',\beta'',\gamma'')\}
[-r_2(f_2,g_2,h_2\,\mid\alpha''',\beta''',\gamma''') + r_3(f_3,g_3,h_3\,\mid\alpha''',\beta''',\gamma''')] + \\
\{x'(a_3,b_3,c_3\,\mid\alpha''',\beta''',\gamma''') + y'(a_3,b_3,c_3\,\mid\alpha''',\beta''',\gamma''')\}
[-r_3(f_3,g_3,h_3\,\mid\alpha',\beta',\gamma') + r_1(f_1,g_1,h_1\,\mid\alpha',\beta',\gamma')] = 0,
\end{multline*}
...
for instance
\begin{multline*}
(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma'') \cdot -(a_1,b_1,c_1\,\mid\alpha',\beta',\gamma') \\
+ (a_1,b_1,c_1\,\mid\alpha',\beta',\gamma') \cdot (a_2,b_2,c_2\,\mid\alpha'',\beta'',\gamma'');
\end{multline*}
this is
\begin{multline*}
...
or, what is the same thing,
\[
= (b_1c_2-b_2c_1, c_1a_2-c_2a_1, a_1b_2-a_2b_1 \,\mid\, \alpha''',\beta''',\gamma''');
\]
...
[-r_1(f_1,g_1,h_1\,\mid\alpha'',\beta'',\gamma'') + r_2(f_2,g_2,h_2\,\mid\alpha'',\beta'',\gamma'')] + \\
+ (b_1c_2-b_2c_1, c_1a_2-c_2a_1, a_1b_2-a_2b_1 \,\mid\, \alpha''',\beta''',\gamma'')
[r_1(f_1,g_1,h_1\,\mid\alpha'',\beta'',\gamma'') - r_2] + \\
+ (b_2c_3-b_3c_2, c_2a_3-c_3a_2, a_2b_3-a_3b_2 \,\mid\, \alpha',\beta',\gamma')
[r_2(f_2,g_2,h_2\,\mid\alpha''',\beta''',\gamma''') - r_3] + \\
+ (b_3c_1-b_1c_3, c_3a_1-c_1a_3, a_3b_1-a_1b_3 \,\mid\, \alpha'',\beta'',\gamma'')
[r_3(f_3,g_3,h_3\,\mid\alpha',\beta',\gamma') - r_1] = 0,
\end{multline*}
being an equation of the form $\Omega = Ax' + By' + C$.
...
\begin{vmatrix}
\alpha'' & \beta'' & \gamma'' \\
(f_1,g_1,h_1\,\mid\alpha'',\beta'',\gamma''), & a_1, & b_1, & c_1 \\
(f_2,g_2,h_2\,\mid\alpha'',\beta'',\gamma''), & a_2, & b_2, & c_2 \\
(f_3,g_3,h_3\,\mid\alpha'',\beta'',\gamma''), & a_3, & b_3, & c_3 \\
\end{vmatrix} = 0.
\]
