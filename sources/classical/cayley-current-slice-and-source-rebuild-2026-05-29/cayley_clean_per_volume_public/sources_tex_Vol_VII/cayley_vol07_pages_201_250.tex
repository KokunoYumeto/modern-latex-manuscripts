...
# Save the file
with open("/mnt/agents/output/latex_typesetting_CONTINUED_WORK/cayley/vol07/cayley_vol07_pages_201_250.tex", "w", encoding="utf-8") as f:
    f.write(latex_content)

print(f"File saved: {len(latex_content)} characters")
print("OK - LaTeX file created")
