...
\[
(a, b, 0, f, g, h\!\!\mid\! x, y, z)^2 + 2(\alpha z + \gamma x)(\mu y + \nu z) = 0;
\]
or what is the same thing
\[
(a, b, 2\nu\gamma, f+\mu\gamma, g+\nu\alpha, h+\mu\alpha\!\!\mid\! x, y, z)^2 = 0;
\]
...
In general
\[
\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\!\lambda x+\mu y,\ \lambda'x+\mu'y)^5 = (\lambda\mu' - \lambda'\mu)^{20}\,\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! x, y)^5.
\]
Hence first, if $(\lambda, \mu, \lambda', \mu') = (0, 1, 1, 0)$, then
\[
\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! y, x)^5 = \text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! x, y)^5;
\]
and secondly, if $\omega$ be an imaginary fifth root of unity and $(\lambda, \mu, \lambda', \mu') = (\omega, 0, 0, 1)$,
then
\[
\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! \omega x, y)^5 = \text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! x, y)^5.
\]
These two results may also be written,
\begin{align*}
\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! x, y)^5 &= \text{Disct.}\,(f, e, d, c, b, a\!\!\mid\! x, y)^5,\\
\text{Disct.}\,(a, b, c, d, e, f\!\!\mid\! x, y)^5 &= \text{Disct.}\,(a, b\omega^4, c\omega^3, d\omega^2, e\omega, f\!\!\mid\! x, y)^5;
\end{align*}
that is, the discriminant of $(a, b, c, d, e, f\!\!\mid\! x, y)^5$ is not altered by taking the coefficients in
a reverse order, or by multiplying the several coefficients by the powers $\omega^5$, $\omega^4$, $\omega^3$, $\omega^2$, $\omega$, of an
imaginary fifth root of unity. Applying these theorems to the form $(a, b\lambda, c\lambda^2, c\mu^2, b\mu, a\!\!\mid\! x, y)^5$,
...
that is, of $\lambda\mu$, $\lambda^5+\mu^5$. For the general form $(a, b, c, d, e, f\!\!\mid\! x, y)^5$, if a term of the
...
$(a, b\lambda, c\lambda^2, c\mu^2, b\mu, a\!\!\mid\! x, y)^5$, the sum of the indices of $b\lambda$, $c\lambda^2$ is $=6$ at most, and
