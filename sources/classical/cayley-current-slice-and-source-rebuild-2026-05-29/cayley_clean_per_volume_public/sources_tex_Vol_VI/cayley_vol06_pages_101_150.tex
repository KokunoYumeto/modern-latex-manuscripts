...
\]
where $(a,h,k,b x,y)^2 = ax^2 + 2hxy + by^2$, and $\Delta = hk - ab$, $V = hk - h^2$, $@ = ah - bk$, $R = -81ab$.

The discriminant of this form, say $Q_{10}$, is a function of $c^2D$, $V$, $c\text{@}$, $cR$, where $D$ is the discriminant of the quadratic $(a,h,k,b x,y)^2$. The expression is found to be
\begin{multline*}
Q_{10} = c^{10}\{D^3\} + c^9\{-99RD^2 - 400VD + 2304V\text{@}D + 8640\text{@}^2\} \\
+ c^8\{12800R^2V\text{@} + 82944V^3\text{@}^2 - 4608V^2D\} \\
+ c^7\{20480R^2V^3 + 147456V^4\text{@} + 65536V^6\}.
\end{multline*}

The foregoing values of $S$ and $T$ give
\[
T^2 - 64S^3 = c^4\{D^3 + c(8RD^2 - 24V\text{@}D - 64\text{@}^3) + c^2(16R^2 + 96RV\text{@} - 48V^2\text{@}^2 + 16V^3D) + c^3(64R^2V^2)\},
\]
so that
\[
...
As regards the discriminant $Q_{10}$, this as already remarked, has been calculated for the general form, but for the present purpose it is easier, by dealing directly with the form $[(a,h,k,b x,y)^2]^2 + 32l\Delta x^2y^2$ and then interpreting $D$, $V$, $\text{@}$, $R$ and restoring the coefficient $c$ as above, to obtain the discriminant $Q_{10}$ of the function $[c(a,h,k,b x,y)^2]^2 + 4[(j,l,f x,y)^2]^2$ in the required form, as a function of $c^2D$, $V$, $c\text{@}$, $cR$.

I find after some laborious calculations
\begin{align*}
Q_5 &= \text{No.\ 31} = c^5\{90\} + c^4\{40VD - 288V\text{@}\} + c^3\{256V^2\},\\
Q_7 &= 10000\,\text{No.\ 34} = c^7\{-99D^2 - 400RD + 2304V\text{@}D + 8640\text{@}^2\}\\
&\quad + c^6\{12800R^2V\text{@} + 82944V^3\text{@}^2 - 4608V^2D\} + c^5\{20480R^2V^3 + 147456V^4\text{@} + 65536V^6\},\\
Q_8 &= 1000000\,\text{No.\ 35} = c^8\{7992D^3 + 72000RD^2 - 145152V\text{@}D^2 + 622080\text{@}^2D\}\\
&\quad + c^7\{160000R^2\text{@} + 691200R^2V\text{@}D + 3456000R^2\text{@}^2 + 3815424V^2\text{@}^2D\\
&\quad\quad + 36080640V\text{@}^3 + 635904V^2D^2\}\\
&\quad + c^6\{33177600R^2V^2\text{@}^2 + 4669440R^2V^2D + 217645056V^4\text{@}^2 + 23003136V^2\text{@}D\}\\
&\quad + c^5\{62914560R^2V^4 + 452984832V^3\text{@} + 14155776V^4D\}\\
&\quad + c^4\{134217728V^8\}.
\end{align*}

Also $Q_{10} = \text{multiple of discriminant} = c^{10}R^2U^2$, where
\begin{multline*}
U = c^4D^3 + c^3(-8R^2D - 24R^2V\text{@}D + 64R^2\text{@}^3) \\
+ c^2(-16R^2 - 96R^2V\text{@} + 48R^2V^2\text{@}^2 - 16R^2V^3D) + c(-64R^2V^2).
\end{multline*}

To these may be joined the intermediate values:
\begin{align*}
Q_3 &= c^3\{81D\} + c^2\{-720RD + 5184V\text{@}D + 1600R^2 + 23040RV\text{@} + 82944V^2\text{@}^2 + 4608V^2D\}\\
&\quad + c\{20480R^2V^3 + 147456V^4\text{@} + 65536V^6\},\\
Q_4 &= c^4\{180D^2 + 1120RD + 2880V\text{@}D - 8640\text{@}^2\}\\
&\quad + c^3\{1600R^2 + 10240RV\text{@} + 270D^2 + 720RD^2 - 51840V\text{@}D^2 - 77760\text{@}^2D\}.
\end{align*}
...
\]
and if by means of these values we eliminate $c\text{@}$ and $c^2D$, we obtain $Q_5$, $Q_7$, $Q_8$ and $Q_{10}$ as functions of $S$, $T$, $V$ and $cR$. Choosing instead of $Q_5$ and $Q_8$ the combinations $Q_5 - Q_3$ and $Q_8 - 8Q_4^2$, and forming also the expression for the combination $Q_5(Q_5 - Q_3)$, we have thus the system of formulae:
\begin{align*}
...
The just-mentioned value of $Q_{10}$ should, I think, admit of being established \textit{a priori}, and if this be so, then the substitution of the values of $S$ and $T$ in terms of $c^2D$, $V$, $c\text{@}$, $cR$, would be the easiest way of arriving at the before-mentioned expression of $Q_{10}$ in terms of these same quantities. The calculation by which this expression was arrived at, is however not without interest, and it will be as well to indicate the mode in which it was effected.
...
\]
and when the symmetric functions have been expressed in terms of the coefficients, the result is to be expressed as a function of $D$, $V$, $\text{@}$, $R$ by means of the values
\begin{align*}
...
$AG$ & $125643$ & $12 \cdot 64\ 25 \cdot 43\ 56 \cdot 31$ & $e\backslash l$\\
$AI$ & $124365$ & $12 \cdot 36\ 24 \cdot 65\ 43 \cdot 51$ & $c\kappa v$\\
$EG$ & $132546$ & $13 \cdot 54\ 32 \cdot 46\ 25 \cdot 61$ & $j?a$\\
