...
\node at (0,2.55) {Fig.~1.};
\draw (-2.2,1.1) arc[start angle=155,end angle=25,radius=2.28];
\draw (-2.2,1.1) -- ++(-0.18,-0.18);
\draw (2.2,1.1) -- ++(0.18,-0.18);
\draw (0,1.55) -- (0,0.85);
\fill (-2.02,1.22) circle (1.3pt) node[below left] {$A$};
\fill (2.02,1.22) circle (1.3pt) node[below right] {$B$};
\node at (0.16,1.72) {$G$};
\draw (-3.05,-1.05) .. controls (-2.2,-1.65) and (-1.0,-1.62) .. (-0.12,-0.92);
\draw (0.12,-0.92) .. controls (1.0,-1.62) and (2.2,-1.65) .. (3.05,-1.05);
\draw (-0.32,-0.72) -- (0.32,-1.20);
\draw (-0.32,-1.20) -- (0.32,-0.72);
\fill (-2.45,-1.26) circle (1.3pt) node[above left] {$D$};
\fill (2.45,-1.26) circle (1.3pt) node[above right] {$E$};
\node at (0,-1.40) {$C$};
\end{tikzpicture}
\end{figure}
...
\node at (0,2.35) {Fig.~2.};
\draw (-3.1,0.65) arc[start angle=140,end angle=40,radius=4.05];
\draw (-2.25,0.05) arc[start angle=142,end angle=43,radius=3.05];
\coordinate (Ap) at (-1.55,1.62);
\coordinate (Bp) at (2.55,0.98);
\coordinate (A) at (-2.05,0.36);
\coordinate (B) at (1.25,0.73);
...
\begin{tikzpicture}[scale=0.82,line cap=round,line join=round]
\node at (0,2.35) {Fig.~3.};
\fill (-0.55,1.78) circle (1pt) node[above left] {$A$};
\fill (0,-2.16) circle (1pt) node[below] {$B$};
\draw (-2.15,0.45) .. controls (-1.15,0.98) and (1.15,0.98) .. (2.15,0.45);
\draw (-2.15,0.45) .. controls (-1.05,0.08) and (1.05,0.08) .. (2.15,0.45);
\draw (-2.45,0.15) -- (-1.65,0.78);
\draw (1.75,0.10) -- (2.45,0.78);
\fill (-2.08,0.48) circle (1.1pt) node[above left] {$c$};
\fill (1.55,0.55) circle (1.1pt) node[above] {$C$};
\draw (-0.18,-0.62) -- (0.18,-1.05);
\draw (-0.20,-1.05) -- (0.20,-0.62);
\node at (0,-0.48) {$S$};
\draw (-2.55,-1.55) .. controls (-1.25,-0.78) and (1.25,-0.78) .. (2.55,-1.55);
\draw (-2.55,-1.55) .. controls (-1.25,-1.96) and (1.25,-1.96) .. (2.55,-1.55);
\draw (-2.85,-1.82) -- (-2.18,-1.23);
\draw (2.15,-1.20) -- (2.88,-1.78);
\fill (-2.45,-1.55) circle (1.1pt) node[below left] {$D$};
\fill (2.45,-1.55) circle (1.1pt) node[below right] {$d$};
\draw (3.45,-0.48) -- (3.88,0.48);
\draw (3.27,0.40) -- (3.76,-0.48);
\node[right] at (3.88,0.12) {$y$};
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}[scale=0.72,line cap=round,line join=round]
  ...
  \draw[thick,smooth] plot coordinates {
    (1.62,0) (1.20,0.62) (0.74,1.12) (0.22,1.52)
    (-0.62,1.83) (-1.48,1.98) (-2.05,2.12)
  };
  \draw[thick,smooth] plot coordinates {
    (0,0) (-0.64,0.10) (-1.35,0.15) (-2.05,0.15)
  };
  \draw[<-] (-1.78,2.06) -- (-2.22,2.14);
  \draw[<-] (-1.72,0.15) -- (-2.17,0.15);
  \fill (0,0) circle (1.1pt) node[below] {$O$};
  \fill (1.62,0) circle (1.1pt) node[below] {$A$};
  \fill (0,1.42) circle (1.1pt) node[left] {$C$};
  \node[left] at (-2.08,2.18) {$B$};
  \node[left] at (-2.12,0.15) {$B$};
\end{tikzpicture}
\qquad
\begin{tikzpicture}[scale=0.72,line cap=round,line join=round]
  \draw (-1.8,0) -- (1.8,0);
  \draw (0,0) -- (0,1.75);
  \draw[thick] (-1.45,0) arc[start angle=180,end angle=0,radius=1.45];
  \fill (-1.45,0) circle (1.1pt) node[below] {$B'$};
  \fill (0,0) circle (1.1pt) node[below] {$O'$};
  \fill (1.45,0) circle (1.1pt) node[below] {$A'$};
  \fill (0,1.45) circle (1.1pt) node[above] {$C'$};
\end{tikzpicture}
\caption*{Fig.~1.\qquad\qquad Fig.~2.}
\end{figure}
...
\begin{tikzpicture}[scale=0.86,line cap=round,line join=round]
  \draw[->] (-3.2,0) -- (4.0,0) node[right] {$x$};
  \draw[->] (0,-2.25) -- (0,2.35) node[above] {$y$};
  \draw[thick] (-1.38,0) circle (1.62);
  \draw[thick] (1.42,0) circle (1.62);
  \draw[thick,smooth] plot coordinates {(-0.05,-1.78) (0.26,-1.00) (0.32,-0.28) (0.18,0.50) (0.05,1.82)};
  \draw[thick,smooth] plot coordinates {(0.12,-1.55) (0.55,-0.62) (0.82,-0.10) (0.64,0.65) (0.22,1.42)};
  \draw[thick,smooth] plot coordinates {(-0.05,0) (0.28,0.30) (0.76,0.32) (1.02,0.10) (0.82,-0.18) (0.38,-0.22) (-0.05,0)};
  \draw[thick,smooth] plot coordinates {(-0.05,0) (0.42,0.12) (1.10,0.06) (1.35,0) (1.08,-0.18) (0.42,-0.15) (-0.05,0)};
  \fill (-3.00,0) circle (1.1pt) node[below] {$A'$};
  \fill (-0.05,0) circle (1.1pt) node[below left] {$O$};
  \fill (0.32,0) circle (1.1pt) node[below] {$B'$};
  \fill (1.05,0.28) circle (1.1pt) node[above right] {$Q$};
  \fill (1.05,-0.28) circle (1.1pt) node[below right] {$Q'$};
  \fill (0.77,0) circle (1.1pt) node[above] {$F$};
  \fill (1.50,0) circle (1.1pt) node[below] {$B$};
  \fill (3.04,0) circle (1.1pt) node[above right] {$A$};
  \node[above right] at (0.30,1.18) {$P$};
  \node[below right] at (0.15,-1.20) {$P'$};
\end{tikzpicture}
\caption*{Fig.~3.}
\end{figure}
...
\begin{tikzpicture}[scale=0.92,line cap=round,line join=round]
  \draw (-2.2,0) -- (3.0,0);
  \draw[thick] (0.90,0) circle (1.55);
  \draw[thick,smooth] plot coordinates {(-0.65,0) (-0.20,0.72) (0.55,1.08) (1.05,0.72) (1.18,0.08) (0.88,-0.42) (0.18,-0.56) (-0.65,0)};
  \draw[thick,smooth] plot coordinates {(-0.65,0) (0.02,0.02) (0.90,0.10) (1.25,0.03) (0.92,-0.18) (0.05,-0.18) (-0.65,0)};
  \draw[thick,smooth] plot coordinates {(0.35,-1.65) (0.54,-0.82) (0.60,-0.10) (0.48,0.82) (0.27,1.65)};
  \draw[dashed,smooth] plot coordinates {(-0.98,-1.05) (-0.78,-0.55) (-0.65,0) (-0.77,0.56) (-1.02,1.08)};
  \draw[dashed,smooth] plot coordinates {(-1.45,-1.40) (-1.10,-0.70) (-0.65,0) (-1.05,0.78) (-1.45,1.35)};
  \fill (-0.65,0) circle (1.2pt) node[left] {$B'$};
  \fill (0.72,0) circle (1.2pt) node[below] {$O'$};
  \fill (2.45,0) circle (1.2pt) node[above right] {$A'$};
\end{tikzpicture}
\caption*{Fig.~4.}
\end{figure}
