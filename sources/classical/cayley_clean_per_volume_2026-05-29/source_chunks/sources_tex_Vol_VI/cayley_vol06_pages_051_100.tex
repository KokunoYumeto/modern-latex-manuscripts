...
\textit{[Plate I facing page 52: Figure illustrating the conics touching three given lines.]}
...
which is
\begin{equation}
\left(\frac{bc}{f}, \frac{ca}{g}, \frac{ab}{h} \between x, y, z\right)^2 = (a, b, c, f, g, h \between x, y, z)^2 + 2\left(\frac{f}{a}yz + \frac{g}{b}zx + \frac{h}{c}xy\right),
\end{equation}
so that the condition is, that the conic
\begin{equation}
(a, b, c, f, g, h \between x, y, z)^2 + 2\left(\frac{f}{a}yz + \frac{g}{b}zx + \frac{h}{c}xy\right) = 0,
\end{equation}
(which is a certain conic passing through the intersections of the Absolute $(a, b, c, f, g, h \between x, y, z)^2 = 0$, and of the locus conic $\frac{f}{a}yz + \frac{g}{b}zx + \frac{h}{c}xy = 0$) shall be a pair of lines.
...
\begin{equation}
\left(\frac{bc}{f}, \frac{ca}{g}, \frac{ab}{h} \between x, y, z\right)^2,
\end{equation}
...
that is
\begin{equation}
\frac{ab-h^2}{\gamma}Y^2 = (hb, -ab, ha \between a\alpha + h\beta, h\alpha + b\beta)^2 = 0.
\end{equation}
...
\begin{equation}
\frac{ab-h^2}{\gamma}\frac{(ax + hy)^2(hx + hy)^2}{chz^2} = (hb, -ab, ha \between ax + hy, hx + by)^2 = 0,
\end{equation}
...
\begin{equation}
= -(ab - h^2)(ha, ah, hh \between x, y)^2 = -(ab - h^2)h(ax^2 + by^2 + \tfrac{2h}{ab}xy),
\end{equation}
...
or, completing the elimination,
\begin{equation}
(ab-h^2)ch\gamma^2 = (hb, -ab, ha \between a\alpha + h\beta, h\alpha + b\beta)^2,
\end{equation}
that is
\begin{equation}
...
\end{equation}
\begin{equation}
(a, b, c, 0, 0, h \between \alpha, \beta, \gamma)^2 = 0.
\end{equation}
...
(a, b, c, 0, 0, h \between x, y, z)^2 = 0,
\end{equation}
which is a conic intersecting the Absolute $(a, b, c, 0, 0, h \between x, y, z)^2 = 0$, at its intersections with the lines $x = 0$, $y = 0$, that is the lines $CB$ and $CA'$.
