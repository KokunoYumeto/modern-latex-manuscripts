...
- Command run in this directory:
  `pdflatex -interaction=nonstopmode -halt-on-error cayley_vol01_pages251_262_source_checked.tex`
- Status: successful.
- Output: `cayley_vol01_pages251_262_source_checked.pdf`
- `pdfinfo` result: 13 pages, A4 page size, PDF 1.5.

## Log Audit

- Log file: `cayley_vol01_pages251_262_source_checked.log`.
- No LaTeX errors.
...
- Large determinants in paper 35, equations (11) and (21), were source-checked against the PNGs and typeset compactly with zero entries where the scan uses dots.
