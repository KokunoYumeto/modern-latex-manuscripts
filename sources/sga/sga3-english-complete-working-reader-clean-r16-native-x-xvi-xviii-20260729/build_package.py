#!/usr/bin/env python3
"""Build the compact, reader-clean SGA3 R16 native-update package."""
...
BUNDLE_MASTER_NAME = (
    "SGA3_English_Complete_Reader_Native_Update_R16_20260729.tex"
)
PREDECESSOR_PDF_NAME = (
    "00c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.pdf"
)
PREDECESSOR_TEX_NAME = (
    "02c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.tex"
)
...
EXPECTED_CLOSURE_FILES = 894
EXPECTED_CLOSURE_BYTES = 7_841_442
EXPECTED_CLOSURE_TEX = 749
EXPECTED_CLOSURE_PNG = 145
EXPECTED_CLOSURE_AGGREGATE = (
    "4EA0E37F0A814C34F7BB1F5074300F6AF6C45A8F1EF027616BB2E639014213E2"
)
EXPECTED_PDF_METRICS = {
    "pages": 1473,
    "named_destinations": 9488,
...
def main() -> int:
    ...
    source_validation = {
        "schema": "sga3_complete_reader_native_update_r16_source_bundle_v1",
    ...
    package_validation = {
        "schema": "sga3_complete_reader_native_update_r16_outer_package_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "reader": {
            "filename": PDF_NAME,
