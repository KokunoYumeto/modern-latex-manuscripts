...
$FrenchAuthority = 'C:\Users\Floris\Documents\interlanguage\03_projects\language_management\english_germanic\02_native_examples\sga5_current_french_workpass\sga5_fr_workpass.tex'
