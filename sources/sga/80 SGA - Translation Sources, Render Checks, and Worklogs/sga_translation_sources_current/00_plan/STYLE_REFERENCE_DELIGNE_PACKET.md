...
Operational choices adopted from the reference packet and from translation segment:
...
6. Place a continuation point at the end of each chunk so the next translation segment can continue without searching.

Notes from this translation segment:

- The Deligne examples favor uncluttered article-style documents and concise preambles. translation segment follows that practice.
