...
- `02_new_translation_latex/batch_005/SGA4_Expose_I_sections_8_9_to_8_13_en.pdf`
- Page count: 16

## Rendering

The fresh Batch 005 PDF was rendered to PNG at 120 dpi using the PDF skill render workflow:

- `04_render_checks/batch_005/SGA4_Expose_I_sections_8_9_to_8_13_en_render/`

A cumulative SGA 4 Exposé I PDF through Section 8.13 was produced by concatenating the prior cumulative PDF through Section 8.8 with the Batch 005 PDF:
...
- page 1
- page 64, the first page of the new Batch 005 segment
