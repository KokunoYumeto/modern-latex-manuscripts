...
PDF_NAME = "00c00_SGA3_English_Complete_Working_Reader_20260728.pdf"
TEX_NAME = "02c00_SGA3_English_Complete_Working_Reader_20260728.tex"
SOURCE_ZIP_NAME = (
    "10c9_SGA3_English_Complete_Working_Reader_"
    "Source_and_Predecessor_20260728.zip"
)
BUNDLE_MASTER_NAME = "SGA3_English_Complete_Working_Reader_20260728.tex"
...
EXPECTED_CLOSURE_FILES = 892
EXPECTED_CLOSURE_BYTES = 7_957_487
EXPECTED_CLOSURE_TEX = 739
EXPECTED_CLOSURE_PNG = 153
EXPECTED_CLOSURE_AGGREGATE = (
    "D50C7A7B1274A103A467F35E694B9ECD62C05E7FCA6782A5D48512599EBE596E"
)
EXPECTED_PDF_METRICS = {
    "pages": 1469,
    "named_destinations": 9483,
    "internal_goto_actions": 4590,
    "linked_pages": 1061,
    "invalid_actions": 0,
    "uri_actions": 0,
    "font_resources": 61,
...
def main() -> int:
    ...
    source_validation = {
        "schema": "sga3_complete_working_reader_source_bundle_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "scope": (
            "Editorial Notice, Introduction, Exposes I-XXVI, "
            "Tome III guide, and terminal index"
        ),
        "claim": (
            "continuous English working reader; not a critical edition, "
    ...
    package_validation = {
        "schema": "sga3_complete_working_reader_outer_package_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "reader": {
            "filename": PDF_NAME,
