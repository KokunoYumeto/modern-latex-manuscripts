#!/usr/bin/env python3
"""Build the SGA6 idx597-606 rights-curated crop release.
...
START_ENTRY = 1349
END_ENTRY = 1358
SELECTED_AUDIT_ROWS = 10
SELECTED_AUDIT_SHA256 = (
    "9E1AC33DEE85FE0E7F000C868758CA7CBFA017C2F7261209008CB5BEC105D418"
)
EXPECTED_TIGHT_FILES = 20
EXPECTED_OPENED_TIGHT_FILES = 20
EXPECTED_OPENED_TIGHT_BYTES = 1_784_546
EXPECTED_UNREAD_TIGHT_FILES = 0
EXPECTED_ROUTINE_FILES = 50
EXPECTED_ROUTINE_BYTES = 14_224_729
...
def main() -> int:
    ...
    parent_identity = {
        ...
        "claim_boundary": (
            "Sparse visual provenance and QA evidence through idx606 only; "
    ...
    readme = f"""# SGA6 targeted ultra-detail source-audit crops, indices 597-606
...
the Expose X appendix from section 7.15 through the end of section 7.18; the
final included audit entry closes idx606. The bibliography at idx607 is excluded.
...
"""
    ...
    validation = {
        "schema": "sga6_targeted_ultradetail_idx597_606_validation_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "selection": {
