#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx597-606 crop release."""
...
START_ENTRY = 1349
END_ENTRY = 1358
AUDIT_SHA256 = "9E1AC33DEE85FE0E7F000C868758CA7CBFA017C2F7261209008CB5BEC105D418"
TARGET_COUNT = 20
TARGET_BYTES = 1_784_546
EXCLUDED_COUNT = 0
ROUTINE_COUNT = 50
ROUTINE_BYTES = 14_224_729
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx597_606_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx597_606_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx597_606_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx597_606_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx597_606_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx597_606_PARENT_SOURCE_20260727.json"
    ]
    ...
    for index, row in enumerate(target_rows, start=1):
        ...
        if not bool(difference["dimensions_exact"]):
            errors.append(f"target replay dimension mismatch: {source.name}")
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx597_606_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx597-606 ultra-detail crops\n\n"
        ...
        f"{TARGET_COUNT}; renderer-version drift is disclosed per row.\n"
