#!/usr/bin/env python3
"""Build exact same-concept Zenodo controls for the SGA6 idx597-606 crop release."""
...
re-verification. They come from parent indices 597-606 and map to the stable
10-entry audit boundary #1349-#1358. The tranche spans the Expose X appendix
from section 7.15 through the end of section 7.18. Each public crop records
...
"""
    ...
    final_rows.append(
        {
            ...
            "provenance": (
                "current compact same-concept release note; SGA6 idx597-606 "
        ...
        final_rows.append(
            {
                ...
                "provenance": (
                    "SGA6 idx597-606 ultra-detail source-audit crop tranche; "
    ...
    validation = {
        ...
        "sga6_source_audit_crops": {
            ...
            "expose_boundary": (
                "Expose X appendix idx597-606; section 7.15 through the end "
                "of section 7.18; bibliography at idx607 excluded"
            ),
