# Machine-readable evidence schema - SGA2-VIII-C23

Unit stable ID: `SGA2-VIII-C23`. Continuation cursor: French source line 2683
after blank line 2682.
...
clean two-pass build, source/target 300 and 600 dpi review, extraction and font
checks, privacy scan, and an exact self-excluding SHA-256 manifest.
