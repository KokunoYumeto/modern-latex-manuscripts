...
primary IDs in column one. Every record carries authority role and source and
target locators plus status confidence record revision continuation cursor and
