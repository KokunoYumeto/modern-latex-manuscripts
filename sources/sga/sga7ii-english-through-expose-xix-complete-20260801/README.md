# SGA 7 II English working reader through complete Expose XIX

Open `reader/SGA7II_English_Through_Expose_XIX_Complete_20260801.pdf`
to read the current cumulative English translation. The `source/` directory
contains its complete buildable TeX closure.

## Coverage

The reader contains complete English Exposes X through XIX, including the
terminal Expose XIX bibliography. It has 203 A4 pages. Exposes XX through
XXII are excluded; the exact next cursor is the opening of Expose XX.
...
```text
xelatex SGA7II_English_Through_Expose_XIX_Complete_20260801.tex
xelatex SGA7II_English_Through_Expose_XIX_Complete_20260801.tex
xelatex SGA7II_English_Through_Expose_XIX_Complete_20260801.tex
```

The reader starts directly with the mathematics and contains no project-status
preface. `SGA7II_English_Through_Expose_XIX_Complete_Reader_and_TeX_20260801.zip`
