...
% SOURCE-CORRECTION / PENDING EDITORIAL ADJUDICATION: print and working control have the undefined
...
% FRENCH-CONTROL CORRECTION / PENDING EDITORIAL ADJUDICATION: commit 8ccdcf8ee changes the scan's
...
% SOURCE-CORRECTION / PENDING EDITORIAL ADJUDICATION: print and working control say merely that
...
% SOURCE-CORRECTION / PENDING EDITORIAL ADJUDICATION: print/working control say "connected
...
% FRENCH-CONTROL CORRECTION / PENDING EDITORIAL ADJUDICATION: print has Phi^{-1}(G'^T) superset
...
% SOURCE-CORRECTION / PENDING EDITORIAL ADJUDICATION: print/working control use exponent r in the
...
\(t\in S\) (EGA III 7.9.4). Hence (c) follows from 4.6
...
\textbf{Remark 4.8.} Let \(X\) be proper and integral over a noetherian
...
\subsection*{5. Finiteness theorems of ``N\'eron--S\'everi'' type}
...
\(S\)-scheme (XII 1.2, 4.7 (iii)). The order of
\(\underline{\Pic}^\tau_{X_K/K}(K)/\underline{\Pic}^0_{X_K/K}(K)\)
...
equivalence \(C^*_{\mathrm{rat}}(X)\) (see X 7.13).
...
\otimes_{\mathbb Z}\mathbb Q\) is finite. By 4.6 (i)
