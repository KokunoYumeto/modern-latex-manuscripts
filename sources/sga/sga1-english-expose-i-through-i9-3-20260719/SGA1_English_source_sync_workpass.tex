...
\hypersetup{
  pdftitle={SGA 1 English source-synchronization workpass: Exposé I opening through Corollary I.9.3 and its proof},
...
\begin{titlepage}
  ...
  \vspace{3mm}
  {\Large Exposé~I opening through Corollary~I.9.3 and its proof\par}
  \vfill
...
This bounded workpass translates the opening of Exposé~I through
Corollary~I.9.3 and its proof directly
...
\texttt{smf\_doc-math\_3\_01.tex}, lines 556--1760; line 1761 begins
Corollary~I.9.4 and is outside the current workpass. The opening through the
second statement numbered I.9.2 is preserved unchanged from the preceding
independently audited bounded checkpoint. This expanding workpass does not by
itself claim archive acceptance, publication, or remote readback.
Corollary~I.9.3 and its proof are the current source-, structure-,
terminology-, build-, and render-review unit.
