...
\begin{equation}\tag{*}
  ...
  \longrightarrow G.\text{\begin{NoHyper}\footnote{We write \(S\) for the final object of the topos \(S\), and \(\mathbb Z_S\) for the constant sheaf with value \(\mathbb Z\).}\end{NoHyper}}
\end{equation}
