...
\textbf{2.5.} Finally, let us reduce assertion $\mathrm{II}'$ to the following
assertion:

\medskip
\noindent
$\mathrm{II}^*$. Theorem 1.1 when $X$ and $Y$ are integral over $S$ and the
sequence
\begin{equation}\tag{*}
...
\textbf{Lemma 2.6.} Let $Y$ be a noetherian scheme, and let $f:X\to Y$ be a
...
\section*{3. Proof of I: Oort's d\'evissage}

\textbf{Proposition 3.1.} (Oort, \emph{Bull. soc. math. France}, vol.~90
...
\[
  \textbf{3.2.}\qquad \operatorname{im}\delta_T^*
...
\textbf{Corollary 3.4.} Let $k$ be a field, and let $X$ be a proper
...
\textbf{Proposition 3.5.} Let $S$ be an integral noetherian scheme, and let
...
$NI=0$; this is condition (i) of 3.1, and we are reduced finally to the case
in which the other conditions (ii)--(v) are satisfied as well. By the generic
flatness theorem (EGA IV 6.9.1), applied in the notation of 3.1 to
...
\textbf{Remark 3.6.} It follows in the same way, taking account of the exact
sequences
\[
...
\section*{4. Proof of $\mathrm{II}^*$: the most delicate part of the proof}

Recall assertion $\mathrm{II}^*$: Theorem 1.1 when $X$ and $Y$ are integral
...
\textbf{Proposition 4.1.} Let $S$ be an integral noetherian scheme, let
...
\textbf{Lemma 4.2.} Under the hypotheses of 4.1, $f$ is a descent morphism
...
relative to $\alpha$. By 4.2 there is an equivalence between the category
