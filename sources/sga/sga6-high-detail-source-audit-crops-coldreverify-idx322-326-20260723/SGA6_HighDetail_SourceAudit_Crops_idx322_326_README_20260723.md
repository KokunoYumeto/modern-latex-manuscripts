# SGA6 high-detail source-audit crops, cold re-verification indices 322-326
...
- `10m_SGA6_SourceAudit_Explicit_Targeted_HighDetail_Crops_ColdReverify_idx322_326_20260723.zip` contains 1 explicit `zoom`, `zoomp`,
  `peek`, or `recheck` crops / 157,310
  image bytes.
...
`10n_SGA6_SourceAudit_Crop_Provenance_RightsBlocked_Metadata_ColdReverify_idx322_326_20260723.zip` groups the complete public provenance surface, including both
...
`SGA6_Routine_PageBands_idx322_326_RightsBlocked_Manifest_20260723.csv` records 25 routine whole-page or
page-band derivatives / 6,178,351
...
increment covers files modified after `2026-07-23T18:33:00+00:00` and closes
at `2026-07-23T19:26:00+00:00`, after the cold-reverification pass reached parent
index 326 and before it began index 327. The
recoverable indices span 322 through
326 across
