#!/usr/bin/env python3
"""Build the SGA6 idx612-617 rights-curated crop release.
...
START_ENTRY = 1364
END_ENTRY = 1369
SELECTED_AUDIT_ROWS = 6
SELECTED_AUDIT_SHA256 = (
    "4C976AAF1FAD550ACBDE07DB33C855308C489EAB79A16A78EFF44FECD23069C4"
)
EXPECTED_TIGHT_FILES = 6
EXPECTED_OPENED_TIGHT_FILES = 4
EXPECTED_OPENED_TIGHT_BYTES = 383_326
EXPECTED_UNREAD_TIGHT_FILES = 2
EXPECTED_ROUTINE_FILES = 30
EXPECTED_ROUTINE_BYTES = 5_950_321
...
def main() -> int:
    ...
    parent_identity = {
        ...
        "claim_boundary": (
            "Sparse visual provenance and QA evidence through idx617 only; "
    ...
    readme = f"""# SGA6 targeted ultra-detail source-audit crops, indices 612-617
...
Expose XII Section 2's reduction diagrams through the opening of the Oort
devissage and Proposition 3.1, items (i)--(iii), at idx617. The next live page,
idx618, is excluded.
...
"""
    ...
    validation = {
        "schema": "sga6_targeted_ultradetail_idx612_617_validation_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "selection": {
