#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx612-617 crop release."""
...
START_ENTRY = 1364
END_ENTRY = 1369
AUDIT_SHA256 = "4C976AAF1FAD550ACBDE07DB33C855308C489EAB79A16A78EFF44FECD23069C4"
TARGET_COUNT = 4
TARGET_BYTES = 383_326
EXCLUDED_COUNT = 2
ROUTINE_COUNT = 30
ROUTINE_BYTES = 5_950_321
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx612_617_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx612_617_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx612_617_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx612_617_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx612_617_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx612_617_PARENT_SOURCE_20260727.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx612_617_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx612-617 ultra-detail crops\n\n"
