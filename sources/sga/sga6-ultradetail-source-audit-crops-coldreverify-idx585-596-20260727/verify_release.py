#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx585-596 crop release."""
...
START_ENTRY = 1337
END_ENTRY = 1348
AUDIT_SHA256 = "795D51BA05ECDA45E4976DBD64EA9523C18AD39A3A424BCCD0D1F6319EEB79F4"
TARGET_COUNT = 16
TARGET_BYTES = 817_300
EXCLUDED_COUNT = 1
ROUTINE_COUNT = 60
ROUTINE_BYTES = 14_626_507
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx585_596_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx585_596_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx585_596_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx585_596_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx585_596_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx585_596_PARENT_SOURCE_20260727.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx585_596_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx585-596 ultra-detail crops\n\n"
