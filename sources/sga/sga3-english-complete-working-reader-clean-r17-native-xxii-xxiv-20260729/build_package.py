#!/usr/bin/env python3
"""Build the compact, reader-clean SGA3 R17 native-update package."""
...
BUNDLE_MASTER_NAME = (
    "SGA3_English_Complete_Reader_Native_Update_R17_20260729.tex"
)
PREDECESSOR_PDF_NAME = (
    "00c00_SGA3_English_Complete_Reader_Native_Update_R16_20260729.pdf"
)
PREDECESSOR_TEX_NAME = (
    "02c00_SGA3_English_Complete_Reader_Native_Update_R16_20260729.tex"
)
...
EXPECTED_CLOSURE_BYTES = 6_546_298
EXPECTED_CLOSURE_TEX = 770
EXPECTED_CLOSURE_PNG = 128
EXPECTED_CLOSURE_AGGREGATE = (
    "FE22946C5D7A35B3826FC1AD1ACC2E20756BADB01A327A91D0CA64CA1191C387"
)
EXPECTED_PDF_METRICS = {
    "pages": 1472,
    "named_destinations": 9487,
...
def main() -> int:
    ...
    source_validation = {
        "schema": "sga3_complete_reader_native_update_r17_source_bundle_v1",
    ...
    package_validation = {
        "schema": "sga3_complete_reader_native_update_r17_outer_package_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "reader": {
            "filename": PDF_NAME,
