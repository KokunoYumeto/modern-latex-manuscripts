...
VII, and the included portion of VIII are project English translations.
Source-image review was used to check translated text, formulas, diagrams, page
mapping, and the continuation point. The source scan is not duplicated inside
this compact reader package.
