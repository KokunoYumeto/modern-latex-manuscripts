#!/usr/bin/env python3
"""Build the SGA6 idx653-665 rights-curated crop release.
...
START_ENTRY = 1405
END_ENTRY = 1417
SELECTED_AUDIT_ROWS = 13
SELECTED_AUDIT_SHA256 = (
    "53552F00132E2672D78C693FF78ACA8DF7E8A5ED1FD6D6621F9F585993340E3C"
)
EXPECTED_TIGHT_FILES = 81
EXPECTED_OPENED_TIGHT_FILES = 68
EXPECTED_OPENED_TIGHT_BYTES = 3_148_724
EXPECTED_UNREAD_TIGHT_FILES = 13
EXPECTED_ROUTINE_FILES = 65
EXPECTED_ROUTINE_BYTES = 14_631_063
...
def main() -> int:
    ...
    parent_identity = {
        ...
        "claim_boundary": (
            "Sparse visual provenance and QA evidence through idx665 only; "
    ...
    readme = f"""# SGA6 targeted ultra-detail source-audit crops, indices 653-665
...
the continuing Expose XIII source audit from idx653 through idx665. The next
live page, idx666, is excluded.
...
"""
    ...
    validation = {
        "schema": "sga6_targeted_ultradetail_idx653_665_validation_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "selection": {
