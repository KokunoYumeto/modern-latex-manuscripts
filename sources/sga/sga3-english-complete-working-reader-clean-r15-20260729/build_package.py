#!/usr/bin/env python3
"""Build the compact, reader-clean SGA3 working-reader package."""
...
PDF_NAME = "00c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.pdf"
TEX_NAME = "02c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.tex"
SOURCE_ZIP_NAME = (
    "10c9_SGA3_English_Complete_Reader_"
    "Source_and_History_20260729.zip"
)
BUNDLE_MASTER_NAME = "SGA3_English_Complete_Reader_TomeI_Index_20260729.tex"
...
EXPECTED_CLOSURE_FILES = 893
EXPECTED_CLOSURE_BYTES = 7_969_173
EXPECTED_CLOSURE_TEX = 740
EXPECTED_CLOSURE_PNG = 153
EXPECTED_CLOSURE_AGGREGATE = (
    "CED6C1AD89184A485251714BAD6D92012F14495FC44B67DAA3B351EE8D6B8EE0"
)
...
def main() -> int:
    ...
    source_validation = {
        "schema": "sga3_complete_reader_tome_i_index_source_bundle_v1",
    ...
    package_validation = {
        "schema": "sga3_complete_reader_tome_i_index_outer_package_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "reader": {
            "filename": PDF_NAME,
