...
\end{equation}
The two terms on the right-hand side of (5.3) can be evaluated using the classical Lefschetz formula (cf. ). (For the last term this is in fact a trivial Lefschetz formula):
