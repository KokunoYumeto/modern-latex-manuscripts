#!/usr/bin/env python3
"""Build exact same-concept Zenodo controls for the SGA6 idx379-584 crop release."""
...
re-verification. They come from parent indices 379-584 and map to the stable
206-entry audit boundary #1131-#1336. The tranche spans Expose VI, VII, VIII,
IX, X, and the Expose X appendix. Each public crop records parent identity,
source page, pixel bounding box, dimensions, scaling, generator identity,
linked audit entry, target context, and QA disposition.
...
pixel-for-pixel and PNG-byte-for-PNG-byte, and their hashes are disjoint from
prior public crop hashes. The {blocked_bands} routine bands retain exact source
identities and PNG dimensions without redundant public pixels.
...
"""
    ...
    final_rows.append(
        {
            ...
            "provenance": (
                "current compact same-concept release note; SGA6 idx379-584 "
        ...
        final_rows.append(
            {
                ...
                "provenance": (
                "SGA6 idx379-584 ultra-detail source-audit crop tranche; "
    ...
    validation = {
        ...
        "sga6_source_audit_crops": {
            "scope": "parent indices 379-584; audit entries 1131-1336",
            "expose_boundary": (
                "Expose VI idx379-428; VII idx429-478; VIII idx479-510; "
                "IX idx511-531; X idx532-571; X appendix idx572-584"
            ),
