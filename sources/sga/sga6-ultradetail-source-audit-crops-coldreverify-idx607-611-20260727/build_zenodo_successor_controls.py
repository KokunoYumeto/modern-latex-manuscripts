#!/usr/bin/env python3
"""Build exact same-concept Zenodo controls for the SGA6 idx607-611 crop release."""
...
re-verification. They come from parent indices 607-611 and map to the stable
5-entry audit boundary #1359-#1363. The tranche spans the final page and
bibliography of the Expose X appendix and the opening of Expose XII through
Remark 1.7. Each public crop records
...
"""
    ...
    final_rows.append(
        {
            ...
            "provenance": (
                "current compact same-concept release note; SGA6 idx607-611 "
        ...
        final_rows.append(
            {
                ...
                "provenance": (
                    "SGA6 idx607-611 ultra-detail source-audit crop tranche; "
    ...
    validation = {
        ...
        "sga6_source_audit_crops": {
            "scope": "parent indices 607-611; audit entries 1359-1363",
            "expose_boundary": (
                "Expose X appendix final page and bibliography at idx607, "
                "then Expose XII opening through Remark 1.7 at idx611; "
                "idx612 excluded"
            ),
