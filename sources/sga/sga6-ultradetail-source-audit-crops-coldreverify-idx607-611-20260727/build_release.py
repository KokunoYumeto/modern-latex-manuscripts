#!/usr/bin/env python3
"""Build the SGA6 idx607-611 rights-curated crop release.
...
EXPECTED_OPENED_TIGHT_FILES = 6
EXPECTED_OPENED_TIGHT_BYTES = 470_916
EXPECTED_UNREAD_TIGHT_FILES = 0
EXPECTED_ROUTINE_FILES = 25
EXPECTED_ROUTINE_BYTES = 5_811_133
...
def main() -> int:
    ...
    parent_identity = {
        ...
        "claim_boundary": (
            "Sparse visual provenance and QA evidence through idx611 only; "
    ...
    readme = f"""# SGA6 targeted ultra-detail source-audit crops, indices 607-611
...
the final page and bibliography of the Expose X appendix at idx607, followed
by the opening of Expose XII through Remark 1.7 at idx611. The next live page,
idx612, is excluded.
...
"""
    ...
    validation = {
        "schema": "sga6_targeted_ultradetail_idx607_611_validation_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "selection": {
