#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx607-611 crop release."""
...
START_ENTRY = 1359
END_ENTRY = 1363
AUDIT_SHA256 = "099E0158CB1B60257F132261B8D8AF8F61BE2F1DCBE7CEC2F0247F1A3FC902E1"
TARGET_COUNT = 6
TARGET_BYTES = 470_916
EXCLUDED_COUNT = 0
ROUTINE_COUNT = 25
ROUTINE_BYTES = 5_811_133
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx607_611_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx607_611_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx607_611_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx607_611_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx607_611_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx607_611_PARENT_SOURCE_20260727.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx607_611_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx607-611 ultra-detail crops\n\n"
