#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx618-626 crop release."""
...
START_ENTRY = 1370
END_ENTRY = 1378
AUDIT_SHA256 = "E06DECB1DC1CD8527367669B4621E47E7C127F3E3C571F3C739B363B61DD87B2"
TARGET_COUNT = 11
TARGET_BYTES = 1_567_142
EXCLUDED_COUNT = 1
ROUTINE_COUNT = 45
ROUTINE_BYTES = 13_757_137
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx618_626_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx618_626_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx618_626_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx618_626_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx618_626_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx618_626_PARENT_SOURCE_20260727.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx618_626_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx618-626 ultra-detail crops\n\n"
