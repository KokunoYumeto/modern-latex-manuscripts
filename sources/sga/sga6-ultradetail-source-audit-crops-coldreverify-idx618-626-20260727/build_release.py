#!/usr/bin/env python3
"""Build the SGA6 idx618-626 rights-curated crop release.
...
START_ENTRY = 1370
END_ENTRY = 1378
SELECTED_AUDIT_ROWS = 9
SELECTED_AUDIT_SHA256 = (
    "E06DECB1DC1CD8527367669B4621E47E7C127F3E3C571F3C739B363B61DD87B2"
)
EXPECTED_TIGHT_FILES = 12
EXPECTED_OPENED_TIGHT_FILES = 11
EXPECTED_OPENED_TIGHT_BYTES = 1_567_142
EXPECTED_UNREAD_TIGHT_FILES = 1
EXPECTED_ROUTINE_FILES = 45
EXPECTED_ROUTINE_BYTES = 13_757_137
...
def main() -> int:
    ...
    parent_identity = {
        ...
        "claim_boundary": (
            "Sparse visual provenance and QA evidence through idx626 only; "
    ...
    readme = f"""# SGA6 targeted ultra-detail source-audit crops, indices 618-626
...
Expose XII Proposition 3.1 through Lemma 4.4 and the opening of its proof at
idx626. The next live page, idx627, is excluded.
...
"""
    ...
    validation = {
        "schema": "sga6_targeted_ultradetail_idx618_626_validation_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
        "selection": {
