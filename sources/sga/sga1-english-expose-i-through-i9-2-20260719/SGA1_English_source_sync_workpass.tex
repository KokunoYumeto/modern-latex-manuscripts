...
\hypersetup{
  pdftitle={SGA 1 English source-synchronization workpass: Exposé I opening through Proposition I.9.2},
...
\begin{titlepage}
  ...
  \vspace{3mm}
  {\Large Exposé~I opening through Proposition~I.9.2\par}
  \vfill
...
This bounded workpass translates the opening of Exposé~I through the second
statement numbered I.9.2 directly
...
\texttt{smf\_doc-math\_3\_01.tex}, lines 556--1721; line 1722 begins the
equivalence leading to Corollary~I.9.3 and is outside the current workpass.
The opening through Proposition~I.9.1 is preserved in the immutable,
independently audited public-r2 checkpoint; its exact custody payload has been
dispatched to the English/Germanic manager and archive maintenance. Parent
custody acknowledgment, archive acceptance, publication, and remote readback
are not claimed here. Corollary~I.9.2 and Proposition~\ref{prop:I.9.2} are
the current source-, structure-, terminology-, build-, and render-review unit.
