...
\hypersetup{
  ...
  pdfsubject={English translation of SGA 1},
...
\(f^{-1}(f(x))\).A morphism is said to be quasi-finite if it is so at
...
is an open immersion.\end{corollary}
...
isomorphism \(\mathcal B\xrightarrow{\sim}\mathcal B^\vee\),or,
equivalently,
