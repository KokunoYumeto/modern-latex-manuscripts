...
Operational choices adopted from the reference packet and from working draft section:
...
Notes from this working draft section:

- The Deligne examples favor uncluttered article-style documents and concise preambles. working draft section follows that practice.
