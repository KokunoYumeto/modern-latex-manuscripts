...
This is **Artin-Schreier theory** in its classical form, at least when $A$ is the spectrum of a field. \[editorial note: the source says “when $A$ is the spectrum of a field”; mathematically one expects “when $S$ is the spectrum of a
...
respectively Q̃, on X₁′ are deduced from P′, respectively P̃′, by extension of the structural group F₁′ → G₁′; [editorial note: the corrected source inserts the missing article before “extension.”] let q′: Q′ ≃ Q̃′ be the isomorphism obtained
