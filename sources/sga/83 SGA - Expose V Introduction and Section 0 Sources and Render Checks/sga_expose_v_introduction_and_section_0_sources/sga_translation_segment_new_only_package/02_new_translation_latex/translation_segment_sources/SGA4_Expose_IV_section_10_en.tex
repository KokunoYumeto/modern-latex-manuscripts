...
% Range translated in this translation segment: Expose IV, Section 10; source lines 8246--8573.
...
\noindent\emph{Translator's status note.} This is a standalone fresh-only repackage of the missing translation segment material. The translated range corresponds to source lines 8246--8573 of the Orgogozo--Laszlo TeX snapshot. Terminology is normalized to current mathematical English: \emph{geometric morphism} for \emph{morphisme de topos}, \emph{internal Hom} for \emph{faisceau de morphismes} where appropriate, \emph{sheaf of morphisms} for the named object $\scrHom_E(X,Y)$, and \emph{localization morphism}. Numbering follows the source.
