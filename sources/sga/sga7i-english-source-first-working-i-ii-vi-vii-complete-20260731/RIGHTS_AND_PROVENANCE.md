...
and VII are project English translations. Source-image review was used to
check the translated text, formulas, diagrams, page map, and continuation
point. The controlling scan and source-image crops are not included in this
compact reader package.
...
their respective holders. The package preserves a bounded scholarly working
reader and its editable source; it is not a complete SGA 7 I edition, a
