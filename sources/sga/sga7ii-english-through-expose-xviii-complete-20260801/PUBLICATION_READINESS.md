...
current-progress custody with the scope stated in `README.md`. Expose XVIII is
complete, but the package must not be represented as complete SGA 7 II or as
exhaustively cross-referenced.
