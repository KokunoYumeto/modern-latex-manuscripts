#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx632-652 crop release."""
...
START_ENTRY = 1384
END_ENTRY = 1404
AUDIT_SHA256 = "83C3FF90D91B9FE0F6643E2FF3EDB838A5E086CC6F6A0321EE3F43E2AA0ACF86"
TARGET_COUNT = 156
TARGET_BYTES = 13_304_384
EXCLUDED_COUNT = 11
ROUTINE_COUNT = 105
ROUTINE_BYTES = 21_116_925
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx632_652_Manifest_20260728.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx632_652_"
        "Excluded_Manifest_20260728.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx632_652_RightsBlocked_Manifest_20260728.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx632_652_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx632_652_README_20260728.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx632_652_PARENT_SOURCE_20260728.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx632_652_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
