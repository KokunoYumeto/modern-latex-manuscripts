#!/usr/bin/env python3
"""Build exact same-concept Zenodo controls for the SGA6 idx627-631 crop release."""
...
PACKAGE_PATH = (
    "sources/sga/"
    "sga6-ultradetail-source-audit-crops-coldreverify-idx627-631-20260727"
)
...
re-verification. They come from parent indices 627-631 and map to the stable
5-entry audit boundary #1379-#1383. The tranche spans the close of Expose XII
and the opening of Expose XIII through Proposition 1.4 and its diagram chase
at idx631. Each public crop records parent identity, source page, pixel
bounding box, dimensions, scaling, generator identity, linked audit entry,
target context, and QA disposition.
...
Expose VII's 32 native-diagram repairs are now implemented and independently
reverified, and its complete 760-target kind audit is manager-adjudicated. It
remains held while the final 135-target anchor resolution, regenerated
reference graph, rebuilt package, privacy/rights checks, and exact release
audit are completed. Six TikZ coordinate literals remain correctly classified
as nonreferences. Expose XI passed the high-zoom diagram gate and is already
public as a sealed bounded checkpoint. Already published bounded SGA3
checkpoints remain immutable working history and are improved only by additive
successors.
...
"""
    ...
    final_rows.append(
        {
            ...
            "provenance": (
                "current compact same-concept release note; SGA6 idx627-631 "
        ...
        final_rows.append(
            {
                ...
                "provenance": (
                    "SGA6 idx627-631 ultra-detail source-audit crop tranche; "
    ...
    validation = {
        ...
        "sga6_source_audit_crops": {
            "scope": "parent indices 627-631; audit entries 1379-1383",
            "expose_boundary": (
                "close of Expose XII and opening of Expose XIII through "
                "Proposition 1.4 and its diagram chase at idx631; idx632 excluded"
            ),
