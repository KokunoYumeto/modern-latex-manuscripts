#!/usr/bin/env python3
"""Independently replay and verify the SGA6 idx627-631 crop release."""
...
START_ENTRY = 1379
END_ENTRY = 1383
AUDIT_SHA256 = "3D56CA97C97CFFC52707BEB5D7E53F57AF47312C4F8A3AF98CF7B1ACBE084BE3"
TARGET_COUNT = 2
TARGET_BYTES = 379_504
EXCLUDED_COUNT = 0
ROUTINE_COUNT = 25
ROUTINE_BYTES = 7_402_000
...
def main() -> int:
    ...
    target_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx627_631_Manifest_20260727.csv"
    ]
    excluded_manifest = files[
        "SGA6_GeneratedUnread_Tight_Crops_idx627_631_"
        "Excluded_Manifest_20260727.csv"
    ]
    blocked_manifest = files[
        "SGA6_PageBands_idx627_631_RightsBlocked_Manifest_20260727.csv"
    ]
    audit_manifest = files[
        "SGA6_Targeted_UltraDetail_Crops_idx627_631_"
    ...
    readme = files[
        "SGA6_UltraDetail_Crops_idx627_631_README_20260727.md"
    ]
    parent_json = files[
        "SGA6_UltraDetail_Crops_idx627_631_PARENT_SOURCE_20260727.json"
    ]
    ...
    result = {
        "schema": "sga6_targeted_ultradetail_idx627_631_independent_replay_v1",
        "status": "PASS" if not errors else "FAIL",
        "errors": errors,
    ...
    report.write_text(
        "# Independent replay: SGA6 idx627-631 ultra-detail crops\n\n"
