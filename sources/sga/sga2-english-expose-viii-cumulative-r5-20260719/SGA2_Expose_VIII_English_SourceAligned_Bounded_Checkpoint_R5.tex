...
\usepackage{lmodern,amsmath,amssymb,amscd,amsthm,enumitem,microtype,xcolor,geometry,hyperref,xparse}
\geometry{margin=19mm}
\definecolor{softgray}{gray}{0.94}
\hypersetup{hidelinks,hypertexnames=false,pdftitle={SGA 2 Expose VIII bounded source-aligned English checkpoint},pdfauthor={Interlanguage translation project},pdfsubject={Independently reviewed bounded English checkpoint for French lines 2501--2928}}
...
\newcommand{\markedfootnote}[2]{\begingroup\renewcommand{\thefootnote}{#1}\footnote{#2}\endgroup}
\newenvironment{sgastatement}[1]{\par\addvspace{0.75\baselineskip}\noindent\textbf{#1.}\ \itshape}{\par}
\newtheoremstyle{sgatheorem}{\topsep}{\topsep}{\itshape}{}{\bfseries}{}{0pt}{\thmname{#1}\thmnumber{ #2}}
...
\NewDocumentEnvironment{sourcecorollary}{g}{%
  \refstepcounter{sourcecorollary}\par\medskip\noindent
  \IfNoValueTF{#1}{\textbf{Corollary~\thesourcecorollary.}\enspace}{\textbf{Corollary~\thesourcecorollary\markedfootnote{(3)}{#1}.}\enspace}%
  \itshape}{\par\medskip}
...
\begin{center}
  ...
  \small Bounded source-aligned English checkpoint --- 19 July 2026
\end{center}
\noindent\colorbox{softgray}{\parbox{0.95\linewidth}{\footnotesize\textbf{Authority and state.}
Corrected French TeX lines 2501--2928; original printed pp.~84--98;
physical same-edition reader pp.~75--85; recomposed running pp.~67--77.
Thirty source-bearing bounded English units are integrated in audited order.
French line 2500 is an inbound layout control; blank line 2929 and the line
2930 chapter-spacing command are outbound controls, so the bounded-state count
is 32 while the source-component count is 30. The same-edition PDF is a page
and visual control, not independent corroboration. The jcreinhold Markdown is
one comparison lineage only. An independent bounded review passed the 30
source-bearing bodies and cumulative evidence on 19 July 2026; this checkpoint
does not claim whole-volume completion or source certification beyond this scope.}}

% INBOUND NON-BODY CONTROL: French line 2500 is \chapterspace{-1}; excluded.
...
% INTEGRATION CONTROL AFTER SGA2-VIII-CUM-C30
\endgroup

% OUTBOUND NON-BODY CONTROL: French line 2929 is blank; line 2930 is \chapterspace{-1}; both excluded.
