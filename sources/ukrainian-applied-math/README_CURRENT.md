...
- Blackman dynamic-target OCR draft: kept the XeLaTeX/fontspec Cyrillic build, avoiding missing glyphs.
...
| `blackman_ch04_dynamic_targets_spark_ua_gap_format_checked.pdf` | 10 | working OCR gap draft; needs source-level review before being treated as complete |
