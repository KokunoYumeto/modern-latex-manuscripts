...
\section{Мінімальний task note для local TeX worker/local organizer}
...
6. Do not add unrelated prose; preserve the mathematical and engineering scope of the source.
\end{lstlisting}
