...
## 2026-07-18 - Paper 4 Sections 6-7 source repair and four-language survival

The source-defect review lane routed three bounded Paper 4 alerts: one Section 6 German word-boundary defect, one Section 7 lost endpoint equality stroke, and four Section 7 complementary-symbol diacritic defects. These notices were treated as locators. local integration lane independently opened the complete original Paper 4 scan and the focused printed-p137, p142, and p143 witnesses before changing the live cumulative.

Printed p. 137 confirms the compound `Schlussausdruecke`. The R823-derived German editable source split it as `Schluss ausdruecke`. The German theorem statement was repaired. All four Section 6 target bodies already conveyed the correct concept as a compound semantic unit, so no downstream wording was changed merely to imitate a German token boundary. Their unchanged hashes and no-change dispositions are retained.

Printed p. 142 confirms `rho <= n` in the series-expansion setup. The inherited German and all four active Section 7 target bodies had lost the equality stroke at that earlier locus even though formula (54) later retained the endpoint and the proof explicitly treats `rho=n`. The endpoint was restored in German, Latin Interslavic, Cyrillic Interslavic, Russian, and Ukrainian.

Printed p. 143 distinguishes four dotted complementary symbols immediately after formula (52): dotted q and dotted p in the double sum, dotted p in the next displayed equivalence, and dotted p in the following proof prose. R823 had dropped both dots in the double sum, turned the next dotted p into a prime, and dropped the prose dot. All four occurrences were restored in German and in every target language. The four occurrences remain separately addressable as `N04-S07-SRCDEF-001` through `-004`; the endpoint is `N04-S07-SRCDEF-005`.

The manager decisions are cross-referenced as `EG-NOETHER-P04-S7-SOURCE-DEFECT-20260718-0001` and `EG-NOETHER-P04-S7-RHO-ENDPOINT-SOURCE-DEFECT-20260718-0001`. The exact dotted-symbol alert hash is `4EB3F02BEF743A7E91F2A0A16CBC2AB15EDD8D05B94B76D55B49639012858654`; the endpoint alert hash is `E774DDE59BB948AC7A80DB75D3789BC995965FF250531FB19605AF7C9D57FA55`.

The German cumulative advanced from TeX SHA-256 `9545884841ECEFDE816A31D4B69B17C2A7F6635AC82D0E14AE8DE60E2E7C063A` to `8851AF561D7C40B2295DB5D4108684A06015756B9B6FDD7CCE67466E0F7F8134`. XeLaTeX passed twice and the PDF remains 466 pages. German output p. 56 shows the compound word, p. 58 shows the restored early endpoint, p. 59 shows all four dotted symbols, and p. 60 retains the already-correct formula-(54) endpoint.

All eight standalone target sections compiled twice. Every Section 7 PDF was rendered in full, and changed-locus pages 1-2 were visually opened for each language. The endpoint and all four dots are visible in every target output. No fatal, undefined-control, rerun, or overfull flags occurred; existing underfull notices are recorded rather than suppressed.

Process lesson: tiny marks are semantic data. A dot, prime, or absent mark cannot be normalized by family resemblance, and `<` versus `<=` must be checked at every occurrence rather than inferred from a later formula. Cross-language correctness also requires an explicit survival matrix: a repaired German source does not imply that downstream bodies inherited the repair.

Status: the six listed German loci and their stated downstream dispositions are closed against the included source witnesses. This checkpoint does not claim a fresh page-by-page audit of all Paper 4 pages or whole-author completion.
