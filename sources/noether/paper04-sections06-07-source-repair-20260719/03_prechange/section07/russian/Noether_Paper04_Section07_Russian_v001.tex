...
Основная идея доказательства такова: введением преобразованных коэффициентов заменить форму с $n-1$ строками $p_\rho$ формами с $n$ строками $\xi$, когредиентными с $x$, то есть строками величин преобразования. Из этих форм искомые нормальные формы непосредственно выводятся инвариантными процессами дифференцирования. Разложение общих форм по нормальным формам опосредуется рядовым разложением для форм с $\rho$ ($\rho<n$) когредиентными строками $\xi$; инвариантные процессы дифференцирования возвращают к формам в исходных строках $p_\rho$.
