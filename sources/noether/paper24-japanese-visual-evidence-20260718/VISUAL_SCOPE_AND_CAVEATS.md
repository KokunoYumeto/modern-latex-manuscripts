...
The PNGs, JSONL, CSV, schema, checksum ledger, package manifest, validation report, and this note are to enter the next exact handoff to the existing GitHub/Zenodo repository-custody task. This retrofit creates no competing Zenodo draft and no archive deposit itself.
