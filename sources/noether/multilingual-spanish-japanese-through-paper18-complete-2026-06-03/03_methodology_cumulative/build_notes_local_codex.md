...
## Paper 10 local build note

Paper 10 Spanish builds with `pdflatex`. Paper 10 Japanese builds with `xelatex` and `xeCJK`/Noto CJK fonts. The German source excerpt in this packet is scan-corrected for known OCR/source-TeX defects and should be checked against the included source scan.
