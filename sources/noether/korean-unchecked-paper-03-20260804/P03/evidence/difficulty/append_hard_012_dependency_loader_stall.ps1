...
$record=[ordered]@{
 ...
 authority=[ordered]@{path='${PUBLIC_INTERLANGUAGE_ROOT}/03_projects/noether/07_german_canon_control/candidates/NOETH-DE-ED-0001/Noether_German_NOETH-DE-ED-0001.tex';snapshot_sha256=$authoritySha;historical_whole_source_sha256=$authoritySha;locators=@('CSV reproducibility validation dependency discovery; no source/target content access');unit_slice_sha256=[ordered]@{U01='DF50EAD7065F663901F51ADFCA37A138921063362CA449665D37B855921B496C';U02='A7B7CA981F7B8D6B32171BF0709E27440A25B2754642BD095304E54A5A25D5C6';U03='0D110465AEE20E18EE1427577D33D435FCF97D5CA99BEF3878EF52DC341F01A5'}}
