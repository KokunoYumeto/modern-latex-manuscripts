#!/usr/bin/env python3
"""Mechanically produce controlled-generic Hant from the pinned Paper 21 Hans TeX."""
...
HANS = ROOT / "zh-Hans-CN/Noether_Paper21_Chinese_CurrentAuthority_zh-Hans-CN_v001.tex"
HANS_EXPECTED_SHA256 = "F4BCD4C27ED724EA4D79B1EAC0E427E370E2CB5BA1970200B1FD7A26D58E8235"
ASSEMBLY_RECORD = ROOT / "qa/HANS_ASSEMBLY_RECORD.json"
HANT_DIR = ROOT / "zh-Hant-controlled"
HANT = HANT_DIR / "Noether_Paper21_Chinese_CurrentAuthority_zh-Hant-controlled_v001.tex"
...
if hans_sha != HANS_EXPECTED_SHA256:
    raise RuntimeError(
        f"Pinned Hans file changed: expected {HANS_EXPECTED_SHA256}, found {hans_sha}"
    )
...
raw_hant = OpenCC("s2t").convert(hans)
hant = raw_hant
...
# Mechanical structure invariants only; these are not semantic or formula review.
