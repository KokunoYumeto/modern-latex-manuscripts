...
$texName='Noether_Paper11_Chinese_CurrentAuthority_zh-Hans-CN_v001.tex'
...
$record=[ordered]@{
  record_type='producer_mechanical_build';work_unit='Noether Paper 11';target_label='zh-Hans-CN';recorded_local_time=(Get-Date -Format 'yyyy-MM-dd HH:mm:ss zzz');compiler='XeLaTeX';passes=$passes;
