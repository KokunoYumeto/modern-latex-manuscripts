#!/usr/bin/env python3
"""Produce controlled-generic Hant from the assembled Paper 40 Hans draft.

This is a mechanical producer transformation only. It performs no linguistic,
source, visual, regional, human, publication, or certification checking.
"""
...
HANS = ROOT / "zh-Hans-CN/Noether_Paper40_Chinese_CurrentAuthority_zh-Hans-CN_v001.tex"
ASSEMBLY_RECORD = ROOT / "qa/HANS_ASSEMBLY_RECORD.json"
HANT_DIR = ROOT / "zh-Hant-controlled"
HANT = HANT_DIR / "Noether_Paper40_Chinese_CurrentAuthority_zh-Hant-controlled_v001.tex"
...
if hans_sha != expected_hans_sha:
    raise RuntimeError(
        f"Hans producer file changed: expected {expected_hans_sha}, found {hans_sha}"
    )
...
record = {
    ...
    "claim_limit": (
        ...
        "source, formula, terminology, visual, regional, human, external, archive, "
