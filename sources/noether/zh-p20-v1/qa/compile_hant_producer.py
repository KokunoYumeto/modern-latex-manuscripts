#!/usr/bin/env python3
"""Run exactly two producer-only XeLaTeX passes for Paper 20 controlled Hant."""
...
TEX = HANT_DIR / "Noether_Paper20_Chinese_CurrentAuthority_zh-Hant-controlled_v001.tex"
...
for pass_number in (1, 2):
    ...
    transcript = ROOT / "qa" / f"P20_HANT_XELATEX_PASS{pass_number}.stdout.log"
    ...
    retained_engine_log = ROOT / "qa" / f"P20_HANT_XELATEX_PASS{pass_number}.engine.log"
