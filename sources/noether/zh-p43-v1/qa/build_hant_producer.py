#!/usr/bin/env python3
"""Produce controlled-generic Hant from assembled Paper 43 Hans mechanically."""
...
HANS = ROOT / "zh-Hans-CN/Noether_Paper43_Chinese_CurrentAuthority_zh-Hans-CN_v001.tex"
ASSEMBLY_RECORD = ROOT / "qa/HANS_ASSEMBLY_RECORD.json"
HANT_DIR = ROOT / "zh-Hant-controlled"
HANT = HANT_DIR / "Noether_Paper43_Chinese_CurrentAuthority_zh-Hant-controlled_v001.tex"
...
record = {
    ...
    "claim_limit": (
        "Mechanical script transformation and file custody only; no linguistic, source, "
        "formula, terminology, visual, regional, human, external, archive, publication, "
