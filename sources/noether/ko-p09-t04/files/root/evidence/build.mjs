...
const hard = [
  ...
  },
  {
    ...
    attempts: ['Used source-near 모듈 영역 and 모듈 성질 while retaining the defining formula and note verbatim in TeX topology.','Rejected importing a modern module definition absent from the source.'], resolution: 'held_for_checker', residual_risk: 'An established Korean historical-algebra label may differ.', recurrence_cues: ['Modulbereich','Moduleigenschaft','z-alpha'], related_structural_ids: [unitRef('T04_U23'),unitRef('T04_U24')], lexical_basin: 'modern Sino-xenic coinage/calque', sense_window: 'domain defined by an additive module-like expression over algebraic-function coefficients', claim_type: 'editorial_inference',
  },
  {
