...
This continuation resumes after the packaged draft of \emph{Ein algebraisches Kriterium f\"ur absolute Irreduzibilit\"at}. It completes the remaining part of that paper and then continues through the next Noether items and the beginning of the subsequent abstract ideal-theory paper:
\begin{enumerate}
  \item \emph{Ein algebraisches Kriterium f\"ur absolute Irreduzibilit\"at}, closing sections 4--7.
  \item \emph{Formale Variationsrechnung und Differentialinvarianten}.
  \item K. Hentzelt, revised by E. Noether, \emph{Zur Theorie der Polynomideale und Resultanten}.
  \item \emph{Algebraische und Differentialinvarianten}.
  \item \emph{Eliminationstheorie und allgemeine Idealtheorie}.
  \item \emph{Eliminationstheorie und Idealtheorie}.
  \item Short reports on abstract ideal theory, Hilbert numbers, and group characters.
  \item Opening installment of \emph{Abstrakter Aufbau der Idealtheorie in algebraischen Zahl- und Funktionenk\"orpern}.
\end{enumerate}
The notation has been kept close to the German source. The word ``module'' is used for Noether's \emph{Modul} in the older sense of a module or ideal-like system; ``divisor'' and ``divisible by'' are likewise used in the ideal-theoretic divisibility sense of the source.
