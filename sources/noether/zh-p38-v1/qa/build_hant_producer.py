#!/usr/bin/env python3
"""Produce controlled-generic Hant from assembled Paper 38 Hans mechanically."""
...
HANS = ROOT / "zh-Hans-CN/Noether_Paper38_Chinese_CurrentAuthority_zh-Hans-CN_v001.tex"
ASSEMBLY_RECORD = ROOT / "qa/HANS_ASSEMBLY_RECORD.json"
HANT_DIR = ROOT / "zh-Hant-controlled"
HANT = HANT_DIR / "Noether_Paper38_Chinese_CurrentAuthority_zh-Hant-controlled_v001.tex"
...
hans_sha = sha(HANS)
if hans_sha != assembly["output_sha256"]:
    raise RuntimeError(f"Hans producer file changed: expected {assembly['output_sha256']}, found {hans_sha}")

hant = OpenCC("s2t").convert(HANS.read_text(encoding="utf-8"))
normalizations = {
    "Microsoft YaHei": "Microsoft JhengHei",
    "% Noether Paper 38 complete zh-Hans-CN translated producer draft.": "% Noether Paper 38 controlled-generic zh-Hant producer draft.",
