...
Svijanje $s$ s formami 8., 9., 10., 11. poręda (sistem III) (\S\S\ 13--16).
...
\end{adjustbox}
\]
\noindent\textit{Redukcije:} Redukcije, ktore nastavajut črez neposrědnje svijanje s reducentami abo razkladnymi formami, dalej ne budut spominjane.

\mbox{B)} Razklad $((aHu)H_j,s,u)$ i $(a_\eta(aHu)H_j,s,u)$ kako transvekcija črez funkcionalne determinanty.
...
\[
 ((KH^2u)^4,s,u)^2.
\]
\noindent\textit{Redukcije:} Razklad $(K_l(KLu)^3,s,u)^2$, $(H_\vartheta(\theta H^2u)^3,s,u)$, $((K,H\cdot L,u)^5,s,u)$ po \S\ 3. \mbox{2)}, \mbox{c)}; t.j. pri jednovrěmennom razsmotrenju razkladnyh form $(K_l(KLu)^2,s,u)^3$, $(H_\vartheta(\theta H'u)^2,s,u)^2$, $((K,H\cdot L,u)^4,s,u)^2$.

\noindent\textit{Poslědok:} $s^2$ ne vhodit do svijanja s oddělnymi formami sistema III.
