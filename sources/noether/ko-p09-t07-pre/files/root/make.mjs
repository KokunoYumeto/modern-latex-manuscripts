...
const tranche7Text = `${lines.slice(7023 - 1, 7133).join('\n')}\n`;
const tranche7Data = Buffer.from(tranche7Text, 'utf8');
const route = {
  authority: {
  ...
  tranche7: {
    id: 'T07',
    lines: [7023, 7133],
    bytes: tranche7Data.length,
    sha256: createHash('sha256').update(tranche7Data).digest('hex').toUpperCase(),
    units: units7,
    excluded_blank_lines: [7026, 7043, 7074, 7083, 7095, 7122, 7133],
    next_line: 7134,
  },
};
