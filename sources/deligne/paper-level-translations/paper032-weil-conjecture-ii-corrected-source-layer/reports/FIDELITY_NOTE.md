...
Status of this package: source-layer correction plus English rebuild. The French/source PDF is now the original-language source extraction from the uploaded *source/reference volume* volume, pages 1026-1141 inclusive, 116 pages. The prior 99-page French/source layer is superseded; it was a re-typeset working layer and should not have been represented as the source-complete original layer.
...
- Source source/reference volume page count: 3300.
