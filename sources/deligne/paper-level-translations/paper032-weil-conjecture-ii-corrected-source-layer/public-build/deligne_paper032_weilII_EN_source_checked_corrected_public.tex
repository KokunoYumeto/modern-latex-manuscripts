...
\date{}
\begin{document}
% Source note: section titles checked against Paper 032 source; original-language source layer is a 116-page reference extraction. Patch in this version: (6.2.13) support condition corrected from erroneous OCR-derived 1/2(n-i) to n-i.
\maketitle
...
\paragraph{A. Preliminary reductions.}
