...
\]
by means of a pencil of hyperplane sections of $X_0\times X_0$, assumed to be in general position, for a suitable projective compactification of $X_0\times X_0$. We assume that the repair A(i) has been carried out.
...
\subsection*{(1.9) Local monodromy of mixed sheaves}
...
\section*{II. The Hadamard--de la Vallée-Poussin Method}
...
\subsection*{(2.2) Applications to \(L\)-functions}
...
\subsection*{(4.2) Lefschetz pencils}
...
\clearpage
\section*{V. Application to the \texorpdfstring{$\mathbb Q_\ell$}{Q_l}-homotopy type}
...
\section*{VI. The formalism of mixed sheaves}
