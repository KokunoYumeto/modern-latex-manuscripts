...
%% Devanagari (Sanskrit/Hindi) font setup
\newfontfamily\devanagarifont[Script=Devanagari]{Nirmala UI}
\newfontfamily\devanagarifontsf[Script=Devanagari]{Nirmala UI}
\newfontfamily\devanagarifontbold[Script=Devanagari]{Nirmala UI Bold}
