...
\newfontfamily\arabicfontbf[Script=Arabic,Scale=1.08]{Amiri Bold}
...
{\large\textit{\ar{النسخة الثنائية اللغة: الإنجليزية والعربية}}}\\[1cm]
...
\begin{bilingual}
\switchcolumn[0]*
\ar{كان دافع الكاشي فلكياً: سعى لحساب محيط الكون بدقة تجعل خطأ التقريب أصغر من عرض شعرة حصان. وحدد دقة تقريبه مسبقاً واستخدم مضلعاً بـ $3 \times 2^{28} = 805{,}306{,}368$ ضلعاً.}
\switchcolumn[1]*
