...
% Round 7 layout repairs: avoid overfull display math in narrow bilingual columns.
\newcommand{\narrowmathbox}[1]{\begin{gathered}#1\end{gathered}}
...
\newenvironment{transbox}[1][]{%
  \smallskip\par\noindent\begingroup
  \setlength{\parskip}{0.3em}%
  \ifx&#1&\else\textbf{#1}\par\smallskip\fi
}{%
...
{\small With modern mathematical notation and explanatory notes}
\end{center}
\end{minipage}}
\end{center}
...
\par\noindent\begingroup\raggedleft
\begin{Arabic}
\textbf{بسم الله الرحمن الرحيم.}

الحمد لله على نعمه لأهل طاعته، بأدائها بقدرته على عباده المؤمنين به، ليثيبهم بها ثواباً، ويحفظهم بها عن التغيير، ويعرفهم قدرته، ويذللهم لعظمته. أرسل محمداً صلى الله عليه وسلم برسالته بعد انقطاع الرسل، وذهاب العدل، وفساد النُُّصُل.
...
لما نظرت فيما يحتاج إليه الناس في حساباتهم، وجدت أن ذلك كله عدد. ووجدت أيضاً أن كل عدد مؤلف من الوحدات، وأنه لا يخلو عدد من أن ينقسم إلى وحدات. وعلمت أن كل عدد يعدَّ من الواحد إلى العشرة يزيد على الذي قبله بواحد، ثم يضاعف العشر ويثلث، كما فعل بالوحدات، فيكون عشرون وثلاثون وهكذا إلى المائة، ثم يضاعف المائة ويثلثها كما فعل بالعشرات والوحدات إلى الألف، ثم يكرر الألف كذلك في كل عدد مركب، وهكذا إلى أقصى حدٍّ في العدِّ.
...
\begin{transbox}[The Three Kinds]
...
\par\noindent\begingroup\raggedleft
\begin{Arabic}
هذه هي الحالات الستّ التي ذكرتها في مقدمة هذا الكتاب. ثلاث منها لا تحتاج إلى أن تنصف الجذور، وقد بيَّنت كيف تجاب. وأما الثلاث الأخرى التي يجب فيها نصف الجذور، فأرى أن أبيّنها أيضاً مفصَّلة مع ذكر الشكل لكل حالة يبين سبب النصف.
...
\begin{transbox}[The Six Canonical Cases]
...
\begin{equation}
\begin{gathered}
\boxed{x^2 = 5x \Rightarrow x = 5}\\[0.35em]
\boxed{\tfrac{1}{3}x^2 = 4x \Rightarrow x = 12}\\[0.35em]
...
\begin{equation}
\begin{gathered}
\boxed{x^2 = 9 \Rightarrow x = 3}\\[0.35em]
\boxed{5x^2 = 80 \Rightarrow x = 4}\\[0.35em]
...
\begin{gathered}
\boxed{x = 3}\\[0.35em]
\boxed{4x = 20 \Rightarrow x = 5}\\[0.35em]
...
\begin{mathbox}[Algorithm for Case IV]
\begin{equation}
...
\begin{mathbox}[Algorithm for Case V]
\begin{equation}
...
\begin{mathbox}[Algorithm for Case VI]
\begin{equation}
...
\begin{mathbox}[Geometric Proof of Case IV — Completion of the Square]
\begin{center}
...
\cnote{Note:} This is the celebrated method of ``\textbf{completion of the square}'' (\ar{إتمام المربع}), which gives algebra its very name: \textit{al-jabr} refers to the ``restoration'' of the deficient corners. The identity underlying the proof is: $\left(x + \frac{b}{2}\right)^2 = x^2 + bx + \left(\frac{b}{2}\right)^2$.
\par\endgroup
\vspace{0.3cm}
...
\begin{mathbox}[Geometric Proof of Case V]
\begin{center}
...
\begin{mathbox}[Geometric Proof of Case VI]
\begin{center}
...
\begin{transbox}[The Fourfold Multiplication Rule]
...
\begin{transbox}[The Rule of Four Numbers (al-nisba)]
\begin{center}
\small
\begin{tabular}{@{}c|c@{}}
...
\[
a \times b = c \times d \qquad \text{(Rule of Three)}
\]
\[
\text{Unknown} =
\dfrac{\text{product of the two proportionate numbers}}
      {\text{the third known number}}.
\]
\end{center}
\end{transbox}
\par\endgroup
...
\begin{mathbox}[The Pythagorean Theorem]
$a^2 + b^2 = c^2$
...
\noindent\begingroup\raggedright
\lettrine[lines=2, lhang=0.33, nindent=0em, findent=3pt, loversize=0.14]{
\textcolor{dropgold}{T}}{he final portion} of this work treats of the Islamic laws of inheritance (\textit{al-farā'iḍ}). This subject, while seemingly belonging to jurisprudence rather than mathematics, requires the full apparatus of algebra for its solution when legacies are superimposed upon the statutory shares.
