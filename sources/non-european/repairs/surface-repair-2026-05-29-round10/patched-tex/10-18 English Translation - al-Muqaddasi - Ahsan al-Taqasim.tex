...
\newfontfamily\arabicheadingfont[Script=Arabic,Scale=1.25]{Amiri}
...
{\small Bilingual Arabic-English Edition}\\[1.5cm]
...
\begin{footnotesize}
\noindent\textbf{a)} B \textit{\ar{جِبَالٍ}} \textit{An forte} \textit{\ar{الْجِبَالِ}}?, b) B \textit{\ar{المغازاتِ}}, c) B \textit{\ar{والمواصِلِ}}, d) B om. \textit{\ar{مواضع الضِّياعِ}} et habet \textit{\ar{والجَذْبِ}}, e) B et C \textit{\ar{والمصادرِ}}. Deinde B \textit{\ar{والْجَزِمِ}}, f) B \textit{\ar{والعَجائزِ}} i.

e. \textit{\ar{والمَباني}}. Deinde B et C \textit{\ar{والمِنْيَمِ}}, g) B om., h) B et C غنى ut saepissime in talibus.
\end{footnotesize}
...
\begin{footnotesize}
\noindent\textbf{a)} \C\ add. ut saepe \textit{\ar{تعالى}}. \textbf{b)} \B\ \textit{\ar{رغبت}} sine \textit{\ar{نفسي}} et deinde \textit{\ar{وطبعت}} et \textit{\ar{وخوفت}}. \textbf{c)} \C\ om. sed post \textit{\ar{برضاه}} addit \textit{\ar{معين}}. \textbf{d)} \B\ \textit{\ar{بفهما}}. \textbf{e)} \C\ \textit{\ar{تعالى}}. \textbf{f)} \B\ om. \textbf{g)} \B\ pro his \textit{\ar{السمان}} \textit{\ar{وذوقته وعقلته}}. Deinde \C\ \textit{\ar{وعليت}} pro \textit{\ar{وعملت}}. \textbf{h)} \C\ om. \textbf{i)} \C\ \textit{\ar{بنيانه}} et om. \textit{\ar{سوال}}. \textbf{k)} \B\ \textit{\ar{يد}}. \textbf{l)} \B\ haec om. Deinde \C\ habet \textit{\ar{وشاهدته بفصول}}.

\vspace{0.2cm}

\noindent\textbf{m)} \C\ \textit{\ar{سلكتها}} (\B\ \textit{\ar{السُّخى}}). \textbf{n)} \C\ om. \textbf{o)} \C\ \textit{\ar{وضد}} addito \textit{\ar{كذا}}. Apud Hadji-Khalifa, V, p.~510 omittitur vocabulum.
\end{footnotesize}
