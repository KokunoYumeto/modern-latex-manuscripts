...
\item Nos. 19--40 list Sanskrit astronomical, algebraic, calendrical, and jyotisha works issued by the Chowkhamba Sanskrit Book Depot.
\item The catalogue includes works attributed to or edited by Sri-Candrasekhara, Srimahavira Pandita, Sriganesha-dhara Mitra, Sri-Sudhakar Dvivedi, and related authors.
\item The final entry records \textit{Tulanatmaka bhasa sastra} by Dr. Mangala-deva Sastri.
\end{itemize}
