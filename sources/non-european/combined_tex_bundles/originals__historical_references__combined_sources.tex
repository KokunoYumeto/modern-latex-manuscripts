...
\newfontfamily\arabicheadingfont[Script=Arabic,Scale=1.3]{Arial}
...
\section*{Editorial Note on the Manuscripts}
...
\item \textbf{local packaging assistant Berolinensis} (B): A manuscript preserved in the Royal Library of Berlin, containing the complete text of al-Muqaddasi's work with certain lacunae.
\item \textbf{local packaging assistant Constantinopolitanus} (C): A manuscript from Constantinople, fuller in certain respects, containing valuable additions and variants.
\end{enumerate}
...
\midrule
\endhead
\textit{B} & local packaging assistant Berolinensis \\
\textit{C} & local packaging assistant Constantinopolitanus \\
\textit{om.} & omits \\
\textit{add.} & adds \\
...
This PDF represents Volume II, containing editorial notes, commentary,
...
\begin{itemize}
  \item \textbf{C.} (= local packaging assistant) --- The primary manuscript
...
\newfontfamily\arabicfont[Script=Arabic,Scale=1.15,Renderer=Harfbuzz]{Arial}
\newfontfamily\arabicfontsf[Script=Arabic,Scale=1.1,Renderer=Harfbuzz]{Arial Arabic}
...
\textit{Now Modern LaTeX edition}\\
...
%% Arabic Font
\newfontfamily\arabicfont[Script=Arabic,Scale=1.1]{Arial Arabic}
