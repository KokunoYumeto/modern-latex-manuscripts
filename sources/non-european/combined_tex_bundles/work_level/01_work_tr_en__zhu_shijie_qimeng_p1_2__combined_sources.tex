...
\newcommand{\transnote}[1]{%
  \par\smallskip\noindent\textcolor{notecolor}{\small[Editorial Note: #1]}\par\smallskip
}
...
% xeCJK for Chinese
\usepackage{xeCJK}
\setCJKmainfont[Path=/mnt/agents/fonts/noto-sc-extracted/]{NotoSansCJKsc-Regular.otf}[Scale=1.0]
\setCJKsansfont[Path=/mnt/agents/fonts/noto-sc-extracted/]{NotoSansCJKsc-Regular.otf}[Scale=1.0]
