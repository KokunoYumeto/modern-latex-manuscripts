...
% xeCJK for Chinese
\usepackage{xeCJK}
\setCJKmainfont[Path=fonts/noto-cjk/]{NotoSansCJKsc-Regular.otf}[Scale=1.0]
\setCJKsansfont[Path=fonts/noto-cjk/]{NotoSansCJKsc-Regular.otf}[Scale=1.0]
\setCJKmonofont[Path=fonts/noto-cjk/]{NotoSansCJKsc-Regular.otf}[Scale=0.9]
