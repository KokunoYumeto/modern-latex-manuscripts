...
| T02 | Geography (regions + cities), longitude/latitude | 8 | Regional leaf 1 (Western Europe, 12 provinces) **COMPLETE with coordinates** (Nallino Pars II regional table, p.481). The full **city gazetteer** (~270 localities, Nallino Pars II pp.485–501) is located and is the next geography work. | leaf 1 complete; city table located, pending |
