...
Written for the open-source DOI workflow (repo: `Papors\GitHub\modern-latex-manuscripts`).
...
- OCR env (`C:\Users\Floris\ocr_env`, a venv): surya/pix2tex/docling + their torch (then force the matching
  CUDA build on top). Invoke via `C:\Users\Floris\ocr_env\Scripts\python.exe`.
...
- Workspace: `C:\Users\Floris\Documents\CLAUDE PLEASE DONT DELETE WINDOWS 32\albattani_work\`
...
- Open-source destination: `C:\Users\Floris\Documents\Papors\GitHub\modern-latex-manuscripts\`
