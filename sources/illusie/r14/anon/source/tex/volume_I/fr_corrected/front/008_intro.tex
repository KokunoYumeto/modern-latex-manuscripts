% Physical p.11 / Roman IX. Only carrier line-break hyphens are joined.
...
et à des applications de celle-ci à quelques problèmes de déformation
infinitésimale globale. Les plus intéressantes concernent des calculs d'obstructions
à la déformation de schémas en groupes plats commutatifs, calculs qui jouent un
...
induisent des isomorphismes sur les faisceaux d'homotopie, on définit diverses
catégories ``dérivées'', généralisations communes des catégories dérivées de
Verdier [27] et des catégories homotopiques de Quillen [23]. En raison de son
...
\IllusieNote{1}{A. Grothendieck, \emph{Cristaux et modules de Dieudonné}, exposé au Congrès International des Mathématiciens, Nice (1970), et Cours au Collège de France, 70-71 et 71-72.}
