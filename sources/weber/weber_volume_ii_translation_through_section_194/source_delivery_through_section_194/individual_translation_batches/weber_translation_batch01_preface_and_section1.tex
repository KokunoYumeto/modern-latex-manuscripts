...
\title{Heinrich Weber --- \textit{Textbook of Algebra}\\Working English Translation part 01}
\author{Translated from the source system-cleaned source lane}
\date{}
\begin{document}
\maketitle
...
\bigskip
\noindent This file is a working translation artifact only. It translates the cleaned source system source opening material and the start of \S 1; it does not yet claim chapter-complete coverage.
\end{document}
