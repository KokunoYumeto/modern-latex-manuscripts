...
\title{Heinrich Weber\\\emph{Lehrbuch der Algebra}\\Working English Translation part 12\\Alternating, Orthogonal, and Fractional Linear Groups}
...
This part continues Weber's linear-group chapter and begins the next section on fractional linear substitutions.  The available cleaned source skips from \S 49 to \S 51; this part translates all sections present in that interval.
