...
\title{Heinrich Weber\\\emph{Lehrbuch der Algebra}\\Working English Translation part 11\\Galois Groups, Metacyclic Groups, and Abstract Groups}
...
This part continues Weber's transition from invariant theory and linear substitutions to Galois groups and the abstract group concept.
