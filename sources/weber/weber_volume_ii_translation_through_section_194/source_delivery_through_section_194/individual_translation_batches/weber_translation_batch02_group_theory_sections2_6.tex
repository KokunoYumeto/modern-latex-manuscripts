...
\usepackage{hyperref}
\title{Heinrich Weber\\Lehrbuch der Algebra\\Working English Translation part 02\\General Group Theory, §§2--6}
\author{}
\date{}
\begin{document}
\maketitle
...
This is a working English translation prepared from the cleaned source system-typeset Weber source currently in hand. It covers the group-theory sections §§2--6 of the extracted Weber volume. Mathematical notation has been normalized lightly, but the structure and claims of the source have been preserved.
