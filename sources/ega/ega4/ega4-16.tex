...
The commutativity of the first diagram \sref{IV.16.4.11.4} follows also from \sref{IV.16.2.3}[(ii)] this time applied to the second diagram \sref{IV.16.11.1.4}.
...
more precisely, it follows from \sref{IV.16.11.1.5} that we have
\[
  \label{IV.16.11.1.7}
