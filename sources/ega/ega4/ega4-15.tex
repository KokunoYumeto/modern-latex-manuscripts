...
\label{IV.15.7.11}
Let $f:X\to Y$ be a separated morphism of finite presentation; suppose that there exists a surjective morphism of finite presentation $g:Y'\to Y$, which is moreover either proper or plat, and such that if one sets $X'=X\times_Y Y'$, there exists a $Y'$-section of $X'$ (or even a $Y$-morphism $Y'\to X$ (\sref[I]{I.3.3.14})).
