...
If $s:S\to Y$ is a section of $g$, then $s'=(1,s\circ f)_S$ and $s':X\to S$ and $s':X\to X\times_S Y$, is a section of $p_1$ and $X$, equipped with the two morphisms $f:X\to S$ and $s':X\to X\times_S Y$, identifies with the fibre product of the $Y$-preschemes $S$ and $X\times_S Y$ for the morphisms $s:S\to Y$ and $p_2:X\times_S Y\to Y$.
\end{lemma}
