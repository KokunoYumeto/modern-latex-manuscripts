...
\medskip\noindent
\begin{enumerate}
  \item[(i)] First note that $f':Y'\to X'$ and $u:Y'\to Y$ jointly identify $Y'$ with the product $Y\times_X X'$ (for the structure morphisms $f:Y\to X$ and $v:X'\to X$) \sref{IV.14.5.12.1}.
