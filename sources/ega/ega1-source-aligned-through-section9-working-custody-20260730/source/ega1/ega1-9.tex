...
\begin{proof}
Let $U_\lambda=U\cup W_\lambda$; we will define a family $(\sh{G}'_\lambda)$ by transfinite induction,
...
$\sh{F}$ such that $\sh{G}'|U_\lambda=\sh{G}'_\lambda$ for all $\lambda\in L$ \sref[0]{0.3.3.1} will then give
