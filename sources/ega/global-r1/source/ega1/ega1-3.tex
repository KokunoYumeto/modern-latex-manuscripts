...
$p_2\circ f=h$. If $X'$ and $Y'$ are two $S$-preschemes, $p_1'$ and $p_2'$ the canonical
  projections of $X'\times_S Y'$ (assumed to exist), and let $u:X'\to X$ and
  $v:Y'\to Y$ be $S$-morphisms. We then write $u\times_S v$ (or simply $u\times v$)
  for the $S$-morphism
...
It also follows from the definitions that every \emph{monomorphism of preschemes} (T,~1.1) is radicial.
