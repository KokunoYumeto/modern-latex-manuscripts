...
\]
by definition; the identification of $u^1$ and $v^1$ with the homomorphisms of \sref{0.18.3.4.2} follows from \sref{0.20.6.6.4}.
\end{proof}
...
We suppose that $\Omega^1_{B/A}$ and $\mathfrak{n}/\mathfrak{n}^2$ are $B_0$-modules of finite type.
