...
Moreover, $\mathfrak{b}+Aa=\mathfrak{m}$, and the composed homomorphism
\[
...
\begin{proof}
(i) This follows from \sref{0.17.3.4.1} and from the fact that for an $A$-module of finite type, it is equivalent to say that this module is projective or free (Bourbaki, \emph{Alg.~comm.}, chap.~II, \textsection3, n\textsuperscript{o}~2, cor.~2 of prop.~5);
