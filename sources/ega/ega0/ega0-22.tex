...
It amounts to the same thing to say that $\mathrm{B}$ is a $\mathrm{A}$-algebra formally smooth \emph{relatively} to $\Lambda$, or a $\mathrm{A}$-algebra formally smooth relatively to $\Lambda$.
To see that $\mathrm{B}$ is a $\mathrm{A}$-algebra formally smooth for the $\mathfrak{J}$-preadic topology, it suffices therefore, by virtue of \sref{0.20.7.2}, to prove that the continuous homomorphism of topological $\mathrm{B}$-modules $u_{\mathrm{B}/\Lambda/\Lambda}:\Omega^1_{\Lambda/\Lambda}\otimes_\mathrm{A}\mathrm{B}\to\Omega^1_{\mathrm{B}/\Lambda}$ is \emph{formally inversible on the left}.
...
By virtue of \sref{0.19.1.9}, it suffices therefore, for $u_{\mathrm{B}/\Lambda/\Lambda}$ to be formally inversible on the left, that $u_{\mathrm{B}/\Lambda/\Lambda}\otimes 1_\mathrm{C}$ be inversible on the left.
But by virtue of $\gamma'$), this last application is injective, and on the other hand
\[
...
(ii) If $\mathrm{B}$ is a $\Lambda$-algebra formally smooth for the $\mathfrak{J}$-preadic topology, $\mathrm{B}$ is a $\mathrm{A}$-algebra formally smooth for the $\mathfrak{J}$-preadic topology as well, since $\mathrm{A}$ is a $\Lambda$-algebra formally smooth for the discrete topology; the conditions $\alpha$) and $\beta$) result from \sref{0.19.5.4}.
It amounts to the same thing to say that $\mathrm{B}$ is a $\mathrm{A}$-algebra formally smooth relatively, or a $\mathrm{A}$-algebra formally smooth relatively to $\Lambda$.
To see that $\mathrm{B}$ is a $\Lambda$-algebra formally smooth, it suffices therefore, by virtue of \sref{0.20.7.2}, to prove that the continuous homomorphism of topological $\mathrm{B}$-modules $u_{\mathrm{B}/\Lambda/\Lambda}:\Omega^1_{\Lambda/\Lambda}\otimes_\mathrm{A}\mathrm{B}\to\Omega^1_{\mathrm{B}/\Lambda}$ is \emph{formally inversible on the left} \sref{0.19.1.7}, and \emph{a fortiori} injective.
Finally, $\Omega^1_{\mathrm{B}/\Lambda}$ is a $\mathrm{B}$-module formally projective \sref{0.20.4.9}, and consequently $\Omega^1_{\mathrm{B}/\Lambda}\otimes_\mathrm{B}\mathrm{C}$ is a projective $\mathrm{C}$-module \sref{0.19.2.4}; the equivalence of $c$) results then from \sref{0.19.1.9}.
\end{proof}
...
\begin{enumerate}
  \item[a)] $\mathrm{B}$ is a $\mathrm{A}$-algebra formally smooth for the $\mathfrak{m}$-preadic topology.
...
Then, for $\mathrm{B}$ to be a $\mathrm{A}$-algebra formally smooth for the $\mathfrak{m}$-preadic topology, it suffices that the following conditions be satisfied:
...
One will note that the two conditions \sref{0.22.1.3.1} and \sref{0.22.1.3.2} are implied by the following:
...
But the formation by recurrence of $v_j$ results from the hypothesis on $\mathrm{B}$ and from the fact that $\mathfrak{n}'^j+(\mathfrak{n}'^{j+1}+\mathfrak{m}\mathrm{B}')=\mathfrak{n}'^j+\mathfrak{m}\mathrm{B}'$.
...
\begin{enumerate}
  ...
  \item[b)] For every $n$, the canonical homomorphism $\Omega^1_k\otimes_k(\mathrm{A}/\mathfrak{m}^{n+1})\to\Omega^1_\mathrm{A}\otimes_\mathrm{A}(\mathrm{A}/\mathfrak{m}^{n+1})$ is inversible on the left.
  \item[c)] The canonical homomorphism $\Omega^1_k\widehat{\otimes}_k\mathrm{A}\to\widehat{\Omega}^1_\mathrm{A}$ is inversible on the left.
  \item[d)] $\mathrm{A}$ is a $k$-algebra formally smooth (for the $\mathfrak{m}$-preadic topology) \emph{relatively to the prime field}.
\end{enumerate}
...
Finally, we have also seen in \sref{0.22.1.1} that $b$) and $d$) are equivalent, and the equivalence of $b$) and $c$) results from \sref{0.19.1.8}.
\end{remark}
...
\]
are commutative.
It is immediate that the \emph{equivalence classes} of triplets $(\mathrm{A},\alpha,\beta)$ form an \emph{ensemble} that we shall denote $\operatorname{FL}(\mathrm{K}/k,\mathrm{V})$.
...
The canonical application \sref{0.22.2.4.1} is a bijection from $\operatorname{FL}(\mathrm{K}/k,\mathrm{V})$ to the set of $\mathrm{K}$-homomorphisms injective from $\Upsilon_{\mathrm{K}/k}$ to $\mathrm{V}$.
\end{proposition}
...
We now note that since $\mathrm{A}'$ is metrizable and complete, and $\mathrm{A}$ a $k$-algebra formally smooth, the homomorphism composed $\mathrm{A}\to\mathrm{A}/\mathfrak{m}^2\xrightarrow{v}\mathrm{A}'/\mathfrak{m}'^2$ factors as $\mathrm{A}\xrightarrow{u}\mathrm{A}'\to\mathrm{A}'/\mathfrak{m}'^2$, where $u$ is a $k$-homomorphism \sref{0.19.3.11}, and one has thus already $\gr^0(u)=v^0$ and $\gr^1(u)=v^1$.
...
For there to exist a $k$-algebra $\mathrm{A}$, which is a local Noetherian ring, with maximal ideal $\mathfrak{m}$, such that $\mathrm{A}/\mathfrak{m}=\mathrm{K}$ and such that $\mathrm{A}$ be formally smooth (for the $\mathfrak{m}$-preadic topology), it is necessary and sufficient that $\Upsilon_{\mathrm{K}/k}$ be a $\mathrm{K}$-vector space of finite rank.
The $k$-algebra $\mathrm{A}$ is then determined (up to $k$-isomorphism near, giving by passing to quotients the identity $\mathrm{K}\to\mathrm{K}$) by its dimension alone, which is subject to the sole condition of being $\geq\rg_\mathrm{K}\Upsilon_{\mathrm{K}/k}$.
\end{theorem}

\begin{proof}
Since $\mathfrak{m}/\mathfrak{m}^2$ is of finite rank over $\mathrm{K}$, the necessity of the condition results from \sref{0.22.2.2}, (ii)); conversely, \sref{0.22.2.5} shows that the condition is sufficient and that one can take for $\mathfrak{m}/\mathfrak{m}^2$ a $\mathrm{K}$-vector space of rank any $\geq\rg_\mathrm{K}(\Upsilon_{\mathrm{K}/k}$).
\end{proof}
...
\begin{enumerate}
  ...
  For example, let $k_0$ be a perfect field of characteristic $p>0$, $k=k_0(\mathrm{T})$ the field of rational fractions in one indeterminate, so that $\mathrm{K}=k^{p^{-\infty}}$ is the smallest perfect extension of $k$.
...
\begin{enumerate}
  ...
  \item[b)] There exists $\alpha_0$ such that $\mathrm{A}$ is a $k$-algebra formally smooth (for the $\mathfrak{m}$-preadic topology) relatively to $k_\alpha$, for every $\alpha\geq\alpha_0$.
...
\begin{proof}
Indeed, if $\mathrm{A}$ is a formally smooth $k$-algebra, it is so \emph{a fortiori} relatively to every subfield of $k$, which implies $c$) by virtue of \sref{0.20.7.2} and \sref{0.19.1.7}; it is clear that $c$) implies $b$), and that $b$) implies $a$).
...
\begin{proof}
The equivalence of $b$) and $c$) results from the exact sequence \sref{0.20.6.22.1}; the equivalence of $c$) and $a$) results from \sref{0.20.5.12}, this sequence being split if it is exact, since these are vector spaces.

One will note that if $\mathrm{K}$ is \emph{separable} over $k$, the conditions equivalent of \sref{0.22.2.9} are satisfied, by virtue of the definition of $\chi_{\mathrm{A}/k}$ \sref{0.22.2.1} and of \sref{0.20.6.3}.
\end{proof}
...
\begin{enumerate}
  ...
  \item[b)] The homomorphism composed $\Upsilon_{\mathrm{K}/k_0}\to\Upsilon_{\mathrm{K}/k}\xrightarrow{\chi_{\mathrm{A}/k_0}}\mathfrak{m}/\mathfrak{m}^2$ is zero.
...
\begin{proof}
Since the composition in $b$) is nothing other than $\chi_{\mathrm{A}/k_0}$, the equivalence of $a$) and $b$) results from \sref{0.22.2.9}; on the other hand, $b$) and $c$) are equivalent by virtue of the exact sequence \sref{0.20.6.18.1}; and since the canonical homomorphism $\Upsilon_{\mathrm{K}/k}\to\Upsilon_{\mathrm{K}/k/k_0}$ is surjective, this implies the uniqueness of $\chi'$; the fact that $\chi'$ is the characteristic homomorphism of the $k_0$-extension $\mathrm{A}/\mathfrak{m}^2$ results from \sref{0.20.6.22.2}.
\end{proof}
...
If $\widehat{\mathrm{A}}_0$ and $\widehat{\mathrm{A}}$ are the completions of $\mathrm{A}_0$ and $\mathrm{A}$ for their preadic topologies respectively, then, when one equips $\mathrm{A}_0$, $\mathrm{A}$ and $\widehat{\mathrm{A}}$ with discrete topologies, $\widehat{\mathrm{A}}$ is a $\mathrm{A}$-algebra formally smooth relatively to $\mathrm{A}_0$ \sref{0.19.9.1}.
\end{lemma}

\begin{proof}
It is known that $\widehat{\mathrm{A}}=\mathrm{A}\otimes_{\mathrm{A}_0}\widehat{\mathrm{A}}_0$ (Bourbaki, \emph{Alg.~comm.}, chap.~IV, \textsection~2, n\textsuperscript{o}~5, cor.~3 of prop.~9 and chap.~III, \textsection~3, n\textsuperscript{o}~4, th.~1), so the proposition results from \sref{0.19.9.3}.
\end{proof}
...
But \sref{0.22.3.1} shows that, for every $\alpha$, $\widehat{\mathrm{A}}$ is a $\mathrm{A}$-algebra formally smooth relatively to $\mathrm{A}_\alpha$ (for the discrete topologies); hence $\widehat{\mathrm{A}}\otimes_{\mathrm{A}_\alpha}\mathrm{K}_\alpha=\widehat{\mathrm{A}}\otimes_\mathrm{A}(\mathrm{A}\otimes_{\mathrm{A}_\alpha}\mathrm{K}_\alpha)$ is an $(\mathrm{A}\otimes_{\mathrm{A}_\alpha}\mathrm{K}_\alpha)$-algebra formally smooth relatively to $\mathrm{K}_\alpha$, for the discrete topologies \sref{0.19.9.2}, (iii)).
Since $\mathrm{A}$ is an $\mathrm{A}_\alpha$-algebra \emph{finite}, we have $\mathrm{A}\otimes_{\mathrm{A}_\alpha}\mathrm{K}_\alpha=\mathrm{K}$; as $\widehat{\mathrm{A}}_\mathfrak{p}$ is a ring of fractions of $\widehat{\mathrm{A}}\otimes_\mathrm{A}\mathrm{K}$, we deduce \sref{0.19.9.2}, (iv)) that $\widehat{\mathrm{A}}_\mathfrak{p}$ is a $\mathrm{K}$-algebra formally smooth \emph{relatively} to $\mathrm{K}_\alpha$, for the discrete topology, and \emph{a fortiori} for its $\mathfrak{p}$-adic topology \sref{0.19.3.8} and \sref{0.19.9.5}).
...
Now, we know that the ring $\mathrm{A}_0$ is \emph{regular} \sref{0.17.3.8}, and it verifies one of the hypotheses (i), (ii) of \sref{0.22.3.2}, by virtue of \sref{0.21.8.8}; it suffices therefore to apply \sref{0.22.3.2}, replacing $\mathrm{B}$ by $\mathrm{A}$ and $\mathrm{A}$ by $\mathrm{A}_0$.
\end{proof}
...
We will note that these two ranks can be equal without having $\mathfrak{m}'=\mathfrak{m}\mathrm{A}'$.
\end{remark}

\begin{proposition}[22.4.3]
\label{0.22.4.3}
With the hypotheses and notations of \sref{0.22.4.1}, suppose that $\mathrm{A}$ and the $\mathrm{K}$ be of characteristic $p>0$ (in other words, that $p.1\in\mathfrak{m}$ in $\mathrm{A}$), and that the $\mathrm{F}_i$ be of the form
\[
\label{0.22.4.3.1}
  \mathrm{F}_i(\mathrm{T}_i)=\mathrm{T}_i^{d_i}+\sum_{1\leq k\leq d_i}c_{ik}\mathrm{T}_i^{d_i-k}
  \tag{22.4.3.1}
\]
where $d_i\geq 2$ for every $i$, and $c_{ik}\in\mathfrak{m}$.
Let $\mathrm{A}'$ be the quotient of $\mathrm{A}[\mathrm{T}_1,\ldots,\mathrm{T}_r]$ by the ideal generated by the $r$ polynomials $\mathrm{F}_i$.
Then:
\begin{enumerate}
  \item[\rm{(i)}] $\mathrm{A}'$ is a local ring, and its residue field $\mathrm{K}'=\mathrm{A}'/\mathfrak{m}'$ is isomorphic to $\mathrm{K}$ as a field over $\mathrm{A}$.
...
\label{0.22.4.4}
With the hypotheses and notations of \sref{0.22.4.1}, suppose that $\mathrm{K}$ be of characteristic $p>0$ (hence $p.1\in\mathfrak{m}$ in $\mathrm{A}$) and that the $\mathrm{F}_i$ be of the form
\[
\label{0.22.4.4.1}
...
(i) This time $\mathrm{A}'\otimes_\mathrm{A}\mathrm{K}=\mathrm{A}'/\mathfrak{m}\mathrm{A}'$ is isomorphic to $\mathrm{K}[\mathrm{T}_1,\ldots,\mathrm{T}_r]/\mathfrak{b}'$, where $\mathfrak{b}'$ is the ideal generated by the polynomials $\mathrm{F}_i=\mathrm{T}_i^p-b_i$ $(1\leq i\leq r)$; on deduces that $\mathrm{A}_1'$ is isomorphic to the quotient of the polynomial ring $\mathrm{A}_1[\mathrm{T}_1,\ldots,\mathrm{T}_r]$ by the ideal generated by the $\mathrm{F}_i$.
...
If $\mathrm{C}$ is a $(\Lambda/p\Lambda)$-algebra formally smooth for the discrete topologies, one has an exact sequence canonical
\[
\label{0.22.4.4.3}
...
We note that one is under the conditions of application of \sref{0.22.1.1}, (ii)), so the upper line of the diagram \sref{0.22.4.4.6} is \emph{exact}; the extreme columns of the diagram
...
\]
hence, tensorizing \sref{0.22.4.5.1} by $\mathrm{K}$, one obtains a $\mathrm{K}$-\emph{homomorphism canonical}
\[
\label{0.22.4.5.2}
...
By \emph{restriction} to $\Xi_{\mathrm{B}_{(\mathrm{K})}/\mathrm{K}}=\Ker(\pi_{\mathrm{B}_{(\mathrm{K})}/\mathrm{K}})$, the homomorphism $\pi'_{\mathrm{B}_{(\mathrm{K})}/\mathrm{K}}$ therefore defines a homomorphism canonical
\[
\label{0.22.4.5.3}
...
It follows from the definitions that for $\chi'_{\mathrm{B}/\mathrm{A}}$ to be \emph{injective}, it is necessary and sufficient that $\pi'_{\mathrm{B}_{(\mathrm{K})}/\mathrm{K}}$ be injective, the kernel of the latter being obviously contained in $\Xi_{\mathrm{B}_{(\mathrm{K})}/\mathrm{K}}$.
\end{env}

\begin{proposition}[22.4.7]
\label{0.22.4.7}
Let $\mathrm{A}$ be a local artinian ring whose maximal ideal $\mathfrak{m}$ is of square zero, $\mathrm{K}=\mathrm{A}/\mathfrak{m}$ its residue field, $\mathrm{V}$ the ideal $\mathfrak{m}$ considered as a $\mathrm{K}$-vector space; one supposes that $\mathrm{A}$ is of characteristic $p>0$; let
\[
\label{0.22.4.7.1}
...
\label{0.22.4.7.2}
  ...
  \tag{22.4.7.2}
\]
  (cf.~\sref{0.22.4.6.2}) be injective.
\end{enumerate}
\end{proposition}
...
But it results from \sref{0.22.4.3} that this last relation is \emph{equivalent} to the fact that the classes $h_i$
\end{proof}
...
If $y^p=x+pz$ with $x\in\mathrm{A}$, $z\in\mathrm{B}$, the \emph{class}$(A\cap pB)$ of $x$ is well determined, and since $\mathrm{A}\cap p\mathrm{B}=p\mathrm{A}$ as $\mathrm{B}$ is a faithfully flat $\mathrm{A}$-module, one has thus defined a canonical application $j:\mathrm{B}\to\mathrm{A}/p\mathrm{A}$, such that, for $x\in\mathrm{A}$, $j(x)$ is the class of $x^p$ mod.~$p\mathrm{A}$.
...
The application $j$ is therefore a \emph{ring homomorphism}.
...
\begin{enumerate}
  ...
  \item[\rm{(ii)}] It results from the proof of \sref{0.22.5.1} and from \sref{0.16.2.6.1} that one has in all cases
\[
\label{0.22.5.2.1}
...
\begin{proof}
Indeed, with the notations of \sref{0.22.5.2}, (i)), if $\overline{\mathrm{F}}_i$ denotes the polynomial of $\mathrm{A}_1[\mathrm{T}_i]$ obtained by applying to the coefficients of $\mathrm{F}_i$ the homomorphism $\mathrm{A}\to\mathrm{A}_1$, $\mathrm{A}_1'$ is defined from $\mathrm{A}_1$ and the polynomials $\overline{\mathrm{F}}_i$ as in \sref{0.22.4.1}, and the conclusion results from \sref{0.22.5.1} and \sref{0.22.4.3}.
\end{proof}
...
Taking into account that $\Omega^1_\mathrm{A}\otimes_\mathrm{A}\mathrm{K}$ is canonically isomorphic to $\Omega^1_{\mathrm{A}_1}\otimes_{\mathrm{A}_1}\mathrm{K}$ \sref{0.20.5.12}, (ii)), the theorem results from \sref{0.22.5.1} and \sref{0.22.4.7.4}, using remark \sref{0.22.4.8} when $\mathrm{A}_1$ is not of characteristic $p$.
\end{proof}
...
Furthermore, it is known \sref{0.21.4.7} that one has $\Xi_{k'/k}=0$, in other words said the canonical homomorphism \sref{0.21.3.2.2}
\[
...
\label{0.22.5.5.2}
  ...
  \tag{22.5.5.2}
\]
which makes explicit in the following way (taking into account \sref{0.22.5.5.1}): for every $x'\in k'$, to the element $d_{k'/k}(x'\otimes 1_\mathrm{K})\otimes 1_\mathrm{K}$ of $\Omega^1_{\mathrm{A}'_{(\mathrm{K})}/\mathrm{K}}\otimes_{\mathrm{A}'_{(\mathrm{K})}}\mathrm{K}$, one makes correspond the element $d_k(x'^p)\otimes 1_\mathrm{K}$ of $\Omega^1_k\otimes_k\mathrm{K}$.
\end{env}
...
(ii) As $\mathrm{A}'_{(\mathrm{K})}=\mathrm{K}\otimes_kk'=(\mathrm{A}_1')_{(\mathrm{K})}$ (by virtue of the relation $\mathrm{K}=\mathrm{A}_1/(\mathfrak{m}/\mathfrak{m}^2)$), $\Theta_{\mathrm{A}'_{(\mathrm{K})}/\mathrm{K}}$ identifies with $\Theta_{(\mathrm{A}_1')_{(\mathrm{K})}/\mathrm{K}}$, and the verification results from the same calculation as in (i) and from the definition of $\pi'_{\mathrm{A}'_{(\mathrm{K})}/\mathrm{K}}$.
\end{proof}
...
Let $k'$ be a finite extension of $k$ such that $k'^p\subset k$, and $\mathrm{A}'=\mathrm{A}\otimes_kk'$; for $\mathrm{A}'$ to be a regular local ring, it is necessary and sufficient that the restriction of the characteristic homomorphism $\chi_{\mathrm{A}/k}:\Upsilon_{\mathrm{K}/k}\to\mathrm{V}$ \sref{0.20.6.24} to $(\Theta_{k'/k}\otimes_k\mathrm{K})\cap\Upsilon_{\mathrm{K}/k}$ be injective.
\end{proposition}

\begin{proof}
\oldpage[0\textsubscript{IV-1}]{204}
It is a matter of proving that the statement is equivalent to \sref{0.22.5.1.1}, by denoting by $\mathfrak{m}'$ the maximal ideal of $\mathrm{A}'$, with $\mathrm{K}'=\mathrm{A}'/\mathfrak{m}'$ its residue field.
...
One can apply the criterion \sref{0.22.4.7}, and the condition is equivalent to the fact that $\chi'_{\mathrm{A}_1'/\mathrm{A}_1}$ be injective; one concludes with the aid of \sref{0.22.5.6}.
\end{proof}
...
\label{0.22.5.10}
\begin{enumerate}
  \item[\rm{(i)}] The conclusion of \sref{0.22.5.8} is in default when, in the condition $b'$), one restricts oneself to \emph{monogene} extensions $k'=k(x)$ of $k$ (with $x^p\in k$).
  ...
  Now, one constructs easily examples of such extensions: start from a perfect field $k_0$ of characteristic $p>0$, let $\mathrm{X}$, $\mathrm{Y}$, $\mathrm{Z}$ be three indeterminates and set $k=k_0(\mathrm{X},\mathrm{Y})$ and $\mathrm{K}=k(\mathrm{X}^{1/p}+\mathrm{Z}\mathrm{Y}^{1/p})$; one verifies easily that $\mathrm{K}$ satisfies the preceding conditions, hence $\Upsilon_{\mathrm{K}/k}\neq 0$.
  Applying now the lemma \sref{0.22.2.5.2} taking $\mathrm{V}=\mathrm{K}$ and for $h$ the zero homomorphism; $\mathrm{A}$ is then a valuation ring of discrete valuation having $\mathrm{K}$ as residue field, with $\chi_{\mathrm{A}/k}=0$, and is not a $k$-algebra formally smooth by \sref{0.22.2.2}; however $\mathrm{A}\otimes_kk'$ is a regular ring for every \emph{monogene} subextension $k'\subset k^{1/p}$ of $k$.
...
\label{0.22.6.1.1}
  ...
  \tag{22.6.1.1}
\]
be \emph{formally inversible on the left} (cf.~\sref{0.19.1.5}).
\end{theorem}
...
\label{0.22.6.2}
With the hypotheses and notations of \sref{0.22.6.1}, suppose furthermore that the square of every open ideal of $\mathrm{B}$ is open, and that on $\mathfrak{J}$ the induced topology be identical to that deduced from that of $\mathrm{B}$ \sref{0.19.0} (one will note that these two conditions are satisfied when $\mathrm{B}$ is \emph{noetherian} and its topology preadic $(\mathbf{0}_\mathrm{I},~7.3.2)$, or if $\mathrm{B}$ has the $\mathfrak{J}$-preadic topology).
...
\label{0.22.6.2.1}
  ...
  \tag{22.6.2.1}
\]
  deduced from $\delta_{\mathrm{C}/\mathrm{B}/\mathrm{A}}$ by tensorization, is inversible on the left (in other words is an isomorphism onto a direct factor of $\Omega^1_{\mathrm{B}/\mathrm{A}}\otimes_\mathrm{B}\mathrm{B}_\lambda$).
  \end{enumerate}
...
\begin{proof}
The hypotheses imply that on $\Omega^1_{\mathrm{B}/\mathrm{A}}$ the topology is deduced from that of $\mathrm{B}$ \sref{0.20.4.5}, hence (i) results from \sref{0.22.6.1} and \sref{0.19.1.7}.
On the other hand, recall \sref{0.20.4.9} that $\Omega^1_{\mathrm{B}/\mathrm{A}}$ is a $\mathrm{B}$-module formally \emph{projective}, hence $\Omega^1_{\mathrm{B}/\mathrm{A}}\otimes_\mathrm{B}\mathrm{B}_\lambda$ is a $\mathrm{B}_\lambda$-module projective for every $\lambda$ \sref{0.19.2.4}; the equivalence of $c$) results then from \sref{0.19.1.9}.
\end{proof}

In particular:
\begin{corollary}[22.6.3]
\label{0.22.6.3}
Let $\mathrm{A}$ be a ring, $\mathrm{B}$ a $\mathrm{A}$-algebra, $\mathfrak{J}$ an ideal of $\mathrm{B}$, $\mathrm{C}=\mathrm{B}/\mathfrak{J}$; one supposes $\mathrm{A}$, $\mathrm{B}$, $\mathrm{C}$ equipped with the discrete topologies and that $\mathrm{B}$ is a formally smooth $\mathrm{A}$-algebra.
For $\mathrm{C}$ to be a formally smooth $\mathrm{A}$-algebra, it is necessary and sufficient that the canonical homomorphism \sref{0.22.6.1.1} be inversible on the left.
\end{corollary}

\begin{proof}
One will note that since \emph{every} $\mathrm{A}$-algebra $\mathrm{C}$ is a quotient of a polynomial algebra $\mathrm{A}[\mathrm{T}_\alpha]_{\alpha\in\mathrm{I}}$, and this last is formally smooth \sref{0.19.3.3}, the criterion \sref{0.22.6.3} allows in principle to recognize if $\mathrm{C}$ is a formally smooth $\mathrm{A}$-algebra.
\end{proof}
...
On the other hand $\mathrm{C}_\mathfrak{p}=\mathrm{B}_{\mathfrak{p}'}/\mathfrak{J}\mathrm{B}_{\mathfrak{p}'}$, and $\mathrm{B}_{\mathfrak{p}'}$ is a $\mathrm{A}$-algebra formally smooth for the discrete topology \sref{0.19.3.5}, (iv)); moreover $\Omega^1_{\mathrm{B}/\mathrm{A}}$ is a $\mathrm{B}$-module \emph{projective}, hence $\Omega^1_{\mathrm{B}/\mathrm{A}}\otimes_\mathrm{B}\mathrm{B}_\lambda$ is a $\mathrm{B}_\lambda$-module projective for every $\lambda$ \sref{0.19.2.4}; and $\mathfrak{J}/\mathfrak{J}^2$ a $\mathrm{B}$-module of finite type, the equivalence of $a'$) and $b$) results then from the application of \sref{0.22.6.3} to $\mathrm{B}_{\mathfrak{p}'}$ and $\mathrm{C}_\mathfrak{p}$, taking into account the fact that $\Omega^1_{\mathrm{B}/\mathrm{A}}$ is a $\mathrm{B}$-module projective \sref{0.20.4.9} and $\mathfrak{J}/\mathfrak{J}^2$ a $\mathrm{C}$-module of finite type.
The application of \sref{0.19.1.12} proves also the equivalence of $b$) and $c$).
Finally, let us note that since $\mathrm{B}_{\mathfrak{p}'}$ is a $\mathrm{A}_{\mathfrak{q}}$-algebra formally smooth for the $\mathfrak{p}'$-preadic topology and its topology is preadic \sref{0.19.3.8}, and $\mathfrak{J}/\mathfrak{J}^2$ a $\mathrm{C}$-module of finite type, and $\mathrm{C}_\mathfrak{p}$ preadmissible et $\mathfrak{p}\mathrm{C}_\mathfrak{p}$ is an ideal of definition for its topology, the equivalence of $c$) and $a$) in (i) results from \sref{0.22.6.4}, and the last assertion results from \sref{0.22.6.2}.
\end{proof}

\begin{corollary}[22.6.5]
\label{0.22.6.5}
Under the general hypotheses of \sref{0.22.6.4}, the set of $\mathfrak{p}\in\Spec(\mathrm{C})$ such that $\mathrm{C}_\mathfrak{p}$ is a formally smooth $\mathrm{A}_{\mathfrak{q}}$-algebra (or an $\mathrm{A}$-algebra formally smooth), in designating by $\mathfrak{q}$ the inverse image of $\mathfrak{p}$ in $\mathrm{A}$, \emph{for the discrete topologies}, is open in $\Spec(\mathrm{C})$.
\end{corollary}

\begin{proof}
This results from form $c$) of \sref{0.22.6.4}.
One will note that when $\mathrm{B}$ is noetherian, one can replace the discrete topologies by the preadic topologies.
\end{proof}
...
\begin{enumerate}
  ...
  \item[b)] For every $\mathfrak{p}\in\Spec(\mathrm{C})$ (or only for every \emph{maximal} ideal $\mathfrak{p}$ of $\mathrm{C}$), $\mathrm{C}_\mathfrak{p}$ is a formally smooth $\mathrm{A}$-algebra (or a formally smooth $\mathrm{A}_{\mathfrak{q}}$-algebra, where $\mathfrak{q}$ designates the inverse image of $\mathfrak{p}$ in $\mathrm{A}$) \emph{for the discrete topologies}.
\end{enumerate}
...
\begin{proof}
The last assertion results from \sref{0.22.6.4}.
By virtue of \sref{0.22.6.3}, the condition $a$) is equivalent to the fact that the homomorphism \sref{0.22.6.1.1} be inversible on the left; the equivalence of $a$) and $b$) results from the application of \sref{0.22.6.3} to $\mathrm{B}_{\mathfrak{p}'}$ and $\mathrm{C}_\mathfrak{p}$, taking into account the fact that $\Omega^1_{\mathrm{B}/\mathrm{A}}$ is a $\mathrm{B}$-module projective and $\mathfrak{J}/\mathfrak{J}^2$ a $\mathrm{C}$-module of finite type.
\end{proof}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item[d)] For every extension $k'$ of $k_0$, $\mathrm{C}\otimes_{k_0}k'$ is a regular ring \sref{0.17.3.6}; one says also that $\mathrm{C}$ is a geometrically regular ring over $k_0$.
  \end{enumerate}
\end{enumerate}
\end{proposition}
...
The equivalence of conditions $a$), $b$), $c$) of (i) results therefore from \sref{0.22.6.4}, and the equivalence of conditions $a$) and $d$) in (i) results from \sref{0.22.5.8}; the equivalence of $d$) and $a$) in (ii) results from \sref{0.22.6.6}; the equivalence of $a$) and $d$) in (ii) results from the criterion of Zariski \sref{0.22.6.4}, and the last assertion results from \sref{0.22.6.5}.

Finally, as $\Omega^1_{\mathrm{B}/k_0}$ is a $\mathrm{B}$-module projective, the equivalence of the criterion of Zariski $e$) and $b$) in (ii) results from the application of \sref{0.19.1.12}, taking into account the fact that $\Omega^1_{\mathrm{B}/\mathrm{A}}$ is a $\mathrm{B}$-module projective \sref{0.20.4.8}, and using \sref{0.22.6.3}, taking into account \sref{0.20.4.8}.
\end{proof}
...
\label{0.22.6.9}
\begin{enumerate}
  \item[\rm{(i)}] The statements of \sref{0.22.6.7} are still valid if instead of supposing $k$ separable over $k_0$, one supposes only that it is of \emph{finite radiciel multiplicity}, that is to say \sref{0.19.6.6} that there exists a finite radiciel extension $k_0'$ of $k_0$ such that the residue field of the local artinian ring $k\otimes_{k_0}k_0'$ is a \emph{separable} extension $k'$ of $k_0'$.
...
\begin{proof}
The residue field of $\mathrm{B}_\mathfrak{p}$ is $k(\mathfrak{p})$; as $k((\mathrm{X}_1,\ldots,\mathrm{X}_s))$ is separable over $k$ \sref{0.21.9.6.4}, $k(\mathfrak{p})$ is separable over $k$ by hypothesis, and one already knows in these conditions that the properties $a$) and $c$) are equivalent \sref{0.19.6.4}.

\oldpage[0\textsubscript{IV-1}]{210}
The residue field of $\mathrm{B}_\mathfrak{p}$ is $k(\mathfrak{p})$; as $k((\mathrm{X}_1,\ldots,\mathrm{X}_s))$ is separable over $k$, $k(\mathfrak{p})$ is separable over $k$ by hypothesis. It results therefore from \sref{0.22.6.2}, (ii)) that the condition $a$) is equivalent to the fact that the homomorphism $j_0$ defined in \sref{0.22.7.2.1} (where $\mathrm{L}=k(\mathfrak{p})$) be \emph{injective}.

Consider on the other hand the homomorphism composed
\[
\label{0.22.7.2.1}
  j_0:(\mathfrak{q}/\mathfrak{q}^2)\otimes_\mathrm{A}\mathrm{L}\to\Omega^1_{\mathrm{A}/k}\otimes_\mathrm{A}\mathrm{L}=\Omega^1_{\mathrm{A}/k}\otimes_\mathrm{A}\mathrm{L}
  \tag{22.7.2.1}
\]
be injective.
...
\label{0.22.7.2.2}
  ...
  \tag{22.7.2.2}
\]
and let us show that condition $b$) is equivalent to saying that $j$ is \emph{injective}.
We note indeed that $(\mathfrak{q}/\mathfrak{q}^2)\otimes_\mathrm{A}\mathrm{L}=(\mathfrak{q}\mathrm{A}_\mathfrak{p}/\mathfrak{q}^2\mathrm{A}_\mathfrak{p})\otimes_{\mathrm{A}_\mathfrak{p}}\mathrm{L}$; the condition $b$) signifies that if $\mathrm{F}_i=j(f_i'\otimes 1)$, where $f_i'$ is the image of $f_i$ in $\mathfrak{q}\mathrm{A}_\mathfrak{p}/\mathfrak{q}^2\mathrm{A}_\mathfrak{p}$, the matrix $(\langle\mathrm{F}_i,\mathrm{D}_j\otimes 1\rangle)$ is inversible; hence this implies that the $\mathrm{F}_i$ are linearly independent, and \emph{a fortiori} the same is true of the $f_i'\otimes 1_\mathrm{K}$; but as the latter generate $(\mathfrak{q}\mathrm{A}_\mathfrak{p}/\mathfrak{q}^2\mathrm{A}_\mathfrak{p})\otimes_{\mathrm{A}_\mathfrak{p}}\mathrm{L}$, one concludes that $j$ is injective.

Conversely, suppose $j$ injective, and take the $f_i$ such that the $f_i'\otimes 1$ form a base of the image of $j$; but one knows \sref{0.21.9.3} that $\widehat{\Omega}^1_{\mathrm{A}/k}$ is a free $\mathrm{A}$-module of rank $r$ and the $k$-derivations of $\mathrm{A}$ into itself generate its dual; it follows therefore that the existence of $k$-derivations $\mathrm{D}_i$ such that the matrix $(\langle\mathrm{F}_i,\mathrm{D}_j\otimes 1\rangle)$ is inversible, in other words condition $b$).

\oldpage[0\textsubscript{IV-1}]{211}
Now, since $\mathrm{A}_\mathfrak{p}$ is regular \sref{0.17.3.2}, $\dim(\mathrm{A}_\mathfrak{p})$ is equal to the rank over $\mathrm{L}$ of $\mathfrak{p}\mathrm{A}_\mathfrak{p}/\mathfrak{p}^2\mathrm{A}_\mathfrak{p}$ \sref{0.17.1.1}, hence to the rank over $\mathrm{L}$ of $(\mathfrak{p}/\mathfrak{p}^2)\otimes_\mathrm{A}\mathrm{L}$, and similarly $\dim(\mathrm{A}/\mathfrak{p})=r-\dim(\mathrm{A}_\mathfrak{p})$ by \sref{0.16.5.11}.
Since $\mathrm{A}_\mathfrak{p}$ is regular \sref{0.17.3.2}, $\dim(\mathrm{A}_\mathfrak{p})$ is equal to the rank over $\mathrm{L}$ of $(\mathfrak{p}/\mathfrak{p}^2)\otimes_\mathrm{A}\mathrm{L}$, which finishes proving that $i$ is injective.
\end{proof}
...
As $\mathrm{K}_0$ is separable over $k$, it results from \sref{0.19.3.5}, (ii)) and \sref{0.19.6.1} that $\mathrm{A}$ is a $k$-algebra formally smooth; by virtue of \sref{0.22.5.9}, $\mathrm{A}_\mathfrak{p}$ is also a $k$-algebra formally smooth for the preadic topology.
It results therefore of \sref{0.22.6.2}, (ii)) that the condition $a$) is equivalent to the fact that the homomorphism $j_0$ defined in \sref{0.22.7.2.1} (where $\mathrm{L}=k(\mathfrak{p})$) be injective.
Therefore \sref{0.19.1.12}, $c$)) shows already that $b$) implies $a$); as elsewhere $b'$) implies trivially $b$), all amounts to showing that the hypothesis that $j_0$ is injective implies $b'$).
...
By the argument of \sref{0.22.7.2} (for a suitable choice of $k'$), the composed homomorphism
\[
\label{0.22.7.3.1}
  j':(\mathfrak{q}/\mathfrak{q}^2)\otimes_\mathrm{A}\mathrm{L}\xrightarrow{j_0}\Omega^1_{\mathrm{A}/k}\otimes_\mathrm{A}\mathrm{L}\to\widehat{\Omega}^1_{\mathrm{A}/k'}\otimes_\mathrm{A}\mathrm{L}
  \tag{22.7.3.1}
...
If $i'$ is the composed homomorphism of the second line of \sref{0.22.7.3.2}, one has similarly
\[
\label{0.22.7.3.3}
  \Ker(i')=\Ker(i).
  \tag{22.7.3.3}
...
But, if the $k$-derivations $\mathrm{D}_i$ and the elements $f_i$ of $\mathfrak{q}$ verify the criterion $b$) of \sref{0.22.7.3}, one has also $f=\det(\mathrm{D}_if_j)\notin\mathfrak{p}$ for every $\mathfrak{p}'\notin\mathrm{D}(f)$; by the other hand, there exists $g\notin\mathfrak{p}$ such that the images of $f_i$ in $\mathfrak{q}\mathrm{A}_{\mathfrak{p}'}$ generate this ideal of $\mathrm{A}_{\mathfrak{p}'}$, from which this finishes the proof of the corollary.
\end{proof}
...
\begin{enumerate}
  ...
  Take $\mathfrak{p}=\mathfrak{q}$, so that $\mathrm{B}_\mathfrak{p}$ is the body of fractions designated by $\mathrm{E}$ in \sref{0.21.9.7}, which is separable over $k$ (\emph{loc.~cit.}), hence a $k$-algebra formally smooth.
