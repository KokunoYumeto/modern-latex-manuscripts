...
$\mathcal{O}_{Y^{(\infty)}}$: \EGAIVidxref{16.1.11}.
...
${}^{t}V_{\mathcal E}$: \EGAIVidxref{18.5.1}.
...
$\mathcal J_U$, $\mathcal J_X(D)$: \EGAIVidxref{21.2.5}.
...
$\mathscr Z_X^{p+}$: \EGAIVidxref{21.6.3}.
...
$\mathfrak{Cl}(X)$: \EGAIVidxref{21.6.7}.
...
$\Gamma_T(\mathscr Z_X^1)$: \EGAIVidxref{21.10.3}.

$f_*(Z')$: \EGAIVidxref{21.10.14}.

$\Lambda^{\max}\mathcal E$: \EGAIVidxref{21.11.1}.

$U'$, $\operatorname{Aff}(U/X)$: \EGAIVidxref{21.12.1}.
