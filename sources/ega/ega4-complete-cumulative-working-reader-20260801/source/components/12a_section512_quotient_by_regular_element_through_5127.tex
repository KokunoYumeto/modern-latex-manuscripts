...
verify that Proposition~5.12.2 is not used in the proof of
...
\begin{remark}[5.12.3]
\label{IV.5.12.3}
If in Proposition~5.12.2 one assumes only that $M/tM$ is
...
$A/tA$ is equidimensional, and Proposition~5.12.2 applies.
\end{proof}
...
Proposition~5.12.2, applied with $k=1$, shows that $A$ is
equidimensional.  Put
\[
...
\]
Since $A$ is equidimensional and catenary, Proposition~5.12.1
gives
\[
...
\begin{remark}[5.12.6]
\label{IV.5.12.6}
If in Proposition~5.12.5 one assumes only that $A/tA$ is reduced
...
implies $(\mathrm R_1)$ for $A$ by Proposition~5.12.5 and
$(\mathrm S_2)$ for $A$ by Corollary~5.12.4.
\end{proof}
