...
- The full source-task thread `019f711e-e434-7af2-9a4d-0cd038cfe022`, its
...
- English R74 validation is PASS/errors empty at 10,891 bytes / SHA-256
  ...
  is C:\Users\Floris\Documents\CHat translates and clean; its former
...
## 2026-08-04 -- final printed p.142 control-identity successor

- The direct-French paired recheck covers the completion of Proposition
  6.1.4; 6.1.5; Proposition 6.1.6; Corollary 6.1.7; Lemma 6.1.8; Corollary
  6.1.9; and Proposition 6.1.10 through “a closed set $F$ containing.” The
  inherited English remains a witness, not authority.
- Lemma 6.1.8 contained one mathematical imprecision. French lines 158--160
  say that the irreducible components of $W$ are the traces on $W$ of the
  irreducible components of $U$ that meet $W$. The inherited English omitted
  that restriction, thereby including empty intersections as components.
  Current source/ega1/ega1-6.tex restores the qualification and is 54,751
  bytes / 839 lines / SHA-256
  EBFAFDE5100D7B2D956AF1B98ACF7948717C8384F2D4C45347E1278EE77D9EA9.
- This repair is classified as a translation mathematical-precision
  correction, not an author correction or an unrecorded override. The first
  decision row's hash-only inverse was insufficiently self-contained. The
  append-only successor
  EG-EGA-I-P142-EN-618-MEETING-COMPONENTS-EXACT-REVERSIBILITY-SUCCESSOR-001
  now records both literal lines, preserved witness, direct French locus,
  rationale, affected-copy scope, exact inverse, and exact successor. Its
  inverse replay gives 54,737 bytes / R89 source SHA-256
  BA45F1965B6085D84CA7E3723E4078039093ACFDDD916FD191AD43DE251CA980.
- English proof headings/QED marks for the four French printed-unheaded
  arguments, conventional nilradical and Noetherian case, and parenthesized
  condition letters are retained and individually classified
  normalizations; none is allowed to masquerade as authorial correction.
- R90 is 54,931 bytes / 1,174 lines / SHA-256
  9C7A39B176AADF819DC164BDAEA8C23EEB6E7B5851D2F2C318952B1C837D3E7D.
  Its 127-file / 7,281,925-byte source tree replays under .NET ordinal order
  to SHA-256
  F25D638DCFAA5654BF5ED53481009D6E2B3D94C4B1AB99AF5AAFECC0C1F1335A.
  Exactly one row changes from R89, ega1/ega1-6.tex by +14 bytes; membership,
  ordering, sizes, hashes, and aggregate all pass.
- The first bounded English wrapper exposed a wrapper-only undefined I-11
  citation. It and its 32-page output remain preserved. R2 adds only a
  build-local bibliography binding, builds three serial passes, and produces
  a 235,993-byte / 32-page PDF with SHA-256
  C089D473DEAA5B8B53F17885802E27A346D78469F81AF8FD1DE2F2BAD53900E7.
  Pages 31--32 textually show both the repaired qualification and exact
  terminal cursor; there is no new reader raster. Every temporary Q: mapping
  was removed in `finally`.
- Paired French source/ega1/ega1-6-fr.tex is 8,918 bytes / 192 lines /
  SHA-256
  00E79CA7426EA6320FF63BF0ED4207272B5210C94CF8F4E6840358A9D5A9A622.
  Its exact truncation inverse restores sealed p.141. The final 44-page
  French PDF has SHA-256
  4ADD343AC4011C7ABB6E3500469122572798EC9488C55D784B5FDDC030C03DF6;
  terminal text and single-page visual QA pass. The first French wrapper and
  build remain preserved for their wrapper-only 0.2.1.6-fr omission.
- The terminal p.142 pre-Stacks scaffold is 121,480 bytes / 2,058 lines /
  SHA-256
  3F4766E1638DD82869CEA6077FE05475920C836A910C40E1860A1BA78E1BC449.
  It contains the typed component, proof-use, implication, repair, reversal,
  normalization, forward-reference, and open-range edges without claiming
  completed Stacks exposition or formalization.
- French and English decision ledgers are parse-clean at 14 and 15 rows;
  their SHA-256 values are
  2309825CB20EC7BD9C9F6ADC6EB6288CFA2164972EE8F99C2FD03A737CA928D5
  and
  7CD5CC82AE13CD4A1036E238CDE8D0BF068B9D43CB68B11BD988B8FDA2ED953D.
  The complete 16-row workflow ledger has SHA-256
  69B2423FBF0D14E661FDB8BCE13224052456CD55BDF4789969055D65BC803343
  and preserves all superseded builds, path/runtime faults, scaffold
  placement reversal, incomplete-reversibility successor, and failed
  read-only probes with their exact resolutions.
- English R90 validation is PASS/errors empty at 16,553 bytes / 337 lines /
  SHA-256
  2E7289015EE4543B2D1576D84FF7120B8AAAFB90092C5A52D66CFADE8512CC75;
  French R65 is PASS/errors empty at 16,414 bytes / 350 lines / SHA-256
  D0526CC97E9E334BA95301E91464CF1482B2CE8B2A97B529CFA6AEDB028B5005.
  Their final independent replay has zero mismatches across 25 bound
  artifacts. No global build/render, OCR, publication, upload, archive, or
  external mutation was performed.
- Next gate: create and replay complete R91 before any p.143 English source
  mutation. Continue direct NUMDAM PDF one-based p.142 / printed p.143 after
  `ensemble fermé $F$ contenant`. No French close is open; the English proof
  continues through oldpage 143.

## 2026-08-04 — printed p.143 paired source recheck

- Compared every English unit between oldpage 143 and the corrected p.144
  boundary directly against NUMDAM and the admitted diplomatic French.
  Proposition 6.1.10's completion, Corollaries 6.1.11--6.1.12, Proposition
  6.1.13, and Definition 6.2.1 retain all mathematical hypotheses,
  implications, stalk conditions, and local-neighbourhood conclusions.
- Individually logged retained choices: symmetric reversal of grammatical
  C/F distinctness, idiomatic English subjunctive for printed French `est`,
  `combination` in the contextual sense of conjunction, visible English
  proof/QED structure for printed-unheaded arguments, and conventional
  Noetherian/Artinian capitalization. None is left to masquerade as an
  undocumented correction of the authors.
- The only source mutation moves oldpage 144 out of `Given a prescheme` and
  before Proposition 6.2.2. Old/new fragments are each 123 bytes, with
  SHA-256 values
  79AC9D782B44110E1DDCA0842AF0D9CB002772D8D77F7676F5A395A922D6D9C0
  and
  92AE3A278A0DE4B4854DA157E0F95A6E40B865579ADC24E173EB9B94910BDF72.
  English source now has SHA-256
  6A3B53A52A7890015034456C4898A69071A7A6E043FD5E40672FD49088407507;
  exact inverse replay reproduces R91 source SHA-256
  EBFAFDE5100D7B2D956AF1B98ACF7948717C8384F2D4C45347E1278EE77D9EA9.
- R92.json is the compact complete post-edit successor. It is 55,728 bytes /
  1,186 lines / SHA-256
  DE8319E24A9AE6BC545C30B1FA88D885A00AB5C07E1038559DE42752905A3D2F;
  all 127 rows and 7,281,925 bytes replay to .NET-ordinal tree SHA-256
  EB44A4EF16A789B4172ADDB5AB83CF774819CD9EAF99C058650BE45493E44935.
  Exactly one zero-byte-delta row changes from R91.
- The first compact cutoff wrapper recursively re-entered optional-argument
  oldpage and stopped with TeX capacity exceeded before page output. R1.tex
  and all three partial artifacts remain in P143_EN_R1. The exact successor
  writes the original marginnote body directly and invokes endinput only at
  144; its fragment inverse restores the R1 wrapper hash.
- The successor wrapper inputs live ega1-6 rather than creating another
  projection. Three serial XeLaTeX passes produce a 239,618-byte / 32-page
  PDF with SHA-256
  48AF4216D8FD08E9FD3171AC64154B5C2E900002242D2EDBF197E84E08A86A2E.
  Pages 31--32 show the source-grounded `that meet W` qualification and end
  at Definition 6.2.1; Proposition 6.2.2 and oldpage 144 are absent. The
  sole temporary Q: mapping was removed in `finally`.
- Paired French source and its final PDF have SHA-256 values
  1A4D3A379062C5EDBA5F7D9F05AD76B87C37A7C813CCA9DBCA60D18D8C13FDB4
  and
  C1E416941FD1CD0C3C2CAD230A111E7A9C469C29BEE3082CF78272C08DEC90C0.
  The French visual gate preserves the printed `est` form and ends cleanly
  at Definition 6.2.1.
- The p.143 scaffold is 127,731 bytes / 2,165 lines / SHA-256
  910A4A982F5AEC976FFF68DA25D4BD79E69C738BB51F1A0E27AF1A43E0C83EFE.
  English decision and complete workflow ledgers have 15 and 15 parse-clean
  rows at SHA-256
  AB0D9F8E9DA644003850741D3FB90EEE796BD9149CFF565EBD623D04A8C3465A
  and
  2EE94AB70F6C92C5482B918E6413D6E500D4AAC532073BCE7E435313FA49811E.
- Compact combined validator P143_CHECK.json is PASS/errors empty at 13,186
  bytes / 381 lines / SHA-256
  6CAE2BB3178C8D8122BDF975CA90BBD6AC716697DBCD5AEC8CCA590D938124C1.
  Independent replay finds zero mismatch across 22 bound artifacts and all
  five ordinal build trees. No upload, publication, archive, global reader
  build, or excluded-series mutation was performed.
- Next gate: create and replay compact R93.json before any p.144 English
  source mutation, then continue direct authority at Proposition 6.2.2.
