...
We draw attention to the fact that the results of n\textsuperscript{o}\hyperref[subsection:III.3.4]{3.4} (and the preliminary propositions of (\textbf{0},~13.4 to 13.7)) will not be used in what follows \hyperref[section:ega3]{Chapter~III}, and can thus be skipped in a first reading.
\bigskip
