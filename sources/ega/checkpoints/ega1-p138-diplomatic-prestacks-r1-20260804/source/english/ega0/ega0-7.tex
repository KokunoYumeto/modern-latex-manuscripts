...
\begin{enumerate}
  ...
  \item[(ii)] Set $A_i=A/\mathfrak{J}^{i+1}$, and for $i\leq j$, let $u_{ij}$ be the canonical
    ...
    Noetherian, then so is $A_0'=S_0^{-1}(A/\mathfrak{J})$, which completes the proof of
    Proposition \sref{0.7.6.11}.\footnote{The French source prints ``(7.2.8)'' here; the paragraph is
    the proof of Proposition~(7.6.11), whereas (7.2.8) is an earlier corollary.}
\end{enumerate}
\end{proof}
