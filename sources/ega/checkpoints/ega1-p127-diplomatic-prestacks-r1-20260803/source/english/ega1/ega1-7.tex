...
For every dense open subset $U$ of $X$, $U_i=U\cap X'_i$ is a nonempty dense open subset of $X'_i$, with the $U_i$ being pairwise disjoint, and so $U'=\bigcup_i U_i$ is dense in $X$.
...
\oldpage[I]{161}
contained in $\mathfrak{j}_x$ \sref{0.2.1.6}, the minimal prime ideals of $A_x$ correspond to the minimal prime ideals of $A$ that are contained in $\mathfrak{j}_x$, hence the lemma \sref{I.1.1.14}.
\end{proof}
