...
We can also give examples where \emph{neither} of the two conditions of \sref{I.5.5.6} is satisfied.
...
we then have an example where neither condition of \sref{I.5.5.6} is satisfied (the integral prescheme thus obtained is called ``the affine plane over $K$ with the point $0$ doubled'').
\end{examples}
