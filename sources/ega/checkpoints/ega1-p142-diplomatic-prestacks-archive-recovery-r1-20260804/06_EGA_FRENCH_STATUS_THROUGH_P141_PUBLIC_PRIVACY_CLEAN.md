...
## Successor checkpoint: printed p.128 complete

The earlier p.128 cursor is superseded. Diplomatic French is admitted through
the exact printed fragment `l'homomor-` opening 5.1.5. The p.128 unit completes
the proof of 5.1.1, names the nilradical, admits Corollary 5.1.2 and its proof,
Definition 5.1.3, Proposition 5.1.4 and its proof, and the locally integral
consequence and converse. `source/ega1/ega1-5-fr.tex` is 5,091 bytes / 103
lines / SHA-256
`EB37539C7AAD273C7A780E087FDB8863CD86A0C284D0BA532B72D395FC5860A0`.
Its final `\end{env}` is temporary. The exact p.128 marker-to-EOF slice is
4,409 bytes / SHA-256
`EF33E8767B2A9209D26CBF9C98CF24D563F0A3C333C53299FC92273C94C1989D`;
truncating to the first 681 bytes restores sealed p.127 exactly.

Canonical French preserves the printed word-order defect `du sous-préschéma
fermé défini Y par N_X`. The paired English recheck repairs only two
source-fidelity defects in `ega1-5.tex`: the ideal relation now has
`\mathfrak{I}\subset\mathfrak{j}_x`, and the defining sentence says
`thus means`. Current English is 46,829 bytes / SHA-256
`D3BB566847A24BD268157D7171BD9F5B282FA2C9B8F4D1A1ABD9B84F656FEFF3`;
two unique inverse substitutions reproduce R60 exactly.

R61 is the active complete English gate: 127 files / 7,281,147 bytes,
manifest 43,455 bytes / SHA-256
...
Source-current bounded PDFs are French 34 pages / 322,571 bytes / SHA-256
`260B266739260B10E9BF2291DBC23A07B323C82018E2AB04EFB8F33705BCCC25`
and English 20 pages / 166,762 bytes / SHA-256
`B033E23E0E5FDD50DBAC6404E752636BDB7BC99E8B62383AB70816A6E6C45614`.
The p.128 English page passes visual QA with both repairs visible; the French
terminal page carries the complete admitted text and exact seam. The p.128
pre-Stacks block is current at 55,476 bytes / SHA-256
`387C86432463544C2DB0B5146A1164F07A4AF49D3876FFA1C50655E7333DFF09`.
No XeLaTeX process, temporary English `source/$out`, or `Q:` mapping remains.

Exact next cursor: remove only the temporary final `\end{env}` from
`source/ega1/ega1-5-fr.tex`, then continue 5.1.5 from direct NUMDAM PDF
one-based p.128 / printed p.129 authority after `l'homomor-`.

## Successor checkpoint: printed p.129 complete

The earlier p.129 cursor is superseded. Diplomatic French completes 5.1.5,
including the reduction functor and its naturality square, and admits
Propositions 5.1.6 and 5.1.7, Corollary 5.1.8, their proofs, and the terminal
warning that a tensor product of reduced algebras can have nilpotents.
`source/ega1/ega1-5-fr.tex` is 9,060 bytes / 190 lines / SHA-256
`D3DEC590DD38DE0A1CB5F756F7970AC4434CF1E5521379855BCC0592B4E7941C`.
The p.129 marker-to-EOF slice is 3,979 bytes / SHA-256
`B0D630DDBDC8D4A6597F12105E6314F0AD0415D40E65B8F192F207C71B696966`.
Replacing it with one `\end{env}` line restores sealed p.128 exactly. No
temporary close is present now.

The paired English recheck requires no source mutation. Current
`ega1-5.tex` remains 46,829 bytes / SHA-256
`D3BB566847A24BD268157D7171BD9F5B282FA2C9B8F4D1A1ABD9B84F656FEFF3`.
R63 is a zero-delta successor of R62: 127 files / 7,281,147 bytes, manifest
44,173 bytes / SHA-256
...
Source-current bounded PDFs are French 35 pages / 327,377 bytes / SHA-256
`22C33565863E3F71CDD975F17A4C26902D22E24C287113D1C113D4649ECC9483`
and English 21 pages / 171,271 bytes / SHA-256
`2B568041BF9DF9E7EADA134DF4986696BA4472B6B50A982E8E38B62696B2686D`.
The affected pages pass review. The p.129 pre-Stacks block is current at
58,492 bytes / SHA-256
`88D8A1AF0020C8F0561F837B9C01DB7494FBD7CE4193B215A44645E9DCE9BA19`.
No XeLaTeX process or `Q:` mapping remains.

Exact next cursor: append directly to `source/ega1/ega1-5-fr.tex` from NUMDAM
PDF one-based p.129 / printed p.130, beginning Proposition 5.1.9. Do not
remove a closing environment first.

## Successor checkpoint: printed p.130 complete

The earlier p.130 cursor is superseded. Diplomatic French admits Proposition
5.1.9 through the square-zero reduction, exact sequence (5.1.9.1), two
commutative diagrams, and the five-lemma isomorphism argument, stopping at the
exact words `ce qui résultera de`. `source/ega1/ega1-5-fr.tex` is 12,517
bytes / 267 lines / SHA-256
`4F6DDD36624D115FF3571344674D5B3D49E101F4851D2E634ED094359F3DC7A2`.
The appended p.130 suffix is 3,457 bytes / SHA-256
`C27E7F6F0D0C4ACE819B4C536D7010DABFD498ABC0900BF1FE350D9DA3924E45`;
truncation to the first 9,060 bytes restores sealed p.129 exactly. No
temporary close is present.

The paired English recheck requires no source mutation. Current
`ega1-5.tex` remains 46,829 bytes / SHA-256
`D3BB566847A24BD268157D7171BD9F5B282FA2C9B8F4D1A1ABD9B84F656FEFF3`.
The systematic ideal-letter notation and the English page-seam placement of
`H^1(X,I)=0` are retained explicitly. R65 is a zero-delta successor of R64:
127 files / 7,281,147 bytes, manifest 44,891 bytes / SHA-256
...
Source-current bounded PDFs are French 36 pages / 331,996 bytes / SHA-256
`C3938C2B94C3CCCBA74225F94A444C3289873FE4D58365D2DEC82B4CD2C10B49`
and English 22 pages / 176,102 bytes / SHA-256
`5989A16F1CB50EF183F849C55E64C0DBB79468CDDF385E70583C0C470F349BD2`.
French terminal pages 35--36 pass text-layout review; English pages 21--22
pass targeted visual QA, including the page prompted by the new bounded box
warning. The p.130 pre-Stacks block is current at 61,902 bytes / SHA-256
`2D2E022FCF22DC3C47278D7273F4B6B4BB79DDD0BFE73D87E65628D520E1E66A`.
No OCR, global build/render, XeLaTeX process, temporary English `source/$out`,
or `Q:` mapping remains.

Exact next cursor: append directly to `source/ega1/ega1-5-fr.tex` from NUMDAM
PDF one-based p.130 / printed p.131, continuing Proposition 5.1.9 after
`ce qui résultera de`. Do not remove a closing environment first.

## Successor checkpoint: printed p.131 complete

The earlier p.131 cursor is superseded. Diplomatic French completes
Proposition 5.1.9, Lemma 5.1.9.2, Corollary 5.1.10, and 5.2.1--5.2.2, then
admits the statement of Corollary 5.2.3 through the exact terminal words
`un sous-préschéma induit sur un ouvert de Z.` `source/ega1/ega1-5-fr.tex`
...
truncation to the first 12,517 bytes restores sealed p.130 exactly. No
temporary close is present.

The printed local splitting formula has `F|Y`, which is preserved
diplomatically and catalogued as a source error. The paired English keeps the
type-correct `F|V` and now carries one immediately visible translator note.
Current `ega1-5.tex` is 46,962 bytes / SHA-256
`89CB70021FE8386126FAAEBFE2C823A07A71F177BEEB8AD0862209391111E543`;
removing that unique note restores the exact R66 source bytes and hash.
...
and exactly one changed row from R66, `ega1/ega1-5.tex`. Its PASS validation
is 9,356 bytes / SHA-256
...
Source-current bounded PDFs are French r2 36 pages / 337,663 bytes / SHA-256
`0521507AD983275AD6152D5B65E011DEEFD4CF727022B5D58983BE29FC14C220`
and English 23 pages / 181,229 bytes / SHA-256
`7B5CB44FE6196E36B3475D879A59F6013EF38C52C054E5B0FE071602C2237057`.
French page 36 passes text-layout review with no duplicate label; English
pages 22--23 pass targeted visual/text QA with the translator note visible.
The p.131 pre-Stacks block is current at 65,174 bytes / SHA-256
`57EC4614738F849349AC91BC57EDC92E85D17B92CCC33F9AE6A57C6A80BBBCB8`.
No OCR, global build/render, XeLaTeX process, temporary English `source/$out`,
or `Q:` mapping remains.

Exact next cursor: append directly to `source/ega1/ega1-5-fr.tex` from NUMDAM
PDF one-based p.131 / printed p.132, beginning the proof of Corollary 5.2.3.
Do not remove a closing environment first.

## Successor checkpoint: printed p.132 complete

The earlier p.132 cursor is superseded. Diplomatic French completes the proof
of Corollary 5.2.3, Corollary 5.2.4, and 5.3.1--5.3.4, then admits Proposition
5.3.5 through diagram (5.3.5.1). `source/ega1/ega1-5-fr.tex` is 19,923 bytes /
442 lines / SHA-256
...
truncation to the first 16,480 bytes restores sealed p.131 exactly. The unique
terminal `\end{proposition}` is a temporary page-seam close and must be
removed before p.133.

French Proposition 5.3.5 prints `f:X→S, Y→S`, omitting the name `g`; the
following identity `π=f∘p=g∘q` fixes the intended reading. Diplomatic French
preserves the omission. English retains `g:Y→S` with one visible translator
note. Reader QA also exposed an inherited empty 5.3.3 environment as a stray
period; it is replaced by a non-rendering anchor that keeps the compatibility
label. Current `ega1-5.tex` is 47,147 bytes / SHA-256
`F28E52859F1D3CF5393BEED2D882180197D6B27DF81976E343864863B9DF821F`;
the logged two-operation inverse restores R68 exactly.
...
and exactly one cumulative changed row from R68, `ega1/ega1-5.tex`. Its PASS
validation is 11,413 bytes / SHA-256
...
Source-current bounded PDFs are French 37 pages / 342,931 bytes / SHA-256
`ADFF8CAEA181CE14DC5F774EF41E095E15C69E024624E0ED7CE65CC6006671A4`
and English r2 23 pages / 186,413 bytes / SHA-256
`D34DD7AE50939B003451C06CBA06BD7E8788F533197D846415A92EE1002E5A1E`.
French pages 36--37 pass text-layout review; English page 23 passes visual QA
with the note visible, stray period absent, and diagram complete. The p.132
pre-Stacks block is current at 69,454 bytes / SHA-256
`EB95123847A5B6B08D50C20ECF0857D31E0D3E3599D15153FECEF8EEC3E58E82`.
No OCR, global build/render, XeLaTeX process, temporary English `source/$out`,
or `Q:` mapping remains.

Exact next cursor: first remove only the temporary final `\end{proposition}`
from `source/ega1/ega1-5-fr.tex`, then continue from NUMDAM PDF one-based
p.132 / printed p.133 with `est commutatif` in Proposition 5.3.5.

## Successor checkpoint: printed p.133 complete

The earlier p.133 cursor is superseded. After removing exactly the temporary
p.132 `\end{proposition}`, diplomatic French completes Proposition 5.3.5,
Corollaries 5.3.6--5.3.7, Propositions 5.3.8--5.3.9, and Corollaries
5.3.10--5.3.11. `source/ega1/ega1-5-fr.tex` is 23,519 bytes / 538 lines /
SHA-256
`DC5D2863A197CE33C9AAC314696ABDD36E840183D8DA735ACE6E99613A60FB91`.
Its exact terminal sentence is `C'est le cas particulier du cor. (5.3.10) où
l'on remplace S par Y et T par S (cf. (5.3.7)).` The p.133 marker begins at
byte offset 19,905; marker-to-EOF is 3,614 bytes / SHA-256
`9D8475E0BB535C2061A1A1A6F860A339C911E31E7C530987C66ED99AD1AB78FD`.
Replacing that suffix with the 18-byte temporary close restores sealed p.132
exactly. No temporary close remains.

Proposition 5.3.8 prints that `X(Z)_Y` is likewise reduced to one element
after injecting it into the singleton `Y(Z)_Y`. This may be empty, so French
preserves the printed wording while English retains “at most one element”
with one visible translator note. Current `ega1-5.tex` is 47,337 bytes / 827
lines / SHA-256
`520D28FBEE094AFC930E09D6A27ED8257D4E4F802FAAE0E2C5135F8F8641D798`;
removing that unique p.133 note restores exact R71 source bytes and hash.
...
and exactly one changed row from R71, `ega1/ega1-5.tex`. Its PASS validation
is 9,300 bytes / SHA-256
...
Source-current bounded PDFs are French 38 pages / 347,584 bytes / SHA-256
`15B36FFA1B62269026EC7ED1A5BF7980203B0163DB137DACFDABE5297979B06B`
and English 24 pages / 191,842 bytes / SHA-256
`5EF5926DA9FFC164E1E60D3228F0F46132F42259D3F66EB8188C0CDC5B73AB7D`.
French pages 37--38 pass text-layout review; English pages 23--24 pass
targeted text/visual QA with the new note visible and no clipping or overlap.
The p.133 pre-Stacks block is current at 72,982 bytes / 1,246 lines / SHA-256
`B95A07D25C9773FE9AC06725E4B9833A9E8851EFA9328F76ED8739EF0994EA44`.
No OCR, global build/render, XeLaTeX process, temporary English `source/$out`,
or `Q:` mapping remains.

Exact next cursor: append directly to `source/ega1/ega1-5-fr.tex` from NUMDAM
PDF one-based p.133 / printed p.134, beginning the graph terminology after
Corollary 5.3.11. Do not remove a closing environment first.

## Successor checkpoint: printed p.134 complete

Direct NUMDAM PDF one-based p.133 / printed p.134 is admitted through the
exact terminal words “z in Delta_Y(Y) intersect p_1^{-1}(X), on a
z=Delta_Y(y)”, inside the proof of Corollary 5.3.16. The bounded authority
image is 4,681,976 bytes / SHA-256
...
source/ega1/ega1-5-fr.tex is now 27,093 bytes / 629 lines / SHA-256
2BF15FE97B29DE032BB338E83897243673A7CC9C5956049AB1A29E195281DC2F.
Truncation to the first 23,519 bytes exactly restores the sealed p.133 source
SHA-256
DC5D2863A197CE33C9AAC314696ABDD36E840183D8DA735ACE6E99613A60FB91.
The p.134 append is 3,574 bytes / SHA-256
EEB829591264986666DBBD5263B58BADCA8122A168BF721A6186DDACDCB9582D;
there is no temporary French close.

English pre-edit R73 and post-recheck R74 both replay all 127 files / 7,281,655
bytes to tree SHA-256
29EB38A85D6F0DEC1644A9B2C4AA2A52D7185A83875E115B6AD0C44C627F9D37;
the complete delta is zero rows. R74 is 48,428 bytes / SHA-256
...
The source-current bounded PDFs are French 38 pages / 352,013 bytes / SHA-256
1DD0BA9C886D8C3BAFDC8AC3504848B5F180EAAFEC63FF9C2ECD820F1585A052
and English 25 pages / 196,609 bytes / SHA-256
629DF4EF410D01F22290444C82BDD350AB8399D2BD108772E973F5469C968F73.
Targeted terminal-page QA passes with no new bounded warnings, clipping, or
overlap. The English proof close visible at the terminal build page belongs
only to the bounded projection, not live source.

The p.134 pre-Stacks block is current at 77,945 bytes / 1,329 lines / SHA-256
C2697E538722F21711C2833A524D689CD084E6F283E058AB37FB1AD40BAB5EA3.
Final p.134 ledger identities are French 3,289 bytes / SHA-256
342FF6BAF4F870B459C209966437144A008C8AB365BE44C2BBF4C9EE10970AE9,
English 2,130 bytes / SHA-256
F4266810E5D1C1D56C373ECEA8349B8751D9E8905D62AE431C546A11CC443B55,
and workflow 17,614 bytes / SHA-256
546920CB0A701EF12C3E8B1FB2CD7405EB5247943D85A7E35C26D21A9D2B332A.
No XeLaTeX process, Q: mapping, or English source/$out remains. The moved
unrelated tree is authoritative only at
[PRIVATE_DOCUMENTS_ROOT]\CHat translates and clean; the former
Papors\Chatnotes tree was not recursed.

Exact next cursor: create and replay the complete R75 pre-edit English
127-file manifest, then append direct NUMDAM PDF one-based p.134 / printed
p.135 to source/ega1/ega1-5-fr.tex, continuing Corollary 5.3.16 after
z=Delta_Y(y). Do not remove a closing environment first.

### Printed-p.134 retained-raster custody correction

A later bounded listing found the retained English p.25 QA raster at
...
This supersedes only the prior ephemeral/not-retained metadata; source, build,
and visual conclusions are unchanged. Final p.134 workflow is 25 rows /
...
## Successor checkpoint: printed p.135 complete

Direct NUMDAM PDF one-based p.134 / printed p.135 is admitted through
Corollary 5.4.4 and its terminal proof comparison. The authority image is
4,299,800 bytes / SHA-256
AA876A55EC9FD2FE0B3140B0F00AB9031D7C0D1909146B1B2396CD508126BB0A;
the 51-line existing text layer is 3,005 bytes / SHA-256
...
The 3,454-byte p.135 append has SHA-256
1E124A848F2701CEF32A1409EF733137892FE2AE4043DCF8A66904AF125C9A33;
truncation to 27,093 bytes exactly restores sealed p.134. There is no
temporary French close.

English R75/R76 replay the same 127 files / 7,281,655 bytes to tree SHA-256
29EB38A85D6F0DEC1644A9B2C4AA2A52D7185A83875E115B6AD0C44C627F9D37
with zero delta. R76 is 49,155 bytes / SHA-256
67192F831823DB9C25E6951DF7CFB69A69C81422CF594EE33C84C3B3ACB386E3.
The inherited p.135 English slice required no source mutation; the visible
5.4.1 historical-terminology footnote is retained and classified as
translator paratext, not French source.

French bounded PDF: 39 pages / 356,630 bytes / SHA-256
EECC102968EB25B18C92A369BFCB5350FCB35B4E1651F00F2BA28BA14CF81BA2.
English bounded PDF: 26 pages / 201,867 bytes / SHA-256
AB575233DAD6613B4CBFD411C085443EDDDB10967D13D9E2A28996099A2293FE.
Targeted QA passes; diagrams and the translator note are visible, with no
clipping or overlap.

The p.135 scaffold is current at 82,678 bytes / 1,408 lines / SHA-256
9545858861D9E506F65069F7E65FCD0403D29C78A7DAC4D6A7A7AFE56348E183.
P.135 ledgers are French 9 rows, English 8 rows, workflow 11 rows, with
workflow SHA-256
6968A314768BE84F01C685A4D9A25C6DE20F29D55C5198870758E2986EADB33E.
English R76 validation is PASS at 10,513 bytes / SHA-256
...
Exact next gate: create/replay complete English R77 before source mutation,
then append direct NUMDAM PDF one-based p.135 / printed p.136, beginning
Corollary 5.4.5. Do not remove a closing environment first.

## Successor checkpoint: printed p.136 complete

Direct NUMDAM PDF one-based p.135 / printed p.136 is admitted through the
proof of Proposition 5.5.1 at the exact terminal words ce qui. The authority
image is 4,742,222 bytes / SHA-256
E0116F6D3509552A6308EBD99DABAFAD63D60ECCCB12EF1907415E734085921E;
the 52-line existing text layer is 2,943 bytes / SHA-256
BA752752DA446DD2EB32AD4805E51487FBA656F82664EE7D81F9AA6692529106.
No OCR was run.

source/ega1/ega1-5-fr.tex is 34,221 bytes / 810 lines / SHA-256
E025EFA76D8F9C9BBDA04042337FA59D653F93E403AAB5FD3BC287F2712FDE67.
The 3,674-byte p.136 append has SHA-256
8DA69EAF0AAB88FFFC45A9A0F8A6D95215ABC96578B798C51528827ADD4A677B;
truncation to 30,547 bytes exactly restores sealed p.135. There is no
temporary French close.

English R77/R78 replay the same 127 files / 7,281,655 bytes to tree SHA-256
29EB38A85D6F0DEC1644A9B2C4AA2A52D7185A83875E115B6AD0C44C627F9D37
with zero delta. R78 is 49,882 bytes / SHA-256
803A294EC3F3CF1EFBC42ED8C3CDEE057FF2DA8142483676ED5B2E0B74F85F7B.
The inherited p.136 English slice required no source mutation and remains
47,337 bytes / SHA-256
520D28FBEE094AFC930E09D6A27ED8257D4E4F802FAAE0E2C5135F8F8641D798.

French bounded PDF: 40 pages / 361,890 bytes / SHA-256
2616D0F29294FF83B73C6BEF0B27728B8C8D5EF1633D3ED0B5DA84EEAEBB6C42.
English bounded PDF: 27 pages / 206,911 bytes / SHA-256
1E4A283AC89786A08A3DC0B5AB5C979D783490E0A4DA47DD2FDBA888F777E5B8.
Targeted QA passes; the triangular diagram and all six clauses of 5.5.1 are
present, with no new source-caused build warning.

The p.136 scaffold is current at 86,845 bytes / 1,481 lines / SHA-256
908D82E0E7063B91CFDE8C2765AD49F7DA2A9B60E5F8E782A4B1C0A697FE1DA2.
P.136 ledgers are French 8 rows, English 8 rows, and workflow 18 rows, with
SHA-256 values
...
All JSONL rows parse and stable IDs are unique.
...
Exact next gate: create/replay complete English R79 before source mutation,
then append direct NUMDAM PDF one-based p.136 / printed p.137, continuing the
proof of Proposition 5.5.1 after ce qui. Do not remove a closing environment
first. The moved unrelated tree remains
[PRIVATE_DOCUMENTS_ROOT]\CHat translates and clean; its former
Papors\Chatnotes location was not recursed.

## Successor checkpoint: printed p.137 complete

Direct NUMDAM PDF one-based p.136 / printed p.137 is admitted through the
proof of Proposition 5.5.4 and the exact terminal reduction sentence ending
with préschémas intègres (2.1.7). The retained authority image is 5,057,783
bytes / SHA-256
85D4DC363A051C5EA7D369D41B0756B13FB29BBC286EF1F77505E32A2B3A109E;
the 53-line existing text layer is 3,592 bytes / SHA-256
58F824549A3718171C76DFF77DAFE5CC6DDFE3033A48ED601BC200C5EE713350.
No OCR was run.

source/ega1/ega1-5-fr.tex is 38,044 bytes / 889 lines / SHA-256
9F316E9901A7DC8F069853E0DC3A9061FA49779CB59CE2016CFF95B2D11FD4BE.
The 3,823-byte p.137 append has SHA-256
804E027A1BCA48480DE29FC8B4B45436BA00B2A588C0042A93B21E64EC50EF91;
truncation to 34,221 bytes exactly restores sealed p.136. There is no
temporary French close and no new catalogued printed-source defect.

The paired English recheck made three individually reversible fidelity
repairs in source/ega1/ega1-5.tex: the exact 3.3.9.1 hyperlink target, the
lower-side Delta_X diagram label, and the mathematical-strength restoration
from a mere “idea” to the source's actual reduction. The source is 47,345
bytes / 827 lines / SHA-256
BE2123101A28F8BEB6BBB5B32FC09CCA17F1B01BA491C9799229D9810B89BE2E;
the three exact inverses restore R79 at 47,337 bytes / SHA-256
520D28FBEE094AFC930E09D6A27ED8257D4E4F802FAAE0E2C5135F8F8641D798.

English R80 has 127 files / 7,281,663 bytes, manifest 50,731 bytes /
SHA-256
...
Exactly ega1/ega1-5.tex changes from R79, by +8 bytes; membership, order,
sizes, row hashes, aggregate bytes, canonical tree replay, and the
three-operation inverse replay all pass.

French bounded PDF: 40 pages / 366,748 bytes / SHA-256
480AA13E0D0694556D4AA2FA5025754F421513D62B8581D44C08276CD68B87F4.
English bounded PDF: 28 pages / 211,829 bytes / SHA-256
2A041B3BAD2EB9F64BE88FE8A4E9F5B3A881FADC84FD53AA4ED894B360B37B62.
Targeted layout/visual QA passes; both diagrams, the lower Delta_X label,
and the corrected reduction claim are visible without clipping or overlap.

The p.137 scaffold is current at 92,172 bytes / 1,571 lines / SHA-256
248460C70D5B42F30E254761EC31C30F9F3AD6EFAFDFC41C768AEC50581D10C6.
P.137 ledgers are French 9 rows, English 10 rows, and workflow 20 rows, with
SHA-256 values
...
All JSONL rows parse and stable IDs are unique; adverse parser, placement,
build, projection, and search-scope attempts remain visible with explicit
no-mutation resolutions.
...
Exact next gate: create and independently replay complete English R81 before
any source mutation, then append direct NUMDAM PDF one-based p.137 / printed
p.138, beginning Proposition 5.5.5. Do not remove a closing environment
first. Continue sequentially and RAM-light; the moved unrelated tree remains
[PRIVATE_DOCUMENTS_ROOT]\CHat translates and clean and its former
Papors\Chatnotes location must not be recursed.

## Successor checkpoint: printed p.138 complete

Direct NUMDAM PDF one-based p.137 / printed p.138 is admitted from
Proposition 5.5.5 through the opening proof of Proposition 5.5.10, ending
exactly at the words “s'identifie à l'espace sous-jacent au”. Current French
...
The 4,909-byte p.138 append has SHA-256
0B25E5A1D790A3A1C09C38E94BE63132A169C8808DFABD2112C1E3664B3F857A;
truncation to 38,044 bytes exactly restores sealed p.137 at SHA-256
9F316E9901A7DC8F069853E0DC3A9061FA49779CB59CE2016CFF95B2D11FD4BE.
There is no temporary French close, printed-source correction, catalogued
source defect, or unresolved reading. The rejected `\mathbb{Z}` encoding and
accepted corpus-standard `\mathbf{Z}` encoding are separately reversible and are
not classified as an author correction.

The paired English recheck made four exact fidelity repairs in
source/ega1/ega1-5.tex: the omitted first 3.2.5 dependency, the affine-target
reduction claim, singular “criterion”, and the mathematically substantive
necessary-versus-sufficient polarity and scope of Corollary 5.5.9. The source
is 47,354 bytes / 827 lines / SHA-256
29761A8C85CC1608E3EC80A7397B0847306F8A5F8C61AEA4772E1C79A3E493E3;
the four exact inverse fragments restore R81 at 47,345 bytes / SHA-256
BE2123101A28F8BEB6BBB5B32FC09CCA17F1B01BA491C9799229D9810B89BE2E.
The retained mapsto glyph, proof wrappers, and structured clause display are
explicitly ledgered normalizations rather than silent attributions to the
author.

English R82 has 127 files / 7,281,672 bytes, manifest 51,613 bytes / 1,126
lines / SHA-256
...
Exactly ega1/ega1-5.tex changes from R81, by +9 bytes; membership, ordinal
order, row sizes and hashes, aggregate bytes, tree replay, all four old/new
fragment hashes, and the four-operation inverse replay pass.

French bounded PDF: 41 pages / 372,423 bytes / SHA-256
96E1279700FDCBEFFC38E7E1E28A28D6CA9C4F08BB9B87A3D1BD7C91B8FD2687.
English bounded PDF: 29 pages / 217,374 bytes / SHA-256
1B4A7532D8DF1C832CBE61249EF6395CC36A3EEFEA1C1C886472ECA62D0297C4.
Targeted French visual QA and paired text-layout QA pass without clipping or
overlap. The English wrapper's sole end-proof token is build-only because the
live proof continues on p.139.

The p.138 scaffold is current at 98,950 bytes / 1,682 lines / SHA-256
1B024552FFE71D56EB1BB2BA50304961073B55B0CEE76D5F514EDDFB65D49BB4.
P.138 ledgers are French 9 rows, English 14 rows, and workflow 22 rows, with
SHA-256 values
...
All rows parse with unique stable IDs. The workflow ledger preserves every
adverse attempt and the pre-existing receipt-order anomaly; this terminal
p.138 receipt supersedes stale later p.130--p.136 cursor entries without
...
Exact next gate: create and independently replay complete English R83 before
any p.139 English source mutation, then use direct NUMDAM PDF one-based p.138
/ printed p.139 to continue the proof of Proposition 5.5.10. Do not remove a
French closing environment first. Continue sequentially and RAM-light in the
two named EGA roots; do not recurse the moved unrelated tree or its former
Papors\Chatnotes location.

## Terminal successor checkpoint: printed p.140 complete

This append-only successor controls over the correct but nonterminal p.140
receipt above and over the intervening historical p.139 block. The misplaced
receipt was not deleted or moved. Its full source, manifest, build, scaffold,
and reversal evidence remains authoritative except for the three superseded
control identities below.

The adverse receipt-order event is now the 27th workflow row. Final workflow
identity is 20,658 bytes / 27 parse-clean unique-ID rows / SHA-256
...
No source, manifest row, PDF, scaffold, or decision ledger changed.

Printed p.140 remains sealed through `Tout sous-$\mathscr{O}_X$-`. First
create and independently replay complete R87; then continue from direct
NUMDAM PDF one-based p.140 / printed p.141 in ega1-6-fr.tex. No French source
...
preserving all append-only source, decision, adverse, and reversal evidence.

Direct NUMDAM PDF one-based p.139 / printed p.140 is admitted through the
exact terminal fragment `Tout sous-$\mathscr{O}_X$-`. Remark 5.5.12 clauses
(iv)--(vi), both arguments, its reduction square and alternate clauses,
5.5.13, section 6, subsection 6.1, Definition 6.1.1, and the following
paragraph are now diplomatic French. The single authority image is 1,611,884
bytes / SHA-256
53C5CB09587812441B5A5ED0C6DB1451E3A63C106EBEDFB7FD33CF421536A93B;
no OCR was run.

source/ega1/ega1-5-fr.tex is 50,232 bytes / 1,149 lines / SHA-256
4610C5F9E732D99948AA809ED64C85D236423990C2750A06F0DC7A805D317701.
Its 3,116-byte p.140 append has SHA-256
67AC729828067E29A52579C8056A65DCE05B6AC1C4C5027AFB7721830F725A15;
truncation to 47,116 bytes exactly restores sealed p.139 at SHA-256
D8168125192DF12B1765D4F81E8DD2A15D37378370454F4370E0A3F18C3BC055.
The new section-aligned source/ega1/ega1-6-fr.tex is 694 bytes / 18 lines /
SHA-256
0292AFD987807F3045A61D94F56A2344684A539439013DE19091181E369F859F;
its exact inverse is removal only while that hash still matches. All live
source environments are balanced and none is temporarily closed.

The first French build exposed a comma after the reduction square's
bottom-right Y copied from English. A single bounded crop proved that NUMDAM
has no comma; the crop was removed, the French comma alone was removed, and
the first source/build identities remain preserved as superseded adverse
evidence. This is a transcription-fidelity repair, not a silent correction
of the author. No printed p.140 author error or unresolved reading was found.

The paired English recheck changed no source. The p.140 slices are
ega1-5.tex lines 782--827 and ega1-6.tex lines 1--13, together 3,214 bytes /
SHA-256
AECF8D9C3BD19AA2CDB86B074270F09921732D829417AFA04F67C41FB0E775A7.
Three retained choices are explicit: translation-syntactic placement of the
p.141 marker after the reordered compound, conventional Noetherian
capitalization, and the English comma as sentence punctuation rather than a
French glyph. R85 and R86 each replay the same 127-file / 7,281,856-byte
ordinal source tree at SHA-256
3DD3F9B92DBC78C7334C1F194836E9F4181DF2FE87A8A3905D64947F51576F6C.
R86 is 53,233 bytes / 1,150 lines / SHA-256
1AACEE47C3D247A51FAC9790F44B8B4291AD670DB299986CEC6F056638063F8B,
with zero changed, added, or removed rows from R85.

The final French bounded PDF is 43 pages / 381,772 bytes / SHA-256
3952A572810DD80868F84C80C4FDD3165C538F1F27576546D2C87AD9F0E887F6;
pages 42--43 pass text-layout QA and page 42 passes visual QA. The English
bounded PDF is 30 pages / 227,500 bytes / SHA-256
29AA995989C8EED0293505EEBF32CFDA4C40C4743C443B041C1566CA5ECBF267;
pages 29--30 pass text-layout QA. Both warning profiles exactly preserve the
inherited p.139 counts and introduce no hard error or build-only source close.

The p.140 scaffold is current at 110,209 bytes / 1,867 lines / SHA-256
42B41EE3099E81D8D32B59ED957F1790EFBF83BC1BC09F535B5D53D04CC0CD32.
French, English, and workflow ledgers parse with unique stable IDs at 11, 13,
and 26 rows, with SHA-256 values
...
Exact next gate: create and independently replay complete English R87 before
any printed-p.141 English source mutation. Then use direct NUMDAM PDF
one-based p.140 / printed p.141 and continue source/ega1/ega1-6-fr.tex after
`Tout sous-$\mathscr{O}_X$-`, adding the p.141 marker at the true continuation.
No French environment close must first be removed. Continue sequentially and
RAM-light; no global build/render, publication, upload, archive, remaining
XeLaTeX process, temporary crop, drive mapping, or agent remains.

## Successor checkpoint: printed p.139 complete

This terminal checkpoint supersedes every older cursor receipt while
preserving its append-only historical evidence and the previously recorded
receipt-order anomaly.

Direct NUMDAM PDF one-based p.138 / printed p.139 is admitted from the
continuation and completion of the proof of Proposition 5.5.10 through
Examples 5.5.11 and Remark 5.5.12 clauses (i)--(iii), ending exactly at
“possède la propriété P.” Current French source/ega1/ega1-5-fr.tex is 47,116
bytes / 1,076 lines / SHA-256
D8168125192DF12B1765D4F81E8DD2A15D37378370454F4370E0A3F18C3BC055.
The 4,163-byte p.139 append has SHA-256
D0B70C7E7D933740BBF31F9FFE81C98CAE06626EDA37CB0EE8410206942846E1;
truncation to 42,953 bytes exactly restores sealed p.138 at SHA-256
2619437E655E33F819B8A965B48F8DA2D9B0F6890A0E9314EA285D8C99DF87CB.
Remark 5.5.12 and its enumerate remain intentionally open for p.140; neither
is temporarily closed in live French source.

The diplomatic French preserves and catalogues the printed doubled-origin
error: both ideal conditions print (0), although the origin of Spec(K[s]) has
prime ideal (s) and (0) is the generic point. English corrects both tokens to
(s) only with a visible translator note preserving the French reading and
reason. The direct-image comma after reference 4.2.1 controls over the
secondary text-layer digit-3 misdecode.

The paired English recheck made three exact source-grounded repairs in
source/ega1/ega1-5.tex: the visible (0)-to-(s) author-source correction with
note, singular agreement in “neither condition is satisfied”, and restoration
of the doubled-plane assertion that neither condition is satisfied. Current
source is 47,538 bytes / 827 lines / SHA-256
E4E6D19A7C19B69E61CBBE8792DB0EED1AD6DAA0DD559E61811057F11641651C.
The three exact inverse line replacements restore the R83-gated 47,354-byte
source at SHA-256
29761A8C85CC1608E3EC80A7397B0847306F8A5F8C61AEA4772E1C79A3E493E3.

English R84 has 127 files / 7,281,856 bytes, manifest 52,489 bytes / 1,138
lines / SHA-256
4C4EF213763A4E9838AF2E8E23A89C8DB0FC45DEBEA0DA078908BED01EA6CFB8,
and ordinal tree SHA-256
3DD3F9B92DBC78C7334C1F194836E9F4181DF2FE87A8A3905D64947F51576F6C.
Exactly ega1/ega1-5.tex changes from R83, by +184 bytes; membership, ordinal
order, row sizes and hashes, aggregate bytes, tree replay, all three old/new
fragment hashes, and the three-operation inverse replay pass.

French bounded PDF: 42 pages / 378,267 bytes / SHA-256
47E016E105621346051731757945D7110492D3D25F34C1DCE93CBC08896DAB07.
English bounded PDF: 29 pages / 223,477 bytes / SHA-256
D9DCC6A8D435A42A762FCE1B60E465873540FBCE8487DDAAB1ACB7353FB505CC.
French terminal text-layout and single-page visual QA and English terminal
text-layout QA pass. Each wrapper adds exactly the two build-only closures
required by the continuing remark and enumerate; live source remains open.

The p.139 scaffold is current at 104,604 bytes / 1,773 lines / SHA-256
BE3FB4F09303AAF6D12C972D38D1590E94201A6952223A35BD32A9CECADA282B.
P.139 ledgers are French 10 rows, English 10 rows, and workflow 24 rows, with
SHA-256 values
...
All rows parse with unique stable IDs, and all adverse attempts retain their
...
XeLaTeX process, temporary crop, drive substitution, or agent remains.

Exact next gate: create and independently replay complete English R85 before
any p.140 English source mutation, then use direct NUMDAM PDF one-based p.139
/ printed p.140, beginning Remark 5.5.12 clause (iv). Do not place or remove
a temporary French source close. Continue sequentially and RAM-light in the
two named EGA roots; do not recurse the moved unrelated tree or its former
Papors\Chatnotes location.

## Final terminal successor checkpoint: printed p.140 complete

This append follows the unique historical R85/p.139 terminal sentence and is
the controlling French STATUS receipt. Both earlier nonterminal p.140 blocks
remain preserved as adverse append-order evidence. No source, manifest row,
PDF, scaffold, authority artifact, or French/English decision row changed.

Final workflow ledger: 23,071 bytes / 29 parse-clean unique-ID rows / SHA-256
A736395707953F046D095A6A6F2EF4CB856F752F5045A1714260B32295C5E1D0.
Final English R86 validator: PASS/errors empty, 14,728 bytes / 315 lines /
SHA-256
17324EC59ECCC5E0E9B9C5905190B841435EE7C07F5C485665E765215FE6F4DC.
Final French R63 validator: PASS/errors empty, 15,819 bytes / 329 lines /
SHA-256
3D8088D1C25BD1925B80083CF44618FE2CDEACFF2C254E09FCCD792FD9C75235.

Printed p.140 remains sealed through `Tout sous-$\mathscr{O}_X$-`. Create and
independently replay complete R87, then continue from direct NUMDAM PDF
one-based p.140 / printed p.141 in source/ega1/ega1-6-fr.tex. No French source
close must be removed.

## Final terminal successor checkpoint: printed p.141 complete

Direct NUMDAM authority is admitted through the exact semicolon after the
finite $D(f_i)$ cover in the proof of Proposition 6.1.4. French
source/ega1/ega1-6-fr.tex is 5,074 bytes / 105 lines / SHA-256
75A77003BDC90E8F0809F0DBF324A1F45268BC7A39C557D5A78C62816168B95B.
The proof remains intentionally open. Its exact two-step inverse restores
sealed p.140 SHA-256
0292AFD987807F3045A61D94F56A2344684A539439013DE19091181E369F859F.

The paired English recheck restores increasing for the corresponding
ideal-sheaf sequence, citation 1.3.7, and the printed canonical equivalence;
it also restores oldpage 142. English source/ega1/ega1-6.tex is 54,737 bytes
/ 839 lines / SHA-256
BA45F1965B6085D84CA7E3723E4078039093ACFDDD916FD191AD43DE251CA980.
The exact inverse restores R87 SHA-256
...
Its 127-file / 7,281,911-byte ordinal tree replays exactly at SHA-256
5AAE163319428FB1DDB52411C7F5CAB6AFA90235FB32C7ADE2AFD6203E6D4C25;
exactly ega1/ega1-6.tex changes from R87 by +55 bytes.

Final French and English bounded PDFs have SHA-256 values
...
Terminal French text/visual QA and English text-layout QA pass. The terminal
p.141 scaffold SHA-256 is
E5BCB61BB2C8CBF65B628253E62B2F5579D9821C15078BFF25A12880ADDDC689.

Final workflow is 20,189 bytes / 22 parse-clean unique-ID rows / SHA-256
...
Next gate: create and independently replay complete English R89 before any
p.142 English mutation, then continue the already-open French proof from
NUMDAM PDF one-based p.141 / printed p.142. Add oldpage 142 at the true French
continuation; add or remove no temporary proof close.
