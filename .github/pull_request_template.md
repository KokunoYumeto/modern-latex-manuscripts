...
- [ ] I checked `docs/github-maps.md`, the work's coverage map, and the reader/source shelf before starting.
...
Describe the correction or addition.

Exact GitHub paths and prior/current commit or byte hashes:

## Source Check

Source witness, page, theorem, or file used:

## Build/Review

PDF rebuilt or checked?
