...
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, newer source-checkable paper-level German/English files, and multilingual Spanish/Japanese cumulative readers through Paper 34 complete.
- `reader-pdfs/deligne/` and `sources/deligne/`: Deligne paper-level working translations, including cumulative English/French working readers for touched papers, individual English paper PDFs, a sequential source-checked packet for papers 001-013 complete plus paper 014 through page 30, standardized source packets for papers 080-090, separate Deligne correspondence items, and TeX/source artifacts for papers 1-14 (14 partial), 32, 42, 45, 56, 57, 58, 69, 70, 71, and 80-90.
