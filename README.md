...
- `reader-pdfs/sga/`: SGA 1-2 snapshots, a cleaned SGA 3 rebuild, complete current SGA 4 working reader, SGA 5 and SGA 6 partial assemblies, SGA 7-I partial assemblies, a source-checked SGA 5 French/English edition through the opening of Expose VII, and French reference scans.
...
- `reader-pdfs/weber/` and `sources/weber/`: Weber original-language readers and current English translation drafts, including the Volume II tail and Volume III sections 1-50.
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, the older cumulative translation/summary draft, and newer source-checkable paper-level German/English files through paper 11.
- `reader-pdfs/deligne/` and `sources/deligne/`: Deligne paper-level working translations, including a complete bilingual working package for Paper 32, *The Weil Conjecture II*.
...
EGA currently includes the inherited community EGA I-II material plus project additions for EGA 0_IV sections 15-23 and EGA IV sections 1-21 as working translations. SGA currently includes a 484-page SGA 4 working reader, broad partial assemblies for SGA 5, SGA 6, and SGA 7-I, plus a source-checkable SGA 5 edition through Expose VII page 318 as paired French-source and English high-fidelity readers. The non-European corpus currently promotes a work-level public surface of 59 reader PDFs including recent Brahmagupta reflow repairs, while older combined readers and weaker drafts are retained in Zenodo ZIP artifacts for provenance and reconstruction. Weber includes broad older English translation drafts plus current paired high-fidelity German/English readers for the Volume II tail and Volume III sections 1-50; Noether includes the older cumulative translation/summary draft plus paper-level high-fidelity German/English readers through Paper 11; Deligne includes a complete bilingual working package for Paper 32; Gauss and Riemann have current author pages with reader PDFs and source artifacts.
