...
- `reader-pdfs/sga/`: SGA 1-2 snapshots, a cleaned SGA 3 rebuild, complete current SGA 4 working reader, SGA 5 and SGA 6 partial assemblies, SGA 7-I partial assemblies, a source-checked SGA 5 French/English edition complete through printed page 484, a strict SGA 6 French/English rebuild through source page 653, and French reference scans.
...
- `reader-pdfs/classical/`: current Cayley volume-level source-checked slice readers, a complete German/English Dedekind edition of *Was sind und was sollen die Zahlen?*, Dedekind and Dirichlet source-checked segments, and classical algebra/arithmetic shelf readers.
...
- `reader-pdfs/sylvester/` and `sources/sylvester/`: Sylvester Volume I source-checked working TeX/PDF through book page 90, with source scan slices and continuation notes.
