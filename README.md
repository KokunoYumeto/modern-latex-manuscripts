...
- `reader-pdfs/weber/` and `sources/weber/`: Weber original-language readers and current English translation drafts, including the Volume II tail and Volume III sections 1-62.
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, the older cumulative translation/summary draft, and newer source-checkable paper-level German/English files through paper 13.
