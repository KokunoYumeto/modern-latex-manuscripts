...
- `reader-pdfs/sga/`: SGA 1-2 snapshots, a cleaned SGA 3 rebuild, complete current SGA 4 working reader, SGA 5 and SGA 6 partial assemblies, SGA 7-I partial assemblies, a source-checked SGA 5 French/English edition complete through printed page 484, a strict SGA 6 French/English rebuild through source page 110, and French reference scans.
- `sources/sga/`: extracted TeX/source/review material from the current SGA artifact packets.
- `reader-pdfs/non-european/`: current work-level public readers for Chinese, Indian/Sanskrit, Islamic/Arabic, and historical-reference material. Recent work-level replacements include Yang Hui, Zhu Shijie, Qin Jiushao, Li Ye, Bhaskara II, al-Khwarizmi, Omar Khayyam, Ibn al-Nadim, and Brahmagupta readers; weaker combined readers are preserved on Zenodo as artifacts rather than promoted as front-facing PDFs.
...
- `reader-pdfs/weber/` and `sources/weber/`: Weber original-language readers and current English translation drafts, including the Volume I source-checked rebuild through section 33, Volume II tail, and Volume III sections 1-90.
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, the older cumulative translation/summary draft, and newer source-checkable paper-level German/English files through Papers 1-29 complete.
...
EGA currently includes the inherited community EGA I-II material plus project additions for EGA 0_IV sections 15-23 and EGA IV sections 1-21 as working translations. SGA currently includes a 484-page SGA 4 working reader, broad partial assemblies for SGA 5, SGA 6, and SGA 7-I, a source-checkable SGA 5 edition complete through printed page 484, and a strict SGA 6 source-checked French/English rebuild through source page 110. The non-European corpus currently promotes a work-level public surface of 59 reader PDFs with recent targeted replacements for Li Ye, Bhaskara II, al-Khwarizmi, Omar Khayyam, Ibn al-Nadim, Qin Jiushao, and Brahmagupta, while older combined readers and weaker drafts are retained in Zenodo ZIP artifacts for provenance and reconstruction. Weber includes broad older English translation drafts plus current paired high-fidelity German/English readers for Volume I through section 33, Volume II sections 176 through end matter, and Volume III sections 1-90; Noether includes the older cumulative translation/summary draft plus paper-level high-fidelity German/English readers through Papers 1-29 complete; Deligne includes cumulative English/French working readers for the touched paper set, individual English paper PDFs, and source artifacts; Gauss and Riemann have current author pages with reader PDFs and source artifacts.
