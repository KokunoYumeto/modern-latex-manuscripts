...
| Emmy Noether | Curated reader-facing surface: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus RA23 display-layout corrections and RA25-RA30 Paper 02 source-critical symbol/body audit packages; RA29 closes the Paper 02 body through printed pp.84-90 at the current page-level standard; RA30 adds the Paper 02 final-summary/table-plate audit package, with Table II lower-row cell audit and multilingual propagation still open. Not a certified critical edition; the RA25-RA30 source corrections still need cross-language propagation. | <https://zenodo.org/records/20672323> |
