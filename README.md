...
- `reader-pdfs/deligne/` and `sources/deligne/`: Deligne paper-level working translations, including cumulative English/French working readers for touched papers, individual English paper PDFs, source-checked paper packets for papers 001, 005, 006, and 081-090, separate Deligne correspondence items, and TeX/source artifacts for papers 1, 5, 6, 32, 42, 45, 56, 57, 58, 69, 70, 71, 81, 82, 83, 84, 85, 86, 87, 88, 89, and 90.
