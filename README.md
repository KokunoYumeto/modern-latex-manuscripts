...
| Emmy Noether | Curated reader-facing surface: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus RA23 display-layout corrections and RA25-RA29 Paper 02 source-critical symbol/body audit packages; RA29 closes the Paper 02 body through printed pp.84-90 at the current page-level standard while table plates and multilingual propagation remain open. Not a certified critical edition; the RA25-RA29 source corrections still need cross-language propagation. | <https://zenodo.org/records/20672174> |
| Heinrich Weber | `Lehrbuch der Algebra` Volume I represented as repaired/source-scan-audited working edition; Volume II current German/English readers through §176 with localized recursive repairs through Batch128. Latest Batch128 repairs Volume II §§29-30 from source scans pp.121-127, with p.128 as the §31 handoff boundary, replacing a previously compressed Sylow-theorem region; larger compression clusters remain explicitly open. Volume III remains the earlier repaired cumulative. | <https://zenodo.org/records/20672175> |
