...
- `reader-pdfs/non-european/`: current work-level public readers for Chinese, Indian/Sanskrit, Islamic/Arabic, and historical-reference material. The current Zenodo reader surface has 68 front-facing PDFs and about 7996 reader pages, including corrected combined readers, an al-Battani v083 trilingual text/reference reader, and an al-Battani fixed-star catalogue descriptive edition with CSV dataset; coordinate and numerical-table collation remain active reconstruction streams rather than a completed table edition.
