...
| Workflow / replication packet | Small AI-run workflow and tooling packet; latest addendum documents edition/source identity checks, structured repair worklists, OCR witness discipline, source-derived figure policy, language propagation from correction ledgers, and public artifact labelling. | <https://zenodo.org/records/20650989> |
| Emmy Noether | Numbered-paper German/English corpus plus multilingual working translations; latest public version adds a distilled RA20 German/source correction for Paper 02 p.63 display layout while keeping raw audit/witness bundles out of the reader-facing surface. | <https://zenodo.org/records/20651370> |
