...
- `reader-pdfs/weber/` and `sources/weber/`: Weber English translation readers and paired German source readers, including the Volume I source-checked rebuild complete, Volume II source-checked cumulative readers through section 124, and the current repaired cumulative Volume III readers. The top-level Weber reader PDFs are ordered English first, then German source.
- `reader-pdfs/noether/` and `sources/noether/`: Noether complete numbered-paper German/English readers, newer source-checkable paper-level files, and multilingual Spanish/Japanese cumulative readers through Paper 39 complete.
- `reader-pdfs/deligne/` and `sources/deligne/`: Deligne paper-level working translations, with English reader PDFs fronted before paired French working/source PDFs. The public surface has three active lanes: a diagram-audited forward source-checked stream covering papers 001-013 complete plus paper 014 through page 30 and paper 015; a reverse source-checked stream covering papers 090 down through 080 complete plus paper 079 pages 1-20 as an explicit partial; and a prominent correspondence lane with twelve English letter readers paired with French working PDFs. Additional TeX/source artifacts exist for papers 32, 42, 45, 56, 57, 58, 69, 70, and 71.
