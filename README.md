...
- `reader-pdfs/sga/`: SGA 1-2 snapshots, a cleaned SGA 3 rebuild, complete current SGA 4 working reader, SGA 5 and SGA 6 partial assemblies, SGA 7-I partial assemblies, a source-checked SGA 5 French/English edition through Expose XV, printed page 461, and French reference scans.
...
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, the older cumulative translation/summary draft, and newer source-checkable paper-level German/English files through Papers 1-18 complete.
