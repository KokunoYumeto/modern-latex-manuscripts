...
| Emmy Noether | Curated reader-facing surface: cumulative readers, 43 standalone English paper PDFs, compact German/source, Spanish, Japanese, French, and Simplified Chinese packages, plus RA23 display-layout corrections and RA25/RA26/RA27/RA28 Paper 02 source-critical symbol audit packages plus the RA28 ν/v source-audit correction package. Not a certified critical edition; RA12-RA28 source corrections still need cross-language propagation. | <https://zenodo.org/records/20670504> |
...
| SGA working English translation | SGA 5/6 and further SGA working translations; repair019 backfills early SGA5 French diagram repairs on pp.030, 031, 038, 046, 047, and 048, and repair020 adds source-level diagram repairs on source pp.083-086 and p102. SGA6 French is carried forward unchanged from the current cumulative, English remains unsynchronized, and SGA6/SGA7 keep explicit compression/provisional caveats; older `Complete`/`Source-Checked` filenames are legacy labels, not global certification. | <https://zenodo.org/records/20670531> |
...
| Additional author cluster | Mixed author shelf for routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. packets. Latest routed sweep includes `poincare_v1_21.zip` through Poincare Tome I Chapter XIV, `Frobenius_all_GE_EN_cum_scans_QA03_20260611.zip`, and `Kneser_LVR_p0206_0219_DE_EN_20260612.zip` for Kneser p0206 lower-p0219 upper / §§46-48 with Fig. 24 as a source-derived crop; lower p0219 / section 49 remains the next handoff. Treat the shelf package by package, not as blanket certification. | <https://zenodo.org/records/20669391> |
