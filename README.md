...
Some local packages have been extracted, patched, and checksummed after the latest public Zenodo versions but are not yet public Zenodo files. The exact queue is tracked in [Pending Zenodo Uploads](docs/pending-zenodo-uploads.md). Fresh 2026-06-13 additions include Noether Paper 08/Paper 15/Paper 16/Paper 17/Paper 18/Paper 19/Paper 20 targeted source-audit fixes, Noether RA43/RA44 Paper 06 pp.161-172, and Gordan `Vorlesungen ueber Invariantentheorie` Bd. 1 p010-p028. These should be cited only after the next Zenodo upload/publish pass updates the public file catalog.
