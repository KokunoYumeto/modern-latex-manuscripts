...
| Luigi Bianchi | `Lezioni di geometria differenziale` Vol. I Italian/English working draft represented through source pdfpages 001-543. A2 now has `Bianchi_A2_cont_p0001_0105_IT_EN_20260612.zip`: source pp.0091-0105 added after the p0001-p0090 summation repair, about 14.36% of the 731-page A2 sequence represented, notation logbook and equation indices included, next continuation p0106 / §27 after formula (17). | <https://zenodo.org/records/20672976> |
| Paul Gordan and Clebsch-Gordan | Dedicated working-edition packets: `Gordan_Abel25_p322_331_DE_EN_20260612.zip` extends `Theorie der Abelschen Functionen` through source pp.322-331 / printed pp.300-309 and cumulative German/English TeX/PDF through source p331. It completes §§85-86 and opens §87 through formula (5); earlier Abel tranches and AllPrior AuditFix01 remain provenance/support layers. | <https://zenodo.org/records/20672969> |
...
| Additional author cluster | Mixed author shelf for routed Poincare/Frobenius/Kneser/Mikami/Kronecker/etc. packets. Latest routed sweep includes `poincare_v1_25.zip` for Poincare Tome I source witnesses v1_0345-v1_0370 / Chapter XIX, explicitly non-continuous because intervening v1_22/v1_23 artifacts are missing locally; the recovery branch uses the local base through v1_0284 plus v1_24 and v1_25, and next continuation is v1_0371. Frobenius QA03 and Kneser p0206-p0219 remain current routed support layers. Treat the shelf package by package, not as blanket certification. | <https://zenodo.org/records/20672984> |
