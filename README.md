...
Some local packages have been extracted, patched, and checksummed after the latest public Zenodo versions but are not yet public Zenodo files. The exact queue is tracked in [Pending Zenodo Uploads](docs/pending-zenodo-uploads.md). Fresh 2026-06-13/14 additions include Noether Paper 03/Paper 11/Paper 12/Paper 13 GDZ source/provenance witnesses, Noether Paper 10/Paper 11/Paper 12 compact GDZ source-audit webdrops, Noether Paper 08/Paper 14/Paper 15/Paper 16/Paper 17/Paper 18/Paper 19/Paper 20 targeted source-audit fixes/results, Noether RA43-RA48 Paper 06 pp.161-196 plus Paper 06 GDZ remaining-source witness pp.173-196, Gordan `Vorlesungen ueber Invariantentheorie` Bd. 1 p010-p028, Weber Batch137 active-ledger closure plus Batch138 control-footnote corruption fix, and Maxwell Vol. I pp.001-059 web/promo index closeout plus a pp.060-079 source-witnessed continuation extending local cumulative Maxwell staging to pp.001-079. These should be cited only after the next Zenodo upload/publish pass updates the public file catalog.
