...
- The list below follows the same completion/usefulness order as the record list above. Coherent reader and translation surfaces come first; serious but caveat-heavy source-aware work follows; partial/non-continuous author lanes come after that; OCR/support/salvage lanes are last.
- `reader-pdfs/noether/` and `sources/noether/`: Noether numbered-paper German/English readers, newer source-checkable paper-level files, and multilingual Spanish/Japanese cumulative readers. This is one of the strongest current reader surfaces, but still a working corpus rather than a critical edition.
...
- `reader-pdfs/frobenius/`, `reader-pdfs/kneser/`, `reader-pdfs/sylvester/`, and their source folders where present: compact or medium-sized author/work lanes with coherent reader surfaces and source/audit packets for declared scopes.
...
- `reader-pdfs/bianchi/`, `reader-pdfs/gordan/`, `reader-pdfs/maxwell/`, `reader-pdfs/gibbs/`, and corresponding source folders where present: serious source-aware workstreams with useful reader or audit surfaces, but package-level caveats still control the claim.
