...
| Heinrich Weber | Lehrbuch Volume I complete; Volume II current German/English readers through §176 with localized recursive gap repairs through Batch122, including the §81 table/boundary repair; Volume III in progress; 92 priority gap-audit rows still open. | <https://zenodo.org/records/20660948> |
...
| SGA working English translation | SGA 5/6 and further SGA working translations; SGA repair017 adds source-level SGA5 diagram repairs for source p.92 and p.107, plus a 179-row SGA5 TikZ diagram index. SGA6 repair017/repair004 restores Expose VI source pp.391-397 in French, including formula (2.5.2), derived morphism (2.5.3), Proposition 2.6 proof material, and sections 2.7-2.8. English remains unsynchronized, SGA6 still has 224 v3 worklist rows after filtering, and SGA6/SGA7 keep explicit compression/provisional caveats; older `Complete`/`Source-Checked` filenames are legacy labels, not global certification. | <https://zenodo.org/records/20661245> |
