...
- `reader-pdfs/noether/` and `sources/noether/`: Noether complete numbered-paper German/English readers, newer source-checkable paper-level files, and multilingual Spanish/Japanese cumulative readers through Paper 40 complete.
