...
- `workflow/`: a public workflow note and a small replication packet with sanitized scripts, tooling notes, metadata templates, OCR notes, and release-process guidance.
