...
- `reader-pdfs/sga/`: SGA 1-2 snapshots, a cleaned SGA 3 rebuild, complete current SGA 4 working reader, SGA 5 and SGA 6 partial assemblies, SGA 7-I partial assemblies, a source-checked SGA 5 French/English edition through Expose XII completion plus Expose XV opening, printed page 450, and French reference scans.
...
- `reader-pdfs/weber/` and `sources/weber/`: Weber original-language readers and current English translation drafts, including the Volume II tail and Volume III sections 1-72.
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, the older cumulative translation/summary draft, and newer source-checkable paper-level German/English files through Paper 16 and Paper 17 through section 9.
...
EGA currently includes the inherited community EGA I-II material plus project additions for EGA 0_IV sections 15-23 and EGA IV sections 1-21 as working translations. SGA currently includes a 484-page SGA 4 working reader, broad partial assemblies for SGA 5, SGA 6, and SGA 7-I, plus a source-checkable SGA 5 edition through Expose XII completion and Expose XV opening, printed page 450, as paired French-source and English high-fidelity readers. The non-European corpus currently promotes a work-level public surface of 59 reader PDFs with recent targeted replacements for Li Ye, Bhaskara II, al-Khwarizmi, Omar Khayyam, Ibn al-Nadim, Qin Jiushao, and Brahmagupta, while older combined readers and weaker drafts are retained in Zenodo ZIP artifacts for provenance and reconstruction. Weber includes broad older English translation drafts plus current paired high-fidelity German/English readers for the Volume I introduction opening, Volume II sections 176-202, and Volume III sections 1-72; Noether includes the older cumulative translation/summary draft plus paper-level high-fidelity German/English readers through Paper 16 and Paper 17 through section 9; Deligne includes cumulative English/French working readers for the touched paper set, individual English paper PDFs, and source artifacts; Gauss and Riemann have current author pages with reader PDFs and source artifacts.
