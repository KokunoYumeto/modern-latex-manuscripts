...
- `reader-pdfs/noether/` and `sources/noether/`: Noether selected-paper reader, newer source-checkable paper-level German/English files, and multilingual Spanish/Japanese cumulative readers through Paper 35 complete.
- `reader-pdfs/deligne/` and `sources/deligne/`: Deligne paper-level working translations, with English reader PDFs fronted before paired French working/source PDFs. The public surface has three active lanes: a diagram-audited forward source-checked stream covering papers 001-013 complete plus paper 014 through page 30 and paper 015; a reverse source-checked stream covering papers 090 down through 080; and a prominent correspondence lane with twelve English letter readers paired with French working PDFs. Additional TeX/source artifacts exist for papers 32, 42, 45, 56, 57, 58, 69, 70, and 71.
