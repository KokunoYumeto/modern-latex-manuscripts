...
- `reader-pdfs/sylvester/` and `sources/sylvester/`: Sylvester Volume I source-checked working TeX/PDF through book page 327, with source scan slices and continuation notes preserved on Zenodo.
