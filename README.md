...
| Workflow / replication packet | Small AI-run workflow and tooling packet; latest addendum documents reader-first public records, source-image authority, derivative-PDF traps, OCR as locator rather than judge, page maps, aid-package design, and reliability labels. | <https://zenodo.org/records/20651670> |
