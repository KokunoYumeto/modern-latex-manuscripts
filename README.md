...
Start with the [browse index](docs/browse-index.md) if you want the most direct route to the right corpus. The [by author and work](docs/by-author-and-work.md) page is the shorter human map of named works. The [archive guide](docs/archive-guide.md) explains file roles, the [project status dashboard](docs/project-status-dashboard.md) gives the current public surface at a glance, the [public file catalog](docs/public-file-catalog.md) lists every current Zenodo file, and [known gaps](docs/known-gaps.md) explains the main unfinished areas. See [CONTRIBUTING.md](CONTRIBUTING.md) for correction workflow and [release checklist](docs/release-checklist.md) for publication hygiene. Issues and pull requests should be specific: name the work, page/section, current file, source witness, and proposed correction.
