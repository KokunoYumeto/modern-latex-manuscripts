...
Generated: 2026-07-05T18:59:33+02:00
...
- Source-use label counts: {'generated-draft': 3, 'audit-ledger': 4, 'manifest': 4, 'method-note': 1, 'native-source-body': 66, 'pointer-only': 3}
- Extension counts: {'.csv': 4, '.json': 4, '.md': 12, '.tex': 58, '.cls': 2, '.sty': 1}
