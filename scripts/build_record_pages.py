...
RECORD_NOTES = {
    ...
    "bianchi": [
        "Dedicated Bianchi working-edition record. Volume I of `Lezioni di geometria differenziale` remains represented as a package-audited Italian/English working edition through source pdfpages 001-543. The A2 branch, `Lezioni sulla teoria dei gruppi continui finiti di trasformazioni`, now has `Bianchi_A2_cont_p0001_0077_IT_EN_20260612.zip` as the latest continuation layer through source p0077. It restores the lower p0066 section-13 material, continues p0066-p0077 through the end of section 16, and starts Chapter II / section 17; the next continuation point is p0078 inside section 17. Earlier p0001-p0066 re-audit/HQ packets remain provenance and support layers, and the package notes that earlier p0001-p0065 handwritten-symbol details were not recursively reasserted. OCR/image-analysis material remains witness/locator evidence only.",
    ],
    "cayley": [
