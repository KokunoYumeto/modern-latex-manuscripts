...
RECORD_NOTES = {
    ...
    "sga": [
        "Current compact SGA record 21745704 leads with the SGA1-7 I English reader-and-TeX bundle, followed by direct readers and masters; SGA1 remains the default preview. The bundle contains current standalone readers and buildable TeX, not yet one cross-volume SGA 1-7.2 PDF. The clean 1,470-page SGA3 R29 cumulative covers the Introduction, Exposes I-XXVI, Tome-I subject index, Tome-III mathematical guide, and terminal index. SGA7 I has a complete 287-page English working reader for all written Exposes I, II, VI, VII, VIII, and IX. A direct 186-page SGA7 II English current-progress reader contains complete Exposes X-XVII and Expose XVIII through Corollary 5.8.7, with a 130-member reader/source ZIP; the continuation and Exposes XIX-XXI are absent. French working transcriptions remain separately available. Anonymous readback passed all 85 outer files, all 82 retained predecessor identities, and all 130 members of the new SGA7 II package. Historical versions remain immutable. These are working editions, translations, and transcriptions, not critical editions, rights determinations, mathematical certifications, exhaustive reference certifications, accessibility certifications, uniform whole-series source certification, or final whole-SGA certification. Record rights metadata remains License Not Specified.",
    ],
    "ega": [
