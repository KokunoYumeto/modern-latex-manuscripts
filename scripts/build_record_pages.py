...
RECORD_NOTES = {
    ...
    "sga": [
        "Current caveat from the 2026-06-24 SGA audit-support updates, reconciled with the 2026-06-26 live SGA5 certification ledger: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not complete and should be assumed to contain many remaining errors unless a later, narrower source-audit packet promotes a specific locus. The public surface carries `SGA5_repair032_audit_support_20260624.zip` plus later local workpass evidence. The controlling manual certification log treats agents/workflows as finders rather than certifiers and now records pp.1-172 as page-local ledger evidence in the curated French workpass: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked certified complete; Expose III B Part II §5 is underway through p172, with p173 next. The current ledger records 13 TeX fixes plus one cosmetic p172 cleanup, 27 source typos/source oddities, and D001-D086 in the running diagram ledger; D082/D084/D085/D086 are perfect and D083 was corrected. The p171 diagram 5.9.1 errors are the key workflow warning: three math-bearing TeX content errors compiled cleanly and were found only by source/type checking; p172 then confirmed adjacent diagrams 5.9.2-5.9.4 as perfect. This remains opening-range evidence for a curated 10-expose selection, not global SGA5 certification, not a certified edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.",
    ],
    "weber": [
