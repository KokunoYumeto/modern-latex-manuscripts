...
RECORD_NOTES = {
    ...
    "ega": [
        "Current EGA surface is record 21712381 under the established EGA concept DOI 10.5281/zenodo.20414353. It retains the compact 125-member ZIP containing all five current cumulative English reader PDFs and their complete buildable TeX closures; the same readers and masters remain direct downloads. EGA 0 through Section 13, EGA I through authority EOF, EGA II through authority EOF, and the complete published EGA III text through 7.9.14 are reference-v2 working readers. EGA IV remains source-aligned through Sections 1-10 and continues at Section 11. Three additional ZIPs preserve 419 actual high-detail EGA IV source-image witnesses from printed pages 5-105: 415 images through page 104 are alignment-bound, while four images on page 105 are active-continuation witnesses only. EGA 0 remains the default preview. Anonymous readback passed all 33 outer files and all 80 members of the newest image archive; all 32 predecessor files were retained byte-identically. Superseded loose readers remain available in immutable predecessor versions. Record rights metadata is License Not Specified. EGA remains separate from SGA because it has its own established concept and authority history. These are working translations and source controls, not a complete whole-EGA translation, critical edition, rights clearance, peer review, accessibility certification, or whole-reader source certification.",
    ],
    "deligne": [
