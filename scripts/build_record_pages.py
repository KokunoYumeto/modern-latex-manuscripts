...
RECORD_NOTES = {
    ...
    "sga": [
        "Current public SGA surface is record 21427899. It fronts the 309-page source-aware English SGA5 working translation, directly exposes the corrected 381-page SGA6 full-range layered English reader, retains the 374-page French SGA6 source-rescribe checkpoint at idx684, and adds a 296-page Spanish SGA5 source-reconciled checkpoint with 345 editable units. The Spanish checkpoint covers complete Exposes I, III A, III B, V, VI, VII, VIII, X, and XII, then Expose XV through section 2 no. 1 and the complete proof of Proposition 1; Proposition 2 is next. The grouped Spanish package contains the editable master and units, frozen authority/evidence, build records, checksums, and targeted visual QA. The French SGA6 package retains its editable TeX, pagewise ledger, errata, source delta, witnesses, render checks, and explicit deferred repairs. The SGA6 English reader retains explicit non-uniform authority layers: inherited/partially synchronized source-PDF 001-525, French-synchronized idx532-662, then scan-checked draft material through the tail. The bounded Spanish SGA6 Expose X idx532-537 tranche also remains public. These are substantive source-aware working translations and repairs, not independently human-certified critical editions, complete translations, uniform whole-volume source certification, or whole-SGA completion.",
    ],
    "deligne": [
