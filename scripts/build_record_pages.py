...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21418246 / DOI 10.5281/zenodo.21418246 under concept DOI 10.5281/zenodo.20412587. It retains the 466-page v26/R822 German source-control reader as the explicit default preview, keeps the older English cumulative reader and multilingual checkpoints available, preserves compact R787-R804 rollups, and groups the current German package in `07_Noether_Current_German_SourceControl_v26_R822integrated_20260717.zip`. File `08_Noether_Paper06_Slavic_WorkingTranslation_Tranche001_20260716.zip` adds 16 units each in Interslavic Latin, Interslavic Cyrillic, Russian, and Ukrainian. Seventeen reviewed orthographic changes were applied to the two Interslavic branches; Russian and Ukrainian were retained as working controls. All 64 standalone TeX files compile, but the tranche still needs line-by-line Paper 06 reconciliation against the German authority and is not native-speaker or source-closure certification. R822 itself adds four bounded direct-source Paper 20 refinements beyond R821 with no OCR promoted and preserves every byte outside Paper 20. These files remain working/source-audit/provenance packages only: not a critical edition, whole-corpus certification, multilingual synchronization proof, or final linguistic approval. Inherited `COMPLETE`, `closure`, and `closed` words mean only that a bounded local task completed.',
