...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21421049 / DOI 10.5281/zenodo.21421049 under concept DOI 10.5281/zenodo.20412587. It retains the 466-page v26/R823 German source-control reader as the default preview; directly exposes the 473-page Spanish R823 working translation; and adds complete current Interslavic body surfaces as a 529-page Latin-script reader, a 552-page Cyrillic-script reader, and 221 canonical TeX units per script. File `11_Noether_Interslavic_WorkingCorpus_Normalization_002A_002B_20260718.zip` groups all 442 TeX bodies and individual PDFs with source/support metadata, German R823 authority, exact normalization evidence, complete-corpus build evidence, scripts, and checksums. File `10` retains the Spanish TeX/evidence; file `09` retains twelve bounded R823-synchronized English components plus CJK/Korean/Slavic components. Spanish passed its declared production gate. Interslavic tranches 002A/002B are mechanically closed and idempotent only at their declared surfaces; native/community review remains open. These are working translations, source-control, and audit evidence: not a critical edition, universal mathematical source certification, complete multilingual synchronization, or final linguistic approval.',
