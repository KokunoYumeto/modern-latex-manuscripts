...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21306360 / DOI 10.5281/zenodo.21306360 under concept DOI 10.5281/zenodo.20412587. It fronts the 466-page R816/integrated-v18 German source-control reader, keeps the older English cumulative reader and multilingual checkpoints available, preserves compact R787-R804 source-repair rollups, and groups R814-R816 plus LocalCodex v14-v18 in `07_Noether_Current_SourceControl_Integrated_v18_R814_R816_20260711.zip`. The chain adds source-backed repairs in Papers 19, 31, 32, and 34, including restoration of an omitted Paper 34 proof step. These files are working/source-audit/provenance packages only: not promoted critical editions, not whole-corpus mathematical certification, not downstream multilingual synchronization proof, not final high-resolution certification, and not source-faithfulness certification. Retained English/multilingual readers predate some German repairs. Inherited `COMPLETE` filename words mean only that a local packet task completed.',
