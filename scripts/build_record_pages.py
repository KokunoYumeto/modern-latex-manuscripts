...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21312393 / DOI 10.5281/zenodo.21312393 under concept DOI 10.5281/zenodo.20412587. It fronts the 466-page integrated-v26 German source-control reader, keeps the older English cumulative reader and multilingual checkpoints available, preserves compact R787-R804 rollups, and groups the source-heavy v26 chain in `07_Noether_Current_German_SourceControl_v26_20260711.zip`. Since v19, direct source work records Paper 34 through printed p692, current-head page passes for Papers 35-39, a Paper 41 regression repair, five integrated R817 Paper 19 corrections, and page dispositions for all 21 printed pages of Paper 43. These files are working/source-audit/provenance packages only: not promoted critical editions, not whole-corpus mathematical certification, not downstream multilingual synchronization proof, not final high-resolution certification, and not source-faithfulness certification. R818 Paper 20 and active v27 Paper 40 remain unintegrated continuation inputs. Retained English/multilingual readers predate some German repairs. Inherited `COMPLETE`, `closure`, and `closed` words mean only that a bounded local task completed.',
