...
RECORD_NOTES = {
    ...
    "interlanguage_reflections": [
        "Methodology, source-body, and provenance sidecar for interlanguage and constructed-language mathematical translation. Current public version 21421135 fronts the v0.6 controlled-normalization report, retains the earlier source-body/provenance payloads and file `12` research-department/automata audit, and adds file `13` with exact Noether Interslavic 002A/002B evidence. The current corpus has 221 Latin and 221 Cyrillic canonical units; 146 files changed under reviewed orthographic rules and 92 under exact lexical rules; both passes were idempotent and all changed units passed build/render QA. Actual translation bodies and readers are on Noether record 21421559. This is reproducible internal normalization and corpus infrastructure, not native-speaker approval, community acceptance, mathematical source-fidelity certification, or a critical edition.",
    ],
    "split_zero_research_sidecar": [
    ...
    "sga": [
        "Current public SGA surface is record 21421508. It fronts a 309-page source-checked English SGA5 working translation through the printed-page-484 index, retains the French SGA5 and French SGA6 idx662 workpasses plus the older unsynchronized English SGA6 reader, and adds a bounded four-page Spanish SGA6 Expose X working translation for idx532-537 / printed pp.519-524. The Spanish PDF is directly readable; its grouped package contains editable TeX, six direct source witnesses, source/terminology ledgers, build evidence, hashes, and render checks. It is not a complete expose or volume and has no native-language certification. The live full-range English SGA6 lane remains in review until its prefix repairs and release documents freeze at one endpoint. These are substantive machine-assisted source-aware working translations and repairs, not independently human-certified critical editions or whole-SGA completion.",
    ],
    "weber": [
