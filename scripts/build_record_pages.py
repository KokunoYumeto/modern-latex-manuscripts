...
RECORD_NOTES = {
    ...
    "bianchi": [
        "Dedicated Bianchi working-edition record. Volume I of `Lezioni di geometria differenziale` remains complete as a package-audited Italian/English working edition through source pdfpages 001-543. The A2 branch, `Lezioni sulla teoria dei gruppi continui finiti di trasformazioni`, has a broader high-quality Italian/English start through source p0001-p0066, about 9 percent of the 731-page source, and a newer preferred audit-continuation layer through p0001-p0057. Prefer `Bianchi_A2_auditcont_p0001_0057_IT_EN_20260611.zip` for overlapping p0001-p0057 pages; it supersedes the p0001-p0050 auditfix on the newest public surface. A2 is not complete; section 13 begins at the lower part of p0066 and continues on p0067. OCR/image-analysis material remains witness/locator evidence only.",
    ],
    "cayley": [
    ...
    "gordan_clebsch_gordan": [
        "Dedicated Gordan / Clebsch-Gordan working-edition split from the mixed additional-author shelf. The current Abelsche continuation now includes Abel11 through Abel15, with `Gordan_Abel15_p203_217_DE_EN_20260611.zip` extending `Theorie der Abelschen Functionen` through source PDF p217. Abel14 covers p194-p202, Abel15 covers p203-p217, and Abel13 remains the preceding p182-p193 promoted segment including the p190 continuation of equation (4). `Gordan_AllPrior_AuditFix01_20260610.zip` remains the consolidated checkpoint for De linea geodetica, theta, Formensystem, and Abelsche through p121; theta carries the FIX05 `c^8=1` display correction. OCR prose witnesses remain noncanonical gap detectors. These are package-audited, source-witnessed working drafts, not final critical editions.",
    ],
    "steinitz": [
    ...
    "weber": [
        "Current Weber public surface: Volume I is complete as a repaired/source-scan-audited working edition; Volume II has current German/English cumulative reader PDFs through section 176, with Batch104-Batch106 covering sections 169-176 and localized Batch107-Batch118 recursive repairs/ledgers added for sections including Vol. I §§124, 151, 183 and Vol. II §§20, 21, 52, 57, 58, 60, 61, 99, 118, 126. Batch117 scan-reviewed Volume I §124 as a false-positive/no-change row; Batch118 reports 15 closed priority repair rows and 97 still open. Volume III remains the current repaired cumulative from the earlier baseline. OCR and display ledgers are omission guards and locator layers, not independent authority; continuation ranges remain working drafts unless the package declares source-checked coverage.",
    ],
    "noether": [
