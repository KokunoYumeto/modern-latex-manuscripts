...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21420665 / DOI 10.5281/zenodo.21420665 under concept DOI 10.5281/zenodo.20412587. It retains the 466-page v26/R823 German source-control reader as the default preview and directly exposes a 473-page Spanish R823 working translation covering all 81 declared source units, Papers 1-43, all 31 lecture-book sections, and retained terminal material. File `10_Noether_Spanish_R823_WorkingTranslation_TeX_Evidence_20260718.zip` groups the Spanish TeX, exact German authority, source/target manifests, parity and terminology records, build evidence, hashes, and visual QA. File `09_Noether_R823_SourceSynchronized_Multilingual_Components_20260718.zip` expands the bounded English set to Papers 5, 7, 10, 18, 20, 25, 26, 27, 28, 29, 36, and 37 and retains CJK/Korean Papers 26 and 36 plus the Slavic lecture-book title/introduction. The Spanish branch passed its declared production gate and an independent 13-of-13 frozen-hash check. The other full language readers remain uneven or unsynchronized. These files are working translations, source-control, and audit evidence: not a critical edition, whole-corpus certification, complete multilingual synchronization, or final linguistic approval. Inherited `COMPLETE`, `closure`, and `closed` words mean only that a bounded local task completed.',
