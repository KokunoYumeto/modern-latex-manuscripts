...
RECORD_NOTES = {
    ...
    "sga": [
        "Current public SGA surface is record 21429328. It fronts the 309-page source-aware English SGA5 working translation, directly exposes the corrected 381-page SGA6 full-range layered English reader, retains the 374-page French SGA6 source-rescribe checkpoint at idx684, and retains the bounded Spanish SGA6 Expose X idx532-537 tranche. The Spanish SGA5 checkpoints in historical records 21428977 and 21429136 are withdrawn from the current file surface after a terminology-ledger cross-check found an English-shaped regression against the edition's canonical Spanish funtor/funtorial forms. No current Spanish SGA5 body is included pending a new canonical payload and hashes. The French SGA6 package retains its editable TeX, pagewise ledger, errata, source delta, witnesses, render checks, and explicit deferred repairs. The SGA6 English reader retains explicit non-uniform authority layers: inherited/partially synchronized source-PDF 001-525, French-synchronized idx532-662, then scan-checked draft material through the tail. These are substantive source-aware working translations and repairs, not independently human-certified critical editions, complete translations, uniform whole-volume source certification, or whole-SGA completion.",
    ],
    "deligne": [
