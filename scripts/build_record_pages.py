...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21300773 / DOI 10.5281/zenodo.21300773 under concept DOI 10.5281/zenodo.20412587. It fronts the 466-page R813/integrated-v12 German source-control reader, keeps the English cumulative reader and multilingual checkpoints available, preserves compact R787-R804 source-repair rollups, and groups the checked R805-R813 chain in `07_Noether_Current_SourceControl_Integrated_v12_R805_R813_20260710.zip`. The final semantic delta is confined to Paper 19. These files are working/source-audit/provenance packages only: not promoted critical editions, not whole-corpus mathematical certification, not downstream multilingual synchronization proof, not final high-resolution certification, and not source-faithfulness certification. Inherited `COMPLETE` filename words mean only that a local packet task completed.',
