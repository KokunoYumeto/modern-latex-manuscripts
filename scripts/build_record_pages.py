...
INDEX_DISPLAY_NAMES = {
    ...
    "ega": "EGA (source-first work underway; layered working reader)",
...
RECORD_NOTES = {
    ...
    "ega": [
        "Current EGA public surface is record 21652720 / DOI 10.5281/zenodo.21652720 under the established EGA concept DOI 10.5281/zenodo.20414353. It preserves the French originals and inherited OCR/support history and adds a compact source-first EGA 0 III successor: a direct 93-page layered working reader, direct editable TeX for sections 11.5.1-11.10.3, one 96-member source ZIP, and exact status/validation controls. The PDF container spans inherited working material through sections 1.0-14.3.6, but this checkpoint newly source-first verifies only sections 11.5.1-11.10.3; surrounding English is not certified by this release. The new reader is the default preview. All 21 outer files and all five ZIPs / 257 members passed anonymous exact readback, while all 16 predecessor files remained byte-identical. EGA remains separate from SGA because it has its own established concept and authority history. These are layered working translations and source controls, not a complete EGA translation, critical edition, rights clearance, peer review, or whole-reader source certification.",
    ],
    "deligne": [
