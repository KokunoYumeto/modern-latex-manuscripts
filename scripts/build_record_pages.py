...
RECORD_NOTES = {
    ...
    "sga": [
        "Current public SGA surface is record 21430393. It retains the SGA1, SGA5, and SGA6 working readers while withdrawing the SGA6 English support ZIP after a wrap-aware audit found reconstructable host-local paths in public text/control files. The corrected 381-page SGA6 reader PDF remains byte-identical and public; a privacy-clean support archive is pending. The record also retains the four-page source-audited English SGA1 Expose I opening/section I.1 checkpoint, the 309-page English SGA5 working translation as default preview, the 374-page French SGA6 idx684 checkpoint, and the bounded Spanish SGA6 Expose X idx532-537 tranche. SGA5 readiness remains under open audit and historical Spanish SGA5 checkpoints remain withdrawn. SGA6 authority remains explicitly layered. These are substantive working translations and repairs, not complete translations, independently human-certified critical editions, uniform whole-volume source certification, or whole-SGA completion.",
    ],
    "deligne": [
