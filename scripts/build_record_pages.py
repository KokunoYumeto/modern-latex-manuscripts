...
RECORD_NOTES = {
    ...
    "sga": [
        "Current caveat from the 2026-06-24 SGA audit-support updates: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not complete and should be assumed to contain many remaining errors unless a later, narrower source-audit packet promotes a specific locus. The public surface carries `SGA5_repair032_audit_support_20260624.zip` plus later local workpass evidence. The live SGA5 workpass reports 411 verified corrections, pdflatex exit 0, 0 errors, and a 307-page French workpass; the careful p375-p484 back-third pass is complete and the front-grind cursor is printed p113 after manual p75-p101 and workflow p102-p112. Open areas still include p1-p74, p113-p374, named heavy-QA pages in p75-p124 plus remaining front/middle heavy-QA pages, uncertain/type-B items, and English synchronization. This is preservation/support evidence for ongoing repair, not a certified edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.",
    ],
    "weber": [
