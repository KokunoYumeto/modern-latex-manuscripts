...
RECORD_NOTES = {
    ...
    "sga": [
        "Current public SGA surface is record 21424602. It fronts the 309-page source-aware English SGA5 working translation, directly exposes the corrected 381-page SGA6 full-range layered English reader, and updates the French SGA6 source-rescribe working reader to a 374-page idx684 checkpoint. The French linear pass has processed through source idx684 / volume p.671 / Expose XIV p.5, with idx685 next; later material remains inherited scaffold and the ledger records deferred repairs. The grouped French package contains editable release and upstream TeX, the pagewise ledger, errata, an idx663-684 source delta, boundary witnesses, render checks, build evidence, and hashes. The SGA6 English reader retains explicit non-uniform authority layers: inherited/partially synchronized source-PDF 001-525, French-synchronized idx532-662, then scan-checked draft material through the tail. The bounded Spanish Expose X idx532-537 tranche remains public. These are substantive source-aware working translations and repairs, not independently human-certified critical editions, uniform whole-volume source certification, or whole-SGA completion.",
    ],
    "deligne": [
