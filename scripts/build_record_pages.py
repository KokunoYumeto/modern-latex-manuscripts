...
RECORD_NOTES = {
    ...
    "noether": [
        "Current Noether public surface: the latest version remains a curated reader-facing cleanup rather than a raw workbench dump. It contains cumulative reader PDFs, 43 standalone English paper PDFs, compact language/source ZIPs, the RA23 display-layout correction package, and the RA25-RA31 Paper 02 source-critical symbol/body/table audit packages. RA28 validates the Greek nu rebase for Paper 02 and protects genuine Latin-v contexts. RA29 closes the Paper 02 body pp.23-90 at the current page-level standard; RA30 adds the Paper 02 final-summary/table-plate audit package, fixing the p.90 final summary display, formula (31) tag placement, A4 landscape table plates, and selected Table II transvectant parentheses. RA31 source-checks Tabelle I on printed/source p.91 and corrects six cell-level issues. Tabelle II on source p.92 and multilingual propagation remain open. This is not a certified critical edition; subtle formula, scan-reading, and cross-language synchronization errors may remain. Raw audit/witness bundles should be distilled into corrected TeX/PDF or concise public status notes before publication.",
    ],
    "albattani_opus_astronomicum": [
