...
RECORD_NOTES = {
    ...
    "frobenius": [
        "Dedicated Frobenius split from the mixed additional-author shelf. The initial public package is `Frobenius_all_GE_EN_cum_scans_QA03_20260611.zip`, a German/English selected group-character cumulative with package status reporting completed items 10/10, tracked source-intake pages 221/221, German all-author cumulative 182 generated pages, English all-author cumulative 176 generated pages, and 241 cumulative source-scan pages merged. This is a source-witnessed working-draft package, not a certified critical edition; OCR/text extraction is a locator and comparison aid only.",
    ],
    "poincare": [
