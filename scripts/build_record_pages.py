...
RECORD_NOTES = {
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21426158 / DOI 10.5281/zenodo.21426158 under concept DOI 10.5281/zenodo.20412587. It retains the German R823 source-control reader and directly exposes the 473-page Spanish, 494-page French, and 529-page Latin / 552-page Cyrillic Interslavic working readers plus bounded CJK/Korean, Slavic, Arabic/Persian, and Indonesian components. Its default preview is now a 466-page German cumulative reader containing a bounded direct-source audit of Paper 30 source pages 37-61. File `15_Noether_Paper30_HardMath_SourceControl_Supplement_20260718.zip` carries corrected TeX, exact R823 diff, direct source pages, enlarged symbol witnesses, build log, hashes, and audit status. One proposed web correction (`durch` to `dnrch`) was rejected after direct source inspection. Existing translations are not silently represented as synchronized to the new Paper 30 changes. File `14` remains the exact French TeX/evidence closure. These are working translations and source-control evidence: not a critical edition, complete Paper 30 or whole-corpus certification, universal mathematical source certification, complete multilingual synchronization, native review, peer review, proof checking, or final linguistic approval.',
