...
RECORD_NOTES = {
    ...
    "split_zero_research_sidecar": [
        "Separate exploratory mathematics record, not part of the manuscript-translation completion ranking. Version 21425117 fronts an 11-page Project Atlas and a 199-page bookmarked results compendium, with exact Lean/Python checks and ledgers, editable working texts, visualizations, scene data, and replay/QA material. It adds the Part 8-C2B residual-Niemeier audit as an atomic six-file proof/check bundle while preserving cited external-theorem and open-interface boundaries. The record is not peer review, not a proof of a famous open problem, and not certification of every broader claim.",
    ],
    "riemann": [
