...
RECORD_NOTES = {
    ...
    "sga": [
        "Current caveat from the 2026-06-24 SGA audit-support updates, reconciled with the 2026-06-26 live SGA5 audit ledger: the latest published record is DOI `10.5281/zenodo.20822648`. SGA5 is explicitly not complete and should be assumed to contain many remaining errors unless a later, narrower source-audit packet promotes a specific locus. The public surface carries `SGA5_repair032_audit_support_20260624.zip` plus later local workpass evidence. The controlling manual audit log treats agents/workflows as finders rather than certifiers and now records pp.1-190 as page-local ledger evidence in the curated French workpass: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked complete; Expose III B Part II §5 is locally closed through p182; and §6 has started with pp.183-190 checked locally, p191 next. The current ledger records 16 TeX fixes plus one cosmetic p172 cleanup, 32 source typos/source oddities, and D001-D103 in the running diagram ledger; D102 and D103 are perfect. The p171/p175/p187 corrections remain key workflow warnings: math-bearing TeX content errors and composite-operator/shriek garbles can compile cleanly and require source/type checking. This remains opening-range evidence for a curated 10-expose selection, not global SGA5 certification, not a certified edition, not English synchronization, and not closure of diagram/formula/notation/typography queues. Treat SGA6 and SGA7 as substantial working drafts with explicit compression caveats unless a specific packet declares source-checked coverage. Older filenames containing words such as `Complete`, `Source-Checked`, `Strict`, or `High-Fidelity` are legacy package names, not current global certification. Witness-aid ZIPs are source-witness/anchor aids, not authority by themselves.",
    ],
    "weber": [
    ...
    "noether": [
        'Current Noether public surface: latest published Zenodo version is record 21247333 / DOI 10.5281/zenodo.21247333 under concept DOI 10.5281/zenodo.20412587. It fronts the R805 German/source-control PDF, keeps the reader-first German/English cumulative readers available, preserves compact R787-R804 source-repair/audit rollups as 06a/06b/06c plus 06d OCR-locator support, retains the R804 integrated v11 source-control head as file `07_Noether_Current_SourceControl_Integrated_v11_R800_R804_20260707.zip`, and adds `08_Noether_SourceRepair_Audit_R805_P19p57_EFamilyCorrection_20260707.zip`. The July 7 rollups cover Paper 30, Paper 24, Paper 34, Paper 40, Paper 14, and Paper 19 support packets; R805 is a narrow Paper 19 printed p57 E-family source-control correction. These files are working/source-audit/provenance packages only: not promoted critical editions, not whole-corpus mathematical certification, not downstream multilingual synchronization proof, not final high-resolution certification, and not source-faithfulness certification. Inherited `COMPLETE` filename words mean only that a local packet task completed.',
