#!/usr/bin/env python3
"""Publish and read back SGA7 I English through complete Expose VI."""
...
import publish_sga7i_english_i_ii_vi_section4_complete_zenodo_20260731 as previous
...
PREDECESSOR_RECORD = 21_725_392
PREDECESSOR_DOI = "10.5281/zenodo.21725392"
PREDECESSOR_FILES = 83
PREDECESSOR_BYTES = 676_447_693
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English I-II and complete VI"

REPO_ROOT = Path(__file__).resolve().parents[1]
PACKAGE_REL = Path(
    "sources/sga/"
    "sga7i-english-source-first-working-i-ii-vi-complete-20260731"
)
PACKAGE_ROOT = REPO_ROOT / PACKAGE_REL
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-vi-complete-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_complete"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7i_english_i_ii_vi_section4_complete_"
    "record_21725392_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "39dc393635ea99637174b8cfc9253c0edc6a1ffb"

OLD_PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Section4_Complete_20260731.pdf"
OLD_TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Section4_Complete_20260731.tex"
OLD_SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_Section4_Complete_"
    "Reader_and_TeX_20260731.zip"
)
PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Complete_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Complete_20260731.tex"
SOURCE_ZIP_NAME = (
...
EXPECTED_PACKAGE_FILES = 71
EXPECTED_PACKAGE_BYTES = 2_026_214
EXPECTED_MANIFEST = (
    9_072,
    "B241F6A4566E9A661ABE70DA469BD7BC374EDA3BE1C8ADEC0CCE943EC666C889",
)
EXPECTED_VALIDATION = (
    2_930,
    "8115A31FCC174BB56F84BECDF6DFB78AB46F8EA26640CBC878B405ABC1EFCF78",
)
EXPECTED_PDF = (
    826_321,
    "53F2AA09B64A01ACAC6FF3541327A41EF6EE7BAAB63B3BA2EE677501A16EF128",
)
EXPECTED_TEX = (
    5_912,
    "281F33C9ADC455986AAAD72A7773812FEEA38DDCA99EBFDD98D8EFEF94A89D18",
)
EXPECTED_SOURCE_ZIP = (
    863_041,
    "44BD249A29750EF93D8EDB260C07E9A969E038C28F056D486FE2728F5E3B4496",
)

DESCRIPTION_ADDITION = (
    "<p><strong>SGA7 I bounded English checkpoint:</strong> this successor "
    "replaces the Section-4 tranche with one 96-page A4 working reader "
    "containing complete English Exposes I and II and complete Expose VI "
    "through Corollary 6.8. The exact continuation is the opening of Expose VII, "
    "scan index 144, source folio 133. "
    "Exposes VII-IX are excluded. The direct "
    "master and compact 68-member archive provide the exact 62 editable "
...
NOTES_ADDITION = (
    ...
    "isolated three-pass rebuild has zero diagnostics. Apart from the sole source "
    "correction, all 96 pages preserve the frozen producer text and geometry, "
    ...
    "archive. Pages 80-96, including the new Section-5 and Section-6 diagrams, "
    "were directly rendered and inspected. "
...
def verify_package() -> dict[str, object]:
    ...
    if len(rows) != 70 or {row["path"] for row in rows} != set(represented):
    ...
    if not source_zip.is_file():
        source_zip = PACKAGE_ROOT / (
            "SGA7I_English_SourceFirst_Working_I_II_VI_Complete_"
            "Reader_and_TeX_20260731.zip"
        )
...
complete Exposes I-II and complete Expose VI through Corollary 6.8.

The exact continuation is the opening of Expose VII at scan index 144, source
folio 133. Exposes VII-IX are absent.
...
""",
    ...
    base.save_json(
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        {
            ...
            "reader_pages": 96,
            "editable_tex_files": 63,
            "continuation": {
                "unit": "Expose VII opening",
                "scan_index_zero_based": 144,
                "source_folio": 133,
            },
            "source_zip_members": 68,
...
def public_readback(
    ...
    if (
        ...
        or retained_errors
        or int(archives[SOURCE_ZIP_NAME]["members"]) != 68
    ):
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through complete Expose VI publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 68 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I-II and VI complete through Corollary 6.8",
                "- Continuation: Expose VII opening / scan index 144 / source folio 133",
