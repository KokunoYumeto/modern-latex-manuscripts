...
# Point this at an isolated OCR-toolkit environment. Keeping OCR/ML stacks out of
# the main project environment prevents torch/CUDA dependency churn.
OCR_PY = os.environ.get("MLM_OCR_PYTHON", sys.executable)
