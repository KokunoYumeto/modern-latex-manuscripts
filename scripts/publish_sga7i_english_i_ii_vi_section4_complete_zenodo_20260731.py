#!/usr/bin/env python3
"""Publish and read back SGA7 I English through Expose VI, Section 4."""
...
import publish_sga7i_english_i_ii_vi_through_2_9_zenodo_20260731 as previous
...
PREDECESSOR_RECORD = 21_724_413
PREDECESSOR_DOI = "10.5281/zenodo.21724413"
PREDECESSOR_FILES = 83
PREDECESSOR_BYTES = 676_262_671
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English I-II and VI through Section 4"

REPO_ROOT = Path(__file__).resolve().parents[1]
PACKAGE_REL = Path(
    "sources/sga/"
    "sga7i-english-source-first-working-i-ii-vi-section-4-complete-20260731"
)
PACKAGE_ROOT = REPO_ROOT / PACKAGE_REL
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-section4-complete-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_section4_complete"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7i_english_i_ii_vi_section3_complete_"
    "record_21724413_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "10a4aab394914f59b3586354e31378df52e78286"

OLD_PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Section3_Complete_20260731.pdf"
OLD_TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Section3_Complete_20260731.tex"
OLD_SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_Section3_Complete_"
    "Reader_and_TeX_20260731.zip"
)
PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Section4_Complete_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Section4_Complete_20260731.tex"
SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_Section4_Complete_"
    "Reader_and_TeX_20260731.zip"
)
REPLACED_NAMES = {
    OLD_PDF_NAME,
...
EXPECTED_PACKAGE_FILES = 58
EXPECTED_PACKAGE_BYTES = 1_804_514
EXPECTED_MANIFEST = (
    7_397,
    "3664CCD2971DB350AC5DBC1CB7B9C757C60F121294B95DF294D643D130B836B7",
)
EXPECTED_VALIDATION = (
    2_307,
    "C32C0B54F794709DC9D1AC6A3D1F5E7A72C0F8AB85B5791FBB58ACD6200F5BA7",
)
EXPECTED_PDF = (
    743_605,
    "05507457C231C2E5C3B44C57D01B8E5A3DA5107784DFACC4CBEEE3EDA0F88126",
)
EXPECTED_TEX = (
    5_252,
    "E368C6917A5B366CD629A4564A2D2B385393267648727535AFC34BC0583E34C0",
)
EXPECTED_SOURCE_ZIP = (
    772_213,
    "031610DC2C2CE2E9B96153A4A3A21F5A8B2E81DDF4699C526665935FC8FC2083",
)

DESCRIPTION_ADDITION = (
    "<p><strong>SGA7 I bounded English checkpoint:</strong> this successor "
    "replaces the Section-3 tranche with one 80-page A4 working reader "
    "containing complete English Exposes I and II and Expose VI from its "
    "opening through Remark 4.16, completing Section 4. The exact continuation "
    "is Section 5, French working-source line 3085, scan index 125, source "
    "folio 114. "
    "Exposes VII-IX and the remainder of Expose VI are excluded. The direct "
    "master and compact 55-member archive provide the exact 49 editable "
    "components. This is current-progress "
    "source-aligned English, not a complete SGA7 I volume, critical edition, "
    "peer review, accessibility certification, or rights-clearance claim.</p>"
)
NOTES_ADDITION = (
    "<p>The SGA7 I English PDF begins directly with mathematical text. Its "
    "isolated two-pass rebuild has zero diagnostics. Before the sole source "
    "correction, all 80 pages preserved the frozen producer text, decoded content, "
    "and geometry. Direct 600-dpi authority inspection corrected the citation in "
    "Remark 4.16 from 4.13(b) to 4.12(b); the correction is documented in the "
    "archive. The Section-4 opening and ending were directly rendered and inspected. "
    "The controlling scan is "
    "identified but not redistributed. SGA1 remains the default browser preview.</p>"
)
...
def verify_package() -> dict[str, object]:
    ...
    if len(rows) != 57 or {row["path"] for row in rows} != set(represented):
    ...
    if not source_zip.is_file():
        source_zip = PACKAGE_ROOT / (
            "SGA7I_English_SourceFirst_Working_I_II_VI_Section4_Complete_"
            "Reader_and_TeX_20260731.zip"
        )
...
def local_uploads() -> dict[str, dict[str, object]]:
    ...
    paths = {
        ...
        / "reader/SGA7I_English_SourceFirst_Working_I_II_VI_Section4_Complete_20260731.pdf",
        TEX_NAME: PACKAGE_ROOT
        / "source/SGA7I_English_SourceFirst_Working_I_II_VI_Section4_Complete_20260731.tex",
        SOURCE_ZIP_NAME: PACKAGE_ROOT
        / "SGA7I_English_SourceFirst_Working_I_II_VI_Section4_Complete_Reader_and_TeX_20260731.zip",
    }
    expected = {
...
def verify_github() -> dict[str, object]:
    ...
    if remote != GITHUB_PACKAGE_COMMIT:
        raise RuntimeError("SGA7 I English GitHub commit is not public main")
...
complete Exposes I-II and Expose VI through Remark 4.16, completing Section 4.

The exact continuation is Section 5, French working-source line 3085, scan
index 125, source folio 114. The remainder of VI and Exposes VII-IX are absent.
...
""",
    ...
    base.save_json(
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        {
            ...
            "reader_pages": 80,
            "editable_tex_files": 50,
            "continuation": {
                "unit": "Section 5, Formal Jacobian subschemes",
                "french_working_source_line": 3085,
                "scan_index_zero_based": 125,
                "source_folio": 114,
            },
            "source_zip_members": 55,
...
def configure_prior() -> None:
    ...
    prior.OLD_DESCRIPTION_ADDITION = previous.DESCRIPTION_ADDITION
    prior.OLD_NOTES_ADDITION = previous.NOTES_ADDITION
...
def public_readback(
    ...
    if (
        ...
        or retained_errors
        or int(archives[SOURCE_ZIP_NAME]["members"]) != 55
    ):
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through Expose VI Section 4 publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 55 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I-II complete; VI through Remark 4.16 / Section 4 complete",
                "- Continuation: Section 5 / source line 3085 / scan index 125",
