#!/usr/bin/env python3
"""Publish and read back the bounded SGA7 I English checkpoint."""
...
import publish_sga7ii_x_xxi_partial_zenodo_20260731 as previous
...
PREDECESSOR_RECORD = 21_722_687
PREDECESSOR_DOI = "10.5281/zenodo.21722687"
PREDECESSOR_FILES = 80
PREDECESSOR_BYTES = 674_923_053
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English I-II and VI through Proposition 2.9"

REPO_ROOT = Path(__file__).resolve().parents[1]
PACKAGE_REL = Path(
    "sources/sga/"
    "sga7i-english-source-first-working-i-ii-vi-through-2-9-20260731"
)
PACKAGE_ROOT = REPO_ROOT / PACKAGE_REL
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-through-2-9-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_through_2_9"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7ii_x_xxi_partial_record_21722687_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "e409a9786e31369edf0ad22a8ad681409063ada2"

PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Through_2_9_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Through_2_9_20260731.tex"
SOURCE_ZIP_NAME = (
...
EXPECTED_PACKAGE_FILES = 28
EXPECTED_PACKAGE_BYTES = 1_090_122
EXPECTED_MANIFEST = (
    4_038,
    "69F2BB91EA0254A3A7C653C17A415A097893D341CBA23B9D4EB9FCE1CE96F851",
)
EXPECTED_VALIDATION = (
    3_342,
    "2E6D8E6648D1C4575F3A717F1E1D34AE301AB80B8F52197EECCDA4ED3B3F275E",
)
EXPECTED_PDF = (
    467_829,
    "D07748D4073F76355DD01243937CA9E4F512879E002A54D00924E9FA312DBBFF",
)
EXPECTED_TEX = (
    3_702,
    "684620A844505692B7C83394D5548503A4F87F28FD7B65241BBD3877BB00F34B",
)
EXPECTED_SOURCE_ZIP = (
    474_955,
    "8B6365FA73952FDA73713346A8DF8868B10C2E6ABF3621A23DE2195176E3B23D",
)

DESCRIPTION_ADDITION = (
    "<p><strong>SGA7 I bounded English checkpoint:</strong> this successor "
    "adds one 39-page A4 working reader containing complete English Exposes "
    "I and II and Expose VI from its opening through Proposition 2.9. The "
    "exact continuation is Corollary 2.10, French working-source line 1153, "
    "scan index 70, source folio 59. Exposes VII-IX and the remainder of "
    "Expose VI are excluded. The direct master and compact 25-member archive "
    "provide the exact 20 editable components. This is current-progress "
...
NOTES_ADDITION = (
    ...
    "isolated two-pass rebuild has exact text, decoded page streams, geometry, "
    "fonts, annotations, and 39/39 rendered pages; only timestamp metadata "
    "changes the rebuilt container bytes. The controlling scan is identified "
    "but not redistributed. SGA1 remains the default browser preview.</p>"
)
...
def verify_package() -> dict[str, object]:
    ...
    if len(rows) != 26 or {row["path"] for row in rows} != set(represented):
    ...
    if not source_zip.is_file():
        source_zip = PACKAGE_ROOT / (
            "SGA7I_English_SourceFirst_Working_I_II_VI_Through_2_9_"
            "Reader_and_TeX_20260731.zip"
        )
...
def local_uploads() -> dict[str, dict[str, object]]:
    ...
    paths = {
        ...
        / "reader/SGA7I_English_SourceFirst_Working_I_II_VI_Through_2_9_20260731.pdf",
        TEX_NAME: PACKAGE_ROOT
        / "source/SGA7I_English_SourceFirst_Working_I_II_VI_Through_2_9_20260731.tex",
        SOURCE_ZIP_NAME: PACKAGE_ROOT
        / "SGA7I_English_SourceFirst_Working_I_II_VI_Through_2_9_Reader_and_TeX_20260731.zip",
    }
    expected = {
...
complete Exposes I-II and Expose VI through Proposition 2.9.

The exact continuation is Corollary 2.10, French working-source line 1153,
scan index 70, source folio 59. The remainder of VI and Exposes VII-IX are
...
""",
    ...
    base.save_json(
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        {
            ...
            "reader_pages": 39,
            "editable_tex_files": 21,
            "continuation": {
                "unit": "Corollary 2.10",
                "french_working_source_line": 1153,
                "scan_index_zero_based": 70,
                "source_folio": 59,
            },
...
def configure_prior() -> None:
    ...
    prior.OLD_DESCRIPTION_ADDITION = "<!-- additive SGA7 I English checkpoint -->"
    prior.OLD_NOTES_ADDITION = "<!-- additive SGA7 I English checkpoint -->"
...
def public_readback(
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through Proposition 2.9 publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 25 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I-II complete; VI through Proposition 2.9",
                "- Continuation: Corollary 2.10 / source line 1153 / scan index 70",
