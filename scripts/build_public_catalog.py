...
RECORD_NOTES = {
    ...
    "sga": [
        "Current SGA update 2026-06-24: the latest public surface is record 20822648. It carries SGA5 repair/audit support, including repair032 and later live-workpass evidence, but SGA5 is explicitly not complete and remains errorful. The controlling manual audit log treats agents/workflows as finders, not certifiers, and now records pp.1-190 as page-local ledger evidence: pp.1-72 close Expose I; pp.73-137 close Expose III; Expose III B Part I (§1-§4, pp.140-161) is marked complete; Expose III B Part II §5 is locally closed through p182; §6 has started with pp.183-190 checked locally; D001-D103 are covered. The p190 ledger reports 16 TeX fixes plus one cosmetic p172 cleanup, 32 source typos/source oddities, and a 307-page / zero-fatal-error compile. p187 fixes an operator/shriek garble, p188 checks bridge identity `(6.6.4)`, p189 checks scalar functoriality and D102, and p190 checks trace transitivity/external multiplicativity, the G-equivariant opening, and D103. These bundles are preservation/support evidence for ongoing repair, not certified editions, not English synchronization, and not closure of diagram/formula/notation queues. Legacy filenames containing `Complete`, `Strict`, `Source-Checked`, or `High-Fidelity` are not current global certification claims.",
    ],
    "noether": [
