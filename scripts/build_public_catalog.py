...
RECORDS: list[tuple[str, str]] = [
    ...
    ("interlanguage_reflections", "21788322"),
    ("fac_quality_assessment", "21783868"),
    ("gaga", "21781323"),
...
EXPECTED_SELECTED_PREVIEWS = {
    ...
    "fac_quality_assessment": "00_FAC_Blind_Comparison_Readable_Report.pdf",
