#!/usr/bin/env python3
"""Publish and read back the SGA6 idx585-596 source-audit crop successor."""
...
PREDECESSOR_RECORD = 21627252
PREDECESSOR_DOI = "10.5281/zenodo.21627252"
SUCCESSOR_RECORD = 21628220
SUCCESSOR_DOI = "10.5281/zenodo.21628220"
VERSION = "2026-07-27 SGA6 ultra-detail source-audit crops idx585-596"
DEFAULT_PREVIEW = (
...
TEMP_ROOT = Path(
    os.environ.get(
        ...
        / "Temp"
        / "sga6_idx585_596_release_zips_20260727",
    )
)
...
READBACK_ROOT = Path(
    os.environ.get(
        ...
        Path(os.environ["LOCALAPPDATA"])
        / "Temp"
        / "sga6_idx585_596_zenodo_21628220_public_readback",
    )
)
...
LOCAL_FILES = {
    "09_README_CURRENT_RELEASE.md": (
        ...
        3_882,
        "FFB95FC60BE25877005815B1F99B15F34324A1B9E89FAC4C8D6CE4EBBD023A79",
    ),
    "09a_RELEASE_FILE_MANIFEST.csv": (
        CONTROLS_ROOT / "09a_RELEASE_FILE_MANIFEST.csv",
        21_950,
        "33CBC4EEC6F20EEBBFA0DACE574B28FA61D155C17C05A4A2553D6CABDB0B0F68",
    ),
    "09b_RELEASE_VALIDATION.json": (
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        3_829,
        "3C6A60CA9EF63E0BADAF2D4948EEE763D77928D8FD9CE9D6C4B08935A3A5E342",
    ),
    "10x_SGA6_SourceAudit_Targeted_UltraDetail_Crops_idx585_596_20260727.zip": (
        TEMP_ROOT
        / "10x_SGA6_SourceAudit_Targeted_UltraDetail_Crops_"
        "idx585_596_20260727.zip",
        869_547,
    ...
    "10y_SGA6_SourceAudit_Crop_Provenance_RightsBlocked_Metadata_idx585_596_20260727.zip": (
        ...
        "Metadata_idx585_596_20260727.zip",
        95_201,
        "D5320BF393E778C71EEA4C3C4266D2B69208CC8A38E5F210E6BBAE857C1550A9",
    ),
}

EXPECTED_OUTER_FILES = 62
EXPECTED_OUTER_BYTES = 325_221_792
EXPECTED_RETAINED_FILES = 57
EXPECTED_ZIP_ARCHIVES = 36
EXPECTED_ZIP_FILE_MEMBERS = 3_580
EXPECTED_ZIP_DIRECTORY_ENTRIES = 7
EXPECTED_ZIP_ALL_ENTRIES = 3_587
EXPECTED_ZIP_UNCOMPRESSED_BYTES = 372_126_140
RELEASE_CONTROL_COMPATIBILITY_COUNTER = 3_586
GITHUB_COMMIT = "0d251645db59dd508e4cb64b1eea30e80b13d82e"
GITHUB_PACKAGE = (
    "sources/sga/"
    "sga6-ultradetail-source-audit-crops-coldreverify-idx585-596-20260727"
)

DESCRIPTION_PARAGRAPHS = [
    (
        "This same-concept compact successor preserves the reader-first SGA "
        "surface from version 10.5281/zenodo.21627252. Fifty-seven predecessor "
    ...
    (
        ...
        "source re-verification. They map parent indices 585-596 to the stable "
        "12-entry audit boundary #1337-#1348 and span the Expose X appendix from "
        "the end of section 7.11 through section 7.14. Every crop records parent "
        "identity, source page, pixel bounding box, dimensions, scaling, "
        "generator identity, linked audit entry, target context, and QA "
        "disposition."
    ),
    (
        "The paired provenance archive records 60 routine full-width page "
        ...
        "while their pixels are withheld. It also records one tight alternative "
        "that was generated but never opened; that crop's pixels are "
    ...
    (
        ...
        "series, 2,153 selected images are public and 3,148 routine page "
...
NOTES_TEXT = (
    ...
    "This version has 62 files and 36 ZIP archives. Literal archive replay "
    "contains 3,580 non-directory file members plus seven directory records "
    "(3,587 ZIP records total), totaling 372,126,140 uncompressed bytes. The "
    "release-control lineage compatibility counter is 3,586: the predecessor's "
    "legacy 3,559 counter plus 27 new non-directory members. SGA1 remains the "
...
def predecessor_identities() -> dict[str, dict]:
    ...
    if len(rows) != 60:
        raise RuntimeError("Predecessor receipt does not contain 60 files")
    result = {
        row["filename"]: {
            "bytes": int(row["bytes"]),
...
def anonymous_readback(
    ...
    zip_receipt = {
        ...
        "compatibility_counter_note": (
            ...
            "legacy 3,559 counter and adds 27 new non-directory members. "
            "Literal replay has 3,580 non-directory files plus seven directory "
            "records, or 3,587 total ZIP records."
        ),
    ...
    receipt = {
        ...
        "metadata": {
            ...
            "description_exact": True,
            "notes_exact": True,
            "scope": "SGA6 source-audit crops idx585-596",
            "selected_opened_crops": 16,
            "routine_page_bands_metadata_only": 60,
            "generated_unread_tight_crops_metadata_only": 1,
            "stable_audit_entries": "1337-1348",
        },
        "zip_archive_count": len(zip_summaries),
        "zip_file_member_count": len(zip_members),
        "zip_directory_entry_count": directory_entries,
