#!/usr/bin/env python3
"""Publish and read back SGA7 I English through Corollary 3.6."""
...
PREDECESSOR_RECORD = 21_723_464
PREDECESSOR_DOI = "10.5281/zenodo.21723464"
PREDECESSOR_FILES = 83
PREDECESSOR_BYTES = 675_869_840
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English I-II and VI through Corollary 3.6"

REPO_ROOT = Path(__file__).resolve().parents[1]
PACKAGE_REL = Path(
    "sources/sga/"
    "sga7i-english-source-first-working-i-ii-vi-through-3-6-20260731"
)
PACKAGE_ROOT = REPO_ROOT / PACKAGE_REL
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-through-3-6-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_through_3_6"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7i_english_i_ii_vi_through_2_9_"
    "record_21723464_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "f1f530e1d7f0bf0b41272a222e7eb80c0a326ded"

OLD_PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Through_2_9_20260731.pdf"
OLD_TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Through_2_9_20260731.tex"
OLD_SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_Through_2_9_"
    "Reader_and_TeX_20260731.zip"
)
PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Through_3_6_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Through_3_6_20260731.tex"
SOURCE_ZIP_NAME = (
...
EXPECTED_PACKAGE_FILES = 37
EXPECTED_PACKAGE_BYTES = 1_334_079
EXPECTED_MANIFEST = (
    5_475,
    "1324BA137807E8E7BC04106379569823EF6DC38A98359065E8E3E2EAC4A9CBE1",
)
EXPECTED_VALIDATION = (
    4_158,
    "B1A8463523BFC5BA23A25ACDADC30F7E29B03F09609857F644444A1FFA0D49CF",
)
EXPECTED_PDF = (
    560_906,
    "136926C53FE913CEBE052687E0FDD64267E4187286F1F5E3D9C24F18714FC135",
)
EXPECTED_TEX = (
    4_176,
    "16998F631179FA0100704AF63565178467B670ACDBF9CCC2A0166F0B47CCA68B",
)
EXPECTED_SOURCE_ZIP = (
    575_103,
    "2D7E50685DA62EBFE203D7128F23571CE936A5C1ACA60390EC4E53134702E1B9",
)

DESCRIPTION_ADDITION = (
    "<p><strong>SGA7 I bounded English checkpoint:</strong> this successor "
    "replaces the earlier 2.9 tranche with one 53-page A4 working reader "
    "containing complete English Exposes I and II and Expose VI from its "
    "opening through Corollary 3.6. The exact continuation is Proposition "
    "3.7, French working-source line 1787, scan index 89, source folio 78. "
    "Exposes VII-IX and the remainder of Expose VI are excluded. The direct "
    "master and compact 34-member archive provide the exact 29 editable "
...
NOTES_ADDITION = (
    ...
    "isolated two-pass rebuild has zero diagnostics. All 53 pages preserve "
    "the producer text and geometry; 52 are pixel-identical, while page 52 "
    "sets one native diagram at normal math size to remove an invalid font-size "
    "warning and was directly reviewed clean. The controlling scan is "
...
def verify_package() -> dict[str, object]:
    ...
    if len(rows) != 35 or {row["path"] for row in rows} != set(represented):
    ...
    if not source_zip.is_file():
        source_zip = PACKAGE_ROOT / (
            "SGA7I_English_SourceFirst_Working_I_II_VI_Through_3_6_"
            "Reader_and_TeX_20260731.zip"
        )
...
def local_uploads() -> dict[str, dict[str, object]]:
    ...
    paths = {
        ...
        / "reader/SGA7I_English_SourceFirst_Working_I_II_VI_Through_3_6_20260731.pdf",
        TEX_NAME: PACKAGE_ROOT
        / "source/SGA7I_English_SourceFirst_Working_I_II_VI_Through_3_6_20260731.tex",
        SOURCE_ZIP_NAME: PACKAGE_ROOT
        / "SGA7I_English_SourceFirst_Working_I_II_VI_Through_3_6_Reader_and_TeX_20260731.zip",
    }
    expected = {
...
complete Exposes I-II and Expose VI through Corollary 3.6.

The exact continuation is Proposition 3.7, French working-source line 1787,
scan index 89, source folio 78. The remainder of VI and Exposes VII-IX are
...
""",
    ...
    base.save_json(
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        {
            ...
            "reader_pages": 53,
            "editable_tex_files": 30,
            "continuation": {
                "unit": "Proposition 3.7",
                "french_working_source_line": 1787,
                "scan_index_zero_based": 89,
                "source_folio": 78,
            },
            "source_zip_members": 34,
...
def public_readback(
    ...
    if (
        ...
        or retained_errors
        or int(archives[SOURCE_ZIP_NAME]["members"]) != 34
    ):
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through Corollary 3.6 publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 34 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I-II complete; VI through Corollary 3.6",
                "- Continuation: Proposition 3.7 / source line 1787 / scan index 89",
