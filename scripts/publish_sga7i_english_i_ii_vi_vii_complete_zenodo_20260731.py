#!/usr/bin/env python3
"""Publish and read back SGA7 I English through complete Expose VII."""
...
import publish_sga7i_english_i_ii_vi_vii_3_2_5_zenodo_20260731 as previous
...
PREDECESSOR_RECORD = 21_726_988
PREDECESSOR_DOI = "10.5281/zenodo.21726988"
PREDECESSOR_FILES = 83
PREDECESSOR_BYTES = 677_006_626
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English through complete Expose VII"
...
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-vii-complete-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_vii_complete"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7i_english_i_ii_vi_vii_3_2_5_"
    "record_21726988_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "7e225460b48b0099794a25e68e189164050f118d"
...
PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_VII_Complete_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_VII_Complete_20260731.tex"
SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_VII_Complete_"
    "Reader_and_TeX_20260731.zip"
)
REPLACED_NAMES = {
    OLD_PDF_NAME,
...
EXPECTED_PACKAGE_FILES = 101
EXPECTED_PACKAGE_BYTES = 2_768_981
EXPECTED_MANIFEST = (
    12_904,
    "153C0B701C02E2D16F4798962174F6F280F4B1150F93CD43B7FC173DCC042BA0",
)
EXPECTED_VALIDATION = (
    4_436,
    "32D3261481E5CD02ECF749414FD45615468B8B6D1E57C60A3D8F76CF30D143DC",
)
EXPECTED_PDF = (
    1_095_582,
...
DESCRIPTION_ADDITION = (
    ...
    "and a 134-page SGA7 I English working reader containing complete Exposes "
    "I, II, VI, and VII. The next English cursor is the Expose VIII opening, "
    "authority line 5, scan index 229, source folio 218. The direct master and "
    "98-member ZIP contain its exact 92 components.</p>"
...
def local_uploads() -> dict[str, dict[str, object]]:
    ...
    paths = {
        ...
        / (
            "reader/SGA7I_English_SourceFirst_Working_I_II_VI_VII_Complete_"
            "20260731.pdf"
        ),
        TEX_NAME: PACKAGE_ROOT
        / (
            "source/SGA7I_English_SourceFirst_Working_I_II_VI_VII_Complete_"
            "20260731.tex"
        ),
...
complete Exposes I, II, VI, and VII.

The exact continuation is the Expose VIII opening at authority line 5,
zero-based scan index 229, source folio 218. Exposes VIII-IX are absent.
...
def public_readback(
    ...
    if (
        ...
        or retained_errors
        or int(archives[SOURCE_ZIP_NAME]["members"]) != 98
    ):
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through complete Expose VII publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 98 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I, II, VI, and VII complete",
                "- Continuation: Expose VIII opening / authority line 5 / scan index 229 / source folio 218",
