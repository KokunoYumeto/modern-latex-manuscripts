#!/usr/bin/env python3
"""Publish the expanded SGA3 current-progress reader on the existing concept."""
...
PREDECESSOR_RECORD = 21636270
PREDECESSOR_DOI = "10.5281/zenodo.21636270"
CONCEPT_DOI = "10.5281/zenodo.20410947"
PUBLICATION_DATE = "2026-07-28"
VERSION = (
    "2026-07-28 SGA3 current-progress cumulative latest: "
    "I-XVI, XVIII, XX; partial XVII, XXI, XXII"
)
GITHUB_COMMIT = "5b20b60912594003716be77974157f9ce1f9336e"
GITHUB_PACKAGE = (
...
EXPECTED_ZIP_FILE_MEMBERS = 4_378
EXPECTED_ZIP_DIRECTORY_ENTRIES = 6
EXPECTED_ZIP_ALL_ENTRIES = 4_384
EXPECTED_ZIP_UNCOMPRESSED_BYTES = 409_414_408
...
CONTROLS_ROOT = (
    ...
    / "Temp"
    / "sga3_cumulative_latest_zenodo_controls"
)
READBACK_ROOT = (
    Path(os.environ["LOCALAPPDATA"])
    / "Temp"
    / "sga3_cumulative_latest_zenodo_public_readback"
)
DRAFT_STATE = (
    RECEIPT_ROOT / "20260728_sga3_cumulative_latest_zenodo_draft_state.json"
)
...
NEW_MANIFEST_ROWS = {
    ...
    NEW_SOURCE_ZIP: {
        ...
        "provenance": (
            "1059-member privacy-clean source/history closure with exact "
...
DESCRIPTION_PARAGRAPHS = [
    (
        ...
        "from version 10.5281/zenodo.21636270 are retained byte-identically. "
        "SGA1 remains the default preview."
    ),
    (
        "The preferred SGA3 working reader has 1,166 A4 pages. It contains "
        "complete current working bodies for the Editorial Notice, "
        "Introduction, Exposes I-XVI, XVIII, and XX; Expose XVII through "
        "authority local page 34 / Section 5.9; Expose XXI through local page "
    ...
    (
        "The reader has 7,340 named destinations, 4,004 valid internal link "
        ...
        "An isolated source-archive rebuild matched all 1,166 decoded page "
        "streams, extracted text, geometry, destinations, links, and "
        "normalized font resources; 19 sampled 200-dpi renders were pixel-exact."
    ),
    (
        "The grouped source/history ZIP has 1,059 exact safe members and "
...
def verify_zip(path: Path) -> None:
    ...
    if (files, directories, uncompressed) != (1_059, 0, 20_232_583):
        raise RuntimeError(
...
- 4,004 valid internal link annotations/actions;
...
- 1,166/1,166 decoded content, text, geometry, destination, link, and
  normalized-font comparisons exact against a fresh extracted-source rebuild;
- 19 sampled 200-dpi page renders pixel-exact; and
- 1,059/1,059 source/history ZIP members exact with privacy hits 0.
...
def generate_controls(
    ...
    validation = {
        ...
        "github": {
            ...
            "source_zip_members_read_back": 1_059,
            "status": "PASS",
        },
        "sga3_reader": {
            "complete": (
                "Editorial Notice, Introduction, Exposes I-XVI, XVIII, XX"
            ),
            "partial": "Exposes XVII, XXI, XXII",
            "gaps": "Expose XIX and Exposes XXIII-XXVI",
            "pages": 1_166,
            "bytes": primary_local[NEW_PDF]["bytes"],
            "sha256": primary_local[NEW_PDF]["sha256"],
            "named_destinations": 7_340,
            "valid_internal_goto": 4_004,
            "broken_or_external_actions": 0,
            "font_resources": 63,
            "type3_fonts": 0,
            "independent_rebuild_all_pages_structurally_exact": True,
            "sampled_200dpi_renders_pixel_exact": 19,
        },
