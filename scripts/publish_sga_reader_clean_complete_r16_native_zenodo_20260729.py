#!/usr/bin/env python3
"""Publish one reader-clean SGA1-6 successor, including SGA3 R16."""
...
VERSION = "2026-07-29 reader-clean SGA1-6 with SGA3 R16 native update"
GITHUB_COMMIT = "06251d9422a6a123839ab5fb9b0e0a0b1f46d256"
GITHUB_PACKAGE = (
    "sources/sga/"
    "sga3-english-complete-working-reader-clean-r16-native-x-xvi-xviii-"
    "20260729"
)
...
SGA3_PDF = (
    ...
    "Native_Update_R16_20260729.pdf"
)
SGA3_TEX = (
    "02c00_SGA3_English_Complete_Reader_"
    "Native_Update_R16_20260729.tex"
)
SGA3_ZIP = (
    "10c9_SGA3_English_Complete_Reader_"
    "Source_and_History_R16_20260729.zip"
)
...
EXPECTED_ZIP_FILE_MEMBERS = 5_599
EXPECTED_ZIP_DIRECTORY_ENTRIES = 6
EXPECTED_ZIP_ALL_ENTRIES = 5_605
EXPECTED_ZIP_UNCOMPRESSED_BYTES = 457_191_870
...
CONTROLS_ROOT = (
    ...
    / "Temp"
    / "sga_reader_clean_complete_r16_native_zenodo_controls"
)
READBACK_ROOT = (
    Path(os.environ["LOCALAPPDATA"])
    / "Temp"
    / "sga_reader_clean_complete_r16_native_zenodo_public_readback"
)
DRAFT_STATE = (
    RECEIPT_ROOT
...
PRIMARY_EXPECTED = {
    **previous.PRIMARY_EXPECTED,
    SGA3_PDF: (
        11_857_918,
        "09B5C96E44BF290626361285BD3366E8965F73F9AAD2E8EB9BD56D98D3B3851C",
    ),
    SGA3_TEX: (
        21_853,
    ...
    SGA3_ZIP: (
        13_374_619,
        "63455839BB35ADF3F5FD73673846E1613CB5E6CE74BA91BC07D58D7CF8204D90",
    ),
}
...
NEW_MANIFEST_ROWS = {
    **previous.NEW_MANIFEST_ROWS,
    SGA3_PDF: {
        "role": "english_reader",
        "provenance": (
            "preferred reader-clean 1473-page SGA3 R16 native cumulative; "
            "GitHub "
    ...
    SGA3_TEX: {
        ...
        "provenance": (
            "direct editable master for the reader-clean SGA3 R16 reader"
        ),
...
DESCRIPTION_PARAGRAPHS = [
    ...
    (
        ...
        "source-status, and workflow commentary. The mathematics, diagrams, "
        "labels, and internal links remain on the reading surface; provenance "
        "and technical history remain in grouped archives and release metadata."
    ),
    (
        "The preferred SGA3 object is a 1,473-page English cumulative covering "
        "the Editorial Notice, Introduction, Exposes I-XXVI, the Tome-I index, "
        "the Tome-III mathematical guide, and the terminal index. R16 "
        "integrates native successors for Exposes X, XVI, and XVIII while "
        "preserving its page count and reference graph. Its source closure "
        "and the superseded R15 reader are grouped in one ZIP."
    ),
    (
...
def verify_primary_local_files() -> dict[str, dict]:
    ...
    verify_manifest(
        SGA3_PACKAGE_ROOT,
        "2E3698B0EEB7A5149191738987E1123CFC2A576E5FDA29F9CE7407AAFE4974CF",
    )
    ...
    if (
        ...
        or new_validation.get("reader", {}).get("pages") != 1_473
        or new_validation.get("reader", {}).get("reader_process_term_hits") != []
        or new_validation.get("source_archive", {}).get("members") != 903
...
Project-facing production-status, source-status, and workflow commentary is
kept outside the readers.

The preferred SGA3 reader has 1,473 A4 pages and covers the Editorial Notice,
Introduction, Exposes I-XXVI, Tome-I index, Tome-III mathematical guide, and
terminal index. R16 integrates the native successors for Exposes X, XVI, and
XVIII. Its exact recursive source closure and superseded R15 reader are grouped
in `{SGA3_ZIP}`.
...
def generate_controls(
    ...
    validation["sga3_replaced_with_reader_clean_r16_native_update"] = True
    ...
    validation["readers"]["SGA3"] = {
        ...
        "pages": 1_473,
        "named_destinations": 9_488,
        "internal_goto_actions": 4_591,
        "invalid_actions": 0,
        "raster_xobjects": 145,
        "native_updated_exposes": ["X", "XVI", "XVIII"],
