#!/usr/bin/env python3
"""Guarded six-concept Zenodo publisher for the 2026-08-02 provenance release.
...
* all six concepts and current heads are compiled into this program;
...
* all six drafts are staged and revalidated before the first is published;
...
CONTROL_BINDING_MANIFEST_NAME = "ALL_SESSION_PROVENANCE_TRANCHE_INDEX.json"
CONTROL_PATH = Path(
...
TARGETS: dict[str, dict[str, Any]] = {
    ...
    "deligne": {
        "predecessor_record": 21_745_061,
        "concept_id": 20_410_853,
        "concept_doi": "10.5281/zenodo.20410853",
    },
    "sga7": {
        "predecessor_record": 21_756_931,
...
def validate_dual_doi(manifests: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    if isinstance(binding_document, dict):
        binding_candidates = [binding_document.get("control_binding") or {}]
    elif isinstance(binding_document, list):
        binding_candidates = binding_document
    else:
        binding_candidates = []
    binding_matches = [
        row
