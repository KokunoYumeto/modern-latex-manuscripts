#!/usr/bin/env python3
"""Read back the SGA7 II through Expose XX 4.3 GitHub publication."""
...
SOURCE_COMMIT = "d8d065f4c346c712943580ff75b2e60d87bb00c3"
MERGE_COMMIT = "880358f6b7e5c93d5b76f8875af34234309fab8f"
PULL_REQUEST = 244
REPOSITORY = "KokunoYumeto/modern-latex-manuscripts"
RECEIPT_STEM = (
    "20260802_sga7ii_english_expose_xx_4_3_"
    "commit_880358f6b_public_readback"
)
...
def main() -> int:
    ...
    md_path.write_text(
        "\n".join(
            [
                "# SGA7 II through Expose XX Section 4.3 GitHub readback",
                "",
                ...
                "reader/source ZIP, both source-image ZIPs, controls, and builders.",
                "",
            ]
        ),
        encoding="utf-8",
