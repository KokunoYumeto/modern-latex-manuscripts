#!/usr/bin/env python3
"""Publish and read back the SGA6 idx379-584 source-audit crop successor."""
...
PREDECESSOR_RECORD = 21623401
PREDECESSOR_DOI = "10.5281/zenodo.21623401"
SUCCESSOR_RECORD = 21627252
SUCCESSOR_DOI = "10.5281/zenodo.21627252"
VERSION = "2026-07-27 SGA6 ultra-detail source-audit crops idx379-584"
DEFAULT_PREVIEW = (
...
TEMP_ROOT = Path(
    os.environ.get(
        ...
        / "Temp"
        / "sga6_idx379_584_release_20260727",
    )
)
...
READBACK_ROOT = Path(
    os.environ.get(
        ...
        Path(os.environ["LOCALAPPDATA"])
        / "Temp"
        / "sga6_idx379_584_zenodo_21627252_public_readback",
    )
)
...
LOCAL_FILES = {
    "09_README_CURRENT_RELEASE.md": (
        ...
        3_695,
        "263AEBD9EF820EF6D65506A3F5591FEC032C87ACCF0E084268D3AD0425BFC5DD",
    ),
    "09a_RELEASE_FILE_MANIFEST.csv": (
        CONTROLS_ROOT / "09a_RELEASE_FILE_MANIFEST.csv",
        21_102,
        "F489AFE6BEDAACCE7E3CAB849552D5795F799EB5B5AF0E91C32B1327020AC8AB",
    ),
    "09b_RELEASE_VALIDATION.json": (
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        3_727,
        "1A6C5E81C069C5C38C234997D4B1083A066F2B378AF00472E948D3FF5EE23E45",
    ),
    "10x_SGA6_SourceAudit_Targeted_UltraDetail_Crops_idx379_584_20260727.zip": (
        TEMP_ROOT
        / "10x_SGA6_SourceAudit_Targeted_UltraDetail_Crops_"
        "idx379_584_20260727.zip",
        12_530_655,
    ...
    "10y_SGA6_SourceAudit_Crop_Provenance_RightsBlocked_Metadata_idx379_584_20260727.zip": (
        ...
        "Metadata_idx379_584_20260727.zip",
        1_294_722,
        "DB49DBFBD4CECAD0AE9E4DFA0F5DB8C3D2BFE914EC74A13877409C3C1FB52AC0",
    ),
}

EXPECTED_OUTER_FILES = 60
EXPECTED_OUTER_BYTES = 324_255_907
EXPECTED_RETAINED_FILES = 55
EXPECTED_ZIP_ARCHIVES = 34
EXPECTED_ZIP_FILE_MEMBERS = 3_553
EXPECTED_ZIP_DIRECTORY_ENTRIES = 7
EXPECTED_ZIP_ALL_ENTRIES = 3_560
EXPECTED_ZIP_UNCOMPRESSED_BYTES = 371_166_464
RELEASE_CONTROL_COMPATIBILITY_COUNTER = 3_559
GITHUB_COMMIT = "37db29ed31a2b6a6cf732c329c130a2bf69815be"
GITHUB_PACKAGE = (
    "sources/sga/"
    "sga6-ultradetail-source-audit-crops-coldreverify-idx379-584-20260727"
)

DESCRIPTION_PARAGRAPHS = [
    (
        "This same-concept compact successor preserves the reader-first SGA "
        "surface from version 10.5281/zenodo.21623401. Fifty-five predecessor "
    ...
    (
        ...
        "source re-verification. They map parent indices 379-584 to the stable "
        "206-entry audit boundary #1131-#1336 and span Exposes VI-X plus the "
        "Expose X appendix. Every crop records parent identity, source page, "
        "pixel bounding box, dimensions, scaling, generator identity, linked "
        "audit entry, target context, and QA disposition."
    ),
    (
        "The paired provenance archive records 1,030 routine full-width page "
        ...
        "while their pixels are withheld. It also records eight tight "
        "alternatives that were generated but never opened; those pixels are "
        "withheld rather than represented as reviewed evidence."
    ),
    (
    ...
    (
        ...
        "rights transfer is asserted. Machine-assisted contributors include "
    ...
    (
        ...
        "and VIII; Expose VII and Exposes IX-XXVI remain absent. This successor "
...
NOTES_TEXT = (
    ...
    "This version has 60 files and 34 ZIP archives. Literal archive replay "
    "contains 3,553 non-directory file members plus seven directory records "
    "(3,560 ZIP records total), totaling 371,166,464 uncompressed bytes. The "
    "release-control lineage compatibility counter is 3,559: the predecessor's "
    "legacy 3,393 counter plus 166 new non-directory members. SGA1 remains the "
...
def predecessor_identities() -> dict[str, dict]:
    ...
    if len(rows) != 58:
        raise RuntimeError("Predecessor receipt does not contain 58 files")
    result = {
        row["filename"]: {
            "bytes": int(row["bytes"]),
...
def anonymous_readback(
    ...
    zip_receipt = {
        ...
        "compatibility_counter_note": (
            ...
            "legacy 3,393 counter and adds 166 new non-directory members. "
            "Literal replay has 3,553 non-directory files plus seven directory "
            "records, or 3,560 total ZIP records."
        ),
    ...
    receipt = {
        ...
        "metadata": {
            ...
            "description_exact": True,
            "notes_exact": True,
            "scope": "SGA6 source-audit crops idx379-584",
            "selected_opened_crops": 155,
            "routine_page_bands_metadata_only": 1_030,
            "generated_unread_tight_crops_metadata_only": 8,
            "stable_audit_entries": "1131-1336",
        },
        "zip_archive_count": len(zip_summaries),
        "zip_file_member_count": len(zip_members),
        "zip_directory_entry_count": directory_entries,
