#!/usr/bin/env python3
"""Publish and read back SGA7 I English through Expose VI, Section 3."""
...
PREDECESSOR_RECORD = 21_723_980
PREDECESSOR_DOI = "10.5281/zenodo.21723980"
PREDECESSOR_FILES = 83
PREDECESSOR_BYTES = 676_065_021
FINAL_FILES = 83
DEFAULT_PREVIEW = "00a_SGA1_English_Reader.pdf"
CONTROLS_NAME = "10z_SGA_Current_Release_Controls_20260730.zip"
VERSION = "2026-07-31 SGA7 I English I-II and VI through Section 3"

REPO_ROOT = Path(__file__).resolve().parents[1]
PACKAGE_REL = Path(
    "sources/sga/"
    "sga7i-english-source-first-working-i-ii-vi-section-3-complete-20260731"
)
PACKAGE_ROOT = REPO_ROOT / PACKAGE_REL
TEMP_ROOT = REPO_ROOT / "tmp/zenodo/sga7i-english-section3-complete-20260731"
...
RECEIPT_TAG = "20260731_sga7i_english_i_ii_vi_section3_complete"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260731_sga7i_english_i_ii_vi_through_3_6_"
    "record_21723980_public_readback.json"
)
GITHUB_PACKAGE_COMMIT = "2b2bc85edcadaefcc1995f53926530e8cccf54d2"

OLD_PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Through_3_6_20260731.pdf"
OLD_TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Through_3_6_20260731.tex"
OLD_SOURCE_ZIP_NAME = (
    "10i_SGA7I_English_Working_I_II_VI_Through_3_6_"
    "Reader_and_TeX_20260731.zip"
)
PDF_NAME = "00i_SGA7I_English_Working_I_II_VI_Section3_Complete_20260731.pdf"
TEX_NAME = "02i_SGA7I_English_Working_I_II_VI_Section3_Complete_20260731.tex"
SOURCE_ZIP_NAME = (
...
EXPECTED_PACKAGE_FILES = 45
EXPECTED_PACKAGE_BYTES = 1_572_937
EXPECTED_MANIFEST = (
    6_757,
    "5279D6EEA1517409313A930C2446A102677A85AF7E2285BA9ECA9141C760FF59",
)
EXPECTED_VALIDATION = (
    4_372,
    "3238243C1A66A395F205D97F7557BBDB4319A4FE8A9ECE2533A7912D91DF593A",
)
EXPECTED_PDF = (
    657_406,
...
EXPECTED_TEX = (
    4_584,
    "9BDBFFB307EE7ED18B2CE955A02D5E3E6861EF6CF1D8B6E7ADC1B7FDF7F04A2A",
)
EXPECTED_SOURCE_ZIP = (
    674_730,
...
DESCRIPTION_ADDITION = (
    ...
    "replaces the earlier Corollary-3.6 tranche with one 66-page A4 working reader "
    "containing complete English Exposes I and II and Expose VI from its "
    "opening through Remark 3.16, completing Section 3. The exact continuation "
    "is Section 4, French working-source line 2451, scan index 105, source "
    "folio 94. "
    "Exposes VII-IX and the remainder of Expose VI are excluded. The direct "
    "master and compact 42-member archive provide the exact 37 editable "
...
NOTES_ADDITION = (
    ...
    "isolated two-pass rebuild has zero diagnostics. All 66 pages preserve "
    "the frozen producer text, decoded content, and geometry. The previously "
    "reviewed page-52 diagram remains set at normal mathematical size, and all "
    "13 newly added pages were directly reviewed at 300 dpi. The controlling scan is "
...
def verify_package() -> dict[str, object]:
    ...
    if len(rows) != 43 or {row["path"] for row in rows} != set(represented):
    ...
    if not source_zip.is_file():
        source_zip = PACKAGE_ROOT / (
            "SGA7I_English_SourceFirst_Working_I_II_VI_Section3_Complete_"
            "Reader_and_TeX_20260731.zip"
        )
...
def local_uploads() -> dict[str, dict[str, object]]:
    ...
    paths = {
        ...
        / "reader/SGA7I_English_SourceFirst_Working_I_II_VI_Section3_Complete_20260731.pdf",
        TEX_NAME: PACKAGE_ROOT
        / "source/SGA7I_English_SourceFirst_Working_I_II_VI_Section3_Complete_20260731.tex",
        SOURCE_ZIP_NAME: PACKAGE_ROOT
        / "SGA7I_English_SourceFirst_Working_I_II_VI_Section3_Complete_Reader_and_TeX_20260731.zip",
    }
    expected = {
...
complete Exposes I-II and Expose VI through Remark 3.16, completing Section 3.

The exact continuation is Section 4, French working-source line 2451, scan
index 105, source folio 94. The remainder of VI and Exposes VII-IX are absent.
...
""",
    ...
    base.save_json(
        CONTROLS_ROOT / "09b_RELEASE_VALIDATION.json",
        {
            ...
            "reader_pages": 66,
            "editable_tex_files": 38,
            "continuation": {
                "unit": "Section 4, Formal moduli of deformations",
                "french_working_source_line": 2451,
                "scan_index_zero_based": 105,
                "source_folio": 94,
            },
            "source_zip_members": 42,
...
def public_readback(
    ...
    if (
        ...
        or retained_errors
        or int(archives[SOURCE_ZIP_NAME]["members"]) != 42
    ):
    ...
    (RECEIPT_ROOT / f"{RECEIPT_TAG}_record_{record_id}.md").write_text(
        "\n".join(
            [
                "# SGA7 I English through Expose VI Section 3 publication receipt",
                "",
                ...
                f"- Reader/source ZIP: 42 members / `{EXPECTED_SOURCE_ZIP[1]}`",
                "- Scope: Exposes I-II complete; VI through Remark 3.16 / Section 3 complete",
                "- Continuation: Section 4 / source line 2451 / scan index 105",
