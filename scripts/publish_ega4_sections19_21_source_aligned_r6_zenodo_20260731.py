#!/usr/bin/env python3
"""Publish the corrected EGA IV Sections 19-21 source-aligned r6 reader."""
...
publisher.PREDECESSOR_RECORD = 21_715_531
publisher.PREDECESSOR_DOI = "10.5281/zenodo.21715531"
publisher.EXPECTED_PREDECESSOR_FILES = 44
publisher.EXPECTED_PREDECESSOR_BYTES = 3_745_045_609
publisher.EXPECTED_FINAL_FILES = 44
publisher.EXPECTED_FINAL_BYTES = 3_745_046_266
publisher.EXPECTED_SOURCE_IMAGES = 0
publisher.EXPECTED_ZIP_MEMBERS = 19
publisher.VERSION = (
    "2026-07-31 EGA IV Sections 19-21 and Part 4 source-aligned r6 reader"
)
publisher.GITHUB_COMMIT = "443693683ea1b07bbbf18eb27e6e00cb1820ec7a"
publisher.GITHUB_PATH = (
    "sources/ega/checkpoints/"
    "ega4-sections19-21-part4-backmatter-source-aligned-r6-20260731"
)
publisher.ZIP_ROOT = Path("C:/w/e620/tmp/zenodo/ega4-sections19-21-r6-20260731")
publisher.READBACK_ROOT = Path(os.environ["LOCALAPPDATA"]) / "Temp" / (
    "ega4_sections19_21_source_aligned_r6_readback_20260731"
)
publisher.PREDECESSOR_RECEIPT = publisher.RECEIPT_ROOT / (
    "20260731_ega4_sections19_21_part4_backmatter_"
    "record_21715531_public_readback.json"
)
publisher.RECEIPT_TAG = "20260731_ega4_sections19_21_source_aligned_r6"
...
READER_PATH = REPO_ROOT / (
    "sources/ega/checkpoints/"
    "ega4-sections19-21-part4-backmatter-source-aligned-r6-20260731/reader/"
    "EGA4_Sections19_21_Part4_Backmatter_English_SourceAligned_R6_20260731.pdf"
)
SOURCE_ZIP_PATH = publisher.ZIP_ROOT / (
    "02f_EGAIV_English_Sections19_21_Part4_Backmatter_"
    "SourceAligned_R6_TeX_PDF_20260731.zip"
)
...
NEW_DESCRIPTION = (
    "<p><strong>EGA IV Sections 19-21 and Part 4 backmatter:</strong> "
    "this corrected successor provides the 133-page source-aligned r6 English "
    "reader covering Sections 19-21 (printed pages 185-332), the bibliography, "
    "notation and terminology indexes, contents, and Errata/Addenda List 3 "
    "(printed pages 333-343 and 345-361). The source ZIP contains the exact "
    "editable TeX, build harness, reader, and validation controls. This r6 "
    "successor corrects notation-index readings and the List-3 p.94 locator in "
    "the predecessor while preserving that predecessor immutably. It is a "
    "bounded reader, not a cumulative EGA IV Sections 1-21 reader; the direct "
    "cumulative EGA IV reader on this record remains the Sections 1-10 edition.</p>"
)
publisher.DESCRIPTION_REPLACEMENTS = ((OLD_DESCRIPTION, NEW_DESCRIPTION),)
publisher.DESCRIPTION_ADDITION = ""
publisher.NOTES_ADDITION = (
    "<p>Files 00f and 02f now carry the corrected source-aligned r6 bounded "
    "reader and source archive. The actual publicly available scan-derived "
    "pixels remain directly preserved in archives 84-89e; none were replaced "
    "by a ledger or reader screenshots, and byte-identical image archives were "
    "not duplicated in this successor. EGA 0 remains the default preview.</p>"
)
IMAGE_DESCRIPTION = (
...
def verify_local() -> dict[str, dict[str, object]]:
    """Verify the replacement reader and source ZIP before remote mutation."""
    ...
    for name, expected in publisher.NEW_FILES.items():
        ...
        local[name] = row
    if sum(int(row["bytes"]) for row in local.values()) != 1_893_094:
...
def public_readback(
    ...
    result = {
        ...
        "retained_predecessor_files": 42,
        "replaced_artifacts": len(publisher.NEW_FILES),
