#!/usr/bin/env python3
"""Publish one reader-clean SGA1-6 successor, including SGA3 R15."""
...
VERSION = "2026-07-29 reader-clean SGA1-6 with SGA3 Tome-I index"
GITHUB_COMMIT = "16b3c2c9f38723d4c7ec66c0505c11c9cb2e9f4f"
GITHUB_PACKAGE = (
    "sources/sga/sga3-english-complete-working-reader-clean-r15-20260729"
)
...
SGA3_PDF = "00c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.pdf"
SGA3_TEX = "02c00_SGA3_English_Complete_Reader_TomeI_Index_20260729.tex"
SGA3_ZIP = "10c9_SGA3_English_Complete_Reader_Source_and_History_20260729.zip"
...
EXPECTED_ZIP_FILE_MEMBERS = 5_598
EXPECTED_ZIP_DIRECTORY_ENTRIES = 6
EXPECTED_ZIP_ALL_ENTRIES = 5_604
EXPECTED_ZIP_UNCOMPRESSED_BYTES = 457_283_393
...
CONTROLS_ROOT = (
    ...
    / "Temp"
    / "sga_reader_clean_complete_r15_zenodo_controls"
)
READBACK_ROOT = (
    Path(os.environ["LOCALAPPDATA"])
    / "Temp"
    / "sga_reader_clean_complete_r15_zenodo_public_readback"
)
DRAFT_STATE = (
    RECEIPT_ROOT
...
PRIMARY_EXPECTED = {
    **previous.PRIMARY_EXPECTED,
    SGA3_PDF: (
        11_967_448,
        "3964C6BE7A731BC30E624E567A2B7D35006658E2F32FA72C494B10316A0A97D3",
    ),
    SGA3_TEX: (
        21_853,
    ...
    SGA3_ZIP: (
        13_467_520,
        "BD8F22CBB2FACAC422E9EB240C321F24F707E691528D0F3771AA46C527252D7F",
    ),
}
...
NEW_MANIFEST_ROWS = {
    **previous.NEW_MANIFEST_ROWS,
    SGA3_PDF: {
        "role": "english_reader",
        "provenance": (
            "preferred reader-clean 1473-page SGA3 cumulative; GitHub "
    ...
    SGA3_TEX: {
        ...
        "provenance": "direct editable master for the reader-clean SGA3 reader",
...
DESCRIPTION_PARAGRAPHS = [
    ...
    (
        "The direct reader PDFs omit project-facing AI, production-status, "
    ...
    (
        ...
        "the Tome-III mathematical guide, and the terminal index. Its source "
        "closure and the superseded 1,469-page reader are grouped in one ZIP."
    ),
    (
...
def verify_primary_local_files() -> dict[str, dict]:
    ...
    verify_manifest(
        SGA3_PACKAGE_ROOT,
        "3D244DB8992F9C525FD8CD4704C9384D72A248087F0B73ADDF4214C6488E7043",
    )
    ...
    if (
        ...
        or new_validation.get("source_archive", {}).get("members") != 902
...
Project-facing AI, production-status, source-status, and workflow commentary
...
terminal index. Its exact recursive source closure and superseded 1,469-page
reader are grouped in `{SGA3_ZIP}`.
...
def generate_controls(
    ...
    validation["sga3_replaced_with_reader_clean_r15"] = True
