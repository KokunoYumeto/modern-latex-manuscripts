#!/usr/bin/env python3
"""Read back the SGA7 II through XIX closeout at source and merge commits."""
...
SOURCE_COMMIT = "b13f585bbbeecc4468d7bc13739a93e0f43af8f7"
MERGE_COMMIT = "1c09e924aa3a981e874e75a0e1f8780f5ea0d1a2"
PULL_REQUEST = 242
REPOSITORY = "KokunoYumeto/modern-latex-manuscripts"
RECEIPT_STEM = (
    "20260801_sga7ii_english_xix_complete_"
    "closeout_commit_1c09e924a_public_readback"
)
...
def main() -> int:
    ...
    md_path.write_text(
        "\n".join(
            [
                "# SGA7 II through Expose XIX GitHub closeout readback",
                "",
