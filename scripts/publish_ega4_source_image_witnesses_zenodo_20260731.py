#!/usr/bin/env python3
"""Publish EGA IV source-image witness ZIPs on the existing EGA concept."""
...
PREDECESSOR_RECORD = 21_708_950
PREDECESSOR_DOI = "10.5281/zenodo.21708950"
CONCEPT_DOI = "10.5281/zenodo.20414353"
EXPECTED_PREDECESSOR_FILES = 30
EXPECTED_PREDECESSOR_BYTES = 506_842_049
EXPECTED_FINAL_FILES = 32
EXPECTED_FINAL_BYTES = 1_413_291_979
DEFAULT_PREVIEW = (
    "00a_EGA0_English_Complete_Through_Section13_Reference_v2_20260730.pdf"
)
VERSION = "2026-07-31 EGA IV high-detail source-image witnesses"
GITHUB_COMMIT = "0373041857e885c2e512df9bc14d2ca7417d46a6"
GITHUB_PATH = (
    "sources/ega/visual-evidence/"
    "ega4-sections16-18-source-image-witnesses-20260731"
)

REPO_ROOT = Path(__file__).resolve().parent.parent
ZIP_ROOT = Path(os.environ["LOCALAPPDATA"]) / "Temp" / (
    "ega4_source_image_witness_upload_20260731"
)
READBACK_ROOT = Path(os.environ["LOCALAPPDATA"]) / "Temp" / (
    "ega4_source_image_witness_readback_20260731"
)
RECEIPT_ROOT = REPO_ROOT / "manifests" / "published-zenodo"
PREDECESSOR_RECEIPT = RECEIPT_ROOT / (
    "20260730_ega_compact_reference_v2_record_21708950_public_readback.json"
)
DRAFT_STATE = RECEIPT_ROOT / (
    "20260731_ega4_source_image_witnesses_zenodo_draft_state.json"
)
...
NEW_FILES = {
    (
        ...
        "members": 188,
        "images": 184,
        "uncompressed_bytes": 473_666_291,
    },
    (
        ...
        "members": 163,
        "images": 159,
        "uncompressed_bytes": 432_680_801,
    },
}

DESCRIPTION_ADDITION = (
    "<p><strong>EGA IV source-image witnesses:</strong> this successor adds "
    "two ZIP archives containing 343 actual scan-derived PNG witnesses from "
    "the publicly available NUMDAM EGA IV Part 4 scan already downloadable "
    "on this record. They preserve 600/1800-dpi full-page and overlapping-band "
    "images plus targeted 5000/9000-dpi ambiguity crops. Images through "
    "printed page 78 correspond to completed source-alignment review; the 32 "
    "images for printed pages 79-86 are clearly marked as prepared witnesses "
    "without a completed-alignment claim. English-reader screenshots are "
    "excluded. Every member has page, dimensions, resolution, SHA-256, linked "
    "TeX, and QA disposition metadata.</p>"
)
NOTES_ADDITION = (
    "<p>The two EGA IV source-image witness archives follow the reader, TeX, "
    "source, and historical archives. They contain source-scan evidence, not "
    "redundant screenshots of the downloadable English readers. EGA 0 remains "
    "the default browser preview.</p>"
)
...
def stage_and_publish(
    ...
    base.save_json(
        RECEIPT_ROOT
        / f"20260731_ega4_source_image_witnesses_record_{draft_id}_draft_files.json",
        {
            "status": "PASS_STAGED",
            "errors": [],
            "predecessor_record": PREDECESSOR_RECORD,
    ...
    base.save_json(
        RECEIPT_ROOT
        / f"20260731_ega4_source_image_witnesses_record_{draft_id}_publish_response.json",
        {
...
def public_readback(
    ...
    if (
        ...
        or sum(int(row["members"]) for row in archives.values()) != 351
    ):
    ...
    result = {
        ...
        "added_source_images": 343,
        "added_zip_members": 351,
        "duplicate_concept_created": False,
        "second_draft_created": False,
    }
    zipped = {
    ...
    base.save_json(
        RECEIPT_ROOT
        / f"20260731_ega4_source_image_witnesses_record_{record_id}_public_readback.json",
        result,
    )
    base.save_json(
        RECEIPT_ROOT
        / f"20260731_ega4_source_image_witnesses_record_{record_id}_zip_member_readback.json",
        zipped,
    )
    return result
