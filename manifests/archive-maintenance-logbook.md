# Archive Maintenance Decision Log

`archive-maintenance-logbook.jsonl` is append-only. Each row records a consequential publication, supersession, rights, privacy, naming, evidence, or routing choice. Corrections append a new row that cites the earlier decision; existing rows are not silently rewritten.

Required fields include alternatives, choice, motivation, evidence, uncertainty/adverse evidence, consequences, review status, revisit conditions, related artifacts, and a public-claim boundary. Delivery, archive review, incorporation, publication, readback, rights clearance, and human validation remain separate states.

## 2026-07-19 - SGA1 I.5 and SGA2 Expose V

- Published and read back Zenodo version `10.5281/zenodo.21435007` on the
  existing SGA concept.
- Replaced the current SGA1 I.3 surface with I.5, added complete bounded SGA2
  Expose V, and retained all fourteen SGA5/6 objects exactly.
- Published 25 indexed project-generated target/QA images and no French-source
  pixels.
- Changed the record rights field from historical CC0 metadata to License Not
  Specified because no blanket source or translation license is asserted.

## 2026-07-19 - SGA2 Expose VI and direct TeX

- Published and read back historical Zenodo version `10.5281/zenodo.21435246`
  on the existing SGA concept.
- Added complete bounded SGA2 Expose VI and exposed direct cumulative TeX
  beside the SGA1 I.5 and SGA2 V-VI PDFs.
- Kept machine ledgers, build evidence, and project renders in coherent support
  packages. A wrap-aware privacy projection repaired evidence-only logs whose
  nominal sanitization had missed line-split local paths.

## 2026-07-19 - SGA1 I.6 current successor

- Published and read back historical Zenodo version `10.5281/zenodo.21435334` on
  the existing SGA concept.
- Replaced SGA1 I.5 with a ten-page checkpoint through I.6 while retaining the
  SGA2 V-VI and SGA5/6 objects exactly.
- Exposed direct PDF/TeX pairs for current SGA1 I.6 and SGA2 Exposes V-VI;
  grouped ledgers and render evidence remain available.
- Indexed 37 project-generated renders and no French-source pixels. SGA1
  continues at line 1217 / I.7; SGA2 continues at line 2274 / Expose VII.

## 2026-07-19 - SGA direct PDF/TeX surface

- Published and read back current Zenodo version `10.5281/zenodo.21435547` on
  the existing SGA concept.
- Added five direct TeX companions, bringing the current record to eight reader
  PDFs and eight matching TeX downloads across SGA1, SGA2, SGA5, and SGA6.
- Independently rebuilt every added source against its retained reader; page
  counts and extracted text match, and the flattened SGA6 English source has no
  unresolved TeX dependencies.
...
## 2026-07-19 - SGA2 Expose VIII Corollary 2.3 custody

- Added independently sealed bounded unit C23 for French lines 2670-2681,
  including Corollary 2.3 and editor note (4). The next cursor is the proof at
  French line 2683 after excluded blank line 2682.
- Replayed all 33 producer rows. The public GitHub projection retains 29
  exact non-source members plus the producer manifest and machine validation.
- Represented four duplicate French source-render rows in a rights-blocked
  ledger rather than publishing source pixels. Both open target renders passed
...
## 2026-07-19 - SGA2 Expose VIII P32S remote readback

- Published the bounded P32S projection on public `main` as commit
  `972a6b809e5dd9b7ce97ffa245c8966d55804404`.
- Downloaded all 35 files from the public raw-content endpoint at that exact
  commit. The directory contains exactly 35 files / 1,327,506 bytes, with no
  missing or extra object and zero byte-count or SHA-256 mismatch.
- The public descriptor, TeX, and PDF retain SHA-256
  `8C6D6984C748C17D8DFFA9F8EF65799910BAC3424AA427BF097892754EB4EADE`,
  `0CA96E488EEA989BD02230DC1047705A0A85F3F6DFE826EE0F0F2F94F6DFFFE3`,
  and `2F2C1049289DC9400DEAAA7F29B9D2AF2A9376859B5D6F269A17B66A3C4C8E85`.
- GitHub custody and downloadable readback are complete for this bounded
...
## 2026-07-22 - SGA2 Expose X Lemma 3.9 statement public GitHub readback

- Pull request `33` merged the exact package to public `main` commit
  `fa41ea92b84fc56eefb09a08da56c5083cf71b8c`.
- A separate sparse clone of public `main` resolved to that merge commit and
  revalidated 74 files / 5,634,234 bytes. All 72 manifest rows matched by
  path, byte count, and SHA-256 with zero missing, extra, size, or hash
  difference.
- The downloaded manifest retained SHA-256
  `FB68B68B58C22C645A812E7C4D80A139889C002834A81ADB5D96DFD04D67D5C3`;
...
- The target TeX retained its handoff hash. The target and retained independent
  PDFs remained byte-identical; both remained one-page A4, unencrypted,
  JavaScript-free, with all 36 total font rows embedded, subset, and Unicode.
  The render and extracted-text pairs remained byte-identical.
- JSON-family parsing and whole-payload privacy checks passed on the downloaded
...
## 2026-07-22 - SGA2 Expose X line 3588 hold public readback

- Pull request [#47](https://github.com/KokunoYumeto/modern-latex-manuscripts/pull/47)
  merged the metadata-only hold at public `main` commit
  `c1994efc86b8bbf39824d9acb1b8078e0abd8974`.
- A fresh sparse clone resolved exactly to that commit with a clean worktree.
  Five ordinary files matched byte for byte. The JSONL has Git blob
  `ab9ab524a89981d887e599eec81c25b492f43702` in both views and normalizes to
  SHA-256
  `5CF3EC9EAFEF7BD66485C8212B3FE6C6CD833B94E07D79A6C4EEB2E47F32B6F4`.
  Both copies parse as 76 records with 76 unique decision IDs.
- The public tree contains the metadata and status controls but no line-3588
  TeX, PDF, source slice, target render, source raster, machine-panel image,
  comparison excerpt, raw log, or preserved privacy-failure evidence.
...
## 2026-07-28 - SGA3 cumulative through XVIII published

- GitHub package commit
  `9245278d0e8fbcf5abd9f162b971f21bae17552a` publishes the exact
  cumulative package at
  `sources/sga/sga3-english-current-progress-cumulative-through-xviii-20260728`.
  Commit-pinned anonymous raw readback passed all 10 files / 18,285,435 bytes
  and all 989 source-archive members.
- Existing-concept Zenodo version `10.5281/zenodo.21634836` succeeds
  immutable predecessor `21634000`; no duplicate concept, parallel successor,
  or second draft was created.
- The 1,008-page preferred current-progress SGA3 reader covers the Editorial
  Notice, Introduction, Exposes I-XIV, XVI, and XVIII. It has explicit gaps
  for Exposes XV, XVII, and XIX-XXVI and remains labelled working and
  incomplete.
- The reader is 6,014,746 bytes, SHA-256
  `4E4EA3DABB65689EF883A93D2B91D92BFD0C9A2DECE70EB5E7C7C7910808E12F`.
  It has 6,304 named destinations, 3,849 valid internal GoTo actions, and zero
  broken internal GoTo actions.
- The direct master TeX is 20,054 bytes, SHA-256
  `DDC52AA84CCFA88842ED8A3D913ABB420B6531B7204E391AD855C73CFEC3F892`.
  The 989-member integration-source ZIP is 12,227,078 bytes, SHA-256
  `220E1E61E39E460E7757F8D2C6C50EF6220099B47E1180846A19D4305EF35B9D`.
- The final surface has 65 files / 386,280,335 bytes. Anonymous SHA-256
  readback passed 65/65, including all 59 retained predecessor files.
- All 46 public ZIPs reopened. Exact replay found 4,229 file members, six
  directory entries, and 402,367,689 uncompressed bytes.
- SGA1 remains the default preview. Numeric file order keeps the new SGA3
  reader as the third direct English reader after SGA1 and SGA2.
- Publication-receipt commit
  `1cf1c3f95b0582dd82d305366f73d541376111cb` is public on `main` and
  the archive branch. Commit-pinned anonymous readback matched all 15 changed
  files / 2,968,106 bytes.
- Shared decision `EG-SGA3-XVIII-PUBLICATION-20260728-0001` was appended
  through the locked helper. The resulting log has 292 records / 1,816,620
  bytes, SHA-256
  `571604BCD965A3931F693826A766E1ECFA1EC6960A398B5DAE4B29D10BDEB9AD`,
  with `errors[]`.
- The separate decision record is 5,759 bytes, SHA-256
  `B3250E4D89376E7B7A197DF2DA015D1214393D3A0E56FFE291DBD0220C8920A7`.
- Exact receipts are
  `manifests/published-zenodo/20260728_sga3_through_xviii_record_21634836.md`,
  the adjacent `public_readback.json`, the adjacent
  `zip_member_readback.json`,
...
- GitHub package commit
  `5b20b60912594003716be77974157f9ce1f9336e` publishes the exact package
  at
  ...
  1,059 source/history ZIP members.
- Existing-concept Zenodo version `10.5281/zenodo.21636902` succeeds
  immutable predecessor `21636270`; no duplicate concept, parallel
  successor, or second draft was created.
- The 1,166-page preferred SGA3 current-progress reader contains complete
  current working bodies for the Editorial Notice, Introduction, Exposes
  I-XVI, XVIII, and XX; partial XVII through Section 5.9, XXI through
  Application 2.1.2, and XXII through Proposition 4.1.2; and explicit gaps
  for XIX and XXIII-XXVI.
- The reader is 7,359,704 bytes, SHA-256
  `93168452B4BBF0FE9835E2D9E4614BAD046A366D9C704D2646934D77C8FB9120`.
  It has 7,340 named destinations, 4,004 valid internal GoTo actions, zero
  invalid or external actions, 63 font resources, and zero Type3 fonts.
- The direct master TeX is 28,921 bytes, SHA-256
  `9AE3AB7772BD9690322A86F71DAC4C792DD6063801052514C90C36531E03A695`.
  The 1,059-member source/history ZIP is 15,469,558 bytes, SHA-256
  `43F8B1F2C43C317BA43A7A0E70C133093B4D6E83F361D9599FC410AA3EEC271F`.
- A post-freeze Claude-style high-zoom audit found five Expose-V layout
  defects in figures 007-011 involving bottom arrow-label side or placement.
  Mathematical content was intact. This publication is working preservation,
  not final diagram-fidelity closure; later no-overwrite corrected components
  remain pending.
- The final Zenodo surface has 67 files / 394,315,032 bytes. Anonymous
  SHA-256 readback passed 67/67, including all 61 retained predecessor files.
- All 48 public ZIPs reopened. Exact replay found 4,378 file members, six
  directory entries, and 409,414,408 uncompressed bytes.
- SGA1 remains the default preview. The latest endpoint resolves to
  `21636902`; authenticated predecessor and successor draft probes returned
  404, and no active parallel draft remains.
- Shared decision
  `EG-SGA3-CUMULATIVE-LATEST-PUBLICATION-20260728-0001` was appended through
  the locked helper. The resulting log has 295 records / 1,835,524 bytes,
  SHA-256
  `735DEFF092A3368F44B6348D11E91A941BEB0E1A56BB6C33981B019E7E7D82FE`,
  with `errors[]`.
- The separate decision record is 6,615 bytes, SHA-256
  `E2C7464EA84DC3B8CCC06E3E2487484DD7AAB283D5B58312F14E8FFA4FF3D8A3`.
- Exact receipts are
  `manifests/published-zenodo/20260728_sga3_cumulative_latest_record_21636902.md`,
  the adjacent `public_readback.json`, the adjacent
  `zip_member_readback.json`, and
...
- GitHub package commit
  `e852c35299397f3b1476437a9da3b8ce4b0c2bd5` preserves three bounded
  packages under `sources/sga`. Anonymous commit-pinned readback passed
  all 37 committed files and all 67 source-ZIP members.
- One successor was published under the existing SGA concept
  `10.5281/zenodo.20410947`: record/version DOI
  `10.5281/zenodo.21639977`, succeeding `21639459`. No duplicate concept,
  parallel successor, or second draft was created.
- Expose XII: 51-page reader / 282,869 bytes / SHA-256
  `17D3646EF85FB1C1D7831B646755C199C862E912935EC4B01DAA0DF0BF48ADDC`;
  five editable TeX files and two native diagrams. Lead comparison passed
  at 5000 dpi, with a 9000-dpi ambiguity escalation and one corrected
  label-side placement.
- Expose XIX: 27-page reader / 659,293 bytes / SHA-256
  `6C57558E58C3D27BF453C094121495F4EC66CF7CEC66E8790D783317BDD1DE39`;
  28 editable TeX files and one native diagram. Fresh archive 5000-dpi
  authority replay passed.
- Expose XXV: 14-page reader / 498,082 bytes / SHA-256
  `8F2FC8434D352354F1AA16A8A36913988768F2261F74072A5F7CF4D796BE04D9`;
  seven editable TeX files and two native diagrams. Lead 5000-dpi review
  passed.
- Three producer and three independent archive build passes completed for
  each reader. All 92 producer/rebuild pages match in extracted text,
  decoded content streams, geometry, and 150-dpi raster output.
- The three compact source/QA ZIPs have 67 safe file members / 320,353
  uncompressed bytes and contain no authority PDF, source crop, raster
  image, delivered raster diagram, raw private log, or private path.
- The final Zenodo surface has 82 files / 404,994,213 bytes. Anonymous
  SHA-256 readback passed 82/82. All 53 ZIPs reopened with 4,531 file
  members, six directory entries, and 419,157,854 uncompressed bytes.
- Seventy predecessor files remained byte-identical. The existing 1,182-page
  cumulative SGA3 reader remains readable history and was not represented
  as native-diagram-final. Exposes XX and XXI remain open under Session-C;
  Expose XXVI remains active.
- Existing 600/1200-dpi evidence remains valid append-only history and
  context. Only 300-dpi-only approvals and independently identified defects
  are reopened.
- Shared decision
  `EG-SGA3-XII-XIX-XXV-NATIVE-LOOP1-PUBLICATION-20260728-0001` was
  appended through the locked helper. The resulting log has 300 records /
  1,866,502 bytes, SHA-256
  `2F15DF5E61A110851916CD43B808B2E7E77909C838C587705220853F8A61B13F`,
  with `errors[]`.
- The separate decision record is 7,186 bytes, SHA-256
  `EA194771682D45B2354118DB789C510BA0495CB8DB82777EF49F9D68E15EB4FB`.
- Exact receipts are
  `manifests/published-zenodo/20260728_sga3_native_batch_xii_xix_xxv_record_21639977.md`,
  the adjacent Zenodo readbacks, and the two
  `manifests/published-github/20260728_sga3_native_batch_xii_xix_xxv_package_commit_e852c3529_*readback.json`
  receipts.

## 2026-07-28 - SGA3 Exposes XX and XXI native readers published

- GitHub package commit
  `9fc59e75e0bcaa4a0998aa14d397a843a4eaf15f` preserves two bounded
  packages under `sources/sga`. Anonymous commit-pinned readback passed
  all 26 package files and all 80 source-ZIP members.
- One successor was published under the existing SGA concept
  `10.5281/zenodo.20410947`: record/version DOI
  `10.5281/zenodo.21642747`, succeeding `21639977`. No duplicate concept,
  parallel successor, or second draft was created.
- Expose XX: 41-page reader / 236,958 bytes / SHA-256
  `0AFA79FC6140B72814EB0BA03191709C1CFC718F5CE0485AD8151E103FD1AB15`;
  19 editable TeX files and ten native atomic diagram panels. Lead
  comparison passed at about 5000 dpi; two copy-on-write repairs corrected
  one label side and one two-row page split.
- Expose XXI: 56-page reader / 295,397 bytes / SHA-256
  `A1C58F35B3AA2D29C02A9953B569295ACB0574786728432DD3D726E9F143F0D0`;
  41 editable TeX files and eleven native atomic diagram panels. Lead
  comparison passed at about 5000 dpi; two copy-on-write repairs restored
  an endpoint and corrected an arrow-label/isomorphism-mark placement.
- The submitted Expose-XXI r6 PDF had a stale table-of-contents page. The
  archive rebuilt the exact source closure through four passes. The public
  reader is the converged build; only the contents page changed, while the
  other 55 pages remain pixel-identical.
- Four fresh archive builds completed for each reader. Converged passes
  match in extracted text, decoded page content, geometry, destinations,
  links, fonts, and 150-dpi raster output. XX has 327 destinations and 46
  valid GoTo actions; XXI has 378 destinations and 240 valid GoTo actions.
- The two compact source/QA ZIPs have 80 safe members / 296,300
  uncompressed bytes and contain no authority PDF, source crop, raster
  image, delivered raster diagram, raw private log, or private path.
- The final Zenodo surface has 88 files / 405,660,724 bytes. Anonymous
  ...
  members, six directory entries, and 419,454,154 uncompressed bytes.
  Seventy-nine predecessor files remained byte-identical.
- The existing 1,182-page cumulative SGA3 reader remains readable history
  and was not represented as native-diagram-final. These bounded releases
  do not claim complete SGA3 or final certification of unfinished units.
- Existing 600/1200-dpi evidence remains valid append-only history and
  context. Only 300-dpi-only approvals and independently identified
  defects are reopened. The Session-C XII/XIV/XX/XXI/XXIII inventory is
  now 28/28 native PASS.
- Shared decision
  `EG-SGA3-XX-XXI-NATIVE-LOOP1-PUBLICATION-20260728-0001` was appended
  through the locked helper. The resulting log has 301 records /
  1,873,250 bytes, SHA-256
  `D79B5390877E4F3C917EDF4B9949D8280B72ED09C0CF57C99620D1D188B3E7F8`,
  with `errors[]`.
- The separate decision record is 7,345 bytes, SHA-256
  `D2F3731054130CF6B889463DC573B2A2145CAFDB6BD5F2C6E60664F4B0248FC2`.
- Exact receipts are
  `manifests/published-zenodo/20260728_sga3_native_batch_xx_xxi_record_21642747.md`,
  the adjacent Zenodo readbacks, and the two
...
## 2026-07-31 - EGA IV source images through printed page 105 published

- Published one additive successor under existing EGA concept DOI
  `10.5281/zenodo.20414353`. The immutable predecessor is `21712025`; the new
  current version is [`10.5281/zenodo.21712381`](https://doi.org/10.5281/zenodo.21712381).
- Added `86 EGA IV - Source Image Witnesses Printed 087-105 (600-1800dpi)
  20260731.zip`: 208,773,461 bytes, SHA-256
  `E89C05E3254FE335146D6E7AB8C47C59039438AF49E29CD4951127067BEC106C`.
- The ZIP has 76 actual scan-derived PNGs and four metadata/control files.
  Printed pages 87-104 are bound to completed alignment review; the four
  printed-page-105 images are explicitly the active continuation.
- Anonymous readback matched all 33 outer files / 1,622,065,440 bytes, all 32
  retained predecessor files, and all 80 ZIP members / 208,750,301
  uncompressed bytes exactly. EGA0 remains the default preview.
- GitHub metadata commit `22b9ba82a7570a3f3f6fc891772f45436555d862`
  publishes the provenance index; publisher commit
  `7a8e790ed17069b5a66260bef75d667264128c47` is also public.
...
## 2026-07-31 - EGA IV page 106-118 release records read back from GitHub

- Published the catalog, current-head pointers, human receipt, machine Zenodo
  receipts, and append-only log entry at GitHub commit
  `c064f739b369fcfeb0ab831a93a328eb594c861d`.
- Anonymous commit-pinned raw retrieval returned HTTP 200 and exact byte,
  SHA-256, and Git-blob identity for all 27 changed files / 2,633,897 bytes.
- Machine and human receipts:
  `manifests/published-github/20260731_ega4_source_image_witness_p106_118_closeout_commit_c064f739_public_readback.json`
  and the matching `.md` file.
- This closes public custody of the release records only; it does not add
  another Zenodo version or expand the direct EGA IV reader scope.
...
- GitHub PR [#218](https://github.com/KokunoYumeto/modern-latex-manuscripts/pull/218)
  merged the guarded editor, receipt, and logbooks as
  `e8b30555507f3d8439fb4937ad90e841f6ebded2` from source commit
  `5a1544133480f648f0202189f901e4d890866caa`. Anonymous commit-pinned
  readback matched all 4/4 blobs at both commits; canonical row SHA-256 is
...
## 2026-08-02 - SGA7 II English through Exposé XXI §4 closed

- Published the stronger 168-file privacy-clean working checkpoint containing
  complete English Exposés X-XX and Exposé XXI through §4 and its bibliography.
  The reader has 226 A4 pages; the §5 appendix is next and Exposé XXII remains
  absent.
- GitHub PR [#247](https://github.com/KokunoYumeto/modern-latex-manuscripts/pull/247)
  merged `508c171649722b2ec52459847344009b40fc7b29` as
  `b8eb3dcf25d48d43a9fca382ce8b850774f9ed19`. Anonymous replay matched
  176 files / 66,672,501 bytes at both commits; aggregate
...
- Published one successor under existing SGA concept
  ...
  Readback matched all 87 files / 780,139,801 bytes, all 83 retained
  identities, 160 reader/source members, 65 translated-scope image members,
  and all 17 release controls. No draft or duplicate concept remains.
- Reader SHA-256:
  ...
  Source-image ZIP SHA-256:
  `3CD57C39D77DFCDD8C6C51B2B5803E348C90E8D62D01D254A5487A7C3F09D22C`.
- PR [#248](https://github.com/KokunoYumeto/modern-latex-manuscripts/pull/248)
  merged `bdc3f0755ccf1fbe6a96031dc4990a43aa0d1f5d` as
  `5b1fafd7988f9ba6df33eda5f1677136355db277`; readback matched 28
  closeout files / 3,643,475 bytes at both commits, aggregate
  `95D89B9F2E27B963189DE84E3234D01A0C088A465EF8F2EEADE0BA965A86CDD4`.
- The locked helper appended
  `EG-ARCHIVE-SGA7II-ENGLISH-XXI-4-CLOSEOUT-20260802-0001`: 444 records /
  2,794,206 bytes / SHA-256
  `772700BCBCCD3CEAF87D199F766DBC8482F554ADE8AB879EC6CDB59DB2F9301B`,
  with `errors=[]`.
- SGA1 remains the preview only until an exact internally linked cumulative
  SGA 1-7.2 reader is delivered and replayed. That global PDF will then be
  fronted while the standalone readers remain direct.
- Exact receipts:
  `manifests/published-github/20260802_sga7ii_english_expose_xxi_4_closeout_commit_5b1fafd79_public_readback.json`,
