...
- Non-European and multilingual mathematics consolidated corpus: https://zenodo.org/records/20424994
...
- The main landing page now points to SGA `20426470`, states that the current SGA 5 reader is complete, and explains that older cross-author shelves are preservation surfaces while author/corpus pages are the recommended public entry points where they exist.
...
- Keep `20424994` as the main non-European/multilingual front door.
