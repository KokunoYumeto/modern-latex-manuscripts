...
- Process-note assessment: no process-note hit; quality/layout issue only
...
- Process-note assessment: possible placeholder/front-matter word; verify and replace if it is editorial scaffolding
...
- Process-note assessment: likely manuscript-codex false positive; verify visually/textually before changing
