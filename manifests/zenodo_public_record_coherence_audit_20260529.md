...
- `02 Islamic and Arabic Texts - Combined Original and Reference Drafts.pdf`
- `10-12 English Translation - al-Khwarizmi - Algebra.pdf`
- `01 Islamic and Arabic Texts - Combined English Translation Drafts.pdf`
- `60-07 Reference Scan - Robert of Chester and Karpinski (1915).pdf`
- `80 Islamic and Arabic Mathematical Texts - TeX Sources and Artifacts.zip`
- `90 Islamic and Arabic Mathematical Texts - Public Summary.json`
- `10-13 English Translation - al-Tusi - Shakl al-Qatta.pdf`
...
### riemann (20434317)
- `90 Artifacts - Riemann - Selected Papers.zip`
- `10 Reader PDF - Riemann - Gesammelte Werke Complete Draft.pdf`
...
- `90 Carl Friedrich Gauss - Public Summary.json`
- `03 Carl Friedrich Gauss - Werke, Band III - Modern LaTeX Draft.pdf`
- `01 Carl Friedrich Gauss - Werke, Band I - Alternate Modern LaTeX Draft.pdf`
- `00 Carl Friedrich Gauss - Werke, Band I - Modern LaTeX Draft.pdf`
- `02 Carl Friedrich Gauss - Werke, Band II - Modern LaTeX Draft.pdf`

### deligne (20414959)
- `10-015 Deligne - Unirational nonrational variet - Original.pdf`
- `10-084 Deligne - Finitude de l extension de Q e - Original.pdf`
- `10-032 Deligne - La conjecture de Weil II - Original.pdf`
- `10-086 Deligne - Counting local systems with pr - Original.pdf`
- `99 Deligne - Public Summary.json`
- `10-025 Deligne - Support of the character of a - Original.pdf`
- `10-001 Deligne - Congruences for numbers of sub - Original.pdf`
- `10-053 Deligne - Le groupe fondamental de la dr - Original.pdf`

### classical_algebra_arithmetic (20418609)
- `33 Gauss - Werke, Band III - Modern LaTeX Draft.pdf`
- `36 Gauss - Werke, Band XI Part I - Modern LaTeX Draft.pdf`
- `41 Weber - Lehrbuch der Algebra, Band III - Modern LaTeX Draft.pdf`
- `80 Classical Algebra and Arithmetic - Sources, TeX, and Audits.zip`
- `35 Gauss - Werke, Band VII - Modern LaTeX Draft.pdf`
- `40 Weber - Lehrbuch der Algebra, Band I - Modern LaTeX Draft.pdf`
- `11 Dedekind - Gesammelte Mathematische Werke, Band II - Modern LaTeX Draft.pdf`
- `32 Gauss - Werke, Band II - Modern LaTeX Draft.pdf`

### additional_author_cluster (20416839)
- `05 Reader PDF - Oka - Analytic Functions of Several Variables I-X.pdf`
- `03 Reader PDF - Steinitz - Algebraische Theorie der Koerper.pdf`
- `07 Reader PDF - Grassmann - Ausdehnungslehre and Related Works.pdf`
- `09 Reader PDF - Killing - Transformationsgruppen.pdf`
- `04 Reader PDF - Hensel - Zahlentheorie.pdf`
