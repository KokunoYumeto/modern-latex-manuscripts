...
- Current pickup PDFs: **231**.
- Range/slice PDFs counted for source-page coverage: **228**.
- Surgical one-paper/one-section fix PDFs: **3**.
- Rendered pages in pickup PDFs: **5,457**.
- Unique source-scan page coverage from named ranges: **6,392 / 8,304 pages = 77.0%** across the 13 main Cayley volumes.
- Pickup size on disk: **66.9 MB**.
...
|---:|---:|---:|---:|---:|---:|---:|---|
| I | 620 | 486 | 78.4% | 134 | 21 | 0 | 1-12; 38-50; 251-262; 389-400; 438-450; 501-525; 574-620 |
...
| XII | 680 | 492 | 72.4% | 188 | 22 | 0 | 238-262; 276-300; 491-500; 553-680 |
| XIII | 594 | 450 | 75.8% | 144 | 18 | 0 | 151-200; 501-594 |

## Interpretation

- The pickup is now much larger than the older 124/127-file reports: **231 PDFs** are present.
...
- Source-TeX PDFs under `cayley_v2_fixes/sources_tex_Vol_*`: **217**.
- Source PDFs named in pickup manifest: **235**.
