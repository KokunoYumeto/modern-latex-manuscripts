...
%%% ZAMIJENITI SLJEDECA DVA na CALCULONU !!!
...
\makeindex
\newcommand{\lettergroup}[1]{ \par \nopagebreak }  % remove index headings
\begin{document}
\pagenumbering{roman}
...
\backmatter
\small
\index{Grupa|seealso{Liejeva grupa, Reprezentacija grupe}}
\index{Reprezentacija grupe|seealso{Ireducibilna reprezentacija}}
\index{Vektorski prostor|seealso{Hilbertov prostor}}
\index{Lorentzova grupa|seealso{SO$^{+}$(1,3)}}
\printindex
